...
`)),Nr=/^<[^>]+>\s*/,Fr=/@\[([^\]]+)\]/g,Dr=/@(\w+)/g,Er={recipient_type_entity:"select.hivefw_recipient_type",channel_entity:"select.hivefw_channel",contact_entity:"select.hivefw_contact",channel_entity_pattern:"binary_sensor.hivefw_{prefix}_ch_{idx}_messages",contact_entity_pattern:"binary_sensor.hivefw_{prefix}_{contact}_messages",domain_filter:"hivefw"},Or={...Er,hours_to_show:48,initial_hours:1,max_messages:500,show_date_separators:!0,group_messages:!0,group_timeout:300,timestamp_format:"time",update_mode:"auto",refresh_interval:30,enable_cache:!0,cache_ttl:86400,cache_max_size:5242880};async function Pr(e){try{return(await e.callWS({type:"hivefw_integration/get_devices"})).devices||[]}catch(e){return[]}}async function Br(e,t){try{const i={type:"hivefw_integration/get_contacts"};return t&&(i.entry_id=t),(await e.callWS(i)).contacts||[]}catch(e){return[]}}async function Lr(e,t){try{const i={type:"hivefw_integration/get_channels"};return t&&(i.entry_id=t),(await e.callWS(i)).channels||[]}catch(e){return[]}}async function Hr(e,t){try{const i={type:"hivefw_integration/get_device_config"};return t&&(i.entry_id=t),await e.callWS(i)}catch(e){throw new Error("Failed to get device configuration")}}async function Ur(e,t,i){try{const a={type:"hivefw_integration/set_device_config",settings:t};return i&&(a.entry_id=i),await e.callWS(a)}catch(e){const t=e;return{success:!1,changed:[],error:t&&t.message?t.code?`${t.message} (${t.code})`:t.message:String(e)}}}async function qr(e,t){try{const i={type:"hivefw_integration/get_flood_scopes"};t&&(i.entry_id=t);const a=await e.callWS(i);return{scopes:a.scopes||[],global:!!a.global}}catch(e){return{scopes:[],global:!1}}}async function jr(e,t){const i={type:"hivefw_integration/get_local_repeater_status"};return t&&(i.entry_id=t),e.callWS(i)}async function Vr(e,t){const i={type:"hivefw_integration/get_local_regions"};return t&&(i.entry_id=t),e.callWS(i)}async function Wr(e,t,i="",a="",o){const s={type:"hivefw_integration/set_local_region",operation:t,name:i,parent:a};return o&&(s.entry_id=o),e.callWS(s)}async function Kr(e,t,i=!1){const a={type:"hivefw_integration/get_firmware_ota_status"};return t&&(a.entry_id=t),i&&(a.force=!0),e.callWS(a)}async function Gr(e,t,i,a){try{const o={type:"hivefw_integration/add_contact",public_key:t};return i&&(o.name=i),a&&(o.entry_id=a),await e.callWS(o)}catch(e){return{success:!1}}}async function Xr(e,t,i){try{const a={type:"hivefw_integration/remove_contact",public_key:t};return i&&(a.entry_id=i),await e.callWS(a)}catch(e){return{success:!1}}}async function Qr(e,t,i){try{const a={type:"hivefw_integration/mark_conversation_read",entity_id:t};return i&&(a.entry_id=i),await e.callWS(a)}catch(e){return{success:!1}}}async function Yr(e,t,i){try{const a={type:"hivefw_integration/set_location_source",source:t};return i&&(a.entry_id=i),await e.callWS(a)}catch(e){return{success:!1}}}class Jr{constructor(){this._counts={},this._lastRead={},this._subscribers=new Set,this._markReadRequestedHandler=null,this._readProgress=null,this._postSwitchTimerHandler=null}subscribe(e){return this._subscribers.add(e),()=>{this._subscribers.delete(e)}}onMarkReadRequested(e){this._markReadRequestedHandler=e}onPostSwitchTimerFire(e){this._postSwitchTimerHandler=e}requestMarkRead(e){e&&this._markReadRequestedHandler&&this._markReadRequestedHandler(e)}_notify(){for(const e of[...this._subscribers])try{e()}catch(e){console.error("[UnreadController] subscriber callback threw",e)}}ingestBackendData(e,t){var i,a;this._counts={...null!==(i=null==e?void 0:e.unread)&&void 0!==i?i:{}},this._lastRead={...null!==(a=null==e?void 0:e.last_read)&&void 0!==a?a:{}},this._notify()}clearEntity(e){e&&this._counts[e]&&(this._counts={...this._counts,[e]:0},this._notify())}get counts(){return this._counts}get lastRead(){return this._lastRead}beginConversation(e,t){var i;this._clearPostSwitchTimer();const a={entityId:e,anchorId:e&&null!==(i=this._lastRead[e])&&void 0!==i?i:null,unreadCountAtSelection:t,graceUntil:Date.now()+1e3,postSwitchTimer:null,markReadFired:!1,lastMarkReadIdSent:null};this._readProgress=a,a.postSwitchTimer=setTimeout(()=>{var e;this._readProgress===a&&(a.postSwitchTimer=null,null===(e=this._postSwitchTimerHandler)||void 0===e||e.call(this))},1e3)}endConversation(){this._clearPostSwitchTimer(),this._readProgress=null}_clearPostSwitchTimer(){const e=this._readProgress;null!=e&&e.postSwitchTimer&&(clearTimeout(e.postSwitchTimer),e.postSwitchTimer=null)}resetUnreadCountAtSelection(){this._readProgress&&(this._readProgress.unreadCountAtSelection=0)}maybeReanchorOnLateData(e){const t=this._readProgress;if(!t||t.entityId!==e)return!1;if(null!==t.anchorId)return!1;if(t.markReadFired)return!1;const i=this._lastRead[e];return!!i&&(t.anchorId=i,!0)}onScrollState(e){return this._tryAdvanceCursor(e.entityId,e.lastMessageVisible,e.hasNewerMessages,e.bufferTailId,!1)}onPillJump(e){return this._tryAdvanceCursor(e.entityId,!0,!1,e.bufferTailId,!0)}_tryAdvanceCursor(e,t,i,a,o){if(!e)return!1;const s=this._readProgress;return!(!s||s.entityId!==e||!o&&Date.now()<s.graceUntil||i||!t||null!==a&&a===s.lastMarkReadIdSent||(s.lastMarkReadIdSent=a,s.markReadFired=!0,this.requestMarkRead(e),0))}badgeCount(e,t,i){if(!e)return 0;const a=this._counts;if(i&&a[i])return a[i];const o=/^\d+$/.test(e),s=t?`hivefw_${t}_ch_${e}_messages`:null;for(const[t,i]of Object.entries(a))if(!(i<=0))if(o){if(s){if(t.endsWith(s))return i}else if(t.endsWith(`_ch_${e}_messages`))return i}else{const a=e.substring(0,6);if(t.endsWith(`_${a}_messages`))return i}return 0}dividerAfterGroupIdx(e){const t=this._readProgress;if(!t)return null;let i=null;if(t.anchorId){let a=0;for(const o of e)if("date-separator"!==o.type){if(o.group.messages.some(e=>e.id===t.anchorId)){i=a;break}a++}}if(null!==i){let t=0;for(const a of e)if("date-separator"!==a.type){if(t>i&&!a.group.isOutgoing)return t;t++}return null}if(t.unreadCountAtSelection>0){const i=e.filter(e=>"date-separator"!==e.type).length,a=i-t.unreadCountAtSelection;return a>=0?a:0}return null}cursorAtTail(e,t){return!(!e||null===t)&&this._lastRead[e]===t}}const Zr=[1116352408,1899447441,3049323471,3921009573,961987163,1508970993,2453635748,2870763221,3624381080,310598401,607225278,1426881987,1925078388,2162078206,2614888103,3248222580,3835390401,4022224774,264347078,604807628,770255983,1249150122,1555081692,1996064986,2554220882,2821834349,2952996808,3210313671,3336571891,3584528711,113926993,338241895,666307205,773529912,1294757372,1396182291,1695183700,1986661051,2177026350,2456956037,2730485921,2820302411,3259730800,3345764771,3516065817,3600352804,4094571909,275423344,430227734,506948616,659060556,883997877,958139571,1322822218,1537002063,1747873779,1955562222,2024104815,2227730452,2361852424,2428436474,2756734187,3204031479,3329325298];function en(e){const t=(new TextEncoder).encode(e),i=t.length,a=8*i,o=i+9+63&-64,s=new Uint8Array(o);s.set(t),s[i]=128;const r=new DataView(s.buffer);r.setUint32(o-4,a,!1);let n=1779033703,l=3144134277,d=1013904242,c=2773480762,p=1359893119,h=2600822924,u=528734635,g=1541459225;const v=new Int32Array(64);for(let e=0;e<o;e+=64){for(let t=0;t<16;t++)v[t]=r.getInt32(e+4*t,!1);for(let e=16;e<64;e++){const t=(v[e-15]>>>7|v[e-15]<<25)^(v[e-15]>>>18|v[e-15]<<14)^v[e-15]>>>3,i=(v[e-2]>>>17|v[e-2]<<15)^(v[e-2]>>>19|v[e-2]<<13)^v[e-2]>>>10;v[e]=v[e-16]+t+v[e-7]+i|0}let t=n,i=l,a=d,o=c,s=p,m=h,f=u,_=g;for(let e=0;e<64;e++){const r=_+((s>>>6|s<<26)^(s>>>11|s<<21)^(s>>>25|s<<7))+(s&m^~s&f)+Zr[e]+v[e]|0,n=t&i^t&a^i&a;_=f,f=m,m=s,s=o+r|0,o=a,a=i,i=t,t=r+(((t>>>2|t<<30)^(t>>>13|t<<19)^(t>>>22|t<<10))+n|0)|0}n=n+t|0,l=l+i|0,d=d+a|0,c=c+o|0,p=p+s|0,h=h+m|0,u=u+f|0,g=g+_|0}const m=e=>(e>>>0).toString(16).padStart(8,"0");return m(n)+m(l)+m(d)+m(c)+m(p)+m(h)+m(u)+m(g)}function tn(e){const t=[],i=new Set;let a;const o=new RegExp(Fr.source,"g");for(;null!==(a=o.exec(e));){const e=a[1];i.has(e)||(i.add(e),t.push(e))}const s=new RegExp(Dr.source,"g");for(;null!==(a=s.exec(e));){const e=a[1];i.has(e)||(i.add(e),t.push(e))}return t}function an(e){if(!e||0===e.length)return{};let t,i;for(const a of e)void 0===t&&"string"==typeof a.flood_scope&&(t=a.flood_scope),void 0===i&&"boolean"==typeof a.region_scope&&(i=a.region_scope);return{floodScope:t,regionScope:i}}function on(e){var t,i;const a=an(e.rx_log_data);return{id:e.id,sender:e.sender,text:e.text,timestamp:new Date(e.timestamp),isOutgoing:e.outgoing,isSystem:!1,raw:e.text,mentions:tn(e.text),rxLogData:e.rx_log_data,deliveryStatus:e.delivery_status?{status:e.delivery_status,ackReceived:e.ack_received,repeaterCount:e.repeater_count,roundTripMs:e.round_trip_ms}:void 0,repeaterCount:e.repeater_count,floodScope:null!==(t=e.flood_scope)&&void 0!==t?t:a.floodScope,regionScope:null!==(i=e.region_scope)&&void 0!==i?i:a.regionScope}}function sn(e,t){return e.getFullYear()!==t.getFullYear()||e.getMonth()!==t.getMonth()||e.getDate()!==t.getDate()}function rn(e){const t=new Date,i=new Date(t.getFullYear(),t.getMonth(),t.getDate()),a=new Date(e.getFullYear(),e.getMonth(),e.getDate()),o=Math.floor((i.getTime()-a.getTime())/864e5);return 0===o?"Today":1===o?"Yesterday":o<7?e.toLocaleDateString(void 0,{weekday:"long"}):e.toLocaleDateString(void 0,{weekday:"long",month:"long",day:"numeric"})}class nn{constructor(e){this._messages=[],this._loading=!1,this._error=null,this._entityId=null,this._hass=null,this._pollTimer=null,this._realtimeSubscriptions=[],this._retryCount=0,this._onChange=null,this._fetchDebounce=null,this._active=!1,this._hasOlderMessages=!0,this._loadingOlder=!1,this._hasNewerMessages=!1,this._loadingNewer=!1,this._newMessagesWhileAway=0,this._userAtBottom=!1,this._config=e}get messages(){return this._messages}get loading(){return this._loading}get error(){return this._error}get entityId(){return this._entityId}get loadingOlder(){return this._loadingOlder}get hasOlderMessages(){return this._hasOlderMessages}get loadingNewer(){return this._loadingNewer}get hasNewerMessages(){return this._hasNewerMessages}get newMessagesWhileAway(){return this._newMessagesWhileAway}setUserAtBottom(e){this._userAtBottom!==e&&(this._userAtBottom=e,e&&!this._hasNewerMessages&&this._newMessagesWhileAway>0&&(this._newMessagesWhileAway=0,this._notify()))}resetNewMessagesCounter(){0!==this._newMessagesWhileAway&&(this._newMessagesWhileAway=0,this._notify())}setOnChange(e){this._onChange=e}setHass(e){this._hass=e}setConfig(e){this._config=e}async switchEntity(e,t=null){if(e!==this._entityId){if(this._stopUpdates(),this._entityId=e,this._messages=[],this._error=null,this._retryCount=0,this._hasOlderMessages=!0,this._loadingOlder=!1,this._hasNewerMessages=!1,this._loadingNewer=!1,this._newMessagesWhileAway=0,this._userAtBottom=!1,!e)return this._active=!1,void this._notify();this._active=!0,this._startUpdates(e),t?await this._fetchAroundAnchor(e,t):await this._fetchMessages(e)}}async refresh(){this._entityId&&await this._fetchMessages(this._entityId)}addOptimisticMessage(e,t){const i=new Date,a={id:`optimistic_${i.getTime()}_${Math.random().toString(36).slice(2,8)}`,sender:e,text:t,timestamp:i,isOutgoing:!0,isSystem:!1,raw:`${e}: ${t}`,mentions:[]};this._messages=[...this._messages,a],this._notify()}async loadOlderMessages(){if(!this._loadingOlder&&this._hasOlderMessages&&this._hass&&this._entityId){this._loadingOlder=!0,this._notify();try{const e=this._messages.find(e=>!e.id.startsWith("rt_")&&!e.id.startsWith("optimistic_")),t={type:"hivefw_integration/get_stored_messages",entity_id:this._entityId,limit:50};e&&(t.before=e.id);const i=await this._hass.callWS(t),a=i.messages.map(on);this._hasOlderMessages=i.has_more;const o=new Set(this._messages.map(e=>e.id)),s=a.filter(e=>!o.has(e.id));s.length>0&&(this._messages=[...s,...this._messages],this._messages.sort((e,t)=>e.timestamp.getTime()-t.timestamp.getTime()))}catch(e){}finally{this._loadingOlder=!1,this._notify()}}}async loadNewerMessages(){if(!this._loadingNewer&&this._hasNewerMessages&&this._hass&&this._entityId){this._loadingNewer=!0,this._notify();try{let t;for(let e=this._messages.length-1;e>=0;e--){const i=this._messages[e].id;if(!i.startsWith("rt_")&&!i.startsWith("optimistic_")){t=i;break}}const i={type:"hivefw_integration/get_stored_messages",entity_id:this._entityId,limit:50};t&&(i.after=t);const a=await this._hass.callWS(i),o=a.messages.map(on);this._hasNewerMessages=a.has_more;const s=new Set(o.map(e=>e.id));this._messages=this._messages.filter(e=>!e.id.startsWith("rt_")||!s.has(e.id.substring(3)));const r=new Set(this._messages.map(e=>e.id)),n=o.filter(e=>!r.has(e.id));if(n.length>0){var e;this._messages=[...this._messages,...n],this._messages.sort((e,t)=>e.timestamp.getTime()-t.timestamp.getTime());const t=null!==(e=this._config.max_messages)&&void 0!==e?e:500;this._messages.length>t&&(this._messages=this._messages.slice(-t),this._hasOlderMessages=!0)}}catch(e){}finally{this._loadingNewer=!1,this._notify()}}}async fetchAroundTimestamp(e){const t=new Date(e).getTime(),i=this._messages.find(e=>Math.abs(e.timestamp.getTime()-t)<2e3);if(i)return!0;let a=0;for(;this._hasOlderMessages&&a<20;){await this.loadOlderMessages(),a++;const e=this._messages.find(e=>Math.abs(e.timestamp.getTime()-t)<2e3);if(e)return!0}return!1}pause(){this._stopUpdates(),this._active=!1,this._fetchDebounce&&(clearTimeout(this._fetchDebounce),this._fetchDebounce=null)}async resume(){this._entityId&&!this._active&&(this._active=!0,this._startUpdates(this._entityId),await this._fetchMessages(this._entityId))}destroy(){this._stopUpdates(),this._active=!1,this._fetchDebounce&&(clearTimeout(this._fetchDebounce),this._fetchDebounce=null),this._onChange=null}async _fetchMessages(e){if(this._hass){this._loading=!0,this._notify();try{var t;const i=50,a=await this._hass.callWS({type:"hivefw_integration/get_stored_messages",entity_id:e,limit:i}),o=a.messages.map(on);this._hasOlderMessages=a.has_more;const s=new Set(o.map(e=>e.id)),r=this._messages.filter(e=>{if(e.id.startsWith("optimistic_")){const t=o.some(t=>t.sender===e.sender&&t.text===e.text);return!t}if(e.id.startsWith("rt_")){const t=e.id.substring(3);return!s.has(t)}return!1});this._messages=[...o,...r],this._messages.sort((e,t)=>e.timestamp.getTime()-t.timestamp.getTime());const n=null!==(t=this._config.max_messages)&&void 0!==t?t:500;this._messages.length>n&&(this._messages=this._messages.slice(-n),this._hasOlderMessages=!0),this._error=null,this._retryCount=0}catch(e){const t=e instanceof Error?e.message:String(e);this._error=`Failed to fetch messages: ${t}`,this._retryCount++}finally{this._loading=!1,this._notify()}}}async _fetchAroundAnchor(e,t){if(this._hass){this._loading=!0,this._notify();try{var i;const a=await async function(e,t,i,a=25,o=50){return e.callWS({type:"hivefw_integration/get_messages_around",entity_id:t,anchor_id:i,before_limit:a,after_limit:o})}(this._hass,e,t),o=a.messages.map(on);this._hasOlderMessages=a.has_more_before,this._hasNewerMessages=a.has_more_after;const s=new Set(o.map(e=>e.id)),r=this._messages.filter(e=>{if(e.id.startsWith("optimistic_")){const t=o.some(t=>t.sender===e.sender&&t.text===e.text);return!t}if(e.id.startsWith("rt_")){const t=e.id.substring(3);return!s.has(t)}return!1});this._messages=[...o,...r],this._messages.sort((e,t)=>e.timestamp.getTime()-t.timestamp.getTime());const n=null!==(i=this._config.max_messages)&&void 0!==i?i:500;this._messages.length>n&&(this._messages=this._messages.slice(-n),this._hasOlderMessages=!0),this._error=null,this._retryCount=0}catch(e){const t=e instanceof Error?e.message:String(e);this._error=`Failed to fetch messages: ${t}`,this._retryCount++}finally{this._loading=!1,this._notify()}}}_startUpdates(e){this._startPolling(e),this._subscribeRealtime(e).catch(()=>{})}async _subscribeRealtime(e){if(!this._hass)return;const t=[];try{const i=await this._hass.connection.subscribeEvents(t=>{t.data.entity_id===e&&this._handleRealtimeMessage(t.data)},"hivefw_message");t.push(i);const a=await this._hass.connection.subscribeEvents(t=>{t.data.entity_id===e&&this._handleDeliveryUpdate(t.data)},"hivefw_delivery_update");t.push(a),this._realtimeSubscriptions=t}catch(e){throw t.forEach(e=>e()),e}}_handleRealtimeMessage(e){var t,i;const a=null!==(t=e.sender_name)&&void 0!==t?t:e.sender,o=null!==(i=e.message)&&void 0!==i?i:e.text;if(a===this._config.node_name){if(a&&o){const t=e.ack_received,i=e.repeater_count,r=e.rx_log_data,n=e.message_type;let l;var s;if("dm"===n||"direct"===n)l={status:!0===t?"delivered":"sent",ackReceived:null!=t?t:void 0};else l={status:"sent",repeaterCount:null!=i?i:null!==(s=null==r?void 0:r.length)&&void 0!==s?s:0};for(let e=this._messages.length-1;e>=0;e--){const t=this._messages[e];if(t.id.startsWith("optimistic_")&&t.sender===a&&t.text===o){t.deliveryStatus=l,r&&(t.rxLogData=r),this._notify();break}}}!this._entityId||this._hasNewerMessages||this._hasOlderMessages||this._debouncedFetch(this._entityId)}else{if(a&&o){let t=o.replace(Nr,"");const i=a+": ";t.startsWith(i)&&(t=t.substring(i.length));const s=e.timestamp||(new Date).toISOString(),r=new Date(s),n=function(e,t,i){return en(`${e}|${t}|${i}`).substring(0,12)}(s,a,t),l=`rt_${n}`,d=this._messages.some(e=>e.id===l||e.id===n);if(!d){const i=tn(t),s=e.rx_log_data,n={id:l,sender:a,text:t,timestamp:r,isOutgoing:!1,isSystem:!1,raw:o,mentions:i,rxLogData:s&&s.length>0?s:void 0,...an(s)};this._messages.push(n),this._messages.sort((e,t)=>e.timestamp.getTime()-t.timestamp.getTime()),this._userAtBottom&&!this._hasNewerMessages||this._newMessagesWhileAway++,this._notify()}}!this._entityId||this._hasNewerMessages||this._hasOlderMessages||this._debouncedFetch(this._entityId)}}_debouncedFetch(e){this._fetchDebounce&&clearTimeout(this._fetchDebounce),this._fetchDebounce=setTimeout(async()=>{if(this._fetchDebounce=null,this._active)try{await this._fetchMessages(e)}catch(e){}},500)}_handleDeliveryUpdate(e){const t=e.rx_log_data;if(e.progressive&&t&&t.length>0){const i=e.sender_name,a=e.message,o=e.timestamp;if(i&&a){const e=o?new Date(o).getTime():0;for(let o=this._messages.length-1;o>=0;o--){const s=this._messages[o];if(!s.isOutgoing&&s.sender===i&&s.text===a&&(!e||Math.abs(s.timestamp.getTime()-e)<1e4))return s.rxLogData=t,s.repeaterCount=t.length,void this._notify()}}}const i=e.send_id,a=e.status,o=e.repeater_count,s=e.ack_received,r=e.round_trip_ms,n=e.progressive;if(!i)return;let l,d;l=a||(!0===s?"delivered":!n||void 0!==o&&0!==o?"sent":"waiting");for(let e=this._messages.length-1;e>=0;e--)if(this._messages[e].isOutgoing){d=this._messages[e];break}d&&(d.deliveryStatus={status:l,repeaterCount:o,ackReceived:s,roundTripMs:r},void 0!==o&&(d.repeaterCount=o),this._notify())}async _pollFetch(e){if(this._hass&&!this._hasNewerMessages)try{let i;for(let e=this._messages.length-1;e>=0;e--){const t=this._messages[e].id;if(!t.startsWith("rt_")&&!t.startsWith("optimistic_")){i=t;break}}const a={type:"hivefw_integration/get_stored_messages",entity_id:e,limit:50};i&&(a.after=i);const o=await this._hass.callWS(a);if(0===o.messages.length)return this._error=null,void(this._retryCount=0);const s=o.messages.map(on),r=new Set(this._messages.map(e=>e.id)),n=s.filter(e=>!r.has(e.id));if(n.length>0){var t;const e=new Set(n.map(e=>e.id));this._messages=this._messages.filter(t=>!t.id.startsWith("rt_")||!e.has(t.id.substring(3))),this._messages=this._messages.filter(e=>!e.id.startsWith("optimistic_")||!n.some(t=>t.sender===e.sender&&t.text===e.text)),this._messages=[...this._messages,...n],this._messages.sort((e,t)=>e.timestamp.getTime()-t.timestamp.getTime());const i=null!==(t=this._config.max_messages)&&void 0!==t?t:500;this._messages.length>i&&(this._messages=this._messages.slice(-i),this._hasOlderMessages=!0),this._notify()}this._error=null,this._retryCount=0}catch(e){this._retryCount++}}_startPolling(e){const t=()=>{if(!this._active)return;const i=this._retryCount>=5?6e4:3e4;this._pollTimer=setTimeout(async()=>{if(this._active){try{await this._pollFetch(e)}catch(e){}t()}},i)};t()}_stopUpdates(){this._pollTimer&&(clearTimeout(this._pollTimer),this._pollTimer=null);for(const e of this._realtimeSubscriptions)e();this._realtimeSubscriptions=[]}_notify(){this._onChange&&this._onChange()}}let ln=class extends Sr{constructor(){super(...arguments),this.conversations=[],this.activeId=null,this.unreadCounts={},this.nodePrefix=null,this._activeFilter="all",this._filteredConversations=[],this._appsChannelId=null,this._appsPickerOpen=!1}connectedCallback(){super.connectedCallback(),this._loadAppsChannelPreference()}updated(e){e.has("nodePrefix")&&this._loadAppsChannelPreference(),(e.has("conversations")||e.has("_activeFilter")||e.has("_appsChannelId"))&&this._updateFiltered()}render(){const e=this._getAppsChannel(),t=this._channelConversations();return rr(n||(n=vs`
  ...
  `)),ms([zr({type:Array})],ln.prototype,"conversations",void 0),ms([zr({type:String})],ln.prototype,"activeId",void 0),ms([zr({attribute:!1})],ln.prototype,"unread",void 0),ms([zr({type:Object})],ln.prototype,"unreadCounts",void 0),ms([zr({type:String})],ln.prototype,"nodePrefix",void 0),ms([Tr()],ln.prototype,"_activeFilter",void 0),ms([Tr()],ln.prototype,"_filteredConversations",void 0),ms([Tr()],ln.prototype,"_appsChannelId",void 0),ms([Tr()],ln.prototype,"_appsPickerOpen",void 0),ln=ms([Mr("meshcore-conversation-list")],ln);const dn=["a[href]","button:not([disabled])",'input:not([disabled]):not([type="hidden"])',"select:not([disabled])","textarea:not([disabled])",'[tabindex]:not([tabindex="-1"])'].join(","),cn=[];let pn=!1;function hn(){pn||(pn=!0,document.addEventListener("keydown",un,!0))}function un(e){0!==cn.length&&cn[cn.length-1]._handleKeyDown(e)}class gn{constructor(e,t){this.host=e,this.opts=t,this._wasOpen=!1,this._previousActive=null,this._inStack=!1,this.host.addController(this),hn()}hostConnected(){hn()}hostDisconnected(){this._inStack&&this._popStack(),this._previousActive=null,this._wasOpen=!1}hostUpdated(){const e=this.opts.isOpen();if(e&&!this._wasOpen)this._previousActive=this._currentDocumentActive(),this._pushStack(),this._focusFirstSoon();else if(!e&&this._wasOpen){this._popStack();const e=this._previousActive;if(this._previousActive=null,e&&e.isConnected&&"function"==typeof e.focus)try{e.focus()}catch(e){}}this._wasOpen=e}_pushStack(){this._inStack||(cn.push(this),this._inStack=!0)}_popStack(){const e=cn.indexOf(this);e>=0&&cn.splice(e,1),this._inStack=!1}_getFocusables(){var e,t,i;const a=null!==(e=null===(t=(i=this.opts).getScope)||void 0===t?void 0:t.call(i))&&void 0!==e?e:this.host.shadowRoot;return a?Array.from(a.querySelectorAll(dn)).filter(e=>!(e.hasAttribute("aria-hidden")||e.hidden||null===e.offsetParent&&0===e.getClientRects().length)):[]}_focusFirstSoon(){queueMicrotask(()=>{var e,t,i;if(!this.opts.isOpen())return;const a=null!==(e=null===(t=(i=this.opts).getScope)||void 0===t?void 0:t.call(i))&&void 0!==e?e:this.host.shadowRoot;if(a&&this._scopeContainsFocus(a))return;const o=this._getFocusables();if(0!==o.length)try{o[0].focus()}catch(e){}})}_scopeContainsFocus(e){let t=document.activeElement;for(;t;){if(t===e)return!0;if(e.host===t)return!0;if("contains"in e&&e.contains(t))return!0;const i=t.shadowRoot;if(!i||!i.activeElement)break;t=i.activeElement}return!1}_currentDocumentActive(){let e=document.activeElement;for(;e&&e.shadowRoot&&e.shadowRoot.activeElement;)e=e.shadowRoot.activeElement;return e}_handleKeyDown(e){var t,i,a;if(!this.opts.isOpen())return;if("Escape"===e.key)return e.preventDefault(),e.stopPropagation(),void this.opts.onEscape();if("Tab"!==e.key)return;const o=this._getFocusables();if(0===o.length)return;const s=null!==(t=null===(i=(a=this.opts).getScope)||void 0===i?void 0:i.call(a))&&void 0!==t?t:this.host.shadowRoot,r=s?this._findFocusedInScope(s):null,n=r?o.indexOf(r):-1;let l;l=e.shiftKey?n<=0?o.length-1:n-1:-1===n||n>=o.length-1?0:n+1,e.preventDefault(),e.stopPropagation();try{o[l].focus()}catch(e){}}_findFocusedInScope(e){let t=document.activeElement;for(;t;){if(e===t||"contains"in e&&e.contains(t)){if(t.shadowRoot&&t.shadowRoot.activeElement){t=t.shadowRoot.activeElement;continue}return t}if(e.host===t){t=e.activeElement;continue}const i=t.shadowRoot;if(!i||!i.activeElement)break;t=i.activeElement}return null}}function vn(e,t){new gn(e,t)}let mn=class extends Sr{constructor(){super(),this.open=!1,this.narrow=!1,this.editMode=!1,this.initialChannelIdx=0,this.initialChannelName="",this.initialScope="",this.initialKey="",this.availableIndices=[],this._channelIdx=0,this._channelName="",this._customKey="",this._autoKey=!0,this._scope="",this._availableScopes=null,this._globalAllowed=!1,this._saving=!1,this._error=null,this._initialized=!1,vn(this,{isOpen:()=>this.open,onEscape:()=>this._onCancel()})}willUpdate(e){if(e.has("open")&&this.open&&!this._initialized){if(this.editMode){this._channelIdx=this.initialChannelIdx,this._channelName=this.initialChannelName,this._scope=this.initialScope;const e=en(this.initialChannelName).slice(0,32);this.initialKey&&this.initialKey.toLowerCase()!==e?(this._autoKey=!1,this._customKey=this.initialKey.toLowerCase()):(this._autoKey=!0,this._customKey="")}else{this._channelIdx=this.availableIndices.length>0?this.availableIndices[0]:0,this._channelName=this.initialChannelName||"",this._scope=this.initialScope||"";const e=this._channelName?en(this._channelName).slice(0,32):"";this.initialKey&&this.initialKey.toLowerCase()!==e?(this._autoKey=!1,this._customKey=this.initialKey.toLowerCase()):(this._autoKey=!0,this._customKey="")}this._initialized=!0,this._loadScopes()}e.has("open")&&!this.open&&(this._initialized=!1),!this.editMode&&this.open&&e.has("availableIndices")&&this.availableIndices.length>0&&!this.availableIndices.includes(this._channelIdx)&&(this._channelIdx=this.availableIndices[0])}async _loadScopes(){if(this._availableScopes=null,!this.hass)return this._availableScopes=[],void(this._globalAllowed=!1);const e=await qr(this.hass,this.entryId);this._availableScopes=e.scopes,this._globalAllowed=e.global}render(){if(!this.open)return;const e=this._customKey.length,t=32===e||0===e||this._autoKey;return rr(b||(b=vs`
      <div
    ...
    `))],ms([zr({type:Boolean})],mn.prototype,"open",void 0),ms([zr({type:Object})],mn.prototype,"hass",void 0),ms([zr({type:String})],mn.prototype,"entryId",void 0),ms([zr({type:Boolean})],mn.prototype,"narrow",void 0),ms([zr({type:Boolean})],mn.prototype,"editMode",void 0),ms([zr({type:Number})],mn.prototype,"initialChannelIdx",void 0),ms([zr({type:String})],mn.prototype,"initialChannelName",void 0),ms([zr({type:String})],mn.prototype,"initialScope",void 0),ms([zr({type:String})],mn.prototype,"initialKey",void 0),ms([zr({type:Array})],mn.prototype,"availableIndices",void 0),ms([Tr()],mn.prototype,"_channelIdx",void 0),ms([Tr()],mn.prototype,"_channelName",void 0),ms([Tr()],mn.prototype,"_customKey",void 0),ms([Tr()],mn.prototype,"_autoKey",void 0),ms([Tr()],mn.prototype,"_scope",void 0),ms([Tr()],mn.prototype,"_availableScopes",void 0),ms([Tr()],mn.prototype,"_globalAllowed",void 0),ms([Tr()],mn.prototype,"_saving",void 0),ms([Tr()],mn.prototype,"_error",void 0),mn=ms([Mr("meshcore-channel-dialog")],mn);let fn=class extends Sr{willUpdate(){this._tabInitialized||(this._tabInitialized=!0,this.initialTab&&(this._activeTab=this.initialTab))}constructor(){super(),this.narrow=!1,this.lockedTab=!1,this._tabInitialized=!1,this._activeTab="contacts",this._contacts=[],this._channels=[],this._searchQuery="",this._categoryFilter="all",this._typeFilter="all",this._loading=!1,this._actionInProgress=null,this._confirmingRemoveContact=null,this._confirmingRemoveChannel=null,this._channelDialogOpen=!1,this._editingChannel=null,this._suggestedChannelName="",this._suggestedChannelKey="",this._maxChannels=4,vn(this,{isOpen:()=>!0,onEscape:()=>this._close()})}connectedCallback(){super.connectedCallback(),this._loadData()}render(){var e,t,i,a,o,s,r,n;return rr(T||(T=vs`
      <div
        class="dialog"
        role="dialog"
        aria-modal="true"
    ...
    `),t,e.adv_name||"Unknown",e.pubkey_prefix,i?"added":"discovered",i?rr(H||(H=vs`<svg viewBox="0 0 24 24" width="10" height="10" fill="currentColor" style="vertical-align: -1px; margin-right: 2px;"><path d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z"/></svg>Added`)):"Discovered",a?rr(U||(U=vs`
  ...
  `)),ms([zr({type:Object})],fn.prototype,"hass",void 0),ms([zr({type:String})],fn.prototype,"entryId",void 0),ms([zr({type:Boolean})],fn.prototype,"narrow",void 0),ms([zr({type:String})],fn.prototype,"initialTab",void 0),ms([zr({type:Boolean})],fn.prototype,"lockedTab",void 0),ms([Tr()],fn.prototype,"_activeTab",void 0),ms([Tr()],fn.prototype,"_contacts",void 0),ms([Tr()],fn.prototype,"_channels",void 0),ms([Tr()],fn.prototype,"_searchQuery",void 0),ms([Tr()],fn.prototype,"_categoryFilter",void 0),ms([Tr()],fn.prototype,"_typeFilter",void 0),ms([Tr()],fn.prototype,"_loading",void 0),ms([Tr()],fn.prototype,"_actionInProgress",void 0),ms([Tr()],fn.prototype,"_confirmingRemoveContact",void 0),ms([Tr()],fn.prototype,"_confirmingRemoveChannel",void 0),ms([Tr()],fn.prototype,"_channelDialogOpen",void 0),ms([Tr()],fn.prototype,"_editingChannel",void 0),ms([Tr()],fn.prototype,"_suggestedChannelName",void 0),ms([Tr()],fn.prototype,"_suggestedChannelKey",void 0),ms([Tr()],fn.prototype,"_maxChannels",void 0),fn=ms([Mr("meshcore-manage-dialog")],fn);let _n=class extends Sr{constructor(){super(),this.timestampFormat="relative",this._selectedMessage=null,vn(this,{isOpen:()=>null!==this._selectedMessage,onEscape:()=>{this._selectedMessage=null},getScope:()=>{var e;return null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector(".message-dialog")}})}render(){return this.group?rr(Z||(Z=vs`
        ${0}
        ${0}
  ...
  `)),ms([zr({type:Object})],_n.prototype,"group",void 0),ms([zr({type:Object})],_n.prototype,"message",void 0),ms([zr({type:String})],_n.prototype,"timestampFormat",void 0),ms([Tr()],_n.prototype,"_selectedMessage",void 0),_n=ms([Mr("meshcore-message-bubble")],_n);let bn=class extends Sr{constructor(){super(),this._query="",this._fromDate="",this._toDate="",this._results=[],this._totalCount=0,this._searching=!1,this._hasSearched=!1,this._showFilters=!1,this._debounceTimer=null,vn(this,{isOpen:()=>!0,onEscape:()=>this.dispatchEvent(new CustomEvent("search-close",{bubbles:!0,composed:!0}))})}render(){return rr(ye||(ye=vs`
  ...
  `)),ms([zr({type:Object})],bn.prototype,"hass",void 0),ms([zr({type:String})],bn.prototype,"entryId",void 0),ms([zr({type:String})],bn.prototype,"entityId",void 0),ms([zr({type:String})],bn.prototype,"meshNodeName",void 0),ms([Tr()],bn.prototype,"_query",void 0),ms([Tr()],bn.prototype,"_fromDate",void 0),ms([Tr()],bn.prototype,"_toDate",void 0),ms([Tr()],bn.prototype,"_results",void 0),ms([Tr()],bn.prototype,"_totalCount",void 0),ms([Tr()],bn.prototype,"_searching",void 0),ms([Tr()],bn.prototype,"_hasSearched",void 0),ms([Tr()],bn.prototype,"_showFilters",void 0),bn=ms([Mr("meshcore-message-search")],bn);let yn=class extends Sr{constructor(){super(...arguments),this.conversations=[],this.selectedId=null,this.narrow=!1,this.lastRead={},this._messageStore=null,this._unsubUnread=null,this._inputText="",this._sending=!1,this._viewportNarrow=!1,this._mediaQuery=null,this._mediaHandler=null,this._narrowShowMessages=!1,this._manageOpen=!1,this._manageInitialTab="contacts",this._searchOpen=!1,this._currentEntityId=null,this._conversationResolved=!1,this._pendingScroll=null,this._scrollInFlight=!1,this._scrollGuardUntil=0,this._lastMessageCount=0}get _isNarrow(){return this.narrow||this._viewportNarrow}connectedCallback(){super.connectedCallback(),this.config&&!this._messageStore&&(this._messageStore=new nn(this.config),this._messageStore.setOnChange(()=>this.requestUpdate())),this.unread&&!this._unsubUnread&&(this._unsubUnread=this.unread.subscribe(()=>{this.lastRead=this.unread.lastRead,this.requestUpdate()}),this.lastRead=this.unread.lastRead,this.unread.onPostSwitchTimerFire(()=>this._checkAndMarkReadIfAtBottom())),this._mediaQuery=window.matchMedia("(max-width: 870px)"),this._viewportNarrow=this._mediaQuery.matches,this._mediaHandler=e=>{this._viewportNarrow=e.matches},this._mediaQuery.addEventListener("change",this._mediaHandler)}disconnectedCallback(){var e;super.disconnectedCallback(),this._messageStore&&(this._messageStore.destroy(),this._messageStore=null),this._unsubUnread&&(this._unsubUnread(),this._unsubUnread=null),null===(e=this.unread)||void 0===e||e.endConversation(),this._mediaQuery&&this._mediaHandler&&(this._mediaQuery.removeEventListener("change",this._mediaHandler),this._mediaQuery=null,this._mediaHandler=null)}updated(e){if(e.has("hass")&&this.hass&&this._messageStore&&this._messageStore.setHass(this.hass),e.has("config")&&this.config&&this._messageStore){this._messageStore.setConfig(this.config);const t=e.get("config");t&&t.entry_id!==this.config.entry_id&&(this.selectedId=null,this._currentEntityId=null,this._conversationResolved=!1,this._pendingScroll=null,this._lastMessageCount=0,this.unread.endConversation(),this._messageStore.switchEntity(null),this.dispatchEvent(new CustomEvent("active-entity-changed",{detail:{entityId:null},bubbles:!0,composed:!0})))}if(e.has("selectedId")&&this._onConversationSelected(),e.has("lastRead")&&this._currentEntityId&&this._conversationResolved&&null===this._pendingScroll&&this.unread.maybeReanchorOnLateData(this._currentEntityId)&&(this._pendingScroll="last-read"),this._pendingScroll){const e=this._messageStore,t=e&&!e.loading;t&&e.messages.length>0?(this._executeScroll(this._pendingScroll),this._pendingScroll=null,this._lastMessageCount=e.messages.length):t&&0===e.messages.length&&(this._pendingScroll=null)}else if(this._messageStore){const e=this._messageStore.messages.length;e>this._lastMessageCount&&this._lastMessageCount>0&&this._scrollToBottomIfNearEnd(),this._lastMessageCount=e}}render(){var e,t,i,a,o,s;return this._isNarrow?this._narrowShowMessages?rr(Ae||(Ae=vs`
    ...
    `),this._onReplyToSender,this._onChatScroll,this._messageStore.loadingOlder?rr(He||(He=vs`<div class="loading-older"><div class="loading-spinner"></div></div>`)):rr(Ue||(Ue=vs``)),this._messageStore.error?rr(qe||(qe=vs`
  ...
  `)),ms([zr({type:Object})],yn.prototype,"hass",void 0),ms([zr({type:Object})],yn.prototype,"config",void 0),ms([zr({type:Array})],yn.prototype,"conversations",void 0),ms([zr({type:String})],yn.prototype,"selectedId",void 0),ms([zr({type:Boolean})],yn.prototype,"narrow",void 0),ms([zr({attribute:!1})],yn.prototype,"unread",void 0),ms([zr({type:Object})],yn.prototype,"lastRead",void 0),ms([Tr()],yn.prototype,"_messageStore",void 0),ms([Tr()],yn.prototype,"_inputText",void 0),ms([Tr()],yn.prototype,"_sending",void 0),ms([Tr()],yn.prototype,"_viewportNarrow",void 0),ms([Tr()],yn.prototype,"_narrowShowMessages",void 0),ms([Tr()],yn.prototype,"_manageOpen",void 0),ms([Tr()],yn.prototype,"_manageInitialTab",void 0),ms([Tr()],yn.prototype,"_searchOpen",void 0),ms([Tr()],yn.prototype,"_currentEntityId",void 0),ms([Tr()],yn.prototype,"_conversationResolved",void 0),ms([Tr()],yn.prototype,"_pendingScroll",void 0),yn=ms([Mr("hivefw-integration-page")],yn);const $n={battery_pct:{displayMin:0,displayMax:100,direction:"higher_better",classify:e=>e<20?"bad":e<50?"warn":"good",tooltip:"Green ≥ 50%, Yellow 20–50%, Red < 20% (critical < 10%). Home Assistant low-battery convention.",source:"https://community.home-assistant.io/t/low-battery-level-detection-notification-for-all-battery-sensors/258664"},rssi:{displayMin:-130,displayMax:-30,direction:"higher_better",classify:e=>e<-115?"bad":e<-100?"warn":"good",tooltip:"Green > −100 dBm, Yellow −100 to −115 dBm, Red < −115 dBm. Lower (more negative) RSSI means a weaker received signal.",source:"https://www.thethingsnetwork.org/docs/lorawan/rssi-and-snr/"},snr:{displayMin:-20,displayMax:20,direction:"higher_better",classify:e=>e<-7?"bad":e<0?"warn":"good",tooltip:"Green > 0 dB, Yellow −7 to 0 dB, Red < −7 dB. Demodulation floor is spreading-factor dependent (Semtech AN1200.13).",source:"https://www.openhacks.com/uploadsproductos/loradesignguide_std.pdf"},noise_floor:{displayMin:-130,displayMax:-90,direction:"lower_better",classify:e=>e>-105?"bad":e>-115?"warn":"good",tooltip:"Green < −115 dBm, Yellow −115 to −105 dBm, Red > −105 dBm. Above −105 dBm typically indicates man-made RF interference, not thermal noise.",source:"https://www.openhacks.com/uploadsproductos/loradesignguide_std.pdf"},tx_airtime_util:{displayMin:0,displayMax:20,direction:"lower_better",classify:e=>e>10?"bad":e>2?"warn":"good",tooltip:"Green < 2%, Yellow 2–10%, Red > 10%. EU868 sub-band 1% / general 10% duty-cycle ceiling (ETSI EN 300 220-2; eCFR 47 CFR 15.247).",source:"https://www.etsi.org/deliver/etsi_en/300200_300299/30022002/03.03.01_60/en_30022002v030301p.pdf"},rx_airtime_util:{displayMin:0,displayMax:100,direction:"lower_better",classify:e=>e>50?"bad":e>25?"warn":"good",tooltip:"Green < 25%, Yellow 25–50%, Red > 50%. High RX utilisation usually means heavy mesh traffic or environmental interference saturating the receiver."},channel_util:{displayMin:0,displayMax:100,direction:"lower_better",classify:e=>e>50?"bad":e>25?"warn":"good",tooltip:"Green < 25%, Yellow 25–50%, Red > 50%. Channel utilisation aggregates all activity on the radio channel."},hop_count:{displayMin:0,displayMax:32,direction:"lower_better",classify:e=>e>=16?"bad":e>=7?"warn":"good",tooltip:"Green ≤ 6, Yellow 7–15, Red ≥ 16. MeshCore allows up to 64 hops; community-recommended meshes run well under 32. Each hop adds airtime cost and latency.",source:"https://nodakmesh.org/blog/meshcore-path-hash-explained"},uptime_hours:{displayMin:0,displayMax:168,direction:"higher_better",classify:e=>e<1?"bad":e<24?"warn":"good",tooltip:"Green > 24 h, Yellow 1–24 h, Red < 1 h. Very recent reboot suggests a watchdog reset or brownout."},last_seen_hours:{displayMin:0,displayMax:6,direction:"lower_better",classify:e=>e>4?"bad":e>2?"warn":"good",tooltip:"Green < 2 h, Yellow 2–4 h, Red > 4 h. Should be tuned to the node’s advertising interval; nodes that advertise hourly should appear far more often than nodes that advertise every 6 hours."},request_success_rate:{displayMin:0,displayMax:100,direction:"higher_better",classify:e=>e<70?"bad":e<90?"warn":"good",tooltip:'Green > 90%, Yellow 70–90%, Red < 70%. Caller is responsible for the min-sample floor — bars should render with band="info" until at least 50 attempts have accumulated.'},duplicate_ratio:{displayMin:0,displayMax:100,direction:"lower_better",classify:()=>"info",tooltip:""},tx_queue_len:{displayMin:0,displayMax:30,direction:"lower_better",classify:e=>e>10?"bad":e>5?"warn":"good",tooltip:"Number of messages queued for transmission. Healthy nodes drain the queue quickly. Sustained backlog (> 10) indicates channel saturation or a stuck transmitter."},temperature:{displayMin:-20,displayMax:140,direction:"higher_better",classify:e=>e<0||e>125?"bad":"good",tooltip:"Red below 0°F (≈ −18°C) or above 125°F (≈ 52°C); green otherwise. Extreme ambient temperatures risk damage to the radio, battery, or enclosure."}};function kn(e,t){const i=t.displayMax-t.displayMin;if(i<=0)return 0;const a=(e-t.displayMin)/i,o="higher_better"===t.direction?a:1-a;return Math.max(0,Math.min(100,100*o))}function Sn(e,t){if(!Number.isFinite(t))return{band:"info",fillPct:0,tooltip:""};const i=$n[e];return i?{band:i.classify(t),fillPct:kn(t,i),tooltip:i.tooltip,source:i.source}:{band:"info",fillPct:0,tooltip:""}}class Cn{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,i){this._$Ct=e,this._$AM=t,this._$Ci=i}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}const Mn=(Rn=class extends Cn{constructor(e){if(super(e),this._timer=null,this._startX=0,this._startY=0,this._attached=!1,this._callback=null,this._element=null,this._onPointerDown=e=>this._handleDown(e),this._onPointerUp=()=>this._cancelTimer(),this._onPointerMove=e=>this._handleMove(e),this._onContextMenu=e=>{null!==this._timer&&e.preventDefault()},6!==e.type)throw new Error("longPress directive must be used on an element")}render(e){}update(e,[t]){if(this._callback=t,!this._attached){this._element=e.element;const t=this._element;t.addEventListener("pointerdown",this._onPointerDown),t.addEventListener("pointerup",this._onPointerUp),t.addEventListener("pointercancel",this._onPointerUp),t.addEventListener("pointermove",this._onPointerMove),t.addEventListener("contextmenu",this._onContextMenu),this._attached=!0}return this.render(t)}_handleDown(e){0===e.button&&(this._startX=e.clientX,this._startY=e.clientY,this._cancelTimer(),this._timer=setTimeout(()=>{var e;this._timer=null,null===(e=this._callback)||void 0===e||e.call(this)},500))}_handleMove(e){if(null===this._timer)return;const t=e.clientX-this._startX,i=e.clientY-this._startY;t*t+i*i>100&&this._cancelTimer()}_cancelTimer(){null!==this._timer&&(clearTimeout(this._timer),this._timer=null)}},(...e)=>({_$litDirective$:Rn,values:e}));var Rn;let An=class extends Sr{constructor(){super(...arguments),this.value=0,this.min=0,this.max=100,this.band="info"}render(){const e=this.max-this.min;let t=0;return Number.isFinite(this.value)&&e>0&&(t=(this.value-this.min)/e*100,t=Math.max(0,Math.min(100,t))),rr(ot||(ot=vs`
    ...
    `),this.value,this.min,this.max,this.band,t)}};An.styles=ws(st||(st=vs`
    :host {
      display: block;
      width: 100%;
    }
  ...
  `)),ms([zr({type:Number})],An.prototype,"value",void 0),ms([zr({type:Number})],An.prototype,"min",void 0),ms([zr({type:Number})],An.prototype,"max",void 0),ms([zr({type:String})],An.prototype,"band",void 0),An=ms([Mr("meshcore-stat-bar")],An);let zn=class extends Sr{constructor(){super(...arguments),this.segments=[],this.legend="below"}_denom(){if(void 0!==this.total&&this.total>0)return this.total;const e=this.segments.reduce((e,t)=>e+(Number.isFinite(t.value)?t.value:0),0);return e>0?e:1}render(){if(!this.segments.length)return dr;const e=this._denom();return rr(rt||(rt=vs`
      <div class="stat-bar"
           role="img"
           aria-label="${0}">
        ${0}
    ...
    `),this.segments.map(e=>`${e.label} ${e.value}`).join(", "),this.segments.map(t=>{const i=Number.isFinite(t.value)?Math.max(0,t.value):0;if(0===i)return dr;const a=i/e*100;return rr(nt||(nt=vs`<div class="stat-bar-segment ${0}"
          ...
          <div class="stat-bar-legend ${0}">
            ${0}
            ${0}
          </div>`),"inline"===this.legend?"inline":"",this.segments.filter(e=>Number.isFinite(e.value)&&e.value>=0).map(e=>rr(dt||(dt=vs`<span><span class="legend-swatch ${0}"></span>${0}</span>`),e.kind,e.label)),this.extraLegendText?rr(ct||(ct=vs`<span class="legend-extra">${0}</span>`),this.extraLegendText):dr):dr)}};zn.styles=ws(pt||(pt=vs`
  ...
  `)),ms([zr({type:Array})],zn.prototype,"segments",void 0),ms([zr({type:Number})],zn.prototype,"total",void 0),ms([zr({type:String})],zn.prototype,"legend",void 0),ms([zr({type:String})],zn.prototype,"extraLegendText",void 0),zn=ms([Mr("meshcore-stacked-bar")],zn);let Tn=class extends Sr{constructor(){super(...arguments),this.content="",this._open=!1,this._onOpen=()=>{this._open||(this._open=!0,window.addEventListener("scroll",this._onScroll,!0))},this._onClose=()=>{this._open&&(this._open=!1,window.removeEventListener("scroll",this._onScroll,!0))},this._onScroll=()=>this._onClose()}render(){return this.content?rr(ht||(ht=vs`
  ...
  `)),ms([zr({type:String})],Tn.prototype,"content",void 0),ms([zr({type:String})],Tn.prototype,"source",void 0),ms([Tr()],Tn.prototype,"_open",void 0),Tn=ms([Mr("meshcore-info-tip")],Tn);const In=[{key:"sent_flood",label:"Sent · Flood",color:"var(--info, #2196f3)",dash:!1},{key:"sent_direct",label:"Sent · Direct",color:"var(--info, #2196f3)",dash:!0},{key:"recv_flood",label:"Recv · Flood",color:"var(--good, #4caf50)",dash:!1},{key:"recv_direct",label:"Recv · Direct",color:"var(--good, #4caf50)",dash:!0},{key:"errors",label:"Errors",color:"var(--bad, #f44336)",dash:!1}];let Nn=class extends Sr{constructor(){super(...arguments),this.data=[],this.width=700,this.height=170,this.timeRange=48,this._hoverIndex=null,this._onPointerMove=e=>{const t=this._indexFromEvent(e);null!=t&&t!==this._hoverIndex&&(this._hoverIndex=t)},this._onPointerDown=e=>{const t=this._indexFromEvent(e);null!=t&&(this._hoverIndex=t===this._hoverIndex?null:t)},this._onPointerLeave=e=>{"mouse"===e.pointerType&&(this._hoverIndex=null)}}render(){return this.data&&0!==this.data.length?rr(vt||(vt=vs`
    ...
    `),this._renderChart(),null!=this._hoverIndex?this._renderTooltip():dr,In.map(e=>rr(mt||(mt=vs`<div class="legend-item">
        ...
        <text x="${0}" y="${0}" font-size="9" text-anchor="middle"
          fill="var(--secondary-text-color,#727272)">${0}</text>`),h(e),r-o+14,this._timeLabel(e,d))),m=In.map(e=>{const t=this.data.filter(t=>"number"==typeof t.values[e.key]&&isFinite(t.values[e.key])).map(t=>`${h(t.timestamp).toFixed(1)},${u(t.values[e.key]).toFixed(1)}`);if(0===t.length)return nr(bt||(bt=vs``));if(1===t.length){const[i,a]=t[0].split(",");return nr(yt||(yt=vs`<circle cx="${0}" cy="${0}" r="2" fill="${0}" />`),i,a,e.color)}return nr(xt||(xt=vs`<polyline points="${0}" fill="none" stroke="${0}"
        stroke-width="1.5" stroke-dasharray="${0}"
        stroke-linecap="round" stroke-linejoin="round" />`),t.join(" "),e.color,e.dash?"5,3":"none")});let f=nr(wt||(wt=vs``));if(null!=this._hoverIndex&&this._hoverIndex<this.data.length){const e=this.data[this._hoverIndex],t=h(e.timestamp),i=In.map(i=>{const a=e.values[i.key];return"number"==typeof a&&isFinite(a)?nr(kt||(kt=vs`<circle cx="${0}" cy="${0}" r="3" fill="${0}"
    ...
    `),r,s,In.map(e=>rr(Rt||(Rt=vs`<div class="tt-row">
            <span class="sw ${0}" style="border-top-color:${0}"></span>
            <span class="lbl">${0}</span>
            <span class="val">${0}</span>
          </div>`),e.dash?"dashed":"",e.color,e.label,this._fmtValue(i.values[e.key]))))}};Nn.styles=ws(At||(At=vs`
    :host { display: block; width: 100%; }
  ...
  `)),ms([zr({type:Array})],Nn.prototype,"data",void 0),ms([zr({type:Number})],Nn.prototype,"width",void 0),ms([zr({type:Number})],Nn.prototype,"height",void 0),ms([zr({type:Number})],Nn.prototype,"timeRange",void 0),ms([Tr()],Nn.prototype,"_hoverIndex",void 0),Nn=ms([Mr("meshcore-message-rate-chart")],Nn);let Fn=class extends Sr{constructor(){super(...arguments),this.entities=[],this.hiddenCount=0,this.knownNodeCount=0,this.contactCount=0,this.channelCount=0,this._rateHistory=[],this._rateHistoryKey=null}render(){if(!this.hass||!this.device)return dr;const e=new Set,t=this._renderHeroTiles(e),i=this._buildGroups(e);return rr(zt||(zt=vs`
      <div class="hero-row">
        ${0}
      </div>
    ...
    `),o?rr(Ht||(Ht=vs` · ${0}`),o):dr,s?rr(Ut||(Ut=vs`<span class="secondary">Compilado: ${0}</span>`),s):dr,100,0,100,"info"):dr}_renderConnectionInfoTile(){var e,t;if("companion"!==(null===(e=this.device)||void 0===e?void 0:e.type))return dr;const i=null===(t=this.device.connection_type)||void 0===t?void 0:t.toUpperCase(),a=this.device.connection_address;return i||a?rr(qt||(qt=vs`
    ...
    `),i[0],i.length>1?rr(Xt||(Xt=vs`<span class="secondary">· ${0} MHz</span>`),i.slice(1).join(" · ")):dr,100,0,100,"info")}_renderTemperatureTile(e){var t,i;const a=this._findByMetric("temperature");if(!a)return dr;const o=this._readNumber(a.entity_id);if(!Number.isFinite(o))return dr;e.add(a.entity_id);const s=(null!==(t=null===(i=this.hass)||void 0===i||null===(i=i.states[a.entity_id])||void 0===i||null===(i=i.attributes)||void 0===i?void 0:i.unit_of_measurement)&&void 0!==t?t:"°C").includes("F")?5*(o-32)/9:o,r=Sn("temperature",9*s/5+32);return rr(Qt||(Qt=vs`
    ...
    `),()=>this._fireMoreInfo(t.entity_id),this._renderInfoTip({band:"info",fillPct:0,tooltip:"Messages received (lifetime), split by receive mode:\n• Flood — broadcast packets received from neighbours.\n• Direct — routed packets where this node is on the path.\n\nEach bar below is a percentage of its own total:\n• Red = receive errors (CRC failures), as a share of all reception attempts (received + errors) — i.e. the error rate.\n• Amber = duplicate receptions, as a share of received messages (duplicates are a subset of received).\n\nBoth are context only, not banded — in a flooding mesh every active neighbour retransmits the same flood once, so a high duplicate ratio is normal (a 2-neighbour repeater sees ~50%, a 3-neighbour ~67%, etc.)."}),this._formatCount(r),d,"none",m>0?rr(_i||(_i=vs`<div class="err-line"
            ...
            </div>`),h,u.toFixed(1),Math.min(100,u).toFixed(1)):dr,n,l,m>0?rr(yi||(yi=vs`<span><span class="msg-swatch error"></span>Error ${0}</span>`),m):dr,h>0?rr(xi||(xi=vs`<span><span class="msg-swatch dup"></span>Dup ${0}</span>`),h):dr)}_renderRequestsTile(e){const t=this._findEntityIdMatching("request_succ"),i=this._findEntityIdMatching("request_fail");if(!t||!i)return dr;const a=this._readNumber(t.entity_id),o=this._readNumber(i.entity_id),s=a+o,r=s>0?a/s*100:0,n=s>=50?Sn("request_success_rate",r):{band:"info",fillPct:0,tooltip:""},l=[{value:a,label:`OK ${a}`,kind:"success"},{value:o,label:`Fail ${o}`,kind:"failure"}];return e.add(t.entity_id),e.add(i.entity_id),rr(wi||(wi=vs`
      <div class="hero-tile" @click=${0}>
        <div class="hero-tile-head">
          <span>Pedidos${0}</span>
          <span class="status-dot ${0}"></span>
    ...
    `),()=>{e&&this._fireMoreInfo(e.entity_id)},"fallback"===o?rr(Si||(Si=vs`<span style="opacity:0.55;text-transform:none;letter-spacing:0;font-size:10px;margin-left:4px;">via contact</span>`)):dr,s?rr(Ci||(Ci=vs`<span class="coord-pair">
                ${0}, ${0}
              </span>`),i.toFixed(4),a.toFixed(4)):rr(Mi||(Mi=vs`<span class="primary">—</span>`)),l?rr(Ri||(Ri=vs`<div class="loc-updated">Updated ${0}</div>`),l):dr)}_formatRelativeTime(e){const t=(Date.now()-e.getTime())/1e3;return!Number.isFinite(t)||t<0||t<60?"just now":t<3600?`${Math.floor(t/60)} min ago`:t<86400?`${Math.floor(t/3600)} h ago`:`${Math.floor(t/86400)} d ago`}_renderCompanionRadioActivityTile(){const e=this._findEntityIdMatching("tx_airtime"),t=this._findEntityIdMatching("rx_airtime"),i=this._findByMetric("uptime_hours");if(!e&&!t||!i)return dr;const a=this._readUptimeMinutes(i);if(!Number.isFinite(a)||a<=0)return dr;const o=e?this._readNumber(e.entity_id):0,s=t?this._readNumber(t.entity_id):0;if(!Number.isFinite(o)&&!Number.isFinite(s))return dr;const r=e=>Number.isFinite(e)?Math.min(100,Math.max(0,e/a*100)):0,n=r(o),l=r(s),d=Math.max(0,100-n-l),c=Sn("tx_airtime_util",n).band,p=Sn("rx_airtime_util",l).band,h=this._worseBand(c,p),u=[{value:n,label:`TX ${n.toFixed(1)}%`,kind:"tx"},{value:l,label:`RX ${l.toFixed(1)}%`,kind:"rx"},{value:d,label:`Idle ${d.toFixed(1)}%`,kind:"idle"}],g=n+l;return rr(Ai||(Ai=vs`
      <div class="hero-tile"
           @click=${0}>
        <div class="hero-tile-head">
          <span>Atividade de rádio${0}</span>
    ...
    `),()=>this._fireMoreInfo(e.entity_id),t=>this._fireContextMenu(t,e),Mn(()=>this._fireContextMenu(void 0,e)),p,e.label,u?this._renderInfoTip(u):dr,g,d?rr(Oi||(Oi=vs`<span class="unit">${0}</span>`),d):dr,c&&e.metricKey?rr(Pi||(Pi=vs`<meshcore-stat-bar
                .value=${0}
                .min=${0}
                .max=${0}
                .band=${0}>
              </meshcore-stat-bar>`),c.fillPct,0,100,p):dr)}_evaluateForRow(e,t,i){if("uptime_hours"===e){var a,o;let s=t;switch(null!==(a=null===(o=this.hass)||void 0===o||null===(o=o.states[i.entity_id])||void 0===o||null===(o=o.attributes)||void 0===o?void 0:o.unit_of_measurement)&&void 0!==a?a:""){case"d":s=24*t;break;case"h":s=t;break;case"min":s=t/60;break;default:s=t/3600}return Sn(e,s)}var s,r;return Sn(e,"temperature"===e&&(null!==(s=null===(r=this.hass)||void 0===r||null===(r=r.states[i.entity_id])||void 0===r||null===(r=r.attributes)||void 0===r?void 0:r.unit_of_measurement)&&void 0!==s?s:"").includes("C")?9*t/5+32:t)}_findByMetric(e){return this.entities.find(t=>t.metricKey===e)}_findEntityIdMatching(e){return this.entities.find(t=>t.entity_id.includes(e))}_findEntityByLabel(e){return this.entities.find(t=>t.label===e)}_readNumber(e){var t;const i=null===(t=this.hass)||void 0===t?void 0:t.states[e];if(!i||"unavailable"===i.state||"unknown"===i.state)return NaN;const a=parseFloat(i.state);return Number.isFinite(a)?a:NaN}_formatNumber(e,t){return Number.isFinite(e)?e.toFixed(t):"—"}_formatRowValue(e,t,i){var a;if("unavailable"===i||"unknown"===i)return"—";if(!Number.isFinite(t))return null!=i?i:"—";const o=null===(a=this.hass)||void 0===a||null===(a=a.entities)||void 0===a||null===(a=a[e.entity_id])||void 0===a?void 0:a.display_precision;return null!=o&&o>=0?t.toFixed(o):i&&i.includes(".")?i:t.toString()}_renderInfoTip(e){var t;return e.tooltip?rr(Bi||(Bi=vs`<meshcore-info-tip
      .content=${0}
      .source=${0}>
    </meshcore-info-tip>`),e.tooltip,null!==(t=e.source)&&void 0!==t?t:""):dr}_worseBand(e,t){const i={good:0,info:0,warn:1,bad:2};return i[e]>=i[t]?e:t}_fireMoreInfo(e){e&&this.dispatchEvent(new CustomEvent("hass-more-info",{detail:{entityId:e},bubbles:!0,composed:!0}))}_fireContextMenu(e,t){null==e||e.preventDefault(),this.dispatchEvent(new CustomEvent("tile-context-menu",{detail:{entityId:t.entity_id,label:t.label},bubbles:!0,composed:!0}))}};Fn.styles=ws(Li||(Li=vs`
  ...
  `)),ms([zr({type:Object})],Fn.prototype,"hass",void 0),ms([zr({type:Object})],Fn.prototype,"device",void 0),ms([zr({type:Array})],Fn.prototype,"entities",void 0),ms([zr({type:Number})],Fn.prototype,"hiddenCount",void 0),ms([zr({type:Number})],Fn.prototype,"knownNodeCount",void 0),ms([zr({type:Number})],Fn.prototype,"contactCount",void 0),ms([zr({type:Number})],Fn.prototype,"channelCount",void 0),ms([zr({type:Number})],Fn.prototype,"fallbackLatitude",void 0),ms([zr({type:Number})],Fn.prototype,"fallbackLongitude",void 0),ms([zr({type:Number})],Fn.prototype,"fallbackUpdated",void 0),ms([zr({type:Object})],Fn.prototype,"repeaterStatus",void 0),ms([Tr()],Fn.prototype,"_rateHistory",void 0),Fn=ms([Mr("meshcore-node-summary")],Fn);let Dn=class extends Sr{constructor(){super(...arguments),this.narrow=!1,this.knownNodeCount=0,this.contactCount=0,this.channelCount=0,this._repeaterStatus=null,this._deviceConfig=null,this._deviceEntities={},this._meshcoreDeviceMap={},this._hiddenSensors={},this._contextMenu=null,this._statusMessage=null,this._hiddenSensorsOpen=!1,this._loadedEntry=null,this._statusMessageTimeout=null,this._trace=()=>{var e;this.dispatchEvent(new CustomEvent("companion-trace-requested",{detail:{entryId:null===(e=this.selectedDevice)||void 0===e?void 0:e.entry_id},bubbles:!0,composed:!0}))}}connectedCallback(){super.connectedCallback(),this._loadHiddenSensors()}updated(){var e;const t=(null===(e=this.selectedDevice)||void 0===e?void 0:e.entry_id)||null;t&&t!==this._loadedEntry&&(this._loadedEntry=t,this._loadData())}async _loadData(){if(this.hass)try{var e,t;const[{meshcoreDeviceMap:i,deviceEntities:a},o,s]=await Promise.all([wn(this.hass),jr(this.hass,null===(e=this.config)||void 0===e?void 0:e.entry_id).catch(()=>null),Hr(this.hass,null===(t=this.config)||void 0===t?void 0:t.entry_id).catch(()=>null)]);this._meshcoreDeviceMap=i,this._deviceEntities=a,this._repeaterStatus=o,this._deviceConfig=s}catch(e){this._repeaterStatus=null}}_deviceKey(){var e;return(null===(e=this.selectedDevice)||void 0===e?void 0:e.entry_id)||"companion"}_entities(){var e;if(!this.hass||!this.selectedDevice)return[];const t=new Set(this._hiddenSensors[this._deviceKey()]||[]),i=this.selectedDevice.entry_id,a=this._meshcoreDeviceMap[i];if(a&&this._deviceEntities[a])return this._deviceEntities[a].filter(e=>!t.has(e.entity_id));const o=(null===(e=this.selectedDevice.pubkey_prefix)||void 0===e||null===(e=e.substring(0,6))||void 0===e?void 0:e.toLowerCase())||"";if(!o)return[];const s=[];for(const[e,i]of Object.entries(this._deviceEntities))if(!Object.entries(this._meshcoreDeviceMap).some(([t,i])=>i===e&&(t.includes("_repeater_")||t.includes("_client_"))))for(const e of i)e.entity_id.toLowerCase().includes(o)&&!t.has(e.entity_id)&&s.push(e);return s.sort((e,t)=>e.sortOrder-t.sortOrder)}_descriptor(e){var t,i,a,o;return{type:"companion",name:e.name,pubkey_prefix:e.pubkey_prefix,connected:e.connected,firmware:e.firmware||(null===(t=this._deviceConfig)||void 0===t?void 0:t.firmware_version),hardware_model:null===(i=this._deviceConfig)||void 0===i?void 0:i.hardware_model,connection_type:null===(a=this._deviceConfig)||void 0===a?void 0:a.connection_type,connection_address:null===(o=this._deviceConfig)||void 0===o?void 0:o.connection_address,entry_id:e.entry_id}}_loadHiddenSensors(){try{this._hiddenSensors=JSON.parse(localStorage.getItem("meshcore-hidden-sensors")||"{}")}catch(e){this._hiddenSensors={}}}_saveHiddenSensors(){try{localStorage.setItem("meshcore-hidden-sensors",JSON.stringify(this._hiddenSensors))}catch(e){}}_hideSensor(e,t){const i=this._deviceKey(),a=this._hiddenSensors[i]||[];a.includes(e)||(this._hiddenSensors={...this._hiddenSensors,[i]:[...a,e]}),this._saveHiddenSensors(),this._contextMenu=null,this._showStatus("Oculto: "+t,"success")}_unhideSensor(e){const t=this._deviceKey(),i=(this._hiddenSensors[t]||[]).filter(t=>t!==e),a={...this._hiddenSensors};i.length?a[t]=i:delete a[t],this._hiddenSensors=a,this._saveHiddenSensors()}async _action(e,t,i){if(this.hass)try{var a;const o=await async function(e,t,i,a){try{const o={type:"hivefw_integration/execute_local",command:t};return i&&(o.args=i),a&&(o.entry_id=a),await e.callWS(o)}catch(e){const t=e;return{response:t&&t.message?t.code?`${t.message} (${t.code})`:t.message:String(e),success:!1,timestamp:(new Date).toISOString()}}}(this.hass,e,t,null===(a=this.config)||void 0===a?void 0:a.entry_id);this._showStatus("Companion: "+(i||e)+" → "+(o.response||"OK"),"success"),"set_time"===e&&this._loadData()}catch(t){this._showStatus("Companion: "+(i||e)+" — "+String(t),"error")}}async _copyPublicKey(e){if(e){try{await navigator.clipboard.writeText(e)}catch(t){const i=document.createElement("textarea");i.value=e,i.style.position="fixed",i.style.opacity="0",document.body.appendChild(i),i.select(),document.execCommand("copy"),i.remove()}this._showStatus("Public Key copiada","success")}}_showStatus(e,t){this._statusMessage={text:e,type:t},null!==this._statusMessageTimeout&&window.clearTimeout(this._statusMessageTimeout),this._statusMessageTimeout=window.setTimeout(()=>{this._statusMessage=null,this._statusMessageTimeout=null},5e3)}render(){var e;const t=this.selectedDevice;if(!t)return rr(Hi||(Hi=vs`<div class="page"><div class="wrap">Sem Companion selecionado.</div></div>`));const i=this._entities(),a=this._hiddenSensors[this._deviceKey()]||[];return rr(Ui||(Ui=vs`
    ...
    `),t.name,(null===(e=this._deviceConfig)||void 0===e?void 0:e.pubkey)||t.pubkey||t.pubkey_prefix,()=>{var e;this._copyPublicKey((null===(e=this._deviceConfig)||void 0===e?void 0:e.pubkey)||t.pubkey||t.pubkey_prefix)},a.length?rr(qi||(qi=vs`<button class="minor" @click=${0}>Sensores ocultos (${0})</button>`),()=>this._hiddenSensorsOpen=!0,a.length):dr,i.length?rr(ji||(ji=vs`<meshcore-node-summary
        ...
        ${0}
      </div></div>`),()=>this._hiddenSensorsOpen=!1,e=>e.stopPropagation(),()=>this._hiddenSensorsOpen=!1,a.map(e=>{var t;return rr(Ki||(Ki=vs`<div class="sensor-row"><div><div>${0}</div><div class="sensor-id">${0}</div></div><button class="minor" @click=${0}>Mostrar</button></div>`),(null===(t=Object.values(this._deviceEntities).flat().find(t=>t.entity_id===e))||void 0===t?void 0:t.label)||e,e,()=>this._unhideSensor(e))})):dr,this._statusMessage?rr(Gi||(Gi=vs`<div class="toast ${0}">${0}</div>`),this._statusMessage.type,this._statusMessage.text):dr)}};Dn.styles=ws(Xi||(Xi=vs`
  ...
  `)),ms([zr({type:Object})],Dn.prototype,"hass",void 0),ms([zr({type:Object})],Dn.prototype,"config",void 0),ms([zr({type:Boolean})],Dn.prototype,"narrow",void 0),ms([zr({type:Object})],Dn.prototype,"selectedDevice",void 0),ms([zr({type:Number})],Dn.prototype,"knownNodeCount",void 0),ms([zr({type:Number})],Dn.prototype,"contactCount",void 0),ms([zr({type:Number})],Dn.prototype,"channelCount",void 0),ms([Tr()],Dn.prototype,"_repeaterStatus",void 0),ms([Tr()],Dn.prototype,"_deviceConfig",void 0),ms([Tr()],Dn.prototype,"_deviceEntities",void 0),ms([Tr()],Dn.prototype,"_meshcoreDeviceMap",void 0),ms([Tr()],Dn.prototype,"_hiddenSensors",void 0),ms([Tr()],Dn.prototype,"_contextMenu",void 0),ms([Tr()],Dn.prototype,"_statusMessage",void 0),ms([Tr()],Dn.prototype,"_hiddenSensorsOpen",void 0),Dn=ms([Mr("meshcore-status-page")],Dn);let En=class extends Sr{constructor(){super(),this.open=!1,this.title="Confirm",this.message="",this.confirmLabel="Confirm",this.cancelLabel="Cancel",this.dangerous=!1,this._typedValue="",vn(this,{isOpen:()=>this.open,onEscape:()=>this._onCancel()})}render(){if(!this.open)return;const e=this.requireTyped&&this._typedValue!==this.requireTyped;return rr(Qi||(Qi=vs`
    ...
    `),a,null!=i&&i.release_available?rr(la||(la=vs`<span>Última Release: ${0}</span>`),o):rr(da||(da=vs`<span>Release: por verificar</span>`)),null!=i&&i.host?rr(ca||(ca=vs`<span class="firmware-host">${0}</span>`),i.host):dr,i?i.supported?i.bootstrap_required?rr(ua||(ua=vs`
          ...
          `),this._softwareUpdateStatus.installed_version||"—",this._softwareUpdateStatus.latest_version||"—",this._softwareUpdateBusy||!this._softwareUpdateStatus.update_available,this._installLatestSoftware,this._softwareUpdateBusy?"A atualizar software…":this._softwareUpdateStatus.update_available?"Atualizar e reiniciar Home Assistant":"Software atualizado"):rr(wa||(wa=vs`
            <div class="firmware-empty">
              ${0}
            </div>
            <button
    ...
    `),null!==(e=this._editValues.name)&&void 0!==e?e:this._deviceConfig.name,e=>{this._editValues.name=e.target.value},!this._editValues.name||this._editValues.name===this._deviceConfig.name,this._handleNameSave,this._showRegenIdentityConfirm,this._importKeyValue,e=>{this._importKeyValue=e.target.value},!this._importKeyValue.trim(),this._handleImportKeyConfirm):dr}_hasChanges(e,t){return!!this._deviceConfig&&t.some(e=>void 0!==this._editValues[e]&&this._editValues[e]!==this._deviceConfig[e])}async _handleApply(e){if(!this.hass||!this._deviceConfig)return;let t=[];switch(e){case"device-name":t=["name"];break;case"radio-settings":t=["tx_power","frequency","bandwidth","spreading_factor","coding_rate","path_hash_mode","rx_boosted_gain","adc_multiplier"]}const i={};for(const e of t)void 0!==this._editValues[e]&&(i[e]=this._editValues[e]);this._saving=!0;try{var a;const o=await Ur(this.hass,i,null===(a=this.config)||void 0===a?void 0:a.entry_id);if(o.success){this._deviceConfig&&(this._deviceConfig={...this._deviceConfig,...i});for(const e of t)delete this._editValues[e];this._editValues={...this._editValues},"radio-settings"===e&&("rx_boosted_gain"in i||"adc_multiplier"in i)&&await this._readRepeaterStatus(!1,!1),o.rename?this._renameSuccess=o.rename:this._showStatusMessage(`Saved: ${t.join(", ")}`,"success")}else this._showStatusMessage("Save failed","error")}catch(e){this._showStatusMessage(`Error: ${String(e)}`,"error")}finally{this._saving=!1}}async _copyToClipboard(e){try{await navigator.clipboard.writeText(e),this._showStatusMessage("Copiado para a área de transferência.","success")}catch(e){this._showStatusMessage("Falha ao copiar.","error")}}_showStatusMessage(e,t){this._statusMessage={text:e,type:t},null!==this._statusMessageTimeout&&clearTimeout(this._statusMessageTimeout),this._statusMessageTimeout=window.setTimeout(()=>{this._statusMessage=null,this._statusMessageTimeout=null},5e3)}_handleNameSave(){var e;const t=this._editValues.name,i=null===(e=this._deviceConfig)||void 0===e?void 0:e.name;if(void 0===t||t===i)return;const a=e=>(e||"").toLowerCase().replace(/[^a-z0-9]+/g,"_").replace(/^_|_$/g,""),o=a(null!=i?i:""),s=a(String(t));this._confirmAction={title:"Renomear dispositivo",message:`Renomear o dispositivo altera todos os IDs de entidades terminados em _${o} para _${s}. Quaisquer automatismos, scripts ou dashboards que referenciem IDs pelo sufixo antigo name will need updating. A repair issue will list every renamed entity. Continue?`,onConfirm:async()=>{await this._handleApply("device-name")}},this._confirmDialogOpen=!0}async _applyLocation(){if(this.hass&&this._deviceConfig){this._saving=!0;try{var e;const i=["latitude","longitude"],a={};if("ha_location"===this._locationSource){const e=this.hass.states["zone.home"];if(!e||null==e.attributes.latitude||null==e.attributes.longitude)return void this._showStatusMessage("Could not read zone.home coordinates from Home Assistant","error");a.latitude=e.attributes.latitude,a.longitude=e.attributes.longitude}else for(const e of i)void 0!==this._editValues[e]&&(a[e]=this._editValues[e]);if(Object.keys(a).length>0){var t;if(!(await Ur(this.hass,a,null===(t=this.config)||void 0===t?void 0:t.entry_id)).success)return void this._showStatusMessage("Failed to save coordinates","error");this._deviceConfig&&(this._deviceConfig={...this._deviceConfig,...a});for(const e of i)delete this._editValues[e];this._editValues={...this._editValues}}if(!(await Yr(this.hass,this._locationSource,null===(e=this.config)||void 0===e?void 0:e.entry_id)).success)return void this._showStatusMessage("Failed to update location source","error");await this._loadDeviceConfig(),this._showStatusMessage("Location settings applied","success")}catch(e){this._showStatusMessage(`Error: ${String(e)}`,"error")}finally{this._saving=!1}}}_showRegenIdentityConfirm(){this._confirmAction={title:"Gerar nova identidade",message:"Será criada uma nova identidade criptográfica, o dispositivo será reiniciado e os IDs das entidades serão migrados para o novo prefixo. Automatismos que usem os IDs antigos terão de ser atualizados. Todos os contactos terão de voltar a adicionar este dispositivo. Esta operação não pode ser anulada.",requireTyped:"REGENERATE",onConfirm:async()=>{var e;this.hass&&this._startIdentityFlow("regenerate",{type:"hivefw_integration/regenerate_identity",payload:null!==(e=this.config)&&void 0!==e&&e.entry_id?{entry_id:this.config.entry_id}:{}})}},this._confirmDialogOpen=!0}_handleImportKeyConfirm(){const e=this._importKeyValue.trim().replace(/\s+/g,"");e&&(64===e.length||128===e.length?/^[0-9a-fA-F]+$/.test(e)?(this._confirmAction={title:"Importar chave privada",message:"Importar uma chave privada substitui a identidade do dispositivo, reinicia o rádio e migra os IDs das entidades para o novo prefixo. Automatismos que usem os IDs antigos terão de ser atualizados. Todos os contactos terão de voltar a adicionar este dispositivo.",requireTyped:"IMPORT",onConfirm:()=>this._importIdentityKey()},this._confirmDialogOpen=!0):this._showStatusMessage("A chave privada deve estar em hexadecimal (0-9, a-f).","error"):this._showStatusMessage("A chave privada deve ter 64 ou 128 caracteres hexadecimais.","error"))}async _importIdentityKey(){var e;if(!this.hass||!this._importKeyValue.trim())return;const t=this._importKeyValue.trim().replace(/\s+/g,"");this._importKeyValue="";const i={private_key:t};null!==(e=this.config)&&void 0!==e&&e.entry_id&&(i.entry_id=this.config.entry_id),this._startIdentityFlow("import",{type:"hivefw_integration/import_identity",payload:i})}_startIdentityFlow(e,t){if(!this.hass)return;this._identityFlowUnsubscribe&&(this._identityFlowUnsubscribe(),this._identityFlowUnsubscribe=null),this._identityFlowState={kind:"progress",flow:e,currentStep:"generating",completedSteps:new Set};const{unsubscribe:i}=function(e,t,i,a){let o,s=null;const r=new Promise(e=>{o=e});let n={success:!1,code:"unknown",message:"Identity flow terminated without a result event."};return e.connection.subscribeMessage(e=>{if("done"===e.step&&e.success&&e.old_pubkey&&e.new_pubkey){const t={success:!0,old_pubkey:e.old_pubkey,new_pubkey:e.new_pubkey,warning:e.warning};n=t,a({type:"result",data:t})}else"done"!==e.step&&a({type:"progress",step:e.step})},{type:t,...i}).then(e=>{s=e,o(n)}).catch(e=>{const t={success:!1,code:e.code||"error",message:e.message||"Identity flow failed."};a({type:"error",data:t}),o(t)}),{unsubscribe:()=>{s&&s()},done:r}}(this.hass,t.type,t.payload,t=>{if("progress"===t.type){if("progress"!==this._identityFlowState.kind)return;const e=new Set(this._identityFlowState.completedSteps);e.add(this._identityFlowState.currentStep),this._identityFlowState={...this._identityFlowState,currentStep:t.step,completedSteps:e}}else"result"===t.type?this._identityFlowState={kind:"success",flow:e,oldPubkey:t.data.old_pubkey,newPubkey:t.data.new_pubkey,warning:t.data.warning}:"error"===t.type&&(this._identityFlowState={kind:"failure",flow:e,code:t.data.code,message:t.data.message})});this._identityFlowUnsubscribe=i}_closeIdentityFlowModal(){this._identityFlowUnsubscribe&&(this._identityFlowUnsubscribe(),this._identityFlowUnsubscribe=null);const e="success"===this._identityFlowState.kind;this._identityFlowState={kind:"closed"},e&&this._loadDeviceConfig()}_renderIdentityFlowModal(){const e=this._identityFlowState;if("closed"===e.kind)return dr;const t="regenerate"===e.flow?"Gerar nova identidade":"Importar chave privada",i="regenerate"===e.flow?"A gerar identidade":"A importar identidade",a="regenerate"===e.flow?"Identidade gerada":"Identidade importada",o="regenerate"===e.flow?"Identity Regeneration Failed":"Identity Import Failed";let s,r;"progress"===e.kind?(s=rr(so||(so=vs`
      ...
      `),On.map(t=>{const i=e.completedSteps.has(t.step),a=e.currentStep===t.step;let o="○",s="var(--secondary-text-color)";return i?(o="✓",s="var(--success-color, #28a745)"):a&&(o="⏳",s="var(--primary-color)"),rr(ro||(ro=vs`
    ...
    `))],ms([zr({type:Object})],Pn.prototype,"hass",void 0),ms([zr({type:Object})],Pn.prototype,"config",void 0),ms([zr({type:Boolean})],Pn.prototype,"narrow",void 0),ms([zr({type:Object})],Pn.prototype,"selectedDevice",void 0),ms([zr({type:Number})],Pn.prototype,"contactCount",void 0),ms([zr({type:Number})],Pn.prototype,"channelCount",void 0),ms([Tr()],Pn.prototype,"_deviceConfig",void 0),ms([Tr()],Pn.prototype,"_repeaterStatus",void 0),ms([Tr()],Pn.prototype,"_managedDevices",void 0),ms([Tr()],Pn.prototype,"_scopeDraft",void 0),ms([Tr()],Pn.prototype,"_scopeGlobal",void 0),ms([Tr()],Pn.prototype,"_scopeSaving",void 0),ms([Tr()],Pn.prototype,"_regionTarget",void 0),ms([Tr()],Pn.prototype,"_regionText",void 0),ms([Tr()],Pn.prototype,"_regionBusy",void 0),ms([Tr()],Pn.prototype,"_localRegions",void 0),ms([Tr()],Pn.prototype,"_localRegionBusy",void 0),ms([Tr()],Pn.prototype,"_localRegionAction",void 0),ms([Tr()],Pn.prototype,"_localRegionName",void 0),ms([Tr()],Pn.prototype,"_localRegionParent",void 0),ms([Tr()],Pn.prototype,"_regionAction",void 0),ms([Tr()],Pn.prototype,"_regionName",void 0),ms([Tr()],Pn.prototype,"_loading",void 0),ms([Tr()],Pn.prototype,"_error",void 0),ms([Tr()],Pn.prototype,"_editValues",void 0),ms([Tr()],Pn.prototype,"_saving",void 0),ms([Tr()],Pn.prototype,"_firmwareOtaStatus",void 0),ms([Tr()],Pn.prototype,"_firmwareFile",void 0),ms([Tr()],Pn.prototype,"_firmwareBusy",void 0),ms([Tr()],Pn.prototype,"_firmwareChecking",void 0),ms([Tr()],Pn.prototype,"_firmwareUploadStage",void 0),ms([Tr()],Pn.prototype,"_firmwareDownloadTarget",void 0),ms([Tr()],Pn.prototype,"_softwareUpdateStatus",void 0),ms([Tr()],Pn.prototype,"_softwareUpdateBusy",void 0),ms([Tr()],Pn.prototype,"_dutyCycleValue",void 0),ms([Tr()],Pn.prototype,"_dutyCycleBusy",void 0),ms([Tr()],Pn.prototype,"_adminPasswordDraft",void 0),ms([Tr()],Pn.prototype,"_guestPasswordDraft",void 0),ms([Tr()],Pn.prototype,"_repeaterAccessBusy",void 0),ms([Tr()],Pn.prototype,"_repeaterReadBusy",void 0),ms([Tr()],Pn.prototype,"_repeaterQuickBusy",void 0),ms([Tr()],Pn.prototype,"_aclNewPublicKey",void 0),ms([Tr()],Pn.prototype,"_aclNewPermissions",void 0),ms([Tr()],Pn.prototype,"_backupBusy",void 0),ms([Tr()],Pn.prototype,"_confirmAction",void 0),ms([Tr()],Pn.prototype,"_confirmDialogOpen",void 0),ms([Tr()],Pn.prototype,"_locationSource",void 0),ms([Tr()],Pn.prototype,"_locationMode",void 0),ms([Tr()],Pn.prototype,"_settingsTopic",void 0),ms([Tr()],Pn.prototype,"_importKeyValue",void 0),ms([Tr()],Pn.prototype,"_identityFlowState",void 0),ms([Tr()],Pn.prototype,"_renameSuccess",void 0),ms([Tr()],Pn.prototype,"_statusMessage",void 0),Pn=ms([Mr("meshcore-settings-page")],Pn);let Bn=class extends Sr{constructor(){super(),this.open=!1,this.contactName="",this.result=null,this.error="",this.availableRepeaters=[],this.targetContact=null,this.pathMode="discovery",this.pathHops=[],this.enteredPath="",this._repeaterFilter="",this._running=!1,this._onPathModeChange=e=>{this.pathMode=e.target.value},this._onExplicitPathInput=e=>{this.enteredPath=e.target.value},this._onRunTrace=()=>{if(!this._canRunTrace())return;const e="discovery"===this.pathMode?void 0:this._buildPathString();this._running=!0,this.dispatchEvent(new CustomEvent("trace-requested",{detail:{pathMode:this.pathMode,path:e},bubbles:!0,composed:!0}))},vn(this,{isOpen:()=>this.open,onEscape:()=>this._close()})}willUpdate(e){if(e.has("open")&&this.open&&!e.get("open")){const e=this.targetContact;if(!e||2!==e.type&&3!==e.type&&4!==e.type)this.pathMode="discovery",this.pathHops=[];else{this.pathMode="select";const t=this._resolveCachedHops(e);this.pathHops=t||[]}this.enteredPath="",this._repeaterFilter="",this._running=!1}(e.has("result")&&this.result||e.has("error")&&this.error)&&(this._running=!1)}_resolveCachedHops(e){var t,i;if(1!==(null!==(t=e.out_path_hash_mode)&&void 0!==t?t:0))return null;const a=(e.out_path||"").toLowerCase(),o=null!==(i=e.out_path_len)&&void 0!==i?i:0;if(!a||o<=0)return null;if(a.length<4*o)return null;const s=[];for(let e=0;e<o;e++){const t=a.substring(4*e,4*(e+1)),i=this.availableRepeaters.find(e=>(e.pubkey_prefix||"").toLowerCase().startsWith(t));if(!i)return null;s.push(i)}return s}render(){return this.open?rr(bo||(bo=vs`
    ...
    `),e.response_time,0===e.hops?"Direct (0 hops)":`${e.hops}`,null!==e.final_snr&&void 0!==e.final_snr?rr(Do||(Do=vs`
          ...
          `),t.map((e,t)=>rr(Po||(Po=vs`
                  ...
                  `),t+1,e.hash,e.snr.toFixed(2)))):rr(Bo||(Bo=vs``)))}_close(){this.open=!1,this.dispatchEvent(new CustomEvent("trace-dialog-closed",{bubbles:!0,composed:!0}))}};Bn.styles=[Ir,ws(Lo||(Lo=vs`
  ...
  `))],ms([zr({type:Boolean})],Bn.prototype,"open",void 0),ms([zr({type:String})],Bn.prototype,"contactName",void 0),ms([zr({type:Object})],Bn.prototype,"result",void 0),ms([zr({type:String})],Bn.prototype,"error",void 0),ms([zr({type:Array})],Bn.prototype,"availableRepeaters",void 0),ms([zr({type:Object})],Bn.prototype,"targetContact",void 0),ms([Tr()],Bn.prototype,"pathMode",void 0),ms([Tr()],Bn.prototype,"pathHops",void 0),ms([Tr()],Bn.prototype,"enteredPath",void 0),ms([Tr()],Bn.prototype,"_repeaterFilter",void 0),ms([Tr()],Bn.prototype,"_running",void 0),Bn=ms([Mr("meshcore-trace-dialog")],Bn);let Ln=class extends Sr{constructor(){super(),this.open=!1,this.contacts=[],this._typeFilter="all",this._search="",this._onTypeChange=e=>{this._typeFilter=e.target.value},this._onSearchInput=e=>{this._search=e.target.value},this._close=()=>{this.dispatchEvent(new CustomEvent("target-picker-closed",{bubbles:!0,composed:!0}))},vn(this,{isOpen:()=>this.open,onEscape:()=>this._close()})}willUpdate(e){e.has("open")&&this.open&&!e.get("open")&&(this._typeFilter="all",this._search="")}render(){if(!this.open)return rr(Ho||(Ho=vs``));const e=this._search.trim().toLowerCase(),t=this.contacts.filter(e=>{switch(this._typeFilter){case"all":default:return!0;case"client":return 1===e.type;case"repeater":return 2===e.type;case"room_server":return 3===e.type;case"sensor":return 4===e.type}}).filter(t=>{if(!e)return!0;const i=(t.adv_name||"").toLowerCase(),a=(t.pubkey_prefix||"").toLowerCase();return i.includes(e)||a.startsWith(e)}).sort((e,t)=>(e.adv_name||"").localeCompare(t.adv_name||""));return rr(Uo||(Uo=vs`
      <div class="dialog-backdrop" @click=${0}>
        <div
          class="dialog"
          role="dialog"
    ...
    `),this._close,e=>e.stopPropagation(),this._close,this._typeFilter,this._onTypeChange,this._search,this._onSearchInput,0===t.length?rr(qo||(qo=vs`<div class="empty">No matching contacts</div>`)):t.map(e=>rr(jo||(jo=vs`
                  ...
                  `),()=>this._select(e),e.adv_name||e.pubkey_prefix,this._iconFor(e.type),e.adv_name||e.pubkey_prefix,(e.pubkey_prefix||"").substring(0,2).toUpperCase())))}_iconFor(e){switch(e){case 2:return rr(Vo||(Vo=vs`<svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor"><path d="M12 2a2 2 0 012 2c0 .74-.4 1.39-1 1.73V10h4.27c.15-.86.45-1.66.87-2.36l-1.82-1.06a.5.5 0 01-.18-.68l.5-.87a.5.5 0 01.68-.18l1.81 1.05C19.66 4.66 20.78 4 22 4v2c-.8 0-1.54.32-2.08.84l1.5 2.6a.5.5 0 01-.18.68l-.87.5a.5.5 0 01-.68-.18L18.2 7.92c-.14.65-.2 1.33-.2 2.08 0 3.31-2.69 6-6 6s-6-2.69-6-6 2.69-6 6-6z"/></svg>`));case 3:return rr(Wo||(Wo=vs`<svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor"><path d="M4 6h16v4H4V6zm0 8h16v4H4v-4zm2-6.5A.5.5 0 116 7a.5.5 0 010 .5zm0 8A.5.5 0 116 15a.5.5 0 010 .5z"/></svg>`));case 4:return rr(Ko||(Ko=vs`<svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor"><path d="M12 2a4 4 0 00-4 4v7.55A5.5 5.5 0 1015.5 20a5.47 5.47 0 00.5-2.45V6a4 4 0 00-4-4zm0 2a2 2 0 012 2v8.1a3.5 3.5 0 11-4 0V6a2 2 0 012-2z"/></svg>`));default:return rr(Go||(Go=vs`<svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor"><path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/></svg>`))}}_select(e){this.dispatchEvent(new CustomEvent("target-selected",{detail:e,bubbles:!0,composed:!0}))}};Ln.styles=[Ir,ws(Xo||(Xo=vs`
      :host { display: contents; }
