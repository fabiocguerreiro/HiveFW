...
`)),il=/^<[^>]+>\s*/,ol=/@\[([^\]]+)\]/g,rl=/@(\w+)/g,al={recipient_type_entity:"select.hivefw_recipient_type",channel_entity:"select.hivefw_channel",contact_entity:"select.hivefw_contact",channel_entity_pattern:"binary_sensor.hivefw_{prefix}_ch_{idx}_messages",contact_entity_pattern:"binary_sensor.hivefw_{prefix}_{contact}_messages",domain_filter:"hivefw"},sl={...al,hours_to_show:48,initial_hours:1,max_messages:500,show_date_separators:!0,group_messages:!0,group_timeout:300,timestamp_format:"relative",update_mode:"auto",refresh_interval:30,enable_cache:!0,cache_ttl:86400,cache_max_size:5242880};async function nl(e){try{return(await e.callWS({type:"hivefw_integration/get_devices"})).devices||[]}catch(e){return[]}}async function ll(e,t){try{const i={type:"hivefw_integration/get_contacts"};return t&&(i.entry_id=t),(await e.callWS(i)).contacts||[]}catch(e){return[]}}async function dl(e,t){try{const i={type:"hivefw_integration/get_channels"};return t&&(i.entry_id=t),(await e.callWS(i)).channels||[]}catch(e){return[]}}async function cl(e,t){try{const i={type:"hivefw_integration/get_device_config"};return t&&(i.entry_id=t),await e.callWS(i)}catch(e){throw new Error("Failed to get device configuration")}}async function pl(e,t,i){try{const o={type:"hivefw_integration/set_device_config",settings:t};return i&&(o.entry_id=i),await e.callWS(o)}catch(e){const t=e;return{success:!1,changed:[],error:t&&t.message?t.code?`${t.message} (${t.code})`:t.message:String(e)}}}async function hl(e,t,i,o){try{const r={type:"hivefw_integration/execute_local",command:t};return i&&(r.args=i),o&&(r.entry_id=o),await e.callWS(r)}catch(e){const t=e;return{response:t&&t.message?t.code?`${t.message} (${t.code})`:t.message:String(e),success:!1,timestamp:(new Date).toISOString()}}}async function ul(e,t,i,o){try{const r={type:"hivefw_integration/execute_remote",target_prefix:t,command:i};return o&&(r.entry_id=o),await e.callWS(r)}catch(e){const t=e;return{response:t&&t.message?t.code?`${t.message} (${t.code})`:t.message:String(e),success:!1,timestamp:(new Date).toISOString()}}}async function ml(e,t){try{const i={type:"hivefw_integration/get_flood_scopes"};t&&(i.entry_id=t);const o=await e.callWS(i);return{scopes:o.scopes||[],global:!!o.global}}catch(e){return{scopes:[],global:!1}}}async function gl(e,t,i=!1){const o={type:"hivefw_integration/get_firmware_ota_status"};return t&&(o.entry_id=t),i&&(o.force=!0),e.callWS(o)}async function vl(e,t){try{const i={type:"hivefw_integration/get_hive_neighbors"};return t&&(i.entry_id=t),await e.callWS(i)}catch(e){return{supported:!1,repeater_enabled:!1,count:0,neighbors:[]}}}async function fl(e,t){const i={type:"hivefw_integration/get_hive_neighbor_discovery"};return t&&(i.entry_id=t),e.callWS(i)}async function yl(e,t,i,o){try{const r={type:"hivefw_integration/add_contact",public_key:t};return i&&(r.name=i),o&&(r.entry_id=o),await e.callWS(r)}catch(e){return{success:!1}}}async function bl(e,t,i){try{const o={type:"hivefw_integration/remove_contact",public_key:t};return i&&(o.entry_id=i),await e.callWS(o)}catch(e){return{success:!1}}}class _l{constructor(){this._counts={},this._lastRead={},this._subscribers=new Set,this._markReadRequestedHandler=null,this._readProgress=null,this._postSwitchTimerHandler=null}subscribe(e){return this._subscribers.add(e),()=>{this._subscribers.delete(e)}}onMarkReadRequested(e){this._markReadRequestedHandler=e}onPostSwitchTimerFire(e){this._postSwitchTimerHandler=e}requestMarkRead(e){e&&this._markReadRequestedHandler&&this._markReadRequestedHandler(e)}_notify(){for(const e of[...this._subscribers])try{e()}catch(e){console.error("[UnreadController] subscriber callback threw",e)}}ingestBackendData(e,t){var i,o;this._counts={...null!==(i=null==e?void 0:e.unread)&&void 0!==i?i:{}},this._lastRead={...null!==(o=null==e?void 0:e.last_read)&&void 0!==o?o:{}},this._notify()}clearEntity(e){e&&this._counts[e]&&(this._counts={...this._counts,[e]:0},this._notify())}get counts(){return this._counts}get lastRead(){return this._lastRead}beginConversation(e,t){var i;this._clearPostSwitchTimer();const o={entityId:e,anchorId:e&&null!==(i=this._lastRead[e])&&void 0!==i?i:null,unreadCountAtSelection:t,graceUntil:Date.now()+1e3,postSwitchTimer:null,markReadFired:!1,lastMarkReadIdSent:null};this._readProgress=o,o.postSwitchTimer=setTimeout(()=>{var e;this._readProgress===o&&(o.postSwitchTimer=null,null===(e=this._postSwitchTimerHandler)||void 0===e||e.call(this))},1e3)}endConversation(){this._clearPostSwitchTimer(),this._readProgress=null}_clearPostSwitchTimer(){const e=this._readProgress;null!=e&&e.postSwitchTimer&&(clearTimeout(e.postSwitchTimer),e.postSwitchTimer=null)}resetUnreadCountAtSelection(){this._readProgress&&(this._readProgress.unreadCountAtSelection=0)}maybeReanchorOnLateData(e){const t=this._readProgress;if(!t||t.entityId!==e)return!1;if(null!==t.anchorId)return!1;if(t.markReadFired)return!1;const i=this._lastRead[e];return!!i&&(t.anchorId=i,!0)}onScrollState(e){return this._tryAdvanceCursor(e.entityId,e.lastMessageVisible,e.hasNewerMessages,e.bufferTailId,!1)}onPillJump(e){return this._tryAdvanceCursor(e.entityId,!0,!1,e.bufferTailId,!0)}_tryAdvanceCursor(e,t,i,o,r){if(!e)return!1;const a=this._readProgress;return!(!a||a.entityId!==e||!r&&Date.now()<a.graceUntil||i||!t||null!==o&&o===a.lastMarkReadIdSent||(a.lastMarkReadIdSent=o,a.markReadFired=!0,this.requestMarkRead(e),0))}badgeCount(e,t,i){if(!e)return 0;const o=this._counts;if(i&&o[i])return o[i];const r=/^\d+$/.test(e),a=t?`hivefw_${t}_ch_${e}_messages`:null;for(const[t,i]of Object.entries(o))if(!(i<=0))if(r){if(a){if(t.endsWith(a))return i}else if(t.endsWith(`_ch_${e}_messages`))return i}else{const o=e.substring(0,6);if(t.endsWith(`_${o}_messages`))return i}return 0}dividerAfterGroupIdx(e){const t=this._readProgress;if(!t)return null;let i=null;if(t.anchorId){let o=0;for(const r of e)if("date-separator"!==r.type){if(r.group.messages.some(e=>e.id===t.anchorId)){i=o;break}o++}}if(null!==i){let t=0;for(const o of e)if("date-separator"!==o.type){if(t>i&&!o.group.isOutgoing)return t;t++}return null}if(t.unreadCountAtSelection>0){const i=e.filter(e=>"date-separator"!==e.type).length,o=i-t.unreadCountAtSelection;return o>=0?o:0}return null}cursorAtTail(e,t){return!(!e||null===t)&&this._lastRead[e]===t}}const xl=[1116352408,1899447441,3049323471,3921009573,961987163,1508970993,2453635748,2870763221,3624381080,310598401,607225278,1426881987,1925078388,2162078206,2614888103,3248222580,3835390401,4022224774,264347078,604807628,770255983,1249150122,1555081692,1996064986,2554220882,2821834349,2952996808,3210313671,3336571891,3584528711,113926993,338241895,666307205,773529912,1294757372,1396182291,1695183700,1986661051,2177026350,2456956037,2730485921,2820302411,3259730800,3345764771,3516065817,3600352804,4094571909,275423344,430227734,506948616,659060556,883997877,958139571,1322822218,1537002063,1747873779,1955562222,2024104815,2227730452,2361852424,2428436474,2756734187,3204031479,3329325298];function wl(e){const t=(new TextEncoder).encode(e),i=t.length,o=8*i,r=i+9+63&-64,a=new Uint8Array(r);a.set(t),a[i]=128;const s=new DataView(a.buffer);s.setUint32(r-4,o,!1);let n=1779033703,l=3144134277,d=1013904242,c=2773480762,p=1359893119,h=2600822924,u=528734635,m=1541459225;const g=new Int32Array(64);for(let e=0;e<r;e+=64){for(let t=0;t<16;t++)g[t]=s.getInt32(e+4*t,!1);for(let e=16;e<64;e++){const t=(g[e-15]>>>7|g[e-15]<<25)^(g[e-15]>>>18|g[e-15]<<14)^g[e-15]>>>3,i=(g[e-2]>>>17|g[e-2]<<15)^(g[e-2]>>>19|g[e-2]<<13)^g[e-2]>>>10;g[e]=g[e-16]+t+g[e-7]+i|0}let t=n,i=l,o=d,r=c,a=p,v=h,f=u,y=m;for(let e=0;e<64;e++){const s=y+((a>>>6|a<<26)^(a>>>11|a<<21)^(a>>>25|a<<7))+(a&v^~a&f)+xl[e]+g[e]|0,n=t&i^t&o^i&o;y=f,f=v,v=a,a=r+s|0,r=o,o=i,i=t,t=s+(((t>>>2|t<<30)^(t>>>13|t<<19)^(t>>>22|t<<10))+n|0)|0}n=n+t|0,l=l+i|0,d=d+o|0,c=c+r|0,p=p+a|0,h=h+v|0,u=u+f|0,m=m+y|0}const v=e=>(e>>>0).toString(16).padStart(8,"0");return v(n)+v(l)+v(d)+v(c)+v(p)+v(h)+v(u)+v(m)}function $l(e){const t=[],i=new Set;let o;const r=new RegExp(ol.source,"g");for(;null!==(o=r.exec(e));){const e=o[1];i.has(e)||(i.add(e),t.push(e))}const a=new RegExp(rl.source,"g");for(;null!==(o=a.exec(e));){const e=o[1];i.has(e)||(i.add(e),t.push(e))}return t}function kl(e){if(!e||0===e.length)return{};let t,i;for(const o of e)void 0===t&&"string"==typeof o.flood_scope&&(t=o.flood_scope),void 0===i&&"boolean"==typeof o.region_scope&&(i=o.region_scope);return{floodScope:t,regionScope:i}}function Sl(e){var t,i;const o=kl(e.rx_log_data);return{id:e.id,sender:e.sender,text:e.text,timestamp:new Date(e.timestamp),isOutgoing:e.outgoing,isSystem:!1,raw:e.text,mentions:$l(e.text),rxLogData:e.rx_log_data,deliveryStatus:e.delivery_status?{status:e.delivery_status,ackReceived:e.ack_received,repeaterCount:e.repeater_count,roundTripMs:e.round_trip_ms}:void 0,repeaterCount:e.repeater_count,floodScope:null!==(t=e.flood_scope)&&void 0!==t?t:o.floodScope,regionScope:null!==(i=e.region_scope)&&void 0!==i?i:o.regionScope}}function Cl(e,t){return e.getFullYear()!==t.getFullYear()||e.getMonth()!==t.getMonth()||e.getDate()!==t.getDate()}function Ml(e){const t=new Date,i=new Date(t.getFullYear(),t.getMonth(),t.getDate()),o=new Date(e.getFullYear(),e.getMonth(),e.getDate()),r=Math.floor((i.getTime()-o.getTime())/864e5);return 0===r?"Today":1===r?"Yesterday":r<7?e.toLocaleDateString(void 0,{weekday:"long"}):e.toLocaleDateString(void 0,{weekday:"long",month:"long",day:"numeric"})}class Al{constructor(e){this._messages=[],this._loading=!1,this._error=null,this._entityId=null,this._hass=null,this._pollTimer=null,this._realtimeSubscriptions=[],this._retryCount=0,this._onChange=null,this._fetchDebounce=null,this._active=!1,this._hasOlderMessages=!0,this._loadingOlder=!1,this._hasNewerMessages=!1,this._loadingNewer=!1,this._newMessagesWhileAway=0,this._userAtBottom=!1,this._config=e}get messages(){return this._messages}get loading(){return this._loading}get error(){return this._error}get entityId(){return this._entityId}get loadingOlder(){return this._loadingOlder}get hasOlderMessages(){return this._hasOlderMessages}get loadingNewer(){return this._loadingNewer}get hasNewerMessages(){return this._hasNewerMessages}get newMessagesWhileAway(){return this._newMessagesWhileAway}setUserAtBottom(e){this._userAtBottom!==e&&(this._userAtBottom=e,e&&!this._hasNewerMessages&&this._newMessagesWhileAway>0&&(this._newMessagesWhileAway=0,this._notify()))}resetNewMessagesCounter(){0!==this._newMessagesWhileAway&&(this._newMessagesWhileAway=0,this._notify())}setOnChange(e){this._onChange=e}setHass(e){this._hass=e}setConfig(e){this._config=e}async switchEntity(e,t=null){if(e!==this._entityId){if(this._stopUpdates(),this._entityId=e,this._messages=[],this._error=null,this._retryCount=0,this._hasOlderMessages=!0,this._loadingOlder=!1,this._hasNewerMessages=!1,this._loadingNewer=!1,this._newMessagesWhileAway=0,this._userAtBottom=!1,!e)return this._active=!1,void this._notify();this._active=!0,this._startUpdates(e),t?await this._fetchAroundAnchor(e,t):await this._fetchMessages(e)}}async refresh(){this._entityId&&await this._fetchMessages(this._entityId)}addOptimisticMessage(e,t){const i=new Date,o={id:`optimistic_${i.getTime()}_${Math.random().toString(36).slice(2,8)}`,sender:e,text:t,timestamp:i,isOutgoing:!0,isSystem:!1,raw:`${e}: ${t}`,mentions:[]};this._messages=[...this._messages,o],this._notify()}async loadOlderMessages(){if(!this._loadingOlder&&this._hasOlderMessages&&this._hass&&this._entityId){this._loadingOlder=!0,this._notify();try{const e=this._messages.find(e=>!e.id.startsWith("rt_")&&!e.id.startsWith("optimistic_")),t={type:"hivefw_integration/get_stored_messages",entity_id:this._entityId,limit:50};e&&(t.before=e.id);const i=await this._hass.callWS(t),o=i.messages.map(Sl);this._hasOlderMessages=i.has_more;const r=new Set(this._messages.map(e=>e.id)),a=o.filter(e=>!r.has(e.id));a.length>0&&(this._messages=[...a,...this._messages],this._messages.sort((e,t)=>e.timestamp.getTime()-t.timestamp.getTime()))}catch(e){}finally{this._loadingOlder=!1,this._notify()}}}async loadNewerMessages(){if(!this._loadingNewer&&this._hasNewerMessages&&this._hass&&this._entityId){this._loadingNewer=!0,this._notify();try{let t;for(let e=this._messages.length-1;e>=0;e--){const i=this._messages[e].id;if(!i.startsWith("rt_")&&!i.startsWith("optimistic_")){t=i;break}}const i={type:"hivefw_integration/get_stored_messages",entity_id:this._entityId,limit:50};t&&(i.after=t);const o=await this._hass.callWS(i),r=o.messages.map(Sl);this._hasNewerMessages=o.has_more;const a=new Set(r.map(e=>e.id));this._messages=this._messages.filter(e=>!e.id.startsWith("rt_")||!a.has(e.id.substring(3)));const s=new Set(this._messages.map(e=>e.id)),n=r.filter(e=>!s.has(e.id));if(n.length>0){var e;this._messages=[...this._messages,...n],this._messages.sort((e,t)=>e.timestamp.getTime()-t.timestamp.getTime());const t=null!==(e=this._config.max_messages)&&void 0!==e?e:500;this._messages.length>t&&(this._messages=this._messages.slice(-t),this._hasOlderMessages=!0)}}catch(e){}finally{this._loadingNewer=!1,this._notify()}}}async fetchAroundTimestamp(e){const t=new Date(e).getTime(),i=this._messages.find(e=>Math.abs(e.timestamp.getTime()-t)<2e3);if(i)return!0;let o=0;for(;this._hasOlderMessages&&o<20;){await this.loadOlderMessages(),o++;const e=this._messages.find(e=>Math.abs(e.timestamp.getTime()-t)<2e3);if(e)return!0}return!1}pause(){this._stopUpdates(),this._active=!1,this._fetchDebounce&&(clearTimeout(this._fetchDebounce),this._fetchDebounce=null)}async resume(){this._entityId&&!this._active&&(this._active=!0,this._startUpdates(this._entityId),await this._fetchMessages(this._entityId))}destroy(){this._stopUpdates(),this._active=!1,this._fetchDebounce&&(clearTimeout(this._fetchDebounce),this._fetchDebounce=null),this._onChange=null}async _fetchMessages(e){if(this._hass){this._loading=!0,this._notify();try{var t;const i=50,o=await this._hass.callWS({type:"hivefw_integration/get_stored_messages",entity_id:e,limit:i}),r=o.messages.map(Sl);this._hasOlderMessages=o.has_more;const a=new Set(r.map(e=>e.id)),s=this._messages.filter(e=>{if(e.id.startsWith("optimistic_")){const t=r.some(t=>t.sender===e.sender&&t.text===e.text);return!t}if(e.id.startsWith("rt_")){const t=e.id.substring(3);return!a.has(t)}return!1});this._messages=[...r,...s],this._messages.sort((e,t)=>e.timestamp.getTime()-t.timestamp.getTime());const n=null!==(t=this._config.max_messages)&&void 0!==t?t:500;this._messages.length>n&&(this._messages=this._messages.slice(-n),this._hasOlderMessages=!0),this._error=null,this._retryCount=0}catch(e){const t=e instanceof Error?e.message:String(e);this._error=`Failed to fetch messages: ${t}`,this._retryCount++}finally{this._loading=!1,this._notify()}}}async _fetchAroundAnchor(e,t){if(this._hass){this._loading=!0,this._notify();try{var i;const o=await async function(e,t,i,o=25,r=50){return e.callWS({type:"hivefw_integration/get_messages_around",entity_id:t,anchor_id:i,before_limit:o,after_limit:r})}(this._hass,e,t),r=o.messages.map(Sl);this._hasOlderMessages=o.has_more_before,this._hasNewerMessages=o.has_more_after;const a=new Set(r.map(e=>e.id)),s=this._messages.filter(e=>{if(e.id.startsWith("optimistic_")){const t=r.some(t=>t.sender===e.sender&&t.text===e.text);return!t}if(e.id.startsWith("rt_")){const t=e.id.substring(3);return!a.has(t)}return!1});this._messages=[...r,...s],this._messages.sort((e,t)=>e.timestamp.getTime()-t.timestamp.getTime());const n=null!==(i=this._config.max_messages)&&void 0!==i?i:500;this._messages.length>n&&(this._messages=this._messages.slice(-n),this._hasOlderMessages=!0),this._error=null,this._retryCount=0}catch(e){const t=e instanceof Error?e.message:String(e);this._error=`Failed to fetch messages: ${t}`,this._retryCount++}finally{this._loading=!1,this._notify()}}}_startUpdates(e){this._startPolling(e),this._subscribeRealtime(e).catch(()=>{})}async _subscribeRealtime(e){if(!this._hass)return;const t=[];try{const i=await this._hass.connection.subscribeEvents(t=>{t.data.entity_id===e&&this._handleRealtimeMessage(t.data)},"hivefw_message");t.push(i);const o=await this._hass.connection.subscribeEvents(t=>{t.data.entity_id===e&&this._handleDeliveryUpdate(t.data)},"hivefw_delivery_update");t.push(o),this._realtimeSubscriptions=t}catch(e){throw t.forEach(e=>e()),e}}_handleRealtimeMessage(e){var t,i;const o=null!==(t=e.sender_name)&&void 0!==t?t:e.sender,r=null!==(i=e.message)&&void 0!==i?i:e.text;if(o===this._config.node_name){if(o&&r){const t=e.ack_received,i=e.repeater_count,s=e.rx_log_data,n=e.message_type;let l;var a;if("dm"===n||"direct"===n)l={status:!0===t?"delivered":"sent",ackReceived:null!=t?t:void 0};else l={status:"sent",repeaterCount:null!=i?i:null!==(a=null==s?void 0:s.length)&&void 0!==a?a:0};for(let e=this._messages.length-1;e>=0;e--){const t=this._messages[e];if(t.id.startsWith("optimistic_")&&t.sender===o&&t.text===r){t.deliveryStatus=l,s&&(t.rxLogData=s),this._notify();break}}}!this._entityId||this._hasNewerMessages||this._hasOlderMessages||this._debouncedFetch(this._entityId)}else{if(o&&r){let t=r.replace(il,"");const i=o+": ";t.startsWith(i)&&(t=t.substring(i.length));const a=e.timestamp||(new Date).toISOString(),s=new Date(a),n=function(e,t,i){return wl(`${e}|${t}|${i}`).substring(0,12)}(a,o,t),l=`rt_${n}`,d=this._messages.some(e=>e.id===l||e.id===n);if(!d){const i=$l(t),a=e.rx_log_data,n={id:l,sender:o,text:t,timestamp:s,isOutgoing:!1,isSystem:!1,raw:r,mentions:i,rxLogData:a&&a.length>0?a:void 0,...kl(a)};this._messages.push(n),this._messages.sort((e,t)=>e.timestamp.getTime()-t.timestamp.getTime()),this._userAtBottom&&!this._hasNewerMessages||this._newMessagesWhileAway++,this._notify()}}!this._entityId||this._hasNewerMessages||this._hasOlderMessages||this._debouncedFetch(this._entityId)}}_debouncedFetch(e){this._fetchDebounce&&clearTimeout(this._fetchDebounce),this._fetchDebounce=setTimeout(async()=>{if(this._fetchDebounce=null,this._active)try{await this._fetchMessages(e)}catch(e){}},500)}_handleDeliveryUpdate(e){const t=e.rx_log_data;if(e.progressive&&t&&t.length>0){const i=e.sender_name,o=e.message,r=e.timestamp;if(i&&o){const e=r?new Date(r).getTime():0;for(let r=this._messages.length-1;r>=0;r--){const a=this._messages[r];if(!a.isOutgoing&&a.sender===i&&a.text===o&&(!e||Math.abs(a.timestamp.getTime()-e)<1e4))return a.rxLogData=t,a.repeaterCount=t.length,void this._notify()}}}const i=e.send_id,o=e.status,r=e.repeater_count,a=e.ack_received,s=e.round_trip_ms,n=e.progressive;if(!i)return;let l,d;l=o||(!0===a?"delivered":!n||void 0!==r&&0!==r?"sent":"waiting");for(let e=this._messages.length-1;e>=0;e--)if(this._messages[e].isOutgoing){d=this._messages[e];break}d&&(d.deliveryStatus={status:l,repeaterCount:r,ackReceived:a,roundTripMs:s},void 0!==r&&(d.repeaterCount=r),this._notify())}async _pollFetch(e){if(this._hass&&!this._hasNewerMessages)try{let i;for(let e=this._messages.length-1;e>=0;e--){const t=this._messages[e].id;if(!t.startsWith("rt_")&&!t.startsWith("optimistic_")){i=t;break}}const o={type:"hivefw_integration/get_stored_messages",entity_id:e,limit:50};i&&(o.after=i);const r=await this._hass.callWS(o);if(0===r.messages.length)return this._error=null,void(this._retryCount=0);const a=r.messages.map(Sl),s=new Set(this._messages.map(e=>e.id)),n=a.filter(e=>!s.has(e.id));if(n.length>0){var t;const e=new Set(n.map(e=>e.id));this._messages=this._messages.filter(t=>!t.id.startsWith("rt_")||!e.has(t.id.substring(3))),this._messages=this._messages.filter(e=>!e.id.startsWith("optimistic_")||!n.some(t=>t.sender===e.sender&&t.text===e.text)),this._messages=[...this._messages,...n],this._messages.sort((e,t)=>e.timestamp.getTime()-t.timestamp.getTime());const i=null!==(t=this._config.max_messages)&&void 0!==t?t:500;this._messages.length>i&&(this._messages=this._messages.slice(-i),this._hasOlderMessages=!0),this._notify()}this._error=null,this._retryCount=0}catch(e){this._retryCount++}}_startPolling(e){const t=()=>{if(!this._active)return;const i=this._retryCount>=5?6e4:3e4;this._pollTimer=setTimeout(async()=>{if(this._active){try{await this._pollFetch(e)}catch(e){}t()}},i)};t()}_stopUpdates(){this._pollTimer&&(clearTimeout(this._pollTimer),this._pollTimer=null);for(const e of this._realtimeSubscriptions)e();this._realtimeSubscriptions=[]}_notify(){this._onChange&&this._onChange()}}let Rl=class extends Gn{constructor(){super(...arguments),this.conversations=[],this.activeId=null,this.unreadCounts={},this.nodePrefix=null,this._activeFilter="all",this._filteredConversations=[],this._appsChannelId=null,this._appsPickerOpen=!1}connectedCallback(){super.connectedCallback(),this._loadAppsChannelPreference()}updated(e){e.has("nodePrefix")&&this._loadAppsChannelPreference(),(e.has("conversations")||e.has("_activeFilter")||e.has("_appsChannelId"))&&this._updateFiltered()}render(){const e=this._getAppsChannel(),t=this._channelConversations();return Rn(n||(n=Es`
    ...
    `),()=>this.dispatchEvent(new CustomEvent("refresh-channels-requested",{bubbles:!0,composed:!0})),this._appsPickerOpen?"true":"false",()=>{this._appsPickerOpen=!this._appsPickerOpen},e?this._renderConversation(e,0):Rn(l||(l=Es`<div class="apps-empty">Seleciona o canal usado por APPS/SOS na roda dentada.</div>`)),this._appsPickerOpen?Rn(d||(d=Es`
  ...
  `)),Ps([Zn({type:Array})],Rl.prototype,"conversations",void 0),Ps([Zn({type:String})],Rl.prototype,"activeId",void 0),Ps([Zn({attribute:!1})],Rl.prototype,"unread",void 0),Ps([Zn({type:Object})],Rl.prototype,"unreadCounts",void 0),Ps([Zn({type:String})],Rl.prototype,"nodePrefix",void 0),Ps([el()],Rl.prototype,"_activeFilter",void 0),Ps([el()],Rl.prototype,"_filteredConversations",void 0),Ps([el()],Rl.prototype,"_appsChannelId",void 0),Ps([el()],Rl.prototype,"_appsPickerOpen",void 0),Rl=Ps([Yn("meshcore-conversation-list")],Rl);const Fl=["a[href]","button:not([disabled])",'input:not([disabled]):not([type="hidden"])',"select:not([disabled])","textarea:not([disabled])",'[tabindex]:not([tabindex="-1"])'].join(","),Tl=[];let zl=!1;function Ol(){zl||(zl=!0,document.addEventListener("keydown",Il,!0))}function Il(e){0!==Tl.length&&Tl[Tl.length-1]._handleKeyDown(e)}class Dl{constructor(e,t){this.host=e,this.opts=t,this._wasOpen=!1,this._previousActive=null,this._inStack=!1,this.host.addController(this),Ol()}hostConnected(){Ol()}hostDisconnected(){this._inStack&&this._popStack(),this._previousActive=null,this._wasOpen=!1}hostUpdated(){const e=this.opts.isOpen();if(e&&!this._wasOpen)this._previousActive=this._currentDocumentActive(),this._pushStack(),this._focusFirstSoon();else if(!e&&this._wasOpen){this._popStack();const e=this._previousActive;if(this._previousActive=null,e&&e.isConnected&&"function"==typeof e.focus)try{e.focus()}catch(e){}}this._wasOpen=e}_pushStack(){this._inStack||(Tl.push(this),this._inStack=!0)}_popStack(){const e=Tl.indexOf(this);e>=0&&Tl.splice(e,1),this._inStack=!1}_getFocusables(){var e,t,i;const o=null!==(e=null===(t=(i=this.opts).getScope)||void 0===t?void 0:t.call(i))&&void 0!==e?e:this.host.shadowRoot;return o?Array.from(o.querySelectorAll(Fl)).filter(e=>!(e.hasAttribute("aria-hidden")||e.hidden||null===e.offsetParent&&0===e.getClientRects().length)):[]}_focusFirstSoon(){queueMicrotask(()=>{var e,t,i;if(!this.opts.isOpen())return;const o=null!==(e=null===(t=(i=this.opts).getScope)||void 0===t?void 0:t.call(i))&&void 0!==e?e:this.host.shadowRoot;if(o&&this._scopeContainsFocus(o))return;const r=this._getFocusables();if(0!==r.length)try{r[0].focus()}catch(e){}})}_scopeContainsFocus(e){let t=document.activeElement;for(;t;){if(t===e)return!0;if(e.host===t)return!0;if("contains"in e&&e.contains(t))return!0;const i=t.shadowRoot;if(!i||!i.activeElement)break;t=i.activeElement}return!1}_currentDocumentActive(){let e=document.activeElement;for(;e&&e.shadowRoot&&e.shadowRoot.activeElement;)e=e.shadowRoot.activeElement;return e}_handleKeyDown(e){var t,i,o;if(!this.opts.isOpen())return;if("Escape"===e.key)return e.preventDefault(),e.stopPropagation(),void this.opts.onEscape();if("Tab"!==e.key)return;const r=this._getFocusables();if(0===r.length)return;const a=null!==(t=null===(i=(o=this.opts).getScope)||void 0===i?void 0:i.call(o))&&void 0!==t?t:this.host.shadowRoot,s=a?this._findFocusedInScope(a):null,n=s?r.indexOf(s):-1;let l;l=e.shiftKey?n<=0?r.length-1:n-1:-1===n||n>=r.length-1?0:n+1,e.preventDefault(),e.stopPropagation();try{r[l].focus()}catch(e){}}_findFocusedInScope(e){let t=document.activeElement;for(;t;){if(e===t||"contains"in e&&e.contains(t)){if(t.shadowRoot&&t.shadowRoot.activeElement){t=t.shadowRoot.activeElement;continue}return t}if(e.host===t){t=e.activeElement;continue}const i=t.shadowRoot;if(!i||!i.activeElement)break;t=i.activeElement}return null}}function Nl(e,t){new Dl(e,t)}let El=class extends Gn{constructor(){super(),this.open=!1,this.narrow=!1,this.editMode=!1,this.initialChannelIdx=0,this.initialChannelName="",this.initialScope="",this.initialKey="",this.availableIndices=[],this._channelIdx=0,this._channelName="",this._customKey="",this._autoKey=!0,this._scope="",this._availableScopes=null,this._globalAllowed=!1,this._saving=!1,this._error=null,this._initialized=!1,Nl(this,{isOpen:()=>this.open,onEscape:()=>this._onCancel()})}willUpdate(e){if(e.has("open")&&this.open&&!this._initialized){if(this.editMode){this._channelIdx=this.initialChannelIdx,this._channelName=this.initialChannelName,this._scope=this.initialScope;const e=wl(this.initialChannelName).slice(0,32);this.initialKey&&this.initialKey.toLowerCase()!==e?(this._autoKey=!1,this._customKey=this.initialKey.toLowerCase()):(this._autoKey=!0,this._customKey="")}else this._channelIdx=this.availableIndices.length>0?this.availableIndices[0]:0;this._initialized=!0,this._loadScopes()}e.has("open")&&!this.open&&(this._initialized=!1)}async _loadScopes(){if(this._availableScopes=null,!this.hass)return this._availableScopes=[],void(this._globalAllowed=!1);const e=await ml(this.hass,this.entryId);this._availableScopes=e.scopes,this._globalAllowed=e.global}render(){if(!this.open)return;const e=this._customKey.length,t=32===e||0===e||this._autoKey;return Rn(f||(f=Es`
    ...
    `),e=>e.stopPropagation(),this._close,"contacts"===this._activeTab?"active":"",()=>this._switchTab("contacts"),"channels"===this._activeTab?"active":"",()=>this._switchTab("channels"),"contacts"===this._activeTab?Rn(F||(F=Es`
            ...
            `),["all","added","discovered"].map(e=>Rn(T||(T=Es`
                    ...
                    `),this._categoryFilter===e?"active":"",()=>{this._categoryFilter=e},"all"===e?"All":"added"===e?"Added":"Discovered")),["all","clients","repeaters"].map(e=>Rn(z||(z=Es`
                      <button
                        class="filter-chip ${0}"
                        @click=${0}
                      >
                    ...
                    `),this._typeFilter===e?"active":"",()=>{this._typeFilter=e},"all"===e?"All":"clients"===e?"Clients":"Repeaters")),this._searchQuery,e=>{this._searchQuery=e.target.value}):"",this._loading?Rn(O||(O=Es`<div class="loading-state">
  ...
  `)),Ps([Zn({type:Object})],Ll.prototype,"hass",void 0),Ps([Zn({type:String})],Ll.prototype,"entryId",void 0),Ps([Zn({type:String})],Ll.prototype,"entityId",void 0),Ps([Zn({type:String})],Ll.prototype,"meshNodeName",void 0),Ps([el()],Ll.prototype,"_query",void 0),Ps([el()],Ll.prototype,"_fromDate",void 0),Ps([el()],Ll.prototype,"_toDate",void 0),Ps([el()],Ll.prototype,"_results",void 0),Ps([el()],Ll.prototype,"_totalCount",void 0),Ps([el()],Ll.prototype,"_searching",void 0),Ps([el()],Ll.prototype,"_hasSearched",void 0),Ps([el()],Ll.prototype,"_showFilters",void 0),Ll=Ps([Yn("meshcore-message-search")],Ll);let Bl=class extends Gn{constructor(){super(...arguments),this.conversations=[],this.selectedId=null,this.narrow=!1,this.lastRead={},this._messageStore=null,this._unsubUnread=null,this._inputText="",this._sending=!1,this._viewportNarrow=!1,this._mediaQuery=null,this._mediaHandler=null,this._narrowShowMessages=!1,this._manageOpen=!1,this._manageInitialTab="contacts",this._searchOpen=!1,this._currentEntityId=null,this._conversationResolved=!1,this._pendingScroll=null,this._scrollInFlight=!1,this._scrollGuardUntil=0,this._lastMessageCount=0}get _isNarrow(){return this.narrow||this._viewportNarrow}connectedCallback(){super.connectedCallback(),this.config&&!this._messageStore&&(this._messageStore=new Al(this.config),this._messageStore.setOnChange(()=>this.requestUpdate())),this.unread&&!this._unsubUnread&&(this._unsubUnread=this.unread.subscribe(()=>{this.lastRead=this.unread.lastRead,this.requestUpdate()}),this.lastRead=this.unread.lastRead,this.unread.onPostSwitchTimerFire(()=>this._checkAndMarkReadIfAtBottom())),this._mediaQuery=window.matchMedia("(max-width: 870px)"),this._viewportNarrow=this._mediaQuery.matches,this._mediaHandler=e=>{this._viewportNarrow=e.matches},this._mediaQuery.addEventListener("change",this._mediaHandler)}disconnectedCallback(){var e;super.disconnectedCallback(),this._messageStore&&(this._messageStore.destroy(),this._messageStore=null),this._unsubUnread&&(this._unsubUnread(),this._unsubUnread=null),null===(e=this.unread)||void 0===e||e.endConversation(),this._mediaQuery&&this._mediaHandler&&(this._mediaQuery.removeEventListener("change",this._mediaHandler),this._mediaQuery=null,this._mediaHandler=null)}updated(e){if(e.has("hass")&&this.hass&&this._messageStore&&this._messageStore.setHass(this.hass),e.has("config")&&this.config&&this._messageStore){this._messageStore.setConfig(this.config);const t=e.get("config");t&&t.entry_id!==this.config.entry_id&&(this.selectedId=null,this._currentEntityId=null,this._conversationResolved=!1,this._pendingScroll=null,this._lastMessageCount=0,this.unread.endConversation(),this._messageStore.switchEntity(null),this.dispatchEvent(new CustomEvent("active-entity-changed",{detail:{entityId:null},bubbles:!0,composed:!0})))}if(e.has("selectedId")&&this._onConversationSelected(),e.has("lastRead")&&this._currentEntityId&&this._conversationResolved&&null===this._pendingScroll&&this.unread.maybeReanchorOnLateData(this._currentEntityId)&&(this._pendingScroll="last-read"),this._pendingScroll){const e=this._messageStore,t=e&&!e.loading;t&&e.messages.length>0?(this._executeScroll(this._pendingScroll),this._pendingScroll=null,this._lastMessageCount=e.messages.length):t&&0===e.messages.length&&(this._pendingScroll=null)}else if(this._messageStore){const e=this._messageStore.messages.length;e>this._lastMessageCount&&this._lastMessageCount>0&&this._scrollToBottomIfNearEnd(),this._lastMessageCount=e}}render(){var e,t,i,o,r,a;return this._isNarrow?this._narrowShowMessages?Rn(Se||(Se=Es`
    ...
    `),this.conversations,this.selectedId,this.unread,this.unread.counts,(null===(e=this.config)||void 0===e?void 0:e.node_prefix)||null,e=>{const t=e.detail.id;t===this.selectedId&&(this.unread.resetUnreadCountAtSelection(),this._pendingScroll="bottom"),this.selectedId=t},()=>this._onManageRequested(),this.selectedId?Rn(Fe||(Fe=Es`
        ...
        `),this.hass,null===(t=this.config)||void 0===t?void 0:t.entry_id,this._currentEntityId||void 0,null===(i=this.config)||void 0===i?void 0:i.node_name,this._onSearchResultSelected,()=>{this._searchOpen=!1}):"",this._manageOpen?Rn(ze||(ze=Es`
          <meshcore-manage-dialog
            .hass=${0}
            .entryId=${0}
            .narrow=${0}
            ...
            @channels-changed=${0}
          ></meshcore-manage-dialog>
        `),this.hass,null===(o=this.config)||void 0===o?void 0:o.entry_id,this.narrow,this._manageInitialTab,()=>this._manageOpen=!1,this._onContactsChanged,this._onChannelsChanged):Rn(Oe||(Oe=Es``)))}_renderChatArea(){var e,t,i,o,r,a;if(!this._messageStore||!this.selectedId)return Rn(Ie||(Ie=Es`
        <div class="empty-state">
      ...
      `));if(!this._conversationResolved)return Rn(De||(De=Es`
        <div class="empty-state">
  ...
  `)),Ps([Zn({type:Object})],Hl.prototype,"contact",void 0),Ps([Zn({type:Boolean})],Hl.prototype,"selected",void 0),Hl=Ps([Yn("meshcore-contact-card")],Hl);let Vl=class extends Gn{constructor(){super(),this.open=!1,this.pendingAction=null,this._confirming=!1,this._confirmAction=null,Nl(this,{isOpen:()=>this.open,onEscape:()=>{this._confirming?(this._confirming=!1,this._confirmAction=null):this._close()}})}render(){if(!this.open||!this.node)return Rn(pt||(pt=Es``));const e="adv_name"in this.node,t=e?2===this.node.type:"repeater"===this.node.type,i=e&&3===this.node.type,o=e?1===this.node.type:"client"===this.node.type,r=e&&4===this.node.type,a=e?this.node.adv_name:this.node.name,s=this.node.pubkey_prefix;let n=Rn(ht||(ht=Es`<svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor"><path d="M16 11c1.66 0 2.99-1.34 2.99-3S17.66 5 16 5c-1.66 0-3 1.34-3 3s1.34 3 3 3zm-8 0c1.66 0 2.99-1.34 2.99-3S9.66 5 8 5C6.34 5 5 6.34 5 8s1.34 3 3 3zm0 2c-2.33 0-7 1.17-7 3.5V19h14v-2.5c0-2.33-4.67-3.5-7-3.5zm8 0c-.29 0-.62.02-.97.05 1.16.84 1.97 1.97 1.97 3.45V19h6v-2.5c0-2.33-4.67-3.5-7-3.5z"/></svg>`)),l="Contact",d="";return t?(n=Rn(ut||(ut=Es`<svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor"><path d="M12 5c-3.87 0-7 3.13-7 7h2c0-2.76 2.24-5 5-5s5 2.24 5 5h2c0-3.87-3.13-7-7-7zm0-4C5.93 1 1 5.93 1 12h2c0-4.97 4.03-9 9-9s9 4.03 9 9h2c0-6.07-4.93-11-11-11zm0 8c-1.66 0-3 1.34-3 3s1.34 3 3 3 3-1.34 3-3-1.34-3-3-3z"/></svg>`)),l="Repeater",d="repeater"):i?(n=Rn(mt||(mt=Es`<svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor"><path d="M20 2H4c-1.1 0-2 .9-2 2v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm0 14H6l-2 2V4h16v12z"/></svg>`)),l="Room Server",d="room-server"):r?(n=Rn(gt||(gt=Es`<svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z"/></svg>`)),l="Sensor",d="sensor"):o&&(n=Rn(vt||(vt=Es`<svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor"><path d="M17 1.01L7 1c-1.1 0-2 .9-2 2v18c0 1.1.9 2 2 2h10c1.1 0 2-.9 2-2V3c0-1.1-.9-1.99-2-1.99zM17 19H7V5h10v14z"/></svg>`)),l="Client",d="client"),Rn(ft||(ft=Es`
    ...
    `),this._close,a,e=>e.stopPropagation(),`dialog-avatar ${d}`,n,a,l,this._close,this._confirming?Rn(yt||(yt=Es`
                ...
                `),e?"":"full",e&&this.node.added_to_node&&(o||i)?Rn(wt||(wt=Es`
                      ...
                      `),this.node.last_advert?new Date(1e3*this.node.last_advert).toLocaleString():"Unknown",this.node.added_to_node?"Added Contact":"Discovered Contact"):Rn(zt||(zt=Es``)),!e||0===this.node.adv_lat&&0===this.node.adv_lon?Rn(It||(It=Es``)):Rn(Ot||(Ot=Es`
                        <div class="section">
                      ...
                      `),this.node.adv_lat.toFixed(6),this.node.adv_lon.toFixed(6)),e&&this.node.out_path?Rn(Dt||(Dt=Es`
                        <div class="section">
                      ...
                      `),this.node.out_path,this.node.out_path_len?Rn(Nt||(Nt=Es`
  ...
  `)),Ps([Zn({type:Array})],Kl.prototype,"contacts",void 0),Ps([Zn({type:Array})],Kl.prototype,"channels",void 0),Ps([Zn({type:Boolean})],Kl.prototype,"narrow",void 0),Ps([Zn({type:Object})],Kl.prototype,"hass",void 0),Ps([Zn({type:Object})],Kl.prototype,"config",void 0),Ps([el()],Kl.prototype,"_viewportNarrow",void 0),Ps([el()],Kl.prototype,"_mapReady",void 0),Ps([el()],Kl.prototype,"_mapFocusId",void 0),Ps([el()],Kl.prototype,"_primaryFilter",void 0),Ps([el()],Kl.prototype,"_typeFilter",void 0),Ps([el()],Kl.prototype,"_searchQuery",void 0),Ps([el()],Kl.prototype,"_activityFilter",void 0),Ps([el()],Kl.prototype,"_displayedContacts",void 0),Ps([el()],Kl.prototype,"_totalCount",void 0),Ps([el()],Kl.prototype,"_typeCounts",void 0),Ps([el()],Kl.prototype,"_l1Counts",void 0),Ps([el()],Kl.prototype,"_loading",void 0),Ps([el()],Kl.prototype,"_selectedNode",void 0),Ps([el()],Kl.prototype,"_nodeDetailDialogOpen",void 0),Ps([el()],Kl.prototype,"_pendingAction",void 0),Ps([el()],Kl.prototype,"_sortBy",void 0),Kl=Ps([Yn("meshcore-nodes-page")],Kl);let Wl=class extends Gn{constructor(){super(...arguments),this.narrow=!1,this._neighbors=null,this._discovery=null,this._loading=!0,this._discovering=!1,this._error=null,this._mapReady=void 0!==customElements.get("ha-map"),this._mapFocusId="",this._mapMarkerElements=new Map}firstUpdated(){this._loadAll(),this._mapReady||customElements.whenDefined("ha-map").then(()=>{this._mapReady=!0})}updated(e){e.has("config")&&this.hasUpdated&&this._loadAll()}disconnectedCallback(){super.disconnectedCallback(),this._stopPolling()}async _loadAll(){if(this.hass){this._loading=!0,this._error=null;try{var e;this._neighbors=await vl(this.hass,null===(e=this.config)||void 0===e?void 0:e.entry_id)}catch(e){this._error=this._errorText(e,"Não foi possível carregar os vizinhos.")}finally{this._loading=!1}try{var t;const e=await fl(this.hass,null===(t=this.config)||void 0===t?void 0:t.entry_id);this._discovery=e,e.active&&this._startPolling()}catch(e){}}}async _refreshNeighbors(){if(this.hass)try{var e;this._neighbors=await vl(this.hass,null===(e=this.config)||void 0===e?void 0:e.entry_id)}catch(e){this._error=this._errorText(e,"Falha ao atualizar os vizinhos.")}}async _startDiscovery(){if(this.hass&&!this._discovering){this._discovering=!0,this._error=null,this._mapFocusId="",this._discovery={supported:!0,active:!0,started_at:(new Date).toISOString(),ends_at:"",remaining_seconds:30,count:0,results:[],error:""};try{var e;this._discovery=await async function(e,t){const i={type:"hivefw_integration/start_hive_neighbor_discovery"};return t&&(i.entry_id=t),e.callWS(i)}(this.hass,null===(e=this.config)||void 0===e?void 0:e.entry_id),this._startPolling()}catch(e){this._error=this._errorText(e,"Não foi possível iniciar a descoberta."),this._discovery={supported:!0,active:!1,started_at:"",ends_at:"",remaining_seconds:0,count:0,results:[],error:this._error},this._stopPolling()}finally{this._discovering=!1}}}_startPolling(){this._stopPolling(),this._pollTimer=setInterval(()=>{this._pollDiscovery()},1e3)}_stopPolling(){this._pollTimer&&(clearInterval(this._pollTimer),this._pollTimer=void 0)}async _pollDiscovery(){if(this.hass)try{var e;const t=await fl(this.hass,null===(e=this.config)||void 0===e?void 0:e.entry_id);this._discovery=t,t.active||this._stopPolling()}catch(e){}}_errorText(e,t){return e instanceof Error?e.message||t:"object"==typeof e&&e&&"message"in e?String(e.message||t):t}_age(e){const t=Math.max(0,Math.floor(e||0));if(t<10)return"agora";if(t<60)return String(t)+"s";const i=Math.floor(t/60);if(i<60)return String(i)+" min";const o=Math.floor(i/60);return o<24?String(o)+" h":String(Math.floor(o/24))+" d"}_latestNeighborAge(){var e;const t=(null===(e=this._neighbors)||void 0===e?void 0:e.neighbors)||[];return t.length?Math.min(...t.map(e=>e.secs_ago)):null}_discoveredWithLocation(){var e;return((null===(e=this._discovery)||void 0===e?void 0:e.results)||[]).filter(e=>{const t=Number(e.latitude),i=Number(e.longitude);return Number.isFinite(t)&&Number.isFinite(i)&&t>=-90&&t<=90&&i>=-180&&i<=180&&!(0===t&&0===i)})}_markerFor(e){const t=e.pubkey||e.pubkey_prefix;let i=this._mapMarkerElements.get(t);i||(i=document.createElement("div"),this._mapMarkerElements.set(t,i));const o=this._mapFocusId===t;return i.style.width="30px",i.style.height="30px",i.style.borderRadius="50%",i.style.display="grid",i.style.placeItems="center",i.style.fontSize="9px",i.style.fontWeight="750",i.style.background=o?"var(--warning-color,#ff9800)":"var(--primary-color,#03a9f4)",i.style.color="white",i.style.border=o?"3px solid white":"2px solid white",i.style.boxShadow=o?"0 0 0 3px rgba(255,152,0,.30),0 2px 7px rgba(0,0,0,.32)":"0 1px 5px rgba(0,0,0,.30)",i.textContent=(e.name||e.pubkey_prefix||"?").slice(0,2).toUpperCase(),i}_mapLocations(){const e=new Set,t=this._discoveredWithLocation().map(t=>{const i=t.pubkey||t.pubkey_prefix;return e.add(i),{id:i,location:[Number(t.latitude),Number(t.longitude)],element:this._markerFor(t),elementSize:[36,36],title:t.name||t.pubkey_prefix,locationEditable:!1,activatable:!0}});for(const t of this._mapMarkerElements.keys())e.has(t)||this._mapMarkerElements.delete(t);return t}_focusDiscovery(e){const t=e.pubkey||e.pubkey_prefix;this._mapFocusId=t,this.requestUpdate();const i=Number(e.latitude),o=Number(e.longitude);Number.isFinite(i)&&Number.isFinite(o)&&this.updateComplete.then(()=>{var e;const t=this.renderRoot.querySelector("ha-map");null==t||null===(e=t.setView)||void 0===e||e.call(t,[i,o],14)})}_onMapClicked(e){var t;const i=((null===(t=this._discovery)||void 0===t?void 0:t.results)||[]).find(t=>{var i;return(t.pubkey||t.pubkey_prefix)===(null===(i=e.detail)||void 0===i?void 0:i.id)});i&&this._focusDiscovery(i)}render(){return Rn(ii||(ii=Es`
    ...
    `),"discovery-item "+(t?"selected":""),()=>this._focusDiscovery(e),e.name||e.pubkey_prefix,e.pubkey_prefix.toUpperCase(),e.known_contact?"Conhecido":"Novo",i?Rn(bi||(bi=Es`<span>📍 GPS</span>`)):zn,null!=e.request_snr?Rn(_i||(_i=Es`<span>REQ ${0} dB</span>`),Number(e.request_snr).toFixed(1)):zn,null==e.snr?"—":Number(e.snr).toFixed(1)+" dB")}};Wl.styles=Us(xi||(xi=Es`
  ...
  `)),Ps([Zn({type:Object})],Wl.prototype,"hass",void 0),Ps([Zn({type:Object})],Wl.prototype,"config",void 0),Ps([Zn({type:Boolean})],Wl.prototype,"narrow",void 0),Ps([el()],Wl.prototype,"_neighbors",void 0),Ps([el()],Wl.prototype,"_discovery",void 0),Ps([el()],Wl.prototype,"_loading",void 0),Ps([el()],Wl.prototype,"_discovering",void 0),Ps([el()],Wl.prototype,"_error",void 0),Ps([el()],Wl.prototype,"_mapReady",void 0),Ps([el()],Wl.prototype,"_mapFocusId",void 0),Wl=Ps([Yn("meshcore-neighbors-page")],Wl);let Gl=class extends Gn{constructor(){super(),this.open=!1,this.title="Confirm",this.message="",this.confirmLabel="Confirm",this.cancelLabel="Cancel",this.dangerous=!1,this._typedValue="",Nl(this,{isOpen:()=>this.open,onEscape:()=>this._onCancel()})}render(){if(!this.open)return;const e=this.requireTyped&&this._typedValue!==this.requireTyped;return Rn(wi||(wi=Es`
    ...
    `),this._onOverlayClick,this.targetPrefix?Rn(Ci||(Ci=Es`<div style="font-size: 12px; color: var(--secondary-text-color); margin-top: 4px;">
                ...
                `),this._selectedCommand.name,this._selectedCommand.description,this._selectedCommand.dangerous?Rn(Fi||(Fi=Es`<div class="danger-warning">
                      ...
                      `),this._selectedCommand.params.map(e=>this._renderParamInput(e))):"",this._selectedCommand.responseFormat?Rn(zi||(zi=Es`<div style="margin-top: 12px; font-size: 12px; color: var(--secondary-text-color); font-style: italic;">
                        Expected: ${0}
                      </div>`),this._selectedCommand.responseFormat):"",this._executing,this._executeCommand,this._executing?"Executing...":"Execute",this._response||this._error?Rn(Oi||(Oi=Es`
                ...
                `),this._deviceResponses.map(e=>Rn(Di||(Di=Es`<div class="device-response-row">
                          <span class="drr-time">${0}</span><span class="drr-text">${0}</span>${0}
                        </div>`),new Date(e.ts).toLocaleTimeString(),e.text,void 0!==e.snr?Rn(Ni||(Ni=Es`<span class="drr-snr"> · SNR ${0}</span>`),e.snr):""))):"",this._onClose)}_renderParamInput(e){var t,i,o;const r=null!==(t=null!==(i=this._paramValues[e.name])&&void 0!==i?i:e.default)&&void 0!==t?t:"",a=null!==(o=e.label)&&void 0!==o?o:e.name;switch(e.type){case"boolean":return Rn(Ei||(Ei=Es`
          <div class="form-group">
            <label class="form-toggle">
              <input
                type="checkbox"
  ...
  `)),Ps([Zn({type:Number})],pd.prototype,"value",void 0),Ps([Zn({type:Number})],pd.prototype,"min",void 0),Ps([Zn({type:Number})],pd.prototype,"max",void 0),Ps([Zn({type:String})],pd.prototype,"band",void 0),pd=Ps([Yn("meshcore-stat-bar")],pd);let hd=class extends Gn{constructor(){super(...arguments),this.segments=[],this.legend="below"}_denom(){if(void 0!==this.total&&this.total>0)return this.total;const e=this.segments.reduce((e,t)=>e+(Number.isFinite(t.value)?t.value:0),0);return e>0?e:1}render(){if(!this.segments.length)return zn;const e=this._denom();return Rn(ro||(ro=Es`
      ...
      ${0}
    `),this.segments.map(e=>`${e.label} ${e.value}`).join(", "),this.segments.map(t=>{const i=Number.isFinite(t.value)?Math.max(0,t.value):0;if(0===i)return zn;const o=i/e*100;return Rn(ao||(ao=Es`<div class="stat-bar-segment ${0}"
                           style="width: ${0}%"
                           title="${0}: ${0}"></div>`),t.kind,o,t.label,t.value)}),"none"!==this.legend?Rn(so||(so=Es`
          <div class="stat-bar-legend ${0}">
            ${0}
            ${0}
          </div>`),"inline"===this.legend?"inline":"",this.segments.filter(e=>Number.isFinite(e.value)&&e.value>=0).map(e=>Rn(no||(no=Es`<span><span class="legend-swatch ${0}"></span>${0}</span>`),e.kind,e.label)),this.extraLegendText?Rn(lo||(lo=Es`<span class="legend-extra">${0}</span>`),this.extraLegendText):zn):zn)}};hd.styles=Us(co||(co=Es`
  ...
  `)),Ps([Zn({type:Array})],hd.prototype,"segments",void 0),Ps([Zn({type:Number})],hd.prototype,"total",void 0),Ps([Zn({type:String})],hd.prototype,"legend",void 0),Ps([Zn({type:String})],hd.prototype,"extraLegendText",void 0),hd=Ps([Yn("meshcore-stacked-bar")],hd);let ud=class extends Gn{constructor(){super(...arguments),this.content="",this._open=!1,this._onOpen=()=>{this._open||(this._open=!0,window.addEventListener("scroll",this._onScroll,!0))},this._onClose=()=>{this._open&&(this._open=!1,window.removeEventListener("scroll",this._onScroll,!0))},this._onScroll=()=>this._onClose()}render(){return this.content?Rn(po||(po=Es`
    ...
    `),this._onOpen,this._onClose,this._onOpen,this._onClose,this._stopPropagation,this._open?"open":"",this.content,this.source?Rn(ho||(ho=Es`<span class="src">${0}</span>`),this.source):zn):zn}updated(){this._open&&this._positionPopover()}disconnectedCallback(){window.removeEventListener("scroll",this._onScroll,!0),super.disconnectedCallback()}_stopPropagation(e){e.stopPropagation()}_positionPopover(){const e=this.shadowRoot;if(!e)return;const t=e.querySelector(".info-tip"),i=e.querySelector(".info-tip-content");if(!t||!i)return;const o=t.getBoundingClientRect(),r=i.getBoundingClientRect(),a=window.innerWidth,s=window.innerHeight;let n=o.left+o.width/2-r.width/2,l=o.bottom+6;n<8?n=8:n+r.width>a-8&&(n=Math.max(8,a-8-r.width)),l+r.height>s-8&&(l=o.top-6-r.height,l<8&&(l=8)),i.style.left=`${n}px`,i.style.top=`${l}px`}};ud.styles=Us(uo||(uo=Es`
    :host {
      display: inline-flex;
      vertical-align: middle;
    }
  ...
  `)),Ps([Zn({type:String})],ud.prototype,"content",void 0),Ps([Zn({type:String})],ud.prototype,"source",void 0),Ps([el()],ud.prototype,"_open",void 0),ud=Ps([Yn("meshcore-info-tip")],ud);const md=[{key:"sent_flood",label:"Sent · Flood",color:"var(--info, #2196f3)",dash:!1},{key:"sent_direct",label:"Sent · Direct",color:"var(--info, #2196f3)",dash:!0},{key:"recv_flood",label:"Recv · Flood",color:"var(--good, #4caf50)",dash:!1},{key:"recv_direct",label:"Recv · Direct",color:"var(--good, #4caf50)",dash:!0},{key:"errors",label:"Errors",color:"var(--bad, #f44336)",dash:!1}];let gd=class extends Gn{constructor(){super(...arguments),this.data=[],this.width=700,this.height=170,this.timeRange=48,this._hoverIndex=null,this._onPointerMove=e=>{const t=this._indexFromEvent(e);null!=t&&t!==this._hoverIndex&&(this._hoverIndex=t)},this._onPointerDown=e=>{const t=this._indexFromEvent(e);null!=t&&(this._hoverIndex=t===this._hoverIndex?null:t)},this._onPointerLeave=e=>{"mouse"===e.pointerType&&(this._hoverIndex=null)}}render(){return this.data&&0!==this.data.length?Rn(mo||(mo=Es`
    ...
    `),this._renderChart(),null!=this._hoverIndex?this._renderTooltip():zn,md.map(e=>Rn(go||(go=Es`<div class="legend-item">
      ...
      </svg>`),a,s,this.timeRange,this._onPointerMove,this._onPointerDown,this._onPointerLeave,m,t,o,t,s-r,t,s-r,a-i,s-r,v,f,g,t,o-2,t,o,e.cw,n)}_renderTooltip(){const e=this._hoverIndex;if(null==e||e>=this.data.length)return zn;const t=this._geom(),i=this.data[e],o=t.xScale(i.timestamp)/t.w*100,r=o>55,a=new Date(i.timestamp).toLocaleString([],{weekday:"short",hour:"2-digit",minute:"2-digit"}),s=r?`left:${o}%; transform:translateX(calc(-100% - 8px));`:`left:${o}%; transform:translateX(8px);`;return Rn(Co||(Co=Es`
  ...
  `)),Ps([Zn({type:Array})],gd.prototype,"data",void 0),Ps([Zn({type:Number})],gd.prototype,"width",void 0),Ps([Zn({type:Number})],gd.prototype,"height",void 0),Ps([Zn({type:Number})],gd.prototype,"timeRange",void 0),Ps([el()],gd.prototype,"_hoverIndex",void 0),gd=Ps([Yn("meshcore-message-rate-chart")],gd);let vd=class extends Gn{constructor(){super(...arguments),this.entities=[],this.hiddenCount=0,this._rateHistory=[],this._rateHistoryKey=null}render(){if(!this.hass||!this.device)return zn;const e=new Set,t=this._renderHeroTiles(e),i=this._buildGroups(e);return Rn(Ro||(Ro=Es`
      <div class="hero-row">
        ${0}
      </div>
    ...
    `),this._rateHistory):zn}_renderHeroTiles(e){const t=this.device;return"companion"===t.type?this._renderCompanionHero(e):"repeater"===t.type?this._renderRepeaterHero(e):this._renderClientHero(e)}_renderRepeaterHero(e){return Rn(Io||(Io=Es`
      ...
      ${0}
      ${0}
    `),this._renderBatteryTile(),this._renderSignalTile(),this._renderRadioActivityTile(),this._renderMessagesSentTile(e),this._renderMessagesReceivedTile(e),this._renderRequestsTile(e))}_renderClientHero(e){return Rn(Do||(Do=Es`
      ${0}
      ${0}
      ${0}
    `),this._renderBatteryTile(),this._renderSignalTile(),this._renderRequestsTile(e))}_renderCompanionHero(e){const t=this._findByMetric("noise_floor");return t&&e.add(t.entity_id),Rn(No||(No=Es`
      ${0}
      ${0}
      ${0}
      ${0}
      ...
      ${0}
      ${0}
    `),this._renderRepeaterStateTile(),this._renderCompanionRadioActivityTile(),this._renderMessagesSentTile(e),this._renderMessagesReceivedTile(e),this._renderUptimeTile(e),this._renderBatteryTile(),this._renderTemperatureTile(e),this._renderSignalTile(),this._renderDeviceClockTile(),this._renderProtocolInfoTile(),this._renderHardwareInfoTile(),this._renderRepeatFrequenciesTile(),this._renderQueueTile(e),this._renderCapacityInfoTile(),this._renderStorageTile(),this._renderLocationTile(),this._renderRequestTokensTile(e),this._renderDiscoveredContactsTile(e))}_renderHardwareInfoTile(){var e,t;const i=null===(e=this.repeaterStatus)||void 0===e?void 0:e.device_info,o=(null==i?void 0:i.model)||(null===(t=this.repeaterStatus)||void 0===t?void 0:t.model);if(!o)return zn;const r=null==i?void 0:i.firmware_build;return Rn(Eo||(Eo=Es`
    ...
    `),o,r?Rn(Po||(Po=Es`<span class="secondary">· ${0}</span>`),r):zn,100,0,100,"info")}_renderProtocolInfoTile(){var e,t;const i=null===(e=this.repeaterStatus)||void 0===e?void 0:e.device_info;if(!i)return zn;const o=null!=i.protocol_version?`v${i.protocol_version}`:"—",r=null==i.path_hash_mode?"—":null!==(t=["1 byte","2 bytes","3 bytes"][Number(i.path_hash_mode)])&&void 0!==t?t:String(i.path_hash_mode);return Rn(qo||(qo=Es`
    ...
    `),o,r,100,0,100,"info")}_renderCapacityInfoTile(){var e,t,i;const o=null===(e=this.repeaterStatus)||void 0===e?void 0:e.device_info;return null==(null==o?void 0:o.max_contacts)&&null==(null==o?void 0:o.max_channels)?zn:Rn(Lo||(Lo=Es`
    ...
    `),i[0],i.length>1?Rn(Ho||(Ho=Es`<span class="secondary">· ${0} MHz</span>`),i.slice(1).join(" · ")):zn,100,0,100,"info")}_renderTemperatureTile(e){var t,i;const o=this._findByMetric("temperature");if(!o)return zn;const r=this._readNumber(o.entity_id);if(!Number.isFinite(r))return zn;e.add(o.entity_id);const a=(null!==(t=null===(i=this.hass)||void 0===i||null===(i=i.states[o.entity_id])||void 0===i||null===(i=i.attributes)||void 0===i?void 0:i.unit_of_measurement)&&void 0!==t?t:"°C").includes("F")?5*(r-32)/9:r,s=nd("temperature",9*a/5+32);return Rn(Vo||(Vo=Es`
    ...
    `),s,n,l,Math.min(a,120),0,120,s)}_renderRequestTokensTile(e){const t=this.entities.find(e=>e.entity_id.includes("request_rate_limiter"));if(!t)return zn;const i=this._readNumber(t.entity_id);if(!Number.isFinite(i))return zn;e.add(t.entity_id);const o=i<5?"bad":i<10?"warn":"good";return Rn(jo||(jo=Es`
    ...
    `),()=>this._fireMoreInfo(t.entity_id),o,this._formatNumber(i,1),i,0,20,o)}_renderDiscoveredContactsTile(e){const t=this.entities.find(e=>e.entity_id.includes("discovered_contacts"));if(!t)return zn;const i=this._readNumber(t.entity_id);return Number.isFinite(i)?(e.add(t.entity_id),Rn(Ko||(Ko=Es`
    ...
    `),a,r.toFixed(0),i,o,r,0,100,a)}_renderRepeaterStateTile(){const e=this.repeaterStatus;if(null==e||!e.supported)return zn;const t=Boolean(e.repeat);return Rn(Go||(Go=Es`
    ...
    `),()=>this._fireMoreInfo(t.entity_id),this._renderInfoTip(a),a.band,this._formatNumber(i,0),Number.isFinite(r)?Rn(Zo||(Zo=Es`<span class="secondary">· ${0} V</span>`),r.toFixed(3)):zn,i,0,100,a.band)}_renderSignalTile(){const e=this._findByMetric("rssi");if(!e)return zn;const t=this._readNumber(e.entity_id),i=this._findByMetric("snr"),o=i?this._readNumber(i.entity_id):NaN,r=nd("rssi",t);return Rn(er||(er=Es`
      <div class="hero-tile" @click=${0}>
        <div class="hero-tile-head">
    ...
    `),()=>this._fireMoreInfo(e.entity_id),this._renderInfoTip(r),r.band,this._formatNumber(t,0),Number.isFinite(o)?Rn(tr||(tr=Es`<span class="secondary">· SNR ${0} dB</span>`),o.toFixed(1)):zn,t,-130,-30,r.band)}_renderRadioActivityTile(){const e=this._findByMetric("tx_airtime_util"),t=this._findByMetric("rx_airtime_util");if(!e&&!t)return zn;const i=e?this._readNumber(e.entity_id):0,o=t?this._readNumber(t.entity_id):0,r=Number.isFinite(i)?Math.max(0,i):0,a=Number.isFinite(o)?Math.max(0,o):0,s=Math.max(0,100-r-a),n=nd("tx_airtime_util",r).band,l=nd("rx_airtime_util",a).band,d=this._worseBand(n,l),c=[{value:r,label:`TX ${r.toFixed(1)}%`,kind:"tx"},{value:a,label:`RX ${a.toFixed(1)}%`,kind:"rx"},{value:s,label:`Idle ${s.toFixed(1)}%`,kind:"idle"}],p=r+a;return Rn(ir||(ir=Es`
      <div class="hero-tile"
           @click=${0}>
        <div class="hero-tile-head">
    ...
    `),()=>this._fireMoreInfo(t.entity_id),this._renderInfoTip({band:"info",fillPct:0,tooltip:"Messages received (lifetime), split by receive mode:\n• Flood — broadcast packets received from neighbours.\n• Direct — routed packets where this node is on the path.\n\nEach bar below is a percentage of its own total:\n• Red = receive errors (CRC failures), as a share of all reception attempts (received + errors) — i.e. the error rate.\n• Amber = duplicate receptions, as a share of received messages (duplicates are a subset of received).\n\nBoth are context only, not banded — in a flooding mesh every active neighbour retransmits the same flood once, so a high duplicate ratio is normal (a 2-neighbour repeater sees ~50%, a 3-neighbour ~67%, etc.)."}),this._formatCount(s),d,"none",v>0?Rn(dr||(dr=Es`<div class="err-line"
            ...
            </div>`),v,y.toFixed(1),Math.min(100,y).toFixed(1)):zn,h>0?Rn(cr||(cr=Es`<div class="dup-line"
                      title="Duplicate receptions: ${0} — ${0}% of received messages">
              <div class="dup-line-fill" style="width:${0}%"></div>
            </div>`),h,u.toFixed(1),Math.min(100,u).toFixed(1)):zn,n,l,v>0?Rn(pr||(pr=Es`<span><span class="msg-swatch error"></span>Error ${0}</span>`),v):zn,h>0?Rn(hr||(hr=Es`<span><span class="msg-swatch dup"></span>Dup ${0}</span>`),h):zn)}_renderRequestsTile(e){const t=this._findEntityIdMatching("request_succ"),i=this._findEntityIdMatching("request_fail");if(!t||!i)return zn;const o=this._readNumber(t.entity_id),r=this._readNumber(i.entity_id),a=o+r,s=a>0?o/a*100:0,n=a>=50?nd("request_success_rate",s):{band:"info",fillPct:0,tooltip:""},l=[{value:o,label:`OK ${o}`,kind:"success"},{value:r,label:`Fail ${r}`,kind:"failure"}];return e.add(t.entity_id),e.add(i.entity_id),Rn(ur||(ur=Es`
      <div class="hero-tile" @click=${0}>
        <div class="hero-tile-head">
    ...
    `),()=>this._fireMoreInfo(t.entity_id),this._renderInfoTip({...n,tooltip:"Outgoing requests this node initiated (login, telemetry, neighbour query) and how they resolved. Success rate bands: Green > 90%, Yellow 70–90%, Red < 70%, with a minimum sample of 50 attempts to colour. Below the floor, the bar stays neutral — too few samples to judge."}),n.band,a>0?`${s.toFixed(0)}%`:"—",a>0?Rn(mr||(mr=Es`<span class="secondary">· ${0} attempt${0}</span>`),a,1===a?"":"s"):zn,l,"inline")}_formatCount(e){return Number.isFinite(e)?Math.round(e).toLocaleString():"—"}_renderLocationTile(){const e=this._findEntityIdMatching("latitude"),t=this._findEntityIdMatching("longitude");let i=e?this._readNumber(e.entity_id):NaN,o=t?this._readNumber(t.entity_id):NaN,r="entity";!Number.isFinite(i)&&Number.isFinite(this.fallbackLatitude)&&(i=this.fallbackLatitude,r="fallback"),!Number.isFinite(o)&&Number.isFinite(this.fallbackLongitude)&&(o=this.fallbackLongitude,r="fallback");const a=Number.isFinite(i)&&Number.isFinite(o)&&(0!==i||0!==o);if(!a)return zn;let s=null;if("entity"===r&&e){var n;const t=null===(n=this.hass)||void 0===n||null===(n=n.states[e.entity_id])||void 0===n?void 0:n.last_updated;if(t){const e=new Date(t);Number.isNaN(e.getTime())||(s=e)}}else"fallback"===r&&Number.isFinite(this.fallbackUpdated)&&(s=new Date(1e3*this.fallbackUpdated));const l=a&&s?this._formatRelativeTime(s):"";return Rn(gr||(gr=Es`
      <div class="hero-tile" @click=${0}>
        <div class="hero-tile-head">
    ...
    `),()=>{e&&this._fireMoreInfo(e.entity_id)},"fallback"===r?Rn(vr||(vr=Es`<span style="opacity:0.55;text-transform:none;letter-spacing:0;font-size:10px;margin-left:4px;">via contact</span>`)):zn,a?Rn(fr||(fr=Es`<span class="coord-pair">
                ${0}, ${0}
              </span>`),i.toFixed(4),o.toFixed(4)):Rn(yr||(yr=Es`<span class="primary">—</span>`)),l?Rn(br||(br=Es`<div class="loc-updated">Updated ${0}</div>`),l):zn)}_formatRelativeTime(e){const t=(Date.now()-e.getTime())/1e3;return!Number.isFinite(t)||t<0||t<60?"just now":t<3600?`${Math.floor(t/60)} min ago`:t<86400?`${Math.floor(t/3600)} h ago`:`${Math.floor(t/86400)} d ago`}_renderCompanionRadioActivityTile(){const e=this._findEntityIdMatching("tx_airtime"),t=this._findEntityIdMatching("rx_airtime"),i=this._findByMetric("uptime_hours");if(!e&&!t||!i)return zn;const o=this._readUptimeMinutes(i);if(!Number.isFinite(o)||o<=0)return zn;const r=e?this._readNumber(e.entity_id):0,a=t?this._readNumber(t.entity_id):0;if(!Number.isFinite(r)&&!Number.isFinite(a))return zn;const s=e=>Number.isFinite(e)?Math.min(100,Math.max(0,e/o*100)):0,n=s(r),l=s(a),d=Math.max(0,100-n-l),c=nd("tx_airtime_util",n).band,p=nd("rx_airtime_util",l).band,h=this._worseBand(c,p),u=[{value:n,label:`TX ${n.toFixed(1)}%`,kind:"tx"},{value:l,label:`RX ${l.toFixed(1)}%`,kind:"rx"},{value:d,label:`Idle ${d.toFixed(1)}%`,kind:"idle"}],m=n+l;return Rn(_r||(_r=Es`
      <div class="hero-tile"
           @click=${0}>
        <div class="hero-tile-head">
          <span>Radio activity${0}</span>
    ...
    `),()=>this._fireMoreInfo(e.entity_id),t=>this._fireContextMenu(t,e),dd(()=>this._fireContextMenu(void 0,e)),p,e.label,u?this._renderInfoTip(u):zn,m,d?Rn(Ar||(Ar=Es`<span class="unit">${0}</span>`),d):zn,c&&e.metricKey?Rn(Rr||(Rr=Es`<meshcore-stat-bar
                .value=${0}
                .min=${0}
                .max=${0}
                .band=${0}>
  ...
  `)),Ps([Zn({type:Object})],vd.prototype,"hass",void 0),Ps([Zn({type:Object})],vd.prototype,"device",void 0),Ps([Zn({type:Array})],vd.prototype,"entities",void 0),Ps([Zn({type:Number})],vd.prototype,"hiddenCount",void 0),Ps([Zn({type:Number})],vd.prototype,"fallbackLatitude",void 0),Ps([Zn({type:Number})],vd.prototype,"fallbackLongitude",void 0),Ps([Zn({type:Number})],vd.prototype,"fallbackUpdated",void 0),Ps([Zn({type:Object})],vd.prototype,"repeaterStatus",void 0),Ps([el()],vd.prototype,"_rateHistory",void 0),vd=Ps([Yn("meshcore-node-summary")],vd);const yd=[{step:"generating",label:"Generating new key"},{step:"importing",label:"Sending key to device"},{step:"rebooting",label:"Rebooting device"},{step:"reconnecting",label:"Waiting for device reconnect"},{step:"reloading",label:"Reloading HiveFW integration"},{step:"verifying",label:"Verifying new identity"}];let bd=class extends Gn{constructor(){super(),this.narrow=!1,this.contactCount=0,this.channelCount=0,this._deviceConfig=null,this._repeaterStatus=null,this._managedDevices={repeaters:[],clients:[]},this._scopeDraft="",this._scopeGlobal=!1,this._scopeSaving=!1,this._regionTarget="",this._regionText="",this._regionBusy=!1,this._regionAction="allowf",this._regionName="",this._loading=!0,this._error=null,this._editValues={},this._saving=!1,this._firmwareOtaStatus=null,this._firmwareFile=null,this._firmwareBusy=!1,this._firmwareChecking=!1,this._firmwareUploadStage=null,this._dutyCycleValue=10,this._dutyCycleReadValue=null,this._dutyCycleBusy=null,this._commandDialogOpen=!1,this._confirmAction=null,this._confirmDialogOpen=!1,this._locationSource="manual",this._importKeyValue="",this._deviceEntities={},this._meshcoreDeviceMap={},this._entityRegistryLoaded=!1,this._hiddenSensors={},this._contextMenu=null,this._overlayPointerStarted=!1,this._settingsModalOpen=!1,this._keyManagementModalOpen=!1,this._identityFlowState={kind:"closed"},this._identityFlowUnsubscribe=null,this._renameSuccess=null,this._hiddenSensorsModalKey=null,this._statusMessage=null,this._statusMessageTimeout=null,this._onCompanionTrace=()=>{var e;const t=null===(e=this.selectedDevice)||void 0===e?void 0:e.entry_id;this.dispatchEvent(new CustomEvent("companion-trace-requested",{detail:{entryId:t},bubbles:!0,composed:!0}))},Nl(this,{isOpen:()=>null!==this._contextMenu,onEscape:()=>this._closeContextMenu(),getScope:()=>{var e;return null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector('[data-a11y="tile-context"]')}}),Nl(this,{isOpen:()=>this._settingsModalOpen,onEscape:()=>this._closeSettingsModal(),getScope:()=>{var e;return null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector('[data-a11y="companion-settings"]')}}),Nl(this,{isOpen:()=>this._keyManagementModalOpen,onEscape:()=>this._closeKeyManagementModal(),getScope:()=>{var e;return null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector('[data-a11y="key-management"]')}}),Nl(this,{isOpen:()=>null!==this._hiddenSensorsModalKey,onEscape:()=>this._closeHiddenSensorsModal(),getScope:()=>{var e;return null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector('[data-a11y="hidden-sensors"]')}}),Nl(this,{isOpen:()=>"closed"!==this._identityFlowState.kind,onEscape:()=>{"success"!==this._identityFlowState.kind&&"failure"!==this._identityFlowState.kind||this._closeIdentityFlowModal()},getScope:()=>{var e;return null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector('[data-a11y="identity-flow"]')}}),Nl(this,{isOpen:()=>null!==this._renameSuccess,onEscape:()=>this._closeRenameSuccessModal(),getScope:()=>{var e;return null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector('[data-a11y="rename-success"]')}})}connectedCallback(){super.connectedCallback(),this._loadDeviceConfig(),this._loadHiddenSensors()}disconnectedCallback(){super.disconnectedCallback(),null!==this._statusMessageTimeout&&(clearTimeout(this._statusMessageTimeout),this._statusMessageTimeout=null)}updated(e){e.has("config")&&this._loadDeviceConfig(),e.has("hass")&&this.hass&&!this._entityRegistryLoaded&&this._loadEntityRegistry()}async _loadDeviceConfig(){if(this.hass){this._loading=!0,this._error=null;try{var e,t,i,o;this._deviceConfig=await cl(this.hass,null===(e=this.config)||void 0===e?void 0:e.entry_id);try{var r,a;this._repeaterStatus=await async function(e,t){const i={type:"hivefw_integration/get_local_repeater_status"};return t&&(i.entry_id=t),e.callWS(i)}(this.hass,null===(r=this.config)||void 0===r?void 0:r.entry_id),void 0!==(null===(a=this._repeaterStatus)||void 0===a?void 0:a.duty_cycle)&&null===this._dutyCycleReadValue&&(this._dutyCycleValue=Number(this._repeaterStatus.duty_cycle),this._dutyCycleReadValue=Number(this._repeaterStatus.duty_cycle))}catch(e){this._repeaterStatus=null}try{var s;this._firmwareOtaStatus=await gl(this.hass,null===(s=this.config)||void 0===s?void 0:s.entry_id)}catch(e){this._firmwareOtaStatus=null}this._managedDevices=await async function(e,t){try{const i={type:"hivefw_integration/get_managed_devices"};t&&(i.entry_id=t);const o=await e.callWS(i);return{repeaters:o.repeaters||[],clients:o.clients||[]}}catch(e){return{repeaters:[],clients:[]}}}(this.hass,null===(t=this.config)||void 0===t?void 0:t.entry_id);const n=await ml(this.hass,null===(i=this.config)||void 0===i?void 0:i.entry_id);this._scopeDraft=n.scopes.join(", "),this._scopeGlobal=n.global,!this._regionTarget&&this._managedDevices.repeaters.length&&(this._regionTarget=this._managedDevices.repeaters[0].pubkey_prefix),null!==(o=this._deviceConfig)&&void 0!==o&&o.location_source&&(this._locationSource=this._deviceConfig.location_source)}catch(e){this._error=`Failed to load device configuration: ${String(e)}`}finally{this._loading=!1}}}render(){var e,t,i,o,r;return this._loading?Rn(zr||(zr=Es`
      ...
      `)):this._error?Rn(Or||(Or=Es`
        <div class="settings-page">
          <div style="padding: 16px; color: var(--error-color); font-size: 14px;">
            ${0}
          </div>
        </div>
      `),this._error):this._deviceConfig?Rn(Dr||(Dr=Es`
      <div class="settings-page">
    ...
    `),this.selectedDevice?this._renderCompanionCard():zn,this.selectedDevice?this._renderFirmwareOta():zn,this._renderDeviceInfo(),this._renderRadioSettings(),this._renderRepeaterSettings(),this._renderRegionsScopes(),this._renderLocation(),this._contextMenu?Rn(Nr||(Nr=Es`
      ...
      `),this._onOverlayPointerDown,this._closeContextMenu,this._contextMenu.label,e=>e.stopPropagation(),e=>e.stopPropagation(),this._contextMenu.label,this._closeContextMenu,e=>e.stopPropagation(),this._hideSensorFromContext):zn,this._settingsModalOpen?Rn(Er||(Er=Es`
      ...
      `),this._closeSettingsModal,e=>e.stopPropagation(),this._closeSettingsModal,this._openHiddenSensorsList,(this._hiddenSensors[this._getCompanionDeviceKey()]||[]).length,this._handleRebootFromModal,this._openKeyManagementModal):zn,this._keyManagementModalOpen?Rn(Pr||(Pr=Es`
        <div class="modal-overlay" @click=${0}>
      ...
      `),this._closeKeyManagementModal,e=>e.stopPropagation(),this._closeKeyManagementModal,this._renderIdentityManagement()):zn,this._hiddenSensorsModalKey?this._renderHiddenSensorsModal():zn,this._renderIdentityFlowModal(),this._renderRenameSuccessModal(),this._statusMessage?Rn(qr||(qr=Es`
    ...
    `),e=>this._onTileContextMenu(e,o),t.name,t.firmware||"unknown",t.pubkey_prefix,this.contactCount,this.channelCount,void 0!==l?Rn(Br||(Br=Es`<span>Added nodes: ${0}</span>`),l):zn,()=>this._settingsModalOpen=!0,r.length>0?Rn(Hr||(Hr=Es`
    ...
    `),i,null!=t&&t.release_available?Rn(Ur||(Ur=Es`<span>Última Release: ${0}</span>`),o):Rn(jr||(jr=Es`<span>Release: por verificar</span>`)),null!=t&&t.host?Rn(Kr||(Kr=Es`<span class="firmware-host">${0}</span>`),t.host):zn,t?t.supported?t.bootstrap_required?Rn(Xr||(Xr=Es`
            ...
            `)),this._firmwareBusy||this._firmwareChecking,this._checkFirmwareUpdates,this._firmwareChecking?"A verificar Releases…":"Verificar Releases",null!=t&&t.release_available?Rn(Qr||(Qr=Es`
                ...
                `),o,t.release_url?Rn(Jr||(Jr=Es`
                        ...
                        `),t.release_url):zn,this._firmwareBusy||!r,this._installLatestFirmware,this._firmwareBusy?"A processar firmware…":`Flash da última Release (${o})`):Rn(Zr||(Zr=Es`
    ...
    `),this._closeHiddenSensorsModal,e=>e.stopPropagation(),this._closeHiddenSensorsModal,0===t.length?Rn(ia||(ia=Es`<div class="empty-hidden">No hidden sensors</div>`)):t.map(t=>Rn(oa||(oa=Es`
              ...
              `),()=>{this._unhideAllSensors(e)}):zn)}_renderDeviceInfo(){var e;if(this._deviceConfig)return Rn(aa||(aa=Es`
      <div class="info-row">
    ...
    `),this._scopeDraft,e=>{this._scopeDraft=e.target.value},this._scopeGlobal,e=>{this._scopeGlobal=e.target.checked},this._scopeSaving,this._saveFloodScopes,this._scopeSaving?"A guardar…":"Guardar Scopes",e.length?Rn(va||(va=Es`
      ...
      `),this._regionTarget,e=>{this._regionTarget=e.target.value,this._regionText=""},e.map(e=>Rn(fa||(fa=Es`<option value=${0}>${0}</option>`),e.pubkey_prefix,e.name)),this._regionBusy||!this._regionTarget,this._readRemoteRegions,this._regionBusy?"A consultar…":"Ler Regions (RF)",this._regionText?Rn(ya||(ya=Es`
        ...
        `),this._regionText):zn,this._regionAction,e=>{this._regionAction=e.target.value},this._regionName,e=>{this._regionName=e.target.value},this._regionBusy||!this._regionTarget||!this._regionName.trim()&&"default"!==this._regionAction,this._applyRemoteRegion,this._regionBusy||!this._regionTarget,()=>this._sendRemoteRegionCommand("region save")):Rn(ba||(ba=Es`
    ...
    `),i.length,e.length,t.length,o,i.map(e=>{var t;const i=e.connected||"online"===e.status,o="repeater"===e.type?"Repeater":"Client";return Rn(wa||(wa=Es`
          ...
          `),"repeater"===e.type?"R":"C",e.name,o,(null===(t=e.pubkey_prefix)||void 0===t?void 0:t.toUpperCase())||"sem chave",e.firmware_version?Rn($a||($a=Es` · FW ${0}`),e.firmware_version):zn,e.neighbors_enabled?Rn(ka||(ka=Es` · vizinhos monitorizados`)):zn,i?"online":"offline",i?"Online":"Offline","repeater"===e.type?Rn(Sa||(Sa=Es`<button class="action-btn" @click=${0}>Admin</button>`),()=>this._requestManagedAdmin(e)):zn)}))}_renderRepeaterSettings(){var e,t,i,o,r,a;const s=this._repeaterStatus;if(null==s||!s.supported)return Rn(Ca||(Ca=Es`
        <div style="font-size: 12px; color: var(--secondary-text-color); line-height: 1.5;">
    ...
    `),this._showRegenIdentityConfirm,this._importKeyValue,e=>{this._importKeyValue=e.target.value},!this._importKeyValue.trim(),this._handleImportKeyConfirm)}_hasChanges(e,t){return!!this._deviceConfig&&t.some(e=>void 0!==this._editValues[e]&&this._editValues[e]!==this._deviceConfig[e])}async _handleApply(e){if(!this.hass||!this._deviceConfig)return;let t=[];switch(e){case"device-name":t=["name"];break;case"radio-settings":t=["tx_power","frequency","bandwidth","spreading_factor","coding_rate","path_hash_mode"]}const i={};for(const e of t)void 0!==this._editValues[e]&&(i[e]=this._editValues[e]);this._saving=!0;try{var o;const e=await pl(this.hass,i,null===(o=this.config)||void 0===o?void 0:o.entry_id);if(e.success){this._deviceConfig&&(this._deviceConfig={...this._deviceConfig,...i});for(const e of t)delete this._editValues[e];this._editValues={...this._editValues},e.rename?this._renameSuccess=e.rename:this._showStatusMessage(`Saved: ${t.join(", ")}`,"success")}else this._showStatusMessage("Save failed","error")}catch(e){this._showStatusMessage(`Error: ${String(e)}`,"error")}finally{this._saving=!1}}async _copyToClipboard(e){try{await navigator.clipboard.writeText(e),this._showStatusMessage("Copied to clipboard","success")}catch(e){this._showStatusMessage("Failed to copy","error")}}_showStatusMessage(e,t){this._statusMessage={text:e,type:t},null!==this._statusMessageTimeout&&clearTimeout(this._statusMessageTimeout),this._statusMessageTimeout=window.setTimeout(()=>{this._statusMessage=null,this._statusMessageTimeout=null},5e3)}_handleNameSave(){var e;const t=this._editValues.name,i=null===(e=this._deviceConfig)||void 0===e?void 0:e.name;if(void 0===t||t===i)return;const o=e=>(e||"").toLowerCase().replace(/[^a-z0-9]+/g,"_").replace(/^_|_$/g,""),r=o(null!=i?i:""),a=o(String(t));this._confirmAction={title:"Rename Device",message:`Renaming the device will rename all entity IDs ending in _${r} to _${a}. Any automations, scripts, or dashboards referencing entity IDs by the old name will need updating. A repair issue will list every renamed entity. Continue?`,onConfirm:async()=>{await this._handleApply("device-name")}},this._confirmDialogOpen=!0}_handleRebootFromModal(){this._settingsModalOpen=!1,this._confirmAction={title:"Reboot Device",message:"Are you sure you want to reboot the device? The device will be temporarily unavailable.",onConfirm:()=>this._executeDeviceCommand("reboot")},this._confirmDialogOpen=!0}async _executeDeviceCommand(e){if(this.hass)try{var t;const i=await hl(this.hass,e,void 0,null===(t=this.config)||void 0===t?void 0:t.entry_id);i.success?this._showStatusMessage(`Device ${e} initiated`,"success"):this._showStatusMessage(`Command failed: ${i.response}`,"error")}catch(e){this._showStatusMessage(`Error: ${String(e)}`,"error")}}async _applyLocation(){if(this.hass&&this._deviceConfig){this._saving=!0;try{var e;const i=["latitude","longitude"],o={};if("ha_location"===this._locationSource){const e=this.hass.states["zone.home"];if(!e||null==e.attributes.latitude||null==e.attributes.longitude)return void this._showStatusMessage("Could not read zone.home coordinates from Home Assistant","error");o.latitude=e.attributes.latitude,o.longitude=e.attributes.longitude}else for(const e of i)void 0!==this._editValues[e]&&(o[e]=this._editValues[e]);if(Object.keys(o).length>0){var t;if(!(await pl(this.hass,o,null===(t=this.config)||void 0===t?void 0:t.entry_id)).success)return void this._showStatusMessage("Failed to save coordinates","error");this._deviceConfig&&(this._deviceConfig={...this._deviceConfig,...o});for(const e of i)delete this._editValues[e];this._editValues={...this._editValues}}if(!(await async function(e,t,i){try{const o={type:"hivefw_integration/set_location_source",source:t};return i&&(o.entry_id=i),await e.callWS(o)}catch(e){return{success:!1}}}(this.hass,this._locationSource,null===(e=this.config)||void 0===e?void 0:e.entry_id)).success)return void this._showStatusMessage("Failed to update location source","error");await this._loadDeviceConfig(),this._showStatusMessage("Location settings applied","success")}catch(e){this._showStatusMessage(`Error: ${String(e)}`,"error")}finally{this._saving=!1}}}_showRegenIdentityConfirm(){this._confirmAction={title:"Regenerate Identity",message:"This will create a new cryptographic identity, reboot the device, and migrate all entity IDs to the new key prefix. Existing automations referencing entity IDs by the old prefix will need updating. All contacts must re-add this device. This cannot be undone.",requireTyped:"REGENERATE",onConfirm:async()=>{var e;this.hass&&(this._closeKeyManagementModal(),this._startIdentityFlow("regenerate",{type:"hivefw_integration/regenerate_identity",payload:null!==(e=this.config)&&void 0!==e&&e.entry_id?{entry_id:this.config.entry_id}:{}}))}},this._confirmDialogOpen=!0}_handleImportKeyConfirm(){const e=this._importKeyValue.trim().replace(/\s+/g,"");e&&(64===e.length||128===e.length?/^[0-9a-fA-F]+$/.test(e)?(this._confirmAction={title:"Import Private Key",message:"Importing a private key will replace the device identity, reboot the device, and migrate all entity IDs to the new key prefix. Existing automations referencing entity IDs by the old prefix will need updating. All contacts must re-add this device.",requireTyped:"IMPORT",onConfirm:()=>this._importIdentityKey()},this._confirmDialogOpen=!0):this._showStatusMessage("Private key must be hex (0-9, a-f)","error"):this._showStatusMessage("Private key must be 64 or 128 hex characters","error"))}async _importIdentityKey(){var e;if(!this.hass||!this._importKeyValue.trim())return;const t=this._importKeyValue.trim().replace(/\s+/g,"");this._closeKeyManagementModal(),this._importKeyValue="";const i={private_key:t};null!==(e=this.config)&&void 0!==e&&e.entry_id&&(i.entry_id=this.config.entry_id),this._startIdentityFlow("import",{type:"hivefw_integration/import_identity",payload:i})}_startIdentityFlow(e,t){if(!this.hass)return;this._identityFlowUnsubscribe&&(this._identityFlowUnsubscribe(),this._identityFlowUnsubscribe=null),this._identityFlowState={kind:"progress",flow:e,currentStep:"generating",completedSteps:new Set};const{unsubscribe:i}=function(e,t,i,o){let r,a=null;const s=new Promise(e=>{r=e});let n={success:!1,code:"unknown",message:"Identity flow terminated without a result event."};return e.connection.subscribeMessage(e=>{if("done"===e.step&&e.success&&e.old_pubkey&&e.new_pubkey){const t={success:!0,old_pubkey:e.old_pubkey,new_pubkey:e.new_pubkey,warning:e.warning};n=t,o({type:"result",data:t})}else"done"!==e.step&&o({type:"progress",step:e.step})},{type:t,...i}).then(e=>{a=e,r(n)}).catch(e=>{const t={success:!1,code:e.code||"error",message:e.message||"Identity flow failed."};o({type:"error",data:t}),r(t)}),{unsubscribe:()=>{a&&a()},done:s}}(this.hass,t.type,t.payload,t=>{if("progress"===t.type){if("progress"!==this._identityFlowState.kind)return;const e=new Set(this._identityFlowState.completedSteps);e.add(this._identityFlowState.currentStep),this._identityFlowState={...this._identityFlowState,currentStep:t.step,completedSteps:e}}else"result"===t.type?this._identityFlowState={kind:"success",flow:e,oldPubkey:t.data.old_pubkey,newPubkey:t.data.new_pubkey,warning:t.data.warning}:"error"===t.type&&(this._identityFlowState={kind:"failure",flow:e,code:t.data.code,message:t.data.message})});this._identityFlowUnsubscribe=i}_closeIdentityFlowModal(){this._identityFlowUnsubscribe&&(this._identityFlowUnsubscribe(),this._identityFlowUnsubscribe=null);const e="success"===this._identityFlowState.kind;this._identityFlowState={kind:"closed"},e&&this._loadDeviceConfig()}_renderIdentityFlowModal(){const e=this._identityFlowState;if("closed"===e.kind)return zn;const t="regenerate"===e.flow?"Regenerate Identity":"Import Private Key",i="regenerate"===e.flow?"Regenerating Identity":"Importing Identity",o="regenerate"===e.flow?"Identity Regenerated":"Identity Imported",r="regenerate"===e.flow?"Identity Regeneration Failed":"Identity Import Failed";let a,s;"progress"===e.kind?(a=Rn(Fa||(Fa=Es`
      ...
      `),yd.map(t=>{const i=e.completedSteps.has(t.step),o=e.currentStep===t.step;let r="○",a="var(--secondary-text-color)";return i?(r="✓",a="var(--success-color, #28a745)"):o&&(r="⏳",a="var(--primary-color)"),Rn(Ta||(Ta=Es`
            ...
            `),a,r,t.label)})),s=zn):"success"===e.kind?(a=Rn(za||(za=Es`
        ...
        ${0}
      `),e.oldPubkey.slice(0,12),e.newPubkey.slice(0,12),e.warning?Rn(Oa||(Oa=Es`
        ...
        `),e.warning):zn),s=Rn(Ia||(Ia=Es`
        <button class="modal-action" @click=${0}>Close</button>
      `),this._closeIdentityFlowModal)):(a=Rn(Da||(Da=Es`
        <div style="font-size: 32px; text-align: center; margin-bottom: 8px;">❌</div>
      ...
      `),"regenerate"===e.flow?"The device firmware rejected the new key. Your device identity is unchanged.":"The import did not take effect. Your device identity may be unchanged.",e.code,e.message),s=Rn(Na||(Na=Es`
        <button class="modal-action" @click=${0}>Close</button>
    ...
    `),t,e=>e.stopPropagation(),n,"progress"===e.kind?zn:Rn(Pa||(Pa=Es`
              <button class="modal-close" aria-label="Close" @click=${0}>&times;</button>
            `),this._closeIdentityFlowModal),a,s?Rn(qa||(qa=Es`<div style="margin-top: 20px; display: flex; justify-content: flex-end;">${0}</div>`),s):zn)}_closeRenameSuccessModal(){this._renameSuccess=null,this._loadDeviceConfig(),this.dispatchEvent(new CustomEvent("device-renamed",{bubbles:!0,composed:!0}))}_renderRenameSuccessModal(){const e=this._renameSuccess;return e?Rn(La||(La=Es`
  ...
  `))],Ps([Zn({type:Boolean})],_d.prototype,"open",void 0),Ps([Zn({type:String})],_d.prototype,"contactName",void 0),Ps([Zn({type:Object})],_d.prototype,"result",void 0),Ps([Zn({type:String})],_d.prototype,"error",void 0),Ps([Zn({type:Array})],_d.prototype,"availableRepeaters",void 0),Ps([Zn({type:Object})],_d.prototype,"targetContact",void 0),Ps([el()],_d.prototype,"pathMode",void 0),Ps([el()],_d.prototype,"pathHops",void 0),Ps([el()],_d.prototype,"enteredPath",void 0),Ps([el()],_d.prototype,"_repeaterFilter",void 0),Ps([el()],_d.prototype,"_running",void 0),_d=Ps([Yn("meshcore-trace-dialog")],_d);let xd=class extends Gn{constructor(){super(),this.open=!1,this.contacts=[],this._typeFilter="all",this._search="",this._onTypeChange=e=>{this._typeFilter=e.target.value},this._onSearchInput=e=>{this._search=e.target.value},this._close=()=>{this.dispatchEvent(new CustomEvent("target-picker-closed",{bubbles:!0,composed:!0}))},Nl(this,{isOpen:()=>this.open,onEscape:()=>this._close()})}willUpdate(e){e.has("open")&&this.open&&!e.get("open")&&(this._typeFilter="all",this._search="")}render(){if(!this.open)return Rn(ps||(ps=Es``));const e=this._search.trim().toLowerCase(),t=this.contacts.filter(e=>{switch(this._typeFilter){case"all":default:return!0;case"client":return 1===e.type;case"repeater":return 2===e.type;case"room_server":return 3===e.type;case"sensor":return 4===e.type}}).filter(t=>{if(!e)return!0;const i=(t.adv_name||"").toLowerCase(),o=(t.pubkey_prefix||"").toLowerCase();return i.includes(e)||o.startsWith(e)}).sort((e,t)=>(e.adv_name||"").localeCompare(t.adv_name||""));return Rn(hs||(hs=Es`
    ...
    `),this.narrow||"always_hidden"===(null===(e=this.hass)||void 0===e?void 0:e.dockedSidebar)?Rn(ks||(ks=Es`<button class="menu-icon" @click=${0} aria-label="Toggle sidebar">
          ...
          <hivefw-integration-page
            ...
            @contacts-changed=${0}
            @channels-changed=${0}
            @refresh-channels-requested=${0}></hivefw-integration-page>`),this.hass,this._config,[...this._channels,...this._contacts.filter(e=>e.added_to_node)],this._unread,this._pendingChatTarget,this.narrow,this._onActiveEntityChanged,()=>this._loadDeviceData(),()=>this._loadDeviceData(),()=>this._refreshChannelsFromRadio());case"nodes":return Rn(Os||(Os=Es`
          <meshcore-nodes-page
            .hass=${0}
            .config=${0}
            .contacts=${0}
          ...
          <meshcore-neighbors-page
            .hass=${0}
            .config=${0}
            .narrow=${0}></meshcore-neighbors-page>`),this.hass,this._config,this.narrow);case"settings":return Rn(Ds||(Ds=Es`
