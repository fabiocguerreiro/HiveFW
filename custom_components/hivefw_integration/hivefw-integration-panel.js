...
`)),yn=/^<[^>]+>\s*/,xn=/@\[([^\]]+)\]/g,wn=/@(\w+)/g,$n={recipient_type_entity:"select.hivefw_recipient_type",channel_entity:"select.hivefw_channel",contact_entity:"select.hivefw_contact",channel_entity_pattern:"binary_sensor.hivefw_{prefix}_ch_{idx}_messages",contact_entity_pattern:"binary_sensor.hivefw_{prefix}_{contact}_messages",domain_filter:"hivefw"},kn={...$n,hours_to_show:48,initial_hours:1,max_messages:500,show_date_separators:!0,group_messages:!0,group_timeout:300,timestamp_format:"time",update_mode:"auto",refresh_interval:30,enable_cache:!0,cache_ttl:86400,cache_max_size:5242880};async function Sn(e){try{return(await e.callWS({type:"hivefw_integration/get_devices"})).devices||[]}catch(e){return[]}}async function Cn(e,t){try{const i={type:"hivefw_integration/get_contacts"};return t&&(i.entry_id=t),(await e.callWS(i)).contacts||[]}catch(e){return[]}}async function Mn(e,t){try{const i={type:"hivefw_integration/get_channels"};return t&&(i.entry_id=t),(await e.callWS(i)).channels||[]}catch(e){return[]}}async function An(e,t){try{const i={type:"hivefw_integration/get_device_config"};return t&&(i.entry_id=t),await e.callWS(i)}catch(e){throw new Error("Failed to get device configuration")}}async function Rn(e,t,i){try{const o={type:"hivefw_integration/set_device_config",settings:t};return i&&(o.entry_id=i),await e.callWS(o)}catch(e){const t=e;return{success:!1,changed:[],error:t&&t.message?t.code?`${t.message} (${t.code})`:t.message:String(e)}}}async function zn(e,t){try{const i={type:"hivefw_integration/get_flood_scopes"};t&&(i.entry_id=t);const o=await e.callWS(i);return{scopes:o.scopes||[],global:!!o.global}}catch(e){return{scopes:[],global:!1}}}async function In(e,t){const i={type:"hivefw_integration/get_local_repeater_status"};return t&&(i.entry_id=t),e.callWS(i)}async function Tn(e,t){const i={type:"hivefw_integration/get_local_regions"};return t&&(i.entry_id=t),e.callWS(i)}async function Nn(e,t,i="",o="",a){const r={type:"hivefw_integration/set_local_region",operation:t,name:i,parent:o};return a&&(r.entry_id=a),e.callWS(r)}async function Fn(e,t,i=!1){const o={type:"hivefw_integration/get_firmware_ota_status"};return t&&(o.entry_id=t),i&&(o.force=!0),e.callWS(o)}async function Dn(e,t,i,o){try{const a={type:"hivefw_integration/add_contact",public_key:t};return i&&(a.name=i),o&&(a.entry_id=o),await e.callWS(a)}catch(e){return{success:!1}}}async function En(e,t,i){try{const o={type:"hivefw_integration/remove_contact",public_key:t};return i&&(o.entry_id=i),await e.callWS(o)}catch(e){return{success:!1}}}async function On(e,t,i){try{const o={type:"hivefw_integration/mark_conversation_read",entity_id:t};return i&&(o.entry_id=i),await e.callWS(o)}catch(e){return{success:!1}}}async function Pn(e,t,i){try{const o={type:"hivefw_integration/set_location_source",source:t};return i&&(o.entry_id=i),await e.callWS(o)}catch(e){return{success:!1}}}class Bn{constructor(){this._counts={},this._lastRead={},this._subscribers=new Set,this._markReadRequestedHandler=null,this._readProgress=null,this._postSwitchTimerHandler=null}subscribe(e){return this._subscribers.add(e),()=>{this._subscribers.delete(e)}}onMarkReadRequested(e){this._markReadRequestedHandler=e}onPostSwitchTimerFire(e){this._postSwitchTimerHandler=e}requestMarkRead(e){e&&this._markReadRequestedHandler&&this._markReadRequestedHandler(e)}_notify(){for(const e of[...this._subscribers])try{e()}catch(e){console.error("[UnreadController] subscriber callback threw",e)}}ingestBackendData(e,t){var i,o;this._counts={...null!==(i=null==e?void 0:e.unread)&&void 0!==i?i:{}},this._lastRead={...null!==(o=null==e?void 0:e.last_read)&&void 0!==o?o:{}},this._notify()}clearEntity(e){e&&this._counts[e]&&(this._counts={...this._counts,[e]:0},this._notify())}get counts(){return this._counts}get lastRead(){return this._lastRead}beginConversation(e,t){var i;this._clearPostSwitchTimer();const o={entityId:e,anchorId:e&&null!==(i=this._lastRead[e])&&void 0!==i?i:null,unreadCountAtSelection:t,graceUntil:Date.now()+1e3,postSwitchTimer:null,markReadFired:!1,lastMarkReadIdSent:null};this._readProgress=o,o.postSwitchTimer=setTimeout(()=>{var e;this._readProgress===o&&(o.postSwitchTimer=null,null===(e=this._postSwitchTimerHandler)||void 0===e||e.call(this))},1e3)}endConversation(){this._clearPostSwitchTimer(),this._readProgress=null}_clearPostSwitchTimer(){const e=this._readProgress;null!=e&&e.postSwitchTimer&&(clearTimeout(e.postSwitchTimer),e.postSwitchTimer=null)}resetUnreadCountAtSelection(){this._readProgress&&(this._readProgress.unreadCountAtSelection=0)}maybeReanchorOnLateData(e){const t=this._readProgress;if(!t||t.entityId!==e)return!1;if(null!==t.anchorId)return!1;if(t.markReadFired)return!1;const i=this._lastRead[e];return!!i&&(t.anchorId=i,!0)}onScrollState(e){return this._tryAdvanceCursor(e.entityId,e.lastMessageVisible,e.hasNewerMessages,e.bufferTailId,!1)}onPillJump(e){return this._tryAdvanceCursor(e.entityId,!0,!1,e.bufferTailId,!0)}_tryAdvanceCursor(e,t,i,o,a){if(!e)return!1;const r=this._readProgress;return!(!r||r.entityId!==e||!a&&Date.now()<r.graceUntil||i||!t||null!==o&&o===r.lastMarkReadIdSent||(r.lastMarkReadIdSent=o,r.markReadFired=!0,this.requestMarkRead(e),0))}badgeCount(e,t,i){if(!e)return 0;const o=this._counts;if(i&&o[i])return o[i];const a=/^\d+$/.test(e),r=t?`hivefw_${t}_ch_${e}_messages`:null;for(const[t,i]of Object.entries(o))if(!(i<=0))if(a){if(r){if(t.endsWith(r))return i}else if(t.endsWith(`_ch_${e}_messages`))return i}else{const o=e.substring(0,6);if(t.endsWith(`_${o}_messages`))return i}return 0}dividerAfterGroupIdx(e){const t=this._readProgress;if(!t)return null;let i=null;if(t.anchorId){let o=0;for(const a of e)if("date-separator"!==a.type){if(a.group.messages.some(e=>e.id===t.anchorId)){i=o;break}o++}}if(null!==i){let t=0;for(const o of e)if("date-separator"!==o.type){if(t>i&&!o.group.isOutgoing)return t;t++}return null}if(t.unreadCountAtSelection>0){const i=e.filter(e=>"date-separator"!==e.type).length,o=i-t.unreadCountAtSelection;return o>=0?o:0}return null}cursorAtTail(e,t){return!(!e||null===t)&&this._lastRead[e]===t}}const Ln=[1116352408,1899447441,3049323471,3921009573,961987163,1508970993,2453635748,2870763221,3624381080,310598401,607225278,1426881987,1925078388,2162078206,2614888103,3248222580,3835390401,4022224774,264347078,604807628,770255983,1249150122,1555081692,1996064986,2554220882,2821834349,2952996808,3210313671,3336571891,3584528711,113926993,338241895,666307205,773529912,1294757372,1396182291,1695183700,1986661051,2177026350,2456956037,2730485921,2820302411,3259730800,3345764771,3516065817,3600352804,4094571909,275423344,430227734,506948616,659060556,883997877,958139571,1322822218,1537002063,1747873779,1955562222,2024104815,2227730452,2361852424,2428436474,2756734187,3204031479,3329325298];function Hn(e){const t=(new TextEncoder).encode(e),i=t.length,o=8*i,a=i+9+63&-64,r=new Uint8Array(a);r.set(t),r[i]=128;const s=new DataView(r.buffer);s.setUint32(a-4,o,!1);let n=1779033703,l=3144134277,d=1013904242,c=2773480762,p=1359893119,h=2600822924,u=528734635,v=1541459225;const g=new Int32Array(64);for(let e=0;e<a;e+=64){for(let t=0;t<16;t++)g[t]=s.getInt32(e+4*t,!1);for(let e=16;e<64;e++){const t=(g[e-15]>>>7|g[e-15]<<25)^(g[e-15]>>>18|g[e-15]<<14)^g[e-15]>>>3,i=(g[e-2]>>>17|g[e-2]<<15)^(g[e-2]>>>19|g[e-2]<<13)^g[e-2]>>>10;g[e]=g[e-16]+t+g[e-7]+i|0}let t=n,i=l,o=d,a=c,r=p,m=h,f=u,_=v;for(let e=0;e<64;e++){const s=_+((r>>>6|r<<26)^(r>>>11|r<<21)^(r>>>25|r<<7))+(r&m^~r&f)+Ln[e]+g[e]|0,n=t&i^t&o^i&o;_=f,f=m,m=r,r=a+s|0,a=o,o=i,i=t,t=s+(((t>>>2|t<<30)^(t>>>13|t<<19)^(t>>>22|t<<10))+n|0)|0}n=n+t|0,l=l+i|0,d=d+o|0,c=c+a|0,p=p+r|0,h=h+m|0,u=u+f|0,v=v+_|0}const m=e=>(e>>>0).toString(16).padStart(8,"0");return m(n)+m(l)+m(d)+m(c)+m(p)+m(h)+m(u)+m(v)}function Un(e){const t=[],i=new Set;let o;const a=new RegExp(xn.source,"g");for(;null!==(o=a.exec(e));){const e=o[1];i.has(e)||(i.add(e),t.push(e))}const r=new RegExp(wn.source,"g");for(;null!==(o=r.exec(e));){const e=o[1];i.has(e)||(i.add(e),t.push(e))}return t}function jn(e){if(!e||0===e.length)return{};let t,i;for(const o of e)void 0===t&&"string"==typeof o.flood_scope&&(t=o.flood_scope),void 0===i&&"boolean"==typeof o.region_scope&&(i=o.region_scope);return{floodScope:t,regionScope:i}}function qn(e){var t,i;const o=jn(e.rx_log_data);return{id:e.id,sender:e.sender,text:e.text,timestamp:new Date(e.timestamp),isOutgoing:e.outgoing,isSystem:!1,raw:e.text,mentions:Un(e.text),rxLogData:e.rx_log_data,deliveryStatus:e.delivery_status?{status:e.delivery_status,ackReceived:e.ack_received,repeaterCount:e.repeater_count,roundTripMs:e.round_trip_ms}:void 0,repeaterCount:e.repeater_count,floodScope:null!==(t=e.flood_scope)&&void 0!==t?t:o.floodScope,regionScope:null!==(i=e.region_scope)&&void 0!==i?i:o.regionScope}}function Vn(e,t){return e.getFullYear()!==t.getFullYear()||e.getMonth()!==t.getMonth()||e.getDate()!==t.getDate()}function Wn(e){const t=new Date,i=new Date(t.getFullYear(),t.getMonth(),t.getDate()),o=new Date(e.getFullYear(),e.getMonth(),e.getDate()),a=Math.floor((i.getTime()-o.getTime())/864e5);return 0===a?"Today":1===a?"Yesterday":a<7?e.toLocaleDateString(void 0,{weekday:"long"}):e.toLocaleDateString(void 0,{weekday:"long",month:"long",day:"numeric"})}class Kn{constructor(e){this._messages=[],this._loading=!1,this._error=null,this._entityId=null,this._hass=null,this._pollTimer=null,this._realtimeSubscriptions=[],this._retryCount=0,this._onChange=null,this._fetchDebounce=null,this._active=!1,this._hasOlderMessages=!0,this._loadingOlder=!1,this._hasNewerMessages=!1,this._loadingNewer=!1,this._newMessagesWhileAway=0,this._userAtBottom=!1,this._config=e}get messages(){return this._messages}get loading(){return this._loading}get error(){return this._error}get entityId(){return this._entityId}get loadingOlder(){return this._loadingOlder}get hasOlderMessages(){return this._hasOlderMessages}get loadingNewer(){return this._loadingNewer}get hasNewerMessages(){return this._hasNewerMessages}get newMessagesWhileAway(){return this._newMessagesWhileAway}setUserAtBottom(e){this._userAtBottom!==e&&(this._userAtBottom=e,e&&!this._hasNewerMessages&&this._newMessagesWhileAway>0&&(this._newMessagesWhileAway=0,this._notify()))}resetNewMessagesCounter(){0!==this._newMessagesWhileAway&&(this._newMessagesWhileAway=0,this._notify())}setOnChange(e){this._onChange=e}setHass(e){this._hass=e}setConfig(e){this._config=e}async switchEntity(e,t=null){if(e!==this._entityId){if(this._stopUpdates(),this._entityId=e,this._messages=[],this._error=null,this._retryCount=0,this._hasOlderMessages=!0,this._loadingOlder=!1,this._hasNewerMessages=!1,this._loadingNewer=!1,this._newMessagesWhileAway=0,this._userAtBottom=!1,!e)return this._active=!1,void this._notify();this._active=!0,this._startUpdates(e),t?await this._fetchAroundAnchor(e,t):await this._fetchMessages(e)}}async refresh(){this._entityId&&await this._fetchMessages(this._entityId)}addOptimisticMessage(e,t){const i=new Date,o={id:`optimistic_${i.getTime()}_${Math.random().toString(36).slice(2,8)}`,sender:e,text:t,timestamp:i,isOutgoing:!0,isSystem:!1,raw:`${e}: ${t}`,mentions:[]};this._messages=[...this._messages,o],this._notify()}async loadOlderMessages(){if(!this._loadingOlder&&this._hasOlderMessages&&this._hass&&this._entityId){this._loadingOlder=!0,this._notify();try{const e=this._messages.find(e=>!e.id.startsWith("rt_")&&!e.id.startsWith("optimistic_")),t={type:"hivefw_integration/get_stored_messages",entity_id:this._entityId,limit:50};e&&(t.before=e.id);const i=await this._hass.callWS(t),o=i.messages.map(qn);this._hasOlderMessages=i.has_more;const a=new Set(this._messages.map(e=>e.id)),r=o.filter(e=>!a.has(e.id));r.length>0&&(this._messages=[...r,...this._messages],this._messages.sort((e,t)=>e.timestamp.getTime()-t.timestamp.getTime()))}catch(e){}finally{this._loadingOlder=!1,this._notify()}}}async loadNewerMessages(){if(!this._loadingNewer&&this._hasNewerMessages&&this._hass&&this._entityId){this._loadingNewer=!0,this._notify();try{let t;for(let e=this._messages.length-1;e>=0;e--){const i=this._messages[e].id;if(!i.startsWith("rt_")&&!i.startsWith("optimistic_")){t=i;break}}const i={type:"hivefw_integration/get_stored_messages",entity_id:this._entityId,limit:50};t&&(i.after=t);const o=await this._hass.callWS(i),a=o.messages.map(qn);this._hasNewerMessages=o.has_more;const r=new Set(a.map(e=>e.id));this._messages=this._messages.filter(e=>!e.id.startsWith("rt_")||!r.has(e.id.substring(3)));const s=new Set(this._messages.map(e=>e.id)),n=a.filter(e=>!s.has(e.id));if(n.length>0){var e;this._messages=[...this._messages,...n],this._messages.sort((e,t)=>e.timestamp.getTime()-t.timestamp.getTime());const t=null!==(e=this._config.max_messages)&&void 0!==e?e:500;this._messages.length>t&&(this._messages=this._messages.slice(-t),this._hasOlderMessages=!0)}}catch(e){}finally{this._loadingNewer=!1,this._notify()}}}async fetchAroundTimestamp(e){const t=new Date(e).getTime(),i=this._messages.find(e=>Math.abs(e.timestamp.getTime()-t)<2e3);if(i)return!0;let o=0;for(;this._hasOlderMessages&&o<20;){await this.loadOlderMessages(),o++;const e=this._messages.find(e=>Math.abs(e.timestamp.getTime()-t)<2e3);if(e)return!0}return!1}pause(){this._stopUpdates(),this._active=!1,this._fetchDebounce&&(clearTimeout(this._fetchDebounce),this._fetchDebounce=null)}async resume(){this._entityId&&!this._active&&(this._active=!0,this._startUpdates(this._entityId),await this._fetchMessages(this._entityId))}destroy(){this._stopUpdates(),this._active=!1,this._fetchDebounce&&(clearTimeout(this._fetchDebounce),this._fetchDebounce=null),this._onChange=null}async _fetchMessages(e){if(this._hass){this._loading=!0,this._notify();try{var t;const i=50,o=await this._hass.callWS({type:"hivefw_integration/get_stored_messages",entity_id:e,limit:i}),a=o.messages.map(qn);this._hasOlderMessages=o.has_more;const r=new Set(a.map(e=>e.id)),s=this._messages.filter(e=>{if(e.id.startsWith("optimistic_")){const t=a.some(t=>t.sender===e.sender&&t.text===e.text);return!t}if(e.id.startsWith("rt_")){const t=e.id.substring(3);return!r.has(t)}return!1});this._messages=[...a,...s],this._messages.sort((e,t)=>e.timestamp.getTime()-t.timestamp.getTime());const n=null!==(t=this._config.max_messages)&&void 0!==t?t:500;this._messages.length>n&&(this._messages=this._messages.slice(-n),this._hasOlderMessages=!0),this._error=null,this._retryCount=0}catch(e){const t=e instanceof Error?e.message:String(e);this._error=`Failed to fetch messages: ${t}`,this._retryCount++}finally{this._loading=!1,this._notify()}}}async _fetchAroundAnchor(e,t){if(this._hass){this._loading=!0,this._notify();try{var i;const o=await async function(e,t,i,o=25,a=50){return e.callWS({type:"hivefw_integration/get_messages_around",entity_id:t,anchor_id:i,before_limit:o,after_limit:a})}(this._hass,e,t),a=o.messages.map(qn);this._hasOlderMessages=o.has_more_before,this._hasNewerMessages=o.has_more_after;const r=new Set(a.map(e=>e.id)),s=this._messages.filter(e=>{if(e.id.startsWith("optimistic_")){const t=a.some(t=>t.sender===e.sender&&t.text===e.text);return!t}if(e.id.startsWith("rt_")){const t=e.id.substring(3);return!r.has(t)}return!1});this._messages=[...a,...s],this._messages.sort((e,t)=>e.timestamp.getTime()-t.timestamp.getTime());const n=null!==(i=this._config.max_messages)&&void 0!==i?i:500;this._messages.length>n&&(this._messages=this._messages.slice(-n),this._hasOlderMessages=!0),this._error=null,this._retryCount=0}catch(e){const t=e instanceof Error?e.message:String(e);this._error=`Failed to fetch messages: ${t}`,this._retryCount++}finally{this._loading=!1,this._notify()}}}_startUpdates(e){this._startPolling(e),this._subscribeRealtime(e).catch(()=>{})}async _subscribeRealtime(e){if(!this._hass)return;const t=[];try{const i=await this._hass.connection.subscribeEvents(t=>{t.data.entity_id===e&&this._handleRealtimeMessage(t.data)},"hivefw_message");t.push(i);const o=await this._hass.connection.subscribeEvents(t=>{t.data.entity_id===e&&this._handleDeliveryUpdate(t.data)},"hivefw_delivery_update");t.push(o),this._realtimeSubscriptions=t}catch(e){throw t.forEach(e=>e()),e}}_handleRealtimeMessage(e){var t,i;const o=null!==(t=e.sender_name)&&void 0!==t?t:e.sender,a=null!==(i=e.message)&&void 0!==i?i:e.text;if(o===this._config.node_name){if(o&&a){const t=e.ack_received,i=e.repeater_count,s=e.rx_log_data,n=e.message_type;let l;var r;if("dm"===n||"direct"===n)l={status:!0===t?"delivered":"sent",ackReceived:null!=t?t:void 0};else l={status:"sent",repeaterCount:null!=i?i:null!==(r=null==s?void 0:s.length)&&void 0!==r?r:0};for(let e=this._messages.length-1;e>=0;e--){const t=this._messages[e];if(t.id.startsWith("optimistic_")&&t.sender===o&&t.text===a){t.deliveryStatus=l,s&&(t.rxLogData=s),this._notify();break}}}!this._entityId||this._hasNewerMessages||this._hasOlderMessages||this._debouncedFetch(this._entityId)}else{if(o&&a){let t=a.replace(yn,"");const i=o+": ";t.startsWith(i)&&(t=t.substring(i.length));const r=e.timestamp||(new Date).toISOString(),s=new Date(r),n=function(e,t,i){return Hn(`${e}|${t}|${i}`).substring(0,12)}(r,o,t),l=`rt_${n}`,d=this._messages.some(e=>e.id===l||e.id===n);if(!d){const i=Un(t),r=e.rx_log_data,n={id:l,sender:o,text:t,timestamp:s,isOutgoing:!1,isSystem:!1,raw:a,mentions:i,rxLogData:r&&r.length>0?r:void 0,...jn(r)};this._messages.push(n),this._messages.sort((e,t)=>e.timestamp.getTime()-t.timestamp.getTime()),this._userAtBottom&&!this._hasNewerMessages||this._newMessagesWhileAway++,this._notify()}}!this._entityId||this._hasNewerMessages||this._hasOlderMessages||this._debouncedFetch(this._entityId)}}_debouncedFetch(e){this._fetchDebounce&&clearTimeout(this._fetchDebounce),this._fetchDebounce=setTimeout(async()=>{if(this._fetchDebounce=null,this._active)try{await this._fetchMessages(e)}catch(e){}},500)}_handleDeliveryUpdate(e){const t=e.rx_log_data;if(e.progressive&&t&&t.length>0){const i=e.sender_name,o=e.message,a=e.timestamp;if(i&&o){const e=a?new Date(a).getTime():0;for(let a=this._messages.length-1;a>=0;a--){const r=this._messages[a];if(!r.isOutgoing&&r.sender===i&&r.text===o&&(!e||Math.abs(r.timestamp.getTime()-e)<1e4))return r.rxLogData=t,r.repeaterCount=t.length,void this._notify()}}}const i=e.send_id,o=e.status,a=e.repeater_count,r=e.ack_received,s=e.round_trip_ms,n=e.progressive;if(!i)return;let l,d;l=o||(!0===r?"delivered":!n||void 0!==a&&0!==a?"sent":"waiting");for(let e=this._messages.length-1;e>=0;e--)if(this._messages[e].isOutgoing){d=this._messages[e];break}d&&(d.deliveryStatus={status:l,repeaterCount:a,ackReceived:r,roundTripMs:s},void 0!==a&&(d.repeaterCount=a),this._notify())}async _pollFetch(e){if(this._hass&&!this._hasNewerMessages)try{let i;for(let e=this._messages.length-1;e>=0;e--){const t=this._messages[e].id;if(!t.startsWith("rt_")&&!t.startsWith("optimistic_")){i=t;break}}const o={type:"hivefw_integration/get_stored_messages",entity_id:e,limit:50};i&&(o.after=i);const a=await this._hass.callWS(o);if(0===a.messages.length)return this._error=null,void(this._retryCount=0);const r=a.messages.map(qn),s=new Set(this._messages.map(e=>e.id)),n=r.filter(e=>!s.has(e.id));if(n.length>0){var t;const e=new Set(n.map(e=>e.id));this._messages=this._messages.filter(t=>!t.id.startsWith("rt_")||!e.has(t.id.substring(3))),this._messages=this._messages.filter(e=>!e.id.startsWith("optimistic_")||!n.some(t=>t.sender===e.sender&&t.text===e.text)),this._messages=[...this._messages,...n],this._messages.sort((e,t)=>e.timestamp.getTime()-t.timestamp.getTime());const i=null!==(t=this._config.max_messages)&&void 0!==t?t:500;this._messages.length>i&&(this._messages=this._messages.slice(-i),this._hasOlderMessages=!0),this._notify()}this._error=null,this._retryCount=0}catch(e){this._retryCount++}}_startPolling(e){const t=()=>{if(!this._active)return;const i=this._retryCount>=5?6e4:3e4;this._pollTimer=setTimeout(async()=>{if(this._active){try{await this._pollFetch(e)}catch(e){}t()}},i)};t()}_stopUpdates(){this._pollTimer&&(clearTimeout(this._pollTimer),this._pollTimer=null);for(const e of this._realtimeSubscriptions)e();this._realtimeSubscriptions=[]}_notify(){this._onChange&&this._onChange()}}let Gn=class extends hn{constructor(){super(...arguments),this.conversations=[],this.activeId=null,this.unreadCounts={},this.nodePrefix=null,this._activeFilter="all",this._filteredConversations=[],this._appsChannelId=null,this._appsPickerOpen=!1}connectedCallback(){super.connectedCallback(),this._loadAppsChannelPreference()}updated(e){e.has("nodePrefix")&&this._loadAppsChannelPreference(),(e.has("conversations")||e.has("_activeFilter")||e.has("_appsChannelId"))&&this._updateFiltered()}render(){const e=this._getAppsChannel(),t=this._channelConversations();return Ws(n||(n=ts`
    ...
    `),()=>this.dispatchEvent(new CustomEvent("refresh-channels-requested",{bubbles:!0,composed:!0})),this._appsPickerOpen?"true":"false",()=>{this._appsPickerOpen=!this._appsPickerOpen},e?this._renderConversation(e,0):Ws(l||(l=ts`<div class="apps-empty">Seleciona o canal usado por APPS/SOS na roda dentada.</div>`)),this._appsPickerOpen?Ws(d||(d=ts`
        ...
        `),null===this._appsChannelId?"active":"",()=>this._setAppsChannel(null),null===this._appsChannelId?"✓":"",t.map(e=>{const t=String(e.channel_idx),i=t===this._appsChannelId;return Ws(c||(c=ts`
                <button
                  class="apps-picker-item ${0}"
                  @click=${0}>
                  <span class="apps-picker-check">${0}</span>
  ...
  `)),is([fn({type:Array})],Gn.prototype,"conversations",void 0),is([fn({type:String})],Gn.prototype,"activeId",void 0),is([fn({attribute:!1})],Gn.prototype,"unread",void 0),is([fn({type:Object})],Gn.prototype,"unreadCounts",void 0),is([fn({type:String})],Gn.prototype,"nodePrefix",void 0),is([_n()],Gn.prototype,"_activeFilter",void 0),is([_n()],Gn.prototype,"_filteredConversations",void 0),is([_n()],Gn.prototype,"_appsChannelId",void 0),is([_n()],Gn.prototype,"_appsPickerOpen",void 0),Gn=is([vn("meshcore-conversation-list")],Gn);const Xn=["a[href]","button:not([disabled])",'input:not([disabled]):not([type="hidden"])',"select:not([disabled])","textarea:not([disabled])",'[tabindex]:not([tabindex="-1"])'].join(","),Qn=[];let Yn=!1;function Jn(){Yn||(Yn=!0,document.addEventListener("keydown",Zn,!0))}function Zn(e){0!==Qn.length&&Qn[Qn.length-1]._handleKeyDown(e)}class el{constructor(e,t){this.host=e,this.opts=t,this._wasOpen=!1,this._previousActive=null,this._inStack=!1,this.host.addController(this),Jn()}hostConnected(){Jn()}hostDisconnected(){this._inStack&&this._popStack(),this._previousActive=null,this._wasOpen=!1}hostUpdated(){const e=this.opts.isOpen();if(e&&!this._wasOpen)this._previousActive=this._currentDocumentActive(),this._pushStack(),this._focusFirstSoon();else if(!e&&this._wasOpen){this._popStack();const e=this._previousActive;if(this._previousActive=null,e&&e.isConnected&&"function"==typeof e.focus)try{e.focus()}catch(e){}}this._wasOpen=e}_pushStack(){this._inStack||(Qn.push(this),this._inStack=!0)}_popStack(){const e=Qn.indexOf(this);e>=0&&Qn.splice(e,1),this._inStack=!1}_getFocusables(){var e,t,i;const o=null!==(e=null===(t=(i=this.opts).getScope)||void 0===t?void 0:t.call(i))&&void 0!==e?e:this.host.shadowRoot;return o?Array.from(o.querySelectorAll(Xn)).filter(e=>!(e.hasAttribute("aria-hidden")||e.hidden||null===e.offsetParent&&0===e.getClientRects().length)):[]}_focusFirstSoon(){queueMicrotask(()=>{var e,t,i;if(!this.opts.isOpen())return;const o=null!==(e=null===(t=(i=this.opts).getScope)||void 0===t?void 0:t.call(i))&&void 0!==e?e:this.host.shadowRoot;if(o&&this._scopeContainsFocus(o))return;const a=this._getFocusables();if(0!==a.length)try{a[0].focus()}catch(e){}})}_scopeContainsFocus(e){let t=document.activeElement;for(;t;){if(t===e)return!0;if(e.host===t)return!0;if("contains"in e&&e.contains(t))return!0;const i=t.shadowRoot;if(!i||!i.activeElement)break;t=i.activeElement}return!1}_currentDocumentActive(){let e=document.activeElement;for(;e&&e.shadowRoot&&e.shadowRoot.activeElement;)e=e.shadowRoot.activeElement;return e}_handleKeyDown(e){var t,i,o;if(!this.opts.isOpen())return;if("Escape"===e.key)return e.preventDefault(),e.stopPropagation(),void this.opts.onEscape();if("Tab"!==e.key)return;const a=this._getFocusables();if(0===a.length)return;const r=null!==(t=null===(i=(o=this.opts).getScope)||void 0===i?void 0:i.call(o))&&void 0!==t?t:this.host.shadowRoot,s=r?this._findFocusedInScope(r):null,n=s?a.indexOf(s):-1;let l;l=e.shiftKey?n<=0?a.length-1:n-1:-1===n||n>=a.length-1?0:n+1,e.preventDefault(),e.stopPropagation();try{a[l].focus()}catch(e){}}_findFocusedInScope(e){let t=document.activeElement;for(;t;){if(e===t||"contains"in e&&e.contains(t)){if(t.shadowRoot&&t.shadowRoot.activeElement){t=t.shadowRoot.activeElement;continue}return t}if(e.host===t){t=e.activeElement;continue}const i=t.shadowRoot;if(!i||!i.activeElement)break;t=i.activeElement}return null}}function tl(e,t){new el(e,t)}let il=class extends hn{constructor(){super(),this.open=!1,this.narrow=!1,this.editMode=!1,this.initialChannelIdx=0,this.initialChannelName="",this.initialScope="",this.initialKey="",this.availableIndices=[],this._channelIdx=0,this._channelName="",this._customKey="",this._autoKey=!0,this._scope="",this._availableScopes=null,this._globalAllowed=!1,this._saving=!1,this._error=null,this._initialized=!1,tl(this,{isOpen:()=>this.open,onEscape:()=>this._onCancel()})}willUpdate(e){if(e.has("open")&&this.open&&!this._initialized){if(this.editMode){this._channelIdx=this.initialChannelIdx,this._channelName=this.initialChannelName,this._scope=this.initialScope;const e=Hn(this.initialChannelName).slice(0,32);this.initialKey&&this.initialKey.toLowerCase()!==e?(this._autoKey=!1,this._customKey=this.initialKey.toLowerCase()):(this._autoKey=!0,this._customKey="")}else{this._channelIdx=this.availableIndices.length>0?this.availableIndices[0]:0,this._channelName=this.initialChannelName||"",this._scope=this.initialScope||"";const e=this._channelName?Hn(this._channelName).slice(0,32):"";this.initialKey&&this.initialKey.toLowerCase()!==e?(this._autoKey=!1,this._customKey=this.initialKey.toLowerCase()):(this._autoKey=!0,this._customKey="")}this._initialized=!0,this._loadScopes()}e.has("open")&&!this.open&&(this._initialized=!1),!this.editMode&&this.open&&e.has("availableIndices")&&this.availableIndices.length>0&&!this.availableIndices.includes(this._channelIdx)&&(this._channelIdx=this.availableIndices[0])}async _loadScopes(){if(this._availableScopes=null,!this.hass)return this._availableScopes=[],void(this._globalAllowed=!1);const e=await zn(this.hass,this.entryId);this._availableScopes=e.scopes,this._globalAllowed=e.global}render(){if(!this.open)return;const e=this._customKey.length,t=32===e||0===e||this._autoKey;return Ws(f||(f=ts`
    ...
    `),this._onOverlayClick,this.editMode?"Edit channel":"Add channel",this.editMode?"Edit Channel":"Add Channel",this._error?Ws(_||(_=ts`<div style="padding: 12px; background: rgba(219, 68, 55, 0.1); border-radius: 6px; color: var(--error-color, #db4437); font-size: 13px; margin-bottom: 16px;">
                  ${0}
                </div>`),this._error):"",this.editMode?Ws(b||(b=ts`
                    <select class="form-select" disabled>
                      <option value=${0} selected>${0}</option>
                    </select>`),this._channelIdx,this._channelIdx):Ws(y||(y=ts`
                    <select
                      class="form-select"
                      @change=${0}>
                      ${0}
                    </select>`),e=>{this._channelIdx=parseInt(e.target.value,10)},this.availableIndices.map(e=>Ws(x||(x=ts`
                        <option value=${0} ?selected=${0}>${0}</option>
                      `),e,e===this._channelIdx,e))),this.editMode?"Channel index cannot be changed":"Select an available channel slot",this._channelName,e=>{this._channelName=e.target.value},this._renderScopeField(),this._autoKey,e=>{this._autoKey=e.target.checked},this._autoKey?"":Ws(w||(w=ts`
                  <div class="form-group">
                ...
                `),this._customKey,e=>{const t=e.target.value.toLowerCase().replace(/[^a-f0-9]/g,"");this._customKey=t.slice(0,32)},this._customKey.length,t?"Valid hex key (16 bytes / 128-bit AES)":`Invalid: expected 32 characters, got ${e}`),this._saving,this._onCancel,!this._channelName||this._saving||!this._autoKey&&!t||!this.editMode&&0===this.availableIndices.length,this._onSave,this._saving?"Saving...":"Save")}_renderScopeField(){const e=this._availableScopes;if(null===e)return Ws($||($=ts`
        <select class="form-select scope-select" disabled>
          <option selected>Loading…</option>
        </select>
      `));const t=this._globalAllowed?"*":"",i=!this._scope||"*"===this._scope,o=!!this._scope&&"*"!==this._scope&&!e.includes(this._scope);return 0!==e.length||o||this._globalAllowed?Ws(S||(S=ts`
      <select
    ...
    `),e=>{this._scope=e.target.value},t,i,o?Ws(C||(C=ts`<option value=${0} selected>${0} (not in allowlist)</option>`),this._scope,this._scope):"",e.map(e=>Ws(M||(M=ts`
            <option value=${0} ?selected=${0}>${0}</option>
          `),e,e===this._scope,e))):Ws(k||(k=ts`
        <select class="form-select scope-select" disabled>
    ...
    `))],is([fn({type:Boolean})],il.prototype,"open",void 0),is([fn({type:Object})],il.prototype,"hass",void 0),is([fn({type:String})],il.prototype,"entryId",void 0),is([fn({type:Boolean})],il.prototype,"narrow",void 0),is([fn({type:Boolean})],il.prototype,"editMode",void 0),is([fn({type:Number})],il.prototype,"initialChannelIdx",void 0),is([fn({type:String})],il.prototype,"initialChannelName",void 0),is([fn({type:String})],il.prototype,"initialScope",void 0),is([fn({type:String})],il.prototype,"initialKey",void 0),is([fn({type:Array})],il.prototype,"availableIndices",void 0),is([_n()],il.prototype,"_channelIdx",void 0),is([_n()],il.prototype,"_channelName",void 0),is([_n()],il.prototype,"_customKey",void 0),is([_n()],il.prototype,"_autoKey",void 0),is([_n()],il.prototype,"_scope",void 0),is([_n()],il.prototype,"_availableScopes",void 0),is([_n()],il.prototype,"_globalAllowed",void 0),is([_n()],il.prototype,"_saving",void 0),is([_n()],il.prototype,"_error",void 0),il=is([vn("meshcore-channel-dialog")],il);let ol=class extends hn{willUpdate(){this._tabInitialized||(this._tabInitialized=!0,this.initialTab&&(this._activeTab=this.initialTab))}constructor(){super(),this.narrow=!1,this._tabInitialized=!1,this._activeTab="contacts",this._contacts=[],this._channels=[],this._searchQuery="",this._categoryFilter="all",this._typeFilter="all",this._loading=!1,this._actionInProgress=null,this._confirmingRemoveContact=null,this._confirmingRemoveChannel=null,this._channelDialogOpen=!1,this._editingChannel=null,this._suggestedChannelName="",this._suggestedChannelKey="",this._maxChannels=4,tl(this,{isOpen:()=>!0,onEscape:()=>this._close()})}connectedCallback(){super.connectedCallback(),this._loadData()}render(){var e,t,i,o,a,r,s,n;return Ws(R||(R=ts`
      ...
      ${0}
    `),e=>e.stopPropagation(),this._close,"contacts"===this._activeTab?"active":"",()=>this._switchTab("contacts"),"channels"===this._activeTab?"active":"",()=>this._switchTab("channels"),"contacts"===this._activeTab?Ws(z||(z=ts`
            ...
            `),["all","added","discovered"].map(e=>Ws(I||(I=ts`
                      <button
                        class="filter-chip ${0}"
                        @click=${0}
                      >
                    ...
                    `),this._categoryFilter===e?"active":"",()=>{this._categoryFilter=e},"all"===e?"All":"added"===e?"Added":"Discovered")),["all","clients","repeaters"].map(e=>Ws(T||(T=ts`
                      <button
                        class="filter-chip ${0}"
                        @click=${0}
                      >
                    ...
                    `),this._typeFilter===e?"active":"",()=>{this._typeFilter=e},"all"===e?"All":"clients"===e?"Clients":"Repeaters")),this._searchQuery,e=>{this._searchQuery=e.target.value}):"",this._loading?Ws(N||(N=ts`<div class="loading-state">
                <div class="loading-spinner"></div>
                Loading...
              </div>`)):"contacts"===this._activeTab?this._renderContacts():this._renderChannels(),this._channelDialogOpen?Ws(F||(F=ts`
    ...
    `),t,e.adv_name||"Unknown",e.pubkey_prefix,i?"added":"discovered",i?Ws(O||(O=ts`<svg viewBox="0 0 24 24" width="10" height="10" fill="currentColor" style="vertical-align: -1px; margin-right: 2px;"><path d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z"/></svg>Added`)):"Discovered",o?Ws(P||(P=ts`
            ...
            `),()=>this._doRemoveContact(e),()=>{this._confirmingRemoveContact=null}):i?Ws(B||(B=ts`
                <button
              ...
              `),a,()=>{this._confirmingRemoveContact=e.public_key},a?"...":"Remove"):Ws(L||(L=ts`
                <button
              ...
              `),a,()=>this._doAddContact(e),a?"...":Ws(H||(H=ts`<svg viewBox="0 0 24 24" width="12" height="12" fill="currentColor" style="vertical-align: -1px; margin-right: 4px;"><path d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z"/></svg>Add`))))}_renderChannels(){if(0===this._channels.length)return Ws(U||(U=ts`
        <div class="empty-state">
      ...
      `),this._openAddChannel);const e=this._confirmingRemoveChannel;return Ws(j||(j=ts`
      ${0}
      <button class="add-channel-btn" @click=${0}>
        + Add Channel
      </button>
    `),this._channels.map(t=>{const i=e===t.channel_idx,o=this._actionInProgress===`ch-${t.channel_idx}`;return Ws(q||(q=ts`
        ...
        `),t.name,t.channel_idx,t.scope?Ws(V||(V=ts` · scope: ${0}`),t.scope):"",i?Ws(W||(W=ts`
                  <div class="confirm-inline">
                    <span class="confirm-text">Remove?</span>
                    <button class="confirm-btn yes" @click=${0}>Yes</button>
                    <button class="confirm-btn no" @click=${0}>No</button>
                  </div>
                `),()=>this._doRemoveChannel(t),()=>{this._confirmingRemoveChannel=null}):Ws(K||(K=ts`
  ...
  `)),is([fn({type:Object})],ol.prototype,"hass",void 0),is([fn({type:String})],ol.prototype,"entryId",void 0),is([fn({type:Boolean})],ol.prototype,"narrow",void 0),is([fn({type:String})],ol.prototype,"initialTab",void 0),is([_n()],ol.prototype,"_activeTab",void 0),is([_n()],ol.prototype,"_contacts",void 0),is([_n()],ol.prototype,"_channels",void 0),is([_n()],ol.prototype,"_searchQuery",void 0),is([_n()],ol.prototype,"_categoryFilter",void 0),is([_n()],ol.prototype,"_typeFilter",void 0),is([_n()],ol.prototype,"_loading",void 0),is([_n()],ol.prototype,"_actionInProgress",void 0),is([_n()],ol.prototype,"_confirmingRemoveContact",void 0),is([_n()],ol.prototype,"_confirmingRemoveChannel",void 0),is([_n()],ol.prototype,"_channelDialogOpen",void 0),is([_n()],ol.prototype,"_editingChannel",void 0),is([_n()],ol.prototype,"_suggestedChannelName",void 0),is([_n()],ol.prototype,"_suggestedChannelKey",void 0),is([_n()],ol.prototype,"_maxChannels",void 0),ol=is([vn("meshcore-manage-dialog")],ol);let al=class extends hn{constructor(){super(),this.timestampFormat="relative",this._selectedMessage=null,tl(this,{isOpen:()=>null!==this._selectedMessage,onEscape:()=>{this._selectedMessage=null},getScope:()=>{var e;return null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector(".message-dialog")}})}render(){return this.group?Ws(X||(X=ts`
    ...
    `),()=>{this._selectedMessage=null},e=>e.stopPropagation(),e.text,()=>this._copyText(e.text),e.isOutgoing||e.isSystem?Ws(ce||(ce=ts``)):Ws(de||(de=ts`
                <button class="message-dialog-action" @click=${0}>
              ...
              `),()=>this._replyToSender(e.sender)),i?Ws(pe||(pe=ts`
  ...
  `)),is([fn({type:Object})],al.prototype,"group",void 0),is([fn({type:Object})],al.prototype,"message",void 0),is([fn({type:String})],al.prototype,"timestampFormat",void 0),is([_n()],al.prototype,"_selectedMessage",void 0),al=is([vn("meshcore-message-bubble")],al);let rl=class extends hn{constructor(){super(),this._query="",this._fromDate="",this._toDate="",this._results=[],this._totalCount=0,this._searching=!1,this._hasSearched=!1,this._showFilters=!1,this._debounceTimer=null,tl(this,{isOpen:()=>!0,onEscape:()=>this.dispatchEvent(new CustomEvent("search-close",{bubbles:!0,composed:!0}))})}render(){return Ws(me||(me=ts`
    ...
    `),this._query,this._onQueryInput,this._showFilters?"active":"",()=>{this._showFilters=!this._showFilters},this._showFilters?Ws(fe||(fe=ts`
              <div class="filters">
                <input
                  class="filter-input"
                  type="date"
            ...
            `),this._fromDate,e=>{this._fromDate=e.target.value,this._doSearch()},this._toDate,e=>{this._toDate=e.target.value,this._doSearch()}):"",this._hasSearched?Ws(_e||(_e=ts`<div class="result-count">${0} result${0}</div>`),this._totalCount,1!==this._totalCount?"s":""):"",this._searching?Ws(be||(be=ts`<div class="loading-state">Searching...</div>`)):this._hasSearched?0===this._results.length?Ws(xe||(xe=ts`
                  <div class="empty-state">
                ...
                `)):this._results.map(e=>this._renderResult(e)):Ws(ye||(ye=ts`
                <div class="empty-state">
              ...
              `)))}_renderResult(e){const t=new Date(e.timestamp),i=t.toLocaleDateString(void 0,{month:"short",day:"numeric"}),o=t.toLocaleTimeString(void 0,{hour:"2-digit",minute:"2-digit"}),a=this._highlightQuery(e.text);return Ws(we||(we=ts`
  ...
  `)),is([fn({type:Object})],rl.prototype,"hass",void 0),is([fn({type:String})],rl.prototype,"entryId",void 0),is([fn({type:String})],rl.prototype,"entityId",void 0),is([fn({type:String})],rl.prototype,"meshNodeName",void 0),is([_n()],rl.prototype,"_query",void 0),is([_n()],rl.prototype,"_fromDate",void 0),is([_n()],rl.prototype,"_toDate",void 0),is([_n()],rl.prototype,"_results",void 0),is([_n()],rl.prototype,"_totalCount",void 0),is([_n()],rl.prototype,"_searching",void 0),is([_n()],rl.prototype,"_hasSearched",void 0),is([_n()],rl.prototype,"_showFilters",void 0),rl=is([vn("meshcore-message-search")],rl);let sl=class extends hn{constructor(){super(...arguments),this.conversations=[],this.selectedId=null,this.narrow=!1,this.lastRead={},this._messageStore=null,this._unsubUnread=null,this._inputText="",this._sending=!1,this._viewportNarrow=!1,this._mediaQuery=null,this._mediaHandler=null,this._narrowShowMessages=!1,this._manageOpen=!1,this._manageInitialTab="contacts",this._searchOpen=!1,this._currentEntityId=null,this._conversationResolved=!1,this._pendingScroll=null,this._scrollInFlight=!1,this._scrollGuardUntil=0,this._lastMessageCount=0}get _isNarrow(){return this.narrow||this._viewportNarrow}connectedCallback(){super.connectedCallback(),this.config&&!this._messageStore&&(this._messageStore=new Kn(this.config),this._messageStore.setOnChange(()=>this.requestUpdate())),this.unread&&!this._unsubUnread&&(this._unsubUnread=this.unread.subscribe(()=>{this.lastRead=this.unread.lastRead,this.requestUpdate()}),this.lastRead=this.unread.lastRead,this.unread.onPostSwitchTimerFire(()=>this._checkAndMarkReadIfAtBottom())),this._mediaQuery=window.matchMedia("(max-width: 870px)"),this._viewportNarrow=this._mediaQuery.matches,this._mediaHandler=e=>{this._viewportNarrow=e.matches},this._mediaQuery.addEventListener("change",this._mediaHandler)}disconnectedCallback(){var e;super.disconnectedCallback(),this._messageStore&&(this._messageStore.destroy(),this._messageStore=null),this._unsubUnread&&(this._unsubUnread(),this._unsubUnread=null),null===(e=this.unread)||void 0===e||e.endConversation(),this._mediaQuery&&this._mediaHandler&&(this._mediaQuery.removeEventListener("change",this._mediaHandler),this._mediaQuery=null,this._mediaHandler=null)}updated(e){if(e.has("hass")&&this.hass&&this._messageStore&&this._messageStore.setHass(this.hass),e.has("config")&&this.config&&this._messageStore){this._messageStore.setConfig(this.config);const t=e.get("config");t&&t.entry_id!==this.config.entry_id&&(this.selectedId=null,this._currentEntityId=null,this._conversationResolved=!1,this._pendingScroll=null,this._lastMessageCount=0,this.unread.endConversation(),this._messageStore.switchEntity(null),this.dispatchEvent(new CustomEvent("active-entity-changed",{detail:{entityId:null},bubbles:!0,composed:!0})))}if(e.has("selectedId")&&this._onConversationSelected(),e.has("lastRead")&&this._currentEntityId&&this._conversationResolved&&null===this._pendingScroll&&this.unread.maybeReanchorOnLateData(this._currentEntityId)&&(this._pendingScroll="last-read"),this._pendingScroll){const e=this._messageStore,t=e&&!e.loading;t&&e.messages.length>0?(this._executeScroll(this._pendingScroll),this._pendingScroll=null,this._lastMessageCount=e.messages.length):t&&0===e.messages.length&&(this._pendingScroll=null)}else if(this._messageStore){const e=this._messageStore.messages.length;e>this._lastMessageCount&&this._lastMessageCount>0&&this._scrollToBottomIfNearEnd(),this._lastMessageCount=e}}render(){var e,t,i,o,a,r;return this._isNarrow?this._narrowShowMessages?Ws(Se||(Se=ts`
        ...
        `),()=>this._narrowShowMessages=!1,this._getConversationName(),this._renderScopeChip(),()=>{this._searchOpen=!this._searchOpen},this._renderChatArea()):Ws(Ce||(Ce=ts`
        ...
        `),this.conversations,this.selectedId,this.unread,this.unread.counts,(null===(a=this.config)||void 0===a?void 0:a.node_prefix)||null,e=>{const t=e.detail.id;t===this.selectedId&&(this.unread.resetUnreadCountAtSelection(),this._pendingScroll="bottom"),this.selectedId=t,this._narrowShowMessages=!0},e=>this._onManageRequested(e),this._manageOpen?Ws(Me||(Me=ts`
              <meshcore-manage-dialog
                ...
                @channels-changed=${0}
              ></meshcore-manage-dialog>
            `),this.hass,null===(r=this.config)||void 0===r?void 0:r.entry_id,this.narrow,this._manageInitialTab,()=>this._manageOpen=!1,this._onContactsChanged,this._onChannelsChanged):Ws(Ae||(Ae=ts``))):Ws(Re||(Re=ts`
      <div class="chat-layout">
        <meshcore-conversation-list
          .conversations=${0}
          .activeId=${0}
    ...
    `),this.conversations,this.selectedId,this.unread,this.unread.counts,(null===(e=this.config)||void 0===e?void 0:e.node_prefix)||null,e=>{const t=e.detail.id;t===this.selectedId&&(this.unread.resetUnreadCountAtSelection(),this._pendingScroll="bottom"),this.selectedId=t},e=>this._onManageRequested(e),this.selectedId?Ws(ze||(ze=ts`
          ...
          `),this._getConversationName(),this._renderScopeChip(),()=>{this._searchOpen=!this._searchOpen}):"",this._renderChatArea(),this._searchOpen?Ws(Ie||(Ie=ts`
        ...
        `),this.hass,null===(t=this.config)||void 0===t?void 0:t.entry_id,this._currentEntityId||void 0,null===(i=this.config)||void 0===i?void 0:i.node_name,this._onSearchResultSelected,()=>{this._searchOpen=!1}):"",this._manageOpen?Ws(Te||(Te=ts`
          <meshcore-manage-dialog
            .hass=${0}
            .entryId=${0}
            .narrow=${0}
            ...
            @channels-changed=${0}
          ></meshcore-manage-dialog>
        `),this.hass,null===(o=this.config)||void 0===o?void 0:o.entry_id,this.narrow,this._manageInitialTab,()=>this._manageOpen=!1,this._onContactsChanged,this._onChannelsChanged):Ws(Ne||(Ne=ts``)))}_renderChatArea(){var e,t,i,o,a,r;if(!this._messageStore||!this.selectedId)return Ws(Fe||(Fe=ts`
        <div class="empty-state">
      ...
      `));if(!this._conversationResolved)return Ws(De||(De=ts`
        <div class="empty-state">
    ...
    `),this._onReplyToSender,this._onChatScroll,this._messageStore.loadingOlder?Ws(Oe||(Oe=ts`<div class="loading-older"><div class="loading-spinner"></div></div>`)):Ws(Pe||(Pe=ts``)),this._messageStore.error?Ws(Be||(Be=ts`
            ...
            `),this._messageStore.error):Ws(Le||(Le=ts``)),this._messageStore.loading&&0===s.length?Ws(He||(He=ts`
              <div class="loading-state">
                <div class="loading-spinner"></div>
                Loading messages...
              </div>
            `)):Ws(Ue||(Ue=ts``)),0!==n.length||this._messageStore.loading?Ws(qe||(qe=ts``)):Ws(je||(je=ts`
              <div class="empty-state">
  ...
  `)),is([fn({type:Object})],sl.prototype,"hass",void 0),is([fn({type:Object})],sl.prototype,"config",void 0),is([fn({type:Array})],sl.prototype,"conversations",void 0),is([fn({type:String})],sl.prototype,"selectedId",void 0),is([fn({type:Boolean})],sl.prototype,"narrow",void 0),is([fn({attribute:!1})],sl.prototype,"unread",void 0),is([fn({type:Object})],sl.prototype,"lastRead",void 0),is([_n()],sl.prototype,"_messageStore",void 0),is([_n()],sl.prototype,"_inputText",void 0),is([_n()],sl.prototype,"_sending",void 0),is([_n()],sl.prototype,"_viewportNarrow",void 0),is([_n()],sl.prototype,"_narrowShowMessages",void 0),is([_n()],sl.prototype,"_manageOpen",void 0),is([_n()],sl.prototype,"_manageInitialTab",void 0),is([_n()],sl.prototype,"_searchOpen",void 0),is([_n()],sl.prototype,"_currentEntityId",void 0),is([_n()],sl.prototype,"_conversationResolved",void 0),is([_n()],sl.prototype,"_pendingScroll",void 0),sl=is([vn("hivefw-integration-page")],sl);let nl=class extends hn{constructor(){super(...arguments),this.selected=!1}render(){if(!this.contact)return Ws(et||(et=ts``));const e=this.contact,t=this._getTypeClass(e.type),{label:i,cls:o}=this._getCategoryBadge(e),a=`contact-card ${e.age_bucket?`age-${e.age_bucket}`:"age-stale"}${this.selected?" selected":""}`,r=Array.isArray(e.tags)?e.tags:[];return Ws(tt||(tt=ts`
    ...
    `),a,t,this._getTypeIcon(e.type),e.favorite?"★ ":"",e.adv_name,e.pubkey_prefix,e.lastmod?`Last heard ${new Date(1e3*e.lastmod).toLocaleString()}`:"",r.length?Ws(it||(it=ts`<div class="contact-tags">
                ${0}
              </div>`),r.slice(0,3).map(e=>Ws(ot||(ot=ts`<span class="contact-tag">#${0}</span>`),e))):Ws(at||(at=ts``)),o,i)}_getCategoryBadge(e){return e.added_to_node?{label:"Added",cls:"added"}:{label:"Discovered",cls:"discovered"}}_getTypeClass(e){switch(e){case 1:return"client";case 2:return"repeater";case 3:return"room-server";case 4:return"sensor";default:return"unknown"}}_getTypeIcon(e){switch(e){case 0:case 1:return Ws(rt||(rt=ts`<svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor"><path d="M17 1.01L7 1c-1.1 0-2 .9-2 2v18c0 1.1.9 2 2 2h10c1.1 0 2-.9 2-2V3c0-1.1-.9-1.99-2-1.99zM17 19H7V5h10v14z"/></svg>`));case 2:return Ws(st||(st=ts`<svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor"><path d="M12 5c-3.87 0-7 3.13-7 7h2c0-2.76 2.24-5 5-5s5 2.24 5 5h2c0-3.87-3.13-7-7-7zm0-4C5.93 1 1 5.93 1 12h2c0-4.97 4.03-9 9-9s9 4.03 9 9h2c0-6.07-4.93-11-11-11zm0 8c-1.66 0-3 1.34-3 3s1.34 3 3 3 3-1.34 3-3-1.34-3-3-3z"/></svg>`));case 3:return Ws(nt||(nt=ts`<svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor"><path d="M20 2H4c-1.1 0-2 .9-2 2v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm0 14H6l-2 2V4h16v12z"/></svg>`));case 4:return Ws(lt||(lt=ts`<svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z"/></svg>`));default:return Ws(dt||(dt=ts`<svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor"><path d="M17 1.01L7 1c-1.1 0-2 .9-2 2v18c0 1.1.9 2 2 2h10c1.1 0 2-.9 2-2V3c0-1.1-.9-1.99-2-1.99zM17 19H7V5h10v14z"/></svg>`))}}};nl.styles=ls(ct||(ct=ts`
    :host {
      display: block;
      height: 100%;
    }
  ...
  `)),is([fn({type:Object})],nl.prototype,"contact",void 0),is([fn({type:Boolean})],nl.prototype,"selected",void 0),nl=is([vn("meshcore-contact-card")],nl);let ll=class extends hn{constructor(){super(),this.open=!1,this.pendingAction=null,this._confirming=!1,this._confirmAction=null,tl(this,{isOpen:()=>this.open,onEscape:()=>{this._confirming?(this._confirming=!1,this._confirmAction=null):this._close()}})}render(){if(!this.open||!this.node)return Ws(pt||(pt=ts``));const e="adv_name"in this.node,t=e?2===this.node.type:"repeater"===this.node.type,i=e&&3===this.node.type,o=e?1===this.node.type:"client"===this.node.type,a=e&&4===this.node.type,r=e?this.node.adv_name:this.node.name,s=this.node.pubkey_prefix;let n=Ws(ht||(ht=ts`<svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor"><path d="M16 11c1.66 0 2.99-1.34 2.99-3S17.66 5 16 5c-1.66 0-3 1.34-3 3s1.34 3 3 3zm-8 0c1.66 0 2.99-1.34 2.99-3S9.66 5 8 5C6.34 5 5 6.34 5 8s1.34 3 3 3zm0 2c-2.33 0-7 1.17-7 3.5V19h14v-2.5c0-2.33-4.67-3.5-7-3.5zm8 0c-.29 0-.62.02-.97.05 1.16.84 1.97 1.97 1.97 3.45V19h6v-2.5c0-2.33-4.67-3.5-7-3.5z"/></svg>`)),l="Contact",d="";return t?(n=Ws(ut||(ut=ts`<svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor"><path d="M12 5c-3.87 0-7 3.13-7 7h2c0-2.76 2.24-5 5-5s5 2.24 5 5h2c0-3.87-3.13-7-7-7zm0-4C5.93 1 1 5.93 1 12h2c0-4.97 4.03-9 9-9s9 4.03 9 9h2c0-6.07-4.93-11-11-11zm0 8c-1.66 0-3 1.34-3 3s1.34 3 3 3 3-1.34 3-3-1.34-3-3-3z"/></svg>`)),l="Repeater",d="repeater"):i?(n=Ws(vt||(vt=ts`<svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor"><path d="M20 2H4c-1.1 0-2 .9-2 2v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm0 14H6l-2 2V4h16v12z"/></svg>`)),l="Room Server",d="room-server"):a?(n=Ws(gt||(gt=ts`<svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z"/></svg>`)),l="Sensor",d="sensor"):o&&(n=Ws(mt||(mt=ts`<svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor"><path d="M17 1.01L7 1c-1.1 0-2 .9-2 2v18c0 1.1.9 2 2 2h10c1.1 0 2-.9 2-2V3c0-1.1-.9-1.99-2-1.99zM17 19H7V5h10v14z"/></svg>`)),l="Client",d="client"),Ws(ft||(ft=ts`
    ...
    `),this._close,r,e=>e.stopPropagation(),`dialog-avatar ${d}`,n,r,l,this._close,this._confirming?Ws(_t||(_t=ts`
                ...
                `),"remove-contact"===this._confirmAction?"Remove this as an Added Contact?":"","remove-contact"===this._confirmAction?Ws(bt||(bt=ts`
                      <div class="confirm-description">Removing the contact will make it a Discovered Contact.</div>
                    `)):Ws(yt||(yt=ts``)),()=>this._confirmAction_exec(),()=>{this._confirming=!1,this._confirmAction=null}):Ws(xt||(xt=ts`
                  <div class="section">
                ...
                `),e?"":"full",e&&this.node.added_to_node&&(o||i)?Ws(wt||(wt=ts`
                      ...
                      `),()=>this._dispatchEvent("message")):Ws($t||($t=ts``)),s&&!o?Ws(kt||(kt=ts`
                      ...
                      `),()=>this._dispatchEvent("trace")):Ws(St||(St=ts``)),e&&this.node.added_to_node?Ws(Ct||(Ct=ts`<button class="action-btn warning"
                            ?disabled=${0}
                            @click=${0}>${0}</button>`),"remove-contact"===this.pendingAction,()=>{this._confirming=!0,this._confirmAction="remove-contact"},"remove-contact"===this.pendingAction?"Removing…":"Remove Contact"):e?Ws(Mt||(Mt=ts`<button class="action-btn"
                            ?disabled=${0}
                            @click=${0}>${0}</button>`),"add-contact"===this.pendingAction,()=>this._dispatchEvent("add-contact"),"add-contact"===this.pendingAction?Ws(At||(At=ts`Adding…`)):Ws(Rt||(Rt=ts`<svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor"><path d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z"/></svg>Add Contact`))):Ws(zt||(zt=ts``)),s,l,e?Ws(It||(It=ts`
                        <div class="info-item">
                      ...
                      `),this.node.last_advert?new Date(1e3*this.node.last_advert).toLocaleString():"Unknown",this.node.added_to_node?"Added Contact":"Discovered Contact"):Ws(Tt||(Tt=ts``)),!e||0===this.node.adv_lat&&0===this.node.adv_lon?Ws(Ft||(Ft=ts``)):Ws(Nt||(Nt=ts`
                        <div class="section">
                      ...
                      `),this.node.adv_lat.toFixed(6),this.node.adv_lon.toFixed(6)),e&&this.node.out_path?Ws(Dt||(Dt=ts`
                        <div class="section">
  ...
  `)),is([fn({type:Object})],ll.prototype,"node",void 0),is([fn({type:Boolean})],ll.prototype,"open",void 0),is([fn({type:Object})],ll.prototype,"hass",void 0),is([fn({type:String})],ll.prototype,"pendingAction",void 0),is([_n()],ll.prototype,"_confirming",void 0),is([_n()],ll.prototype,"_confirmAction",void 0),ll=is([vn("meshcore-node-detail-dialog")],ll);const dl={clients:1,repeaters:2,room_servers:3,sensors:4},cl={clients:"Clients",repeaters:"Repeaters",room_servers:"Room Servers",sensors:"Sensors"};let pl=class extends hn{constructor(){super(...arguments),this.contacts=[],this.channels=[],this.narrow=!1,this._viewportNarrow=!1,this._mapReady=void 0!==customElements.get("ha-map"),this._mapFocusId="",this._mapMarkerElements=new Map,this._primaryFilter="all",this._typeFilter=null,this._searchQuery="",this._activityFilter="all",this._displayedContacts=[],this._totalCount=0,this._typeCounts={clients:0,repeaters:0,room_servers:0,sensors:0},this._l1Counts={all:0,added:0,discovered:0},this._loading=!1,this._nodeDetailDialogOpen=!1,this._pendingAction=null,this._sortBy="last_heard",this._onMediaChange=e=>{this._viewportNarrow=e.matches},this._onImportFile=async e=>{var t;if(!this.hass)return;const i=e.target,o=null===(t=i.files)||void 0===t?void 0:t[0];if(o)try{var a;const e=JSON.parse(await o.text());if(!Array.isArray(e.discovered_contacts))return void window.alert("Ficheiro inválido: falta discovered_contacts.");const t=await async function(e,t,i){const o={type:"hivefw_integration/import_contacts",contacts:t};return i&&(o.entry_id=i),e.callWS(o)}(this.hass,e.discovered_contacts,null===(a=this.config)||void 0===a?void 0:a.entry_id);await Promise.all([this._loadPage(!0),this._loadCounts()]),this.dispatchEvent(new CustomEvent("contacts-changed",{bubbles:!0,composed:!0})),window.alert(`Importação concluída: ${t.imported} novos, ${t.skipped_existing} já existentes`+(t.invalid?`, ${t.invalid} inválidos.`:"."))}catch(e){console.error("Failed to import contacts:",e),window.alert("Não foi possível importar este ficheiro.")}finally{i.value=""}}}connectedCallback(){super.connectedCallback(),this._mediaQuery=window.matchMedia("(max-width: 870px)"),this._viewportNarrow=this._mediaQuery.matches,this._mediaQuery.addEventListener("change",this._onMediaChange),this._loadCounts(),this._loadPage(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),null===(e=this._mediaQuery)||void 0===e||e.removeEventListener("change",this._onMediaChange),this._searchTimer&&(clearTimeout(this._searchTimer),this._searchTimer=void 0)}get _isNarrow(){return this.narrow||this._viewportNarrow}updated(e){super.updated(e),this._isNarrow?this.setAttribute("narrow",""):this.removeAttribute("narrow"),e.has("config")&&(this._displayedContacts=[],this._totalCount=0,this._loadCounts(),this._loadPage(!0))}render(){return Ws(Lt||(Lt=ts`
    ...
    `),a,()=>this._setPrimaryFilter(e),t,i)}_renderL2Buttons(){return["clients","repeaters","room_servers","sensors"].filter(e=>this._typeCounts[e]>0).map(e=>{const t=this._typeFilter===e;return Ws(Kt||(Kt=ts`
      ...
      ${0}
    `),this._displayedContacts.map(e=>Ws(Qt||(Qt=ts`
          <div @click=${0}>
  ...
  `)),is([fn({type:Array})],pl.prototype,"contacts",void 0),is([fn({type:Array})],pl.prototype,"channels",void 0),is([fn({type:Boolean})],pl.prototype,"narrow",void 0),is([fn({type:Object})],pl.prototype,"hass",void 0),is([fn({type:Object})],pl.prototype,"config",void 0),is([_n()],pl.prototype,"_viewportNarrow",void 0),is([_n()],pl.prototype,"_mapReady",void 0),is([_n()],pl.prototype,"_mapFocusId",void 0),is([_n()],pl.prototype,"_primaryFilter",void 0),is([_n()],pl.prototype,"_typeFilter",void 0),is([_n()],pl.prototype,"_searchQuery",void 0),is([_n()],pl.prototype,"_activityFilter",void 0),is([_n()],pl.prototype,"_displayedContacts",void 0),is([_n()],pl.prototype,"_totalCount",void 0),is([_n()],pl.prototype,"_typeCounts",void 0),is([_n()],pl.prototype,"_l1Counts",void 0),is([_n()],pl.prototype,"_loading",void 0),is([_n()],pl.prototype,"_selectedNode",void 0),is([_n()],pl.prototype,"_nodeDetailDialogOpen",void 0),is([_n()],pl.prototype,"_pendingAction",void 0),is([_n()],pl.prototype,"_sortBy",void 0),pl=is([vn("meshcore-nodes-page")],pl);const vl={battery_pct:{displayMin:0,displayMax:100,direction:"higher_better",classify:e=>e<20?"bad":e<50?"warn":"good",tooltip:"Green ≥ 50%, Yellow 20–50%, Red < 20% (critical < 10%). Home Assistant low-battery convention.",source:"https://community.home-assistant.io/t/low-battery-level-detection-notification-for-all-battery-sensors/258664"},rssi:{displayMin:-130,displayMax:-30,direction:"higher_better",classify:e=>e<-115?"bad":e<-100?"warn":"good",tooltip:"Green > −100 dBm, Yellow −100 to −115 dBm, Red < −115 dBm. Lower (more negative) RSSI means a weaker received signal.",source:"https://www.thethingsnetwork.org/docs/lorawan/rssi-and-snr/"},snr:{displayMin:-20,displayMax:20,direction:"higher_better",classify:e=>e<-7?"bad":e<0?"warn":"good",tooltip:"Green > 0 dB, Yellow −7 to 0 dB, Red < −7 dB. Demodulation floor is spreading-factor dependent (Semtech AN1200.13).",source:"https://www.openhacks.com/uploadsproductos/loradesignguide_std.pdf"},noise_floor:{displayMin:-130,displayMax:-90,direction:"lower_better",classify:e=>e>-105?"bad":e>-115?"warn":"good",tooltip:"Green < −115 dBm, Yellow −115 to −105 dBm, Red > −105 dBm. Above −105 dBm typically indicates man-made RF interference, not thermal noise.",source:"https://www.openhacks.com/uploadsproductos/loradesignguide_std.pdf"},tx_airtime_util:{displayMin:0,displayMax:20,direction:"lower_better",classify:e=>e>10?"bad":e>2?"warn":"good",tooltip:"Green < 2%, Yellow 2–10%, Red > 10%. EU868 sub-band 1% / general 10% duty-cycle ceiling (ETSI EN 300 220-2; eCFR 47 CFR 15.247).",source:"https://www.etsi.org/deliver/etsi_en/300200_300299/30022002/03.03.01_60/en_30022002v030301p.pdf"},rx_airtime_util:{displayMin:0,displayMax:100,direction:"lower_better",classify:e=>e>50?"bad":e>25?"warn":"good",tooltip:"Green < 25%, Yellow 25–50%, Red > 50%. High RX utilisation usually means heavy mesh traffic or environmental interference saturating the receiver."},channel_util:{displayMin:0,displayMax:100,direction:"lower_better",classify:e=>e>50?"bad":e>25?"warn":"good",tooltip:"Green < 25%, Yellow 25–50%, Red > 50%. Channel utilisation aggregates all activity on the radio channel."},hop_count:{displayMin:0,displayMax:32,direction:"lower_better",classify:e=>e>=16?"bad":e>=7?"warn":"good",tooltip:"Green ≤ 6, Yellow 7–15, Red ≥ 16. MeshCore allows up to 64 hops; community-recommended meshes run well under 32. Each hop adds airtime cost and latency.",source:"https://nodakmesh.org/blog/meshcore-path-hash-explained"},uptime_hours:{displayMin:0,displayMax:168,direction:"higher_better",classify:e=>e<1?"bad":e<24?"warn":"good",tooltip:"Green > 24 h, Yellow 1–24 h, Red < 1 h. Very recent reboot suggests a watchdog reset or brownout."},last_seen_hours:{displayMin:0,displayMax:6,direction:"lower_better",classify:e=>e>4?"bad":e>2?"warn":"good",tooltip:"Green < 2 h, Yellow 2–4 h, Red > 4 h. Should be tuned to the node’s advertising interval; nodes that advertise hourly should appear far more often than nodes that advertise every 6 hours."},request_success_rate:{displayMin:0,displayMax:100,direction:"higher_better",classify:e=>e<70?"bad":e<90?"warn":"good",tooltip:'Green > 90%, Yellow 70–90%, Red < 70%. Caller is responsible for the min-sample floor — bars should render with band="info" until at least 50 attempts have accumulated.'},duplicate_ratio:{displayMin:0,displayMax:100,direction:"lower_better",classify:()=>"info",tooltip:""},tx_queue_len:{displayMin:0,displayMax:30,direction:"lower_better",classify:e=>e>10?"bad":e>5?"warn":"good",tooltip:"Number of messages queued for transmission. Healthy nodes drain the queue quickly. Sustained backlog (> 10) indicates channel saturation or a stuck transmitter."},temperature:{displayMin:-20,displayMax:140,direction:"higher_better",classify:e=>e<0||e>125?"bad":"good",tooltip:"Red below 0°F (≈ −18°C) or above 125°F (≈ 52°C); green otherwise. Extreme ambient temperatures risk damage to the radio, battery, or enclosure."}};function gl(e,t){const i=t.displayMax-t.displayMin;if(i<=0)return 0;const o=(e-t.displayMin)/i,a="higher_better"===t.direction?o:1-o;return Math.max(0,Math.min(100,100*a))}function ml(e,t){if(!Number.isFinite(t))return{band:"info",fillPct:0,tooltip:""};const i=vl[e];return i?{band:i.classify(t),fillPct:gl(t,i),tooltip:i.tooltip,source:i.source}:{band:"info",fillPct:0,tooltip:""}}class fl{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,i){this._$Ct=e,this._$AM=t,this._$Ci=i}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}const _l=(bl=class extends fl{constructor(e){if(super(e),this._timer=null,this._startX=0,this._startY=0,this._attached=!1,this._callback=null,this._element=null,this._onPointerDown=e=>this._handleDown(e),this._onPointerUp=()=>this._cancelTimer(),this._onPointerMove=e=>this._handleMove(e),this._onContextMenu=e=>{null!==this._timer&&e.preventDefault()},6!==e.type)throw new Error("longPress directive must be used on an element")}render(e){}update(e,[t]){if(this._callback=t,!this._attached){this._element=e.element;const t=this._element;t.addEventListener("pointerdown",this._onPointerDown),t.addEventListener("pointerup",this._onPointerUp),t.addEventListener("pointercancel",this._onPointerUp),t.addEventListener("pointermove",this._onPointerMove),t.addEventListener("contextmenu",this._onContextMenu),this._attached=!0}return this.render(t)}_handleDown(e){0===e.button&&(this._startX=e.clientX,this._startY=e.clientY,this._cancelTimer(),this._timer=setTimeout(()=>{var e;this._timer=null,null===(e=this._callback)||void 0===e||e.call(this)},500))}_handleMove(e){if(null===this._timer)return;const t=e.clientX-this._startX,i=e.clientY-this._startY;t*t+i*i>100&&this._cancelTimer()}_cancelTimer(){null!==this._timer&&(clearTimeout(this._timer),this._timer=null)}},(...e)=>({_$litDirective$:bl,values:e}));var bl;let yl=class extends hn{constructor(){super(...arguments),this.value=0,this.min=0,this.max=100,this.band="info"}render(){const e=this.max-this.min;let t=0;return Number.isFinite(this.value)&&e>0&&(t=(this.value-this.min)/e*100,t=Math.max(0,Math.min(100,t))),Ws(ii||(ii=ts`
    ...
    `),this.value,this.min,this.max,this.band,t)}};yl.styles=ls(oi||(oi=ts`
    :host {
      display: block;
      width: 100%;
    }
  ...
  `)),is([fn({type:Number})],yl.prototype,"value",void 0),is([fn({type:Number})],yl.prototype,"min",void 0),is([fn({type:Number})],yl.prototype,"max",void 0),is([fn({type:String})],yl.prototype,"band",void 0),yl=is([vn("meshcore-stat-bar")],yl);let xl=class extends hn{constructor(){super(...arguments),this.segments=[],this.legend="below"}_denom(){if(void 0!==this.total&&this.total>0)return this.total;const e=this.segments.reduce((e,t)=>e+(Number.isFinite(t.value)?t.value:0),0);return e>0?e:1}render(){if(!this.segments.length)return Xs;const e=this._denom();return Ws(ai||(ai=ts`
      ...
      ${0}
    `),this.segments.map(e=>`${e.label} ${e.value}`).join(", "),this.segments.map(t=>{const i=Number.isFinite(t.value)?Math.max(0,t.value):0;if(0===i)return Xs;const o=i/e*100;return Ws(ri||(ri=ts`<div class="stat-bar-segment ${0}"
                           style="width: ${0}%"
                           title="${0}: ${0}"></div>`),t.kind,o,t.label,t.value)}),"none"!==this.legend?Ws(si||(si=ts`
          <div class="stat-bar-legend ${0}">
            ${0}
            ${0}
          </div>`),"inline"===this.legend?"inline":"",this.segments.filter(e=>Number.isFinite(e.value)&&e.value>=0).map(e=>Ws(ni||(ni=ts`<span><span class="legend-swatch ${0}"></span>${0}</span>`),e.kind,e.label)),this.extraLegendText?Ws(li||(li=ts`<span class="legend-extra">${0}</span>`),this.extraLegendText):Xs):Xs)}};xl.styles=ls(di||(di=ts`
  ...
  `)),is([fn({type:Array})],xl.prototype,"segments",void 0),is([fn({type:Number})],xl.prototype,"total",void 0),is([fn({type:String})],xl.prototype,"legend",void 0),is([fn({type:String})],xl.prototype,"extraLegendText",void 0),xl=is([vn("meshcore-stacked-bar")],xl);let wl=class extends hn{constructor(){super(...arguments),this.content="",this._open=!1,this._onOpen=()=>{this._open||(this._open=!0,window.addEventListener("scroll",this._onScroll,!0))},this._onClose=()=>{this._open&&(this._open=!1,window.removeEventListener("scroll",this._onScroll,!0))},this._onScroll=()=>this._onClose()}render(){return this.content?Ws(ci||(ci=ts`
    ...
    `),this._onOpen,this._onClose,this._onOpen,this._onClose,this._stopPropagation,this._open?"open":"",this.content,this.source?Ws(pi||(pi=ts`<span class="src">${0}</span>`),this.source):Xs):Xs}updated(){this._open&&this._positionPopover()}disconnectedCallback(){window.removeEventListener("scroll",this._onScroll,!0),super.disconnectedCallback()}_stopPropagation(e){e.stopPropagation()}_positionPopover(){const e=this.shadowRoot;if(!e)return;const t=e.querySelector(".info-tip"),i=e.querySelector(".info-tip-content");if(!t||!i)return;const o=t.getBoundingClientRect(),a=i.getBoundingClientRect(),r=window.innerWidth,s=window.innerHeight;let n=o.left+o.width/2-a.width/2,l=o.bottom+6;n<8?n=8:n+a.width>r-8&&(n=Math.max(8,r-8-a.width)),l+a.height>s-8&&(l=o.top-6-a.height,l<8&&(l=8)),i.style.left=`${n}px`,i.style.top=`${l}px`}};wl.styles=ls(hi||(hi=ts`
    :host {
      display: inline-flex;
      vertical-align: middle;
    }
  ...
  `)),is([fn({type:String})],wl.prototype,"content",void 0),is([fn({type:String})],wl.prototype,"source",void 0),is([_n()],wl.prototype,"_open",void 0),wl=is([vn("meshcore-info-tip")],wl);const $l=[{key:"sent_flood",label:"Sent · Flood",color:"var(--info, #2196f3)",dash:!1},{key:"sent_direct",label:"Sent · Direct",color:"var(--info, #2196f3)",dash:!0},{key:"recv_flood",label:"Recv · Flood",color:"var(--good, #4caf50)",dash:!1},{key:"recv_direct",label:"Recv · Direct",color:"var(--good, #4caf50)",dash:!0},{key:"errors",label:"Errors",color:"var(--bad, #f44336)",dash:!1}];let kl=class extends hn{constructor(){super(...arguments),this.data=[],this.width=700,this.height=170,this.timeRange=48,this._hoverIndex=null,this._onPointerMove=e=>{const t=this._indexFromEvent(e);null!=t&&t!==this._hoverIndex&&(this._hoverIndex=t)},this._onPointerDown=e=>{const t=this._indexFromEvent(e);null!=t&&(this._hoverIndex=t===this._hoverIndex?null:t)},this._onPointerLeave=e=>{"mouse"===e.pointerType&&(this._hoverIndex=null)}}render(){return this.data&&0!==this.data.length?Ws(ui||(ui=ts`
    ...
    `),this._renderChart(),null!=this._hoverIndex?this._renderTooltip():Xs,$l.map(e=>Ws(vi||(vi=ts`<div class="legend-item">
              <span class="legend-line ${0}"
                    style="border-top-color:${0}"></span>${0}
            </div>`),e.dash?"dashed":"",e.color,e.label))):Xs}_timeLabel(e,t){const i=Math.round((t-e)/36e5);return i<=0?"now":`-${i}h`}_fmtValue(e){return"number"==typeof e&&isFinite(e)?0===e?"0":e<1?e.toFixed(2):e.toFixed(1):"—"}_geom(){const e=this.width,t=this.height,i=e-40-12,o=t-12-22;let a=0;for(const e of this.data)for(const t of $l){const i=e.values[t.key];"number"==typeof i&&isFinite(i)&&(a=Math.max(a,i))}a<=0&&(a=1);const r=Date.now(),s=36e5*this.timeRange,n=r-s;return{padL:40,padR:12,padT:12,padB:22,w:e,h:t,cw:i,ch:o,maxV:a,now:r,range:s,oldest:n,xScale:e=>40+(e-n)/s*i,yScale:e=>12+o-e/a*o}}_nearestBucket(e){const{xScale:t}=this._geom();let i=-1,o=1/0;for(let a=0;a<this.data.length;a++){const r=Math.abs(t(this.data[a].timestamp)-e);r<o&&(o=r,i=a)}return i}_indexFromEvent(e){const t=this.renderRoot.querySelector("svg");if(!t||0===this.data.length)return null;const i=t.getBoundingClientRect();if(0===i.width)return null;const o=(e.clientX-i.left)/i.width*this.width;return this._nearestBucket(o)}_renderChart(){const e=this._geom(),{padL:t,padR:i,padT:o,padB:a,w:r,h:s,ch:n,maxV:l,now:d,range:c,oldest:p,xScale:h,yScale:u}=e,v=[0,l/2,l].map(e=>{const o=u(e);return Ks(gi||(gi=ts`
        <line x1="${0}" y1="${0}" x2="${0}" y2="${0}"
          stroke="var(--divider-color,#e0e0e0)" stroke-dasharray="4,4" opacity="0.3" />
        <text x="${0}" y="${0}" font-size="9" text-anchor="end"
          fill="var(--secondary-text-color,#727272)">${0}</text>`),t,o,r-i,o,t-6,o+3,e<1?e.toFixed(1):Math.round(e))}),g=[p,p+c/2,d].map(e=>Ks(mi||(mi=ts`
        <text x="${0}" y="${0}" font-size="9" text-anchor="middle"
          fill="var(--secondary-text-color,#727272)">${0}</text>`),h(e),s-a+14,this._timeLabel(e,d))),m=$l.map(e=>{const t=this.data.filter(t=>"number"==typeof t.values[e.key]&&isFinite(t.values[e.key])).map(t=>`${h(t.timestamp).toFixed(1)},${u(t.values[e.key]).toFixed(1)}`);if(0===t.length)return Ks(fi||(fi=ts``));if(1===t.length){const[i,o]=t[0].split(",");return Ks(_i||(_i=ts`<circle cx="${0}" cy="${0}" r="2" fill="${0}" />`),i,o,e.color)}return Ks(bi||(bi=ts`<polyline points="${0}" fill="none" stroke="${0}"
        stroke-width="1.5" stroke-dasharray="${0}"
        stroke-linecap="round" stroke-linejoin="round" />`),t.join(" "),e.color,e.dash?"5,3":"none")});let f=Ks(yi||(yi=ts``));if(null!=this._hoverIndex&&this._hoverIndex<this.data.length){const e=this.data[this._hoverIndex],t=h(e.timestamp),i=$l.map(i=>{const o=e.values[i.key];return"number"==typeof o&&isFinite(o)?Ks(wi||(wi=ts`<circle cx="${0}" cy="${0}" r="3" fill="${0}"
          stroke="var(--card-background-color,#fff)" stroke-width="1" />`),t,u(o),i.color):Ks(xi||(xi=ts``))});f=Ks($i||($i=ts`
        <line x1="${0}" y1="${0}" x2="${0}" y2="${0}"
          stroke="var(--primary-text-color,#888)" stroke-width="1" opacity="0.35" />
        ${0}`),t,o,t,s-a,i)}return Ks(ki||(ki=ts`
      ...
      </svg>`),r,s,this.timeRange,this._onPointerMove,this._onPointerDown,this._onPointerLeave,v,t,o,t,s-a,t,s-a,r-i,s-a,m,f,g,t,o-2,t,o,e.cw,n)}_renderTooltip(){const e=this._hoverIndex;if(null==e||e>=this.data.length)return Xs;const t=this._geom(),i=this.data[e],o=t.xScale(i.timestamp)/t.w*100,a=o>55,r=new Date(i.timestamp).toLocaleString([],{weekday:"short",hour:"2-digit",minute:"2-digit"}),s=a?`left:${o}%; transform:translateX(calc(-100% - 8px));`:`left:${o}%; transform:translateX(8px);`;return Ws(Si||(Si=ts`
      <div class="tooltip" style="${0}">
        <div class="tt-head">${0} · msg/min</div>
        ${0}
      </div>
    `),s,r,$l.map(e=>Ws(Ci||(Ci=ts`<div class="tt-row">
            <span class="sw ${0}" style="border-top-color:${0}"></span>
            <span class="lbl">${0}</span>
            <span class="val">${0}</span>
          </div>`),e.dash?"dashed":"",e.color,e.label,this._fmtValue(i.values[e.key]))))}};kl.styles=ls(Mi||(Mi=ts`
    :host { display: block; width: 100%; }
  ...
  `)),is([fn({type:Array})],kl.prototype,"data",void 0),is([fn({type:Number})],kl.prototype,"width",void 0),is([fn({type:Number})],kl.prototype,"height",void 0),is([fn({type:Number})],kl.prototype,"timeRange",void 0),is([_n()],kl.prototype,"_hoverIndex",void 0),kl=is([vn("meshcore-message-rate-chart")],kl);let Sl=class extends hn{constructor(){super(...arguments),this.entities=[],this.hiddenCount=0,this.knownNodeCount=0,this.contactCount=0,this.channelCount=0,this._rateHistory=[],this._rateHistoryKey=null}render(){if(!this.hass||!this.device)return Xs;const e=new Set,t=this._renderHeroTiles(e),i=this._buildGroups(e);return Ws(Ai||(Ai=ts`
    ...
    `),this._rateHistory):Xs}_renderHeroTiles(e){const t=this.device;return"companion"===t.type?this._renderCompanionHero(e):"repeater"===t.type?this._renderRepeaterHero(e):this._renderClientHero(e)}_renderRepeaterHero(e){return Ws(Ni||(Ni=ts`
      ...
      ${0}
      ${0}
    `),this._renderBatteryTile(),this._renderSignalTile(),this._renderRadioActivityTile(),this._renderMessagesSentTile(e),this._renderMessagesReceivedTile(e),this._renderRequestsTile(e))}_renderClientHero(e){return Ws(Fi||(Fi=ts`
      ${0}
      ${0}
      ${0}
    `),this._renderBatteryTile(),this._renderSignalTile(),this._renderRequestsTile(e))}_renderCompanionHero(e){const t=this._findByMetric("noise_floor");return t&&e.add(t.entity_id),Ws(Di||(Di=ts`
      ${0}
      ${0}
      ${0}
      ${0}
    ...
    `),n?Ws(Oi||(Oi=ts`<span class="primary compact">${0}</span>`),n):Xs,s,100,0,100,"info")}_renderFirmwareInfoTile(){var e,t,i;if("companion"!==(null===(e=this.device)||void 0===e?void 0:e.type))return Xs;const o=null===(t=this.repeaterStatus)||void 0===t?void 0:t.device_info,a=this.device.firmware||(null==o?void 0:o.version)||(null===(i=this.repeaterStatus)||void 0===i?void 0:i.firmware),r=null==o?void 0:o.firmware_build;return a||r?Ws(Pi||(Pi=ts`
    ...
    `),a?Ws(Bi||(Bi=ts` · ${0}`),a):Xs,r?Ws(Li||(Li=ts`<span class="secondary">Compilado: ${0}</span>`),r):Xs,100,0,100,"info"):Xs}_renderConnectionInfoTile(){var e,t;if("companion"!==(null===(e=this.device)||void 0===e?void 0:e.type))return Xs;const i=null===(t=this.device.connection_type)||void 0===t?void 0:t.toUpperCase(),o=this.device.connection_address;return i||o?Ws(Hi||(Hi=ts`
    ...
    `),this.device.connected?"good":"bad",o||i||"—",i&&o?Ws(Ui||(Ui=ts`<span class="secondary">${0}</span>`),i):Xs,this.device.connected?100:0,0,100,this.device.connected?"good":"bad"):Xs}_renderKnownNodesTile(){var e;return"companion"!==(null===(e=this.device)||void 0===e?void 0:e.type)?Xs:Ws(ji||(ji=ts`
    ...
    `),this.knownNodeCount,100,0,100,"info")}_renderProtocolInfoTile(){var e,t;const i=null===(e=this.repeaterStatus)||void 0===e?void 0:e.device_info;if(!i)return Xs;const o=null!=i.protocol_version?`v${i.protocol_version}`:"—",a=null==i.path_hash_mode?"—":null!==(t=["1 byte","2 bytes","3 bytes"][Number(i.path_hash_mode)])&&void 0!==t?t:String(i.path_hash_mode);return Ws(qi||(qi=ts`
    ...
    `),o,a,100,0,100,"info")}_renderCapacityInfoTile(){var e,t,i;const o=null===(e=this.repeaterStatus)||void 0===e?void 0:e.device_info;return null==(null==o?void 0:o.max_contacts)&&null==(null==o?void 0:o.max_channels)?Xs:Ws(Vi||(Vi=ts`
    ...
    `),i[0],i.length>1?Ws(Ki||(Ki=ts`<span class="secondary">· ${0} MHz</span>`),i.slice(1).join(" · ")):Xs,100,0,100,"info")}_renderTemperatureTile(e){var t,i;const o=this._findByMetric("temperature");if(!o)return Xs;const a=this._readNumber(o.entity_id);if(!Number.isFinite(a))return Xs;e.add(o.entity_id);const r=(null!==(t=null===(i=this.hass)||void 0===i||null===(i=i.states[o.entity_id])||void 0===i||null===(i=i.attributes)||void 0===i?void 0:i.unit_of_measurement)&&void 0!==t?t:"°C").includes("F")?5*(a-32)/9:a,s=ml("temperature",9*r/5+32);return Ws(Gi||(Gi=ts`
    ...
    `),s,n,l,Math.min(r,120),0,120,s)}_renderRequestTokensTile(e){const t=this.entities.find(e=>e.entity_id.includes("request_rate_limiter"));if(!t)return Xs;const i=this._readNumber(t.entity_id);if(!Number.isFinite(i))return Xs;e.add(t.entity_id);const o=i<5?"bad":i<10?"warn":"good";return Ws(Qi||(Qi=ts`
    ...
    `),()=>this._fireMoreInfo(t.entity_id),o,this._formatNumber(i,1),i,0,20,o)}_renderDiscoveredContactsTile(e){const t=this.entities.find(e=>e.entity_id.includes("discovered_contacts"));if(!t)return Xs;const i=this._readNumber(t.entity_id);return Number.isFinite(i)?(e.add(t.entity_id),Ws(Yi||(Yi=ts`
    ...
    `),r,a.toFixed(0),i,o,a,0,100,r)}_renderRepeaterStateTile(){const e=this.repeaterStatus;if(null==e||!e.supported)return Xs;const t=Boolean(e.repeat);return Ws(Zi||(Zi=ts`
    ...
    `),()=>t&&this._fireMoreInfo(t.entity_id),this._renderInfoTip(a),a.band,this._formatCount(i),Math.min(Math.max(i,0),30),0,30,a.band)}_renderBatteryTile(){var e;const t=this._findByMetric("battery_pct");if(!t)return Xs;const i=this._readNumber(t.entity_id),o=null!==(e=this._findEntityIdMatching("battery_voltage"))&&void 0!==e?e:this._findEntityByLabel("Voltage"),a=o?this._readNumber(o.entity_id):NaN,r=ml("battery_pct",i);return Ws(oo||(oo=ts`
    ...
    `),()=>this._fireMoreInfo(t.entity_id),this._renderInfoTip(r),r.band,this._formatNumber(i,0),Number.isFinite(a)?Ws(ao||(ao=ts`<span class="secondary">· ${0} V</span>`),a.toFixed(3)):Xs,i,0,100,r.band)}_renderSignalTile(){const e=this._findByMetric("rssi");if(!e)return Xs;const t=this._readNumber(e.entity_id),i=this._findByMetric("snr"),o=i?this._readNumber(i.entity_id):NaN,a=ml("rssi",t);return Ws(ro||(ro=ts`
      <div class="hero-tile" @click=${0}>
        <div class="hero-tile-head">
    ...
    `),()=>this._fireMoreInfo(e.entity_id),this._renderInfoTip(a),a.band,this._formatNumber(t,0),Number.isFinite(o)?Ws(so||(so=ts`<span class="secondary">· SNR ${0} dB</span>`),o.toFixed(1)):Xs,t,-130,-30,a.band)}_renderRadioActivityTile(){const e=this._findByMetric("tx_airtime_util"),t=this._findByMetric("rx_airtime_util");if(!e&&!t)return Xs;const i=e?this._readNumber(e.entity_id):0,o=t?this._readNumber(t.entity_id):0,a=Number.isFinite(i)?Math.max(0,i):0,r=Number.isFinite(o)?Math.max(0,o):0,s=Math.max(0,100-a-r),n=ml("tx_airtime_util",a).band,l=ml("rx_airtime_util",r).band,d=this._worseBand(n,l),c=[{value:a,label:`TX ${a.toFixed(1)}%`,kind:"tx"},{value:r,label:`RX ${r.toFixed(1)}%`,kind:"rx"},{value:s,label:`Idle ${s.toFixed(1)}%`,kind:"idle"}],p=a+r;return Ws(no||(no=ts`
      <div class="hero-tile"
           @click=${0}>
        <div class="hero-tile-head">
    ...
    `),()=>e&&this._fireMoreInfo(e.entity_id),this._renderInfoTip({band:d,fillPct:0,tooltip:"Half-duplex composition over the last reporting interval. The radio can transmit OR receive, never both. TX above 10% indicates duty-cycle pressure; sustained TX+RX above 30% means the channel is congested."}),d,p.toFixed(1),c,100,"none",e?Ws(lo||(lo=ts`<span class="ra-legend-item" @click=${0}>
                  <span class="legend-swatch tx"></span>TX ${0}%
                </span>`),t=>{t.stopPropagation(),e&&this._fireMoreInfo(e.entity_id)},a.toFixed(1)):Ws(co||(co=ts`<span class="ra-legend-item">
                  <span class="legend-swatch tx"></span>TX ${0}%
                </span>`),a.toFixed(1)),t?Ws(po||(po=ts`<span class="ra-legend-item" @click=${0}>
                  <span class="legend-swatch rx"></span>RX ${0}%
                </span>`),e=>{e.stopPropagation(),t&&this._fireMoreInfo(t.entity_id)},r.toFixed(1)):Ws(ho||(ho=ts`<span class="ra-legend-item">
                  <span class="legend-swatch rx"></span>RX ${0}%
                </span>`),r.toFixed(1)),s.toFixed(1))}_renderMessagesSentTile(e){const t=this._findEntityIdMatching("nb_sent"),i=this._findEntityIdMatching("sent_flood"),o=this._findEntityIdMatching("sent_direct");if(!t||!i&&!o)return Xs;const a=this._readNumber(t.entity_id),r=i?this._readNumber(i.entity_id):0,s=o?this._readNumber(o.entity_id):0,n=[{value:r,label:`Flood ${r}`,kind:"flood"},{value:s,label:`Direct ${s}`,kind:"direct"}];return e.add(t.entity_id),i&&e.add(i.entity_id),o&&e.add(o.entity_id),Ws(uo||(uo=ts`
      <div class="hero-tile" @click=${0}>
        <div class="hero-tile-head">
    ...
    `),()=>this._fireMoreInfo(t.entity_id),this._renderInfoTip({band:"info",fillPct:0,tooltip:"Messages sent (lifetime), split by send mode:\n• Flood — broadcast retransmits visible to all neighbours.\n• Direct — routed point-to-point along a path."}),this._formatCount(a),n,"inline")}_renderMessagesReceivedTile(e){const t=this._findEntityIdMatching("nb_recv"),i=this._findEntityIdMatching("recv_flood"),o=this._findEntityIdMatching("recv_direct"),a=this._findEntityIdMatching("flood_dups"),r=this._findEntityIdMatching("direct_dups");if(!t||!i&&!o)return Xs;const s=this._readNumber(t.entity_id),n=i?this._readNumber(i.entity_id):0,l=o?this._readNumber(o.entity_id):0,d=[{value:n,label:`Flood ${n}`,kind:"flood"},{value:l,label:`Direct ${l}`,kind:"direct"}],c=a?this._readNumber(a.entity_id):0,p=r?this._readNumber(r.entity_id):0,h=(Number.isFinite(c)?c:0)+(Number.isFinite(p)?p:0),u=s>0?h/s*100:0;e.add(t.entity_id),i&&e.add(i.entity_id),o&&e.add(o.entity_id),a&&e.add(a.entity_id),r&&e.add(r.entity_id);const v=this._findEntityIdMatching("recv_errors"),g=v?this._readNumber(v.entity_id):NaN,m=Number.isFinite(g)?g:0,f=s+m,_=f>0?m/f*100:0;return v&&e.add(v.entity_id),Ws(vo||(vo=ts`
      <div class="hero-tile" @click=${0}>
        <div class="hero-tile-head">
    ...
    `),()=>this._fireMoreInfo(t.entity_id),this._renderInfoTip({band:"info",fillPct:0,tooltip:"Messages received (lifetime), split by receive mode:\n• Flood — broadcast packets received from neighbours.\n• Direct — routed packets where this node is on the path.\n\nEach bar below is a percentage of its own total:\n• Red = receive errors (CRC failures), as a share of all reception attempts (received + errors) — i.e. the error rate.\n• Amber = duplicate receptions, as a share of received messages (duplicates are a subset of received).\n\nBoth are context only, not banded — in a flooding mesh every active neighbour retransmits the same flood once, so a high duplicate ratio is normal (a 2-neighbour repeater sees ~50%, a 3-neighbour ~67%, etc.)."}),this._formatCount(s),d,"none",m>0?Ws(go||(go=ts`<div class="err-line"
                      title="Receive errors (CRC failures): ${0} — ${0}% of reception attempts (received + errors)">
              <div class="err-line-fill" style="width:${0}%"></div>
            </div>`),m,_.toFixed(1),Math.min(100,_).toFixed(1)):Xs,h>0?Ws(mo||(mo=ts`<div class="dup-line"
                      title="Duplicate receptions: ${0} — ${0}% of received messages">
              <div class="dup-line-fill" style="width:${0}%"></div>
            </div>`),h,u.toFixed(1),Math.min(100,u).toFixed(1)):Xs,n,l,m>0?Ws(fo||(fo=ts`<span><span class="msg-swatch error"></span>Error ${0}</span>`),m):Xs,h>0?Ws(_o||(_o=ts`<span><span class="msg-swatch dup"></span>Dup ${0}</span>`),h):Xs)}_renderRequestsTile(e){const t=this._findEntityIdMatching("request_succ"),i=this._findEntityIdMatching("request_fail");if(!t||!i)return Xs;const o=this._readNumber(t.entity_id),a=this._readNumber(i.entity_id),r=o+a,s=r>0?o/r*100:0,n=r>=50?ml("request_success_rate",s):{band:"info",fillPct:0,tooltip:""},l=[{value:o,label:`OK ${o}`,kind:"success"},{value:a,label:`Fail ${a}`,kind:"failure"}];return e.add(t.entity_id),e.add(i.entity_id),Ws(bo||(bo=ts`
      <div class="hero-tile" @click=${0}>
        <div class="hero-tile-head">
          <span>Pedidos${0}</span>
          <span class="status-dot ${0}"></span>
    ...
    `),()=>this._fireMoreInfo(t.entity_id),this._renderInfoTip({...n,tooltip:"Outgoing requests this node initiated (login, telemetry, neighbour query) and how they resolved. Success rate bands: Green > 90%, Yellow 70–90%, Red < 70%, with a minimum sample of 50 attempts to colour. Below the floor, the bar stays neutral — too few samples to judge."}),n.band,r>0?`${s.toFixed(0)}%`:"—",r>0?Ws(yo||(yo=ts`<span class="secondary">· ${0} attempt${0}</span>`),r,1===r?"":"s"):Xs,l,"inline")}_formatCount(e){return Number.isFinite(e)?Math.round(e).toLocaleString():"—"}_renderLocationTile(){const e=this._findEntityIdMatching("latitude"),t=this._findEntityIdMatching("longitude");let i=e?this._readNumber(e.entity_id):NaN,o=t?this._readNumber(t.entity_id):NaN,a="entity";!Number.isFinite(i)&&Number.isFinite(this.fallbackLatitude)&&(i=this.fallbackLatitude,a="fallback"),!Number.isFinite(o)&&Number.isFinite(this.fallbackLongitude)&&(o=this.fallbackLongitude,a="fallback");const r=Number.isFinite(i)&&Number.isFinite(o)&&(0!==i||0!==o);if(!r)return Xs;let s=null;if("entity"===a&&e){var n;const t=null===(n=this.hass)||void 0===n||null===(n=n.states[e.entity_id])||void 0===n?void 0:n.last_updated;if(t){const e=new Date(t);Number.isNaN(e.getTime())||(s=e)}}else"fallback"===a&&Number.isFinite(this.fallbackUpdated)&&(s=new Date(1e3*this.fallbackUpdated));const l=r&&s?this._formatRelativeTime(s):"";return Ws(xo||(xo=ts`
      <div class="hero-tile" @click=${0}>
        <div class="hero-tile-head">
    ...
    `),()=>{e&&this._fireMoreInfo(e.entity_id)},"fallback"===a?Ws(wo||(wo=ts`<span style="opacity:0.55;text-transform:none;letter-spacing:0;font-size:10px;margin-left:4px;">via contact</span>`)):Xs,r?Ws($o||($o=ts`<span class="coord-pair">
                ${0}, ${0}
              </span>`),i.toFixed(4),o.toFixed(4)):Ws(ko||(ko=ts`<span class="primary">—</span>`)),l?Ws(So||(So=ts`<div class="loc-updated">Updated ${0}</div>`),l):Xs)}_formatRelativeTime(e){const t=(Date.now()-e.getTime())/1e3;return!Number.isFinite(t)||t<0||t<60?"just now":t<3600?`${Math.floor(t/60)} min ago`:t<86400?`${Math.floor(t/3600)} h ago`:`${Math.floor(t/86400)} d ago`}_renderCompanionRadioActivityTile(){const e=this._findEntityIdMatching("tx_airtime"),t=this._findEntityIdMatching("rx_airtime"),i=this._findByMetric("uptime_hours");if(!e&&!t||!i)return Xs;const o=this._readUptimeMinutes(i);if(!Number.isFinite(o)||o<=0)return Xs;const a=e?this._readNumber(e.entity_id):0,r=t?this._readNumber(t.entity_id):0;if(!Number.isFinite(a)&&!Number.isFinite(r))return Xs;const s=e=>Number.isFinite(e)?Math.min(100,Math.max(0,e/o*100)):0,n=s(a),l=s(r),d=Math.max(0,100-n-l),c=ml("tx_airtime_util",n).band,p=ml("rx_airtime_util",l).band,h=this._worseBand(c,p),u=[{value:n,label:`TX ${n.toFixed(1)}%`,kind:"tx"},{value:l,label:`RX ${l.toFixed(1)}%`,kind:"rx"},{value:d,label:`Idle ${d.toFixed(1)}%`,kind:"idle"}],v=n+l;return Ws(Co||(Co=ts`
      <div class="hero-tile"
           @click=${0}>
        <div class="hero-tile-head">
          <span>Atividade de rádio${0}</span>
    ...
    `),()=>this._fireMoreInfo(e.entity_id),t=>this._fireContextMenu(t,e),_l(()=>this._fireContextMenu(void 0,e)),p,e.label,u?this._renderInfoTip(u):Xs,v,d?Ws(Fo||(Fo=ts`<span class="unit">${0}</span>`),d):Xs,c&&e.metricKey?Ws(Do||(Do=ts`<meshcore-stat-bar
                .value=${0}
                .min=${0}
                .max=${0}
                .band=${0}>
              </meshcore-stat-bar>`),c.fillPct,0,100,p):Xs)}_evaluateForRow(e,t,i){if("uptime_hours"===e){var o,a;let r=t;switch(null!==(o=null===(a=this.hass)||void 0===a||null===(a=a.states[i.entity_id])||void 0===a||null===(a=a.attributes)||void 0===a?void 0:a.unit_of_measurement)&&void 0!==o?o:""){case"d":r=24*t;break;case"h":r=t;break;case"min":r=t/60;break;default:r=t/3600}return ml(e,r)}var r,s;return ml(e,"temperature"===e&&(null!==(r=null===(s=this.hass)||void 0===s||null===(s=s.states[i.entity_id])||void 0===s||null===(s=s.attributes)||void 0===s?void 0:s.unit_of_measurement)&&void 0!==r?r:"").includes("C")?9*t/5+32:t)}_findByMetric(e){return this.entities.find(t=>t.metricKey===e)}_findEntityIdMatching(e){return this.entities.find(t=>t.entity_id.includes(e))}_findEntityByLabel(e){return this.entities.find(t=>t.label===e)}_readNumber(e){var t;const i=null===(t=this.hass)||void 0===t?void 0:t.states[e];if(!i||"unavailable"===i.state||"unknown"===i.state)return NaN;const o=parseFloat(i.state);return Number.isFinite(o)?o:NaN}_formatNumber(e,t){return Number.isFinite(e)?e.toFixed(t):"—"}_formatRowValue(e,t,i){var o;if("unavailable"===i||"unknown"===i)return"—";if(!Number.isFinite(t))return null!=i?i:"—";const a=null===(o=this.hass)||void 0===o||null===(o=o.entities)||void 0===o||null===(o=o[e.entity_id])||void 0===o?void 0:o.display_precision;return null!=a&&a>=0?t.toFixed(a):i&&i.includes(".")?i:t.toString()}_renderInfoTip(e){var t;return e.tooltip?Ws(Eo||(Eo=ts`<meshcore-info-tip
      .content=${0}
      .source=${0}>
    </meshcore-info-tip>`),e.tooltip,null!==(t=e.source)&&void 0!==t?t:""):Xs}_worseBand(e,t){const i={good:0,info:0,warn:1,bad:2};return i[e]>=i[t]?e:t}_fireMoreInfo(e){e&&this.dispatchEvent(new CustomEvent("hass-more-info",{detail:{entityId:e},bubbles:!0,composed:!0}))}_fireContextMenu(e,t){null==e||e.preventDefault(),this.dispatchEvent(new CustomEvent("tile-context-menu",{detail:{entityId:t.entity_id,label:t.label},bubbles:!0,composed:!0}))}};Sl.styles=ls(Oo||(Oo=ts`
  ...
  `)),is([fn({type:Object})],Sl.prototype,"hass",void 0),is([fn({type:Object})],Sl.prototype,"device",void 0),is([fn({type:Array})],Sl.prototype,"entities",void 0),is([fn({type:Number})],Sl.prototype,"hiddenCount",void 0),is([fn({type:Number})],Sl.prototype,"knownNodeCount",void 0),is([fn({type:Number})],Sl.prototype,"contactCount",void 0),is([fn({type:Number})],Sl.prototype,"channelCount",void 0),is([fn({type:Number})],Sl.prototype,"fallbackLatitude",void 0),is([fn({type:Number})],Sl.prototype,"fallbackLongitude",void 0),is([fn({type:Number})],Sl.prototype,"fallbackUpdated",void 0),is([fn({type:Object})],Sl.prototype,"repeaterStatus",void 0),is([_n()],Sl.prototype,"_rateHistory",void 0),Sl=is([vn("meshcore-node-summary")],Sl);let Cl=class extends hn{constructor(){super(...arguments),this.narrow=!1,this.knownNodeCount=0,this.contactCount=0,this.channelCount=0,this._repeaterStatus=null,this._deviceConfig=null,this._deviceEntities={},this._meshcoreDeviceMap={},this._hiddenSensors={},this._contextMenu=null,this._statusMessage=null,this._hiddenSensorsOpen=!1,this._loadedEntry=null,this._statusMessageTimeout=null,this._trace=()=>{var e;this.dispatchEvent(new CustomEvent("companion-trace-requested",{detail:{entryId:null===(e=this.selectedDevice)||void 0===e?void 0:e.entry_id},bubbles:!0,composed:!0}))}}connectedCallback(){super.connectedCallback(),this._loadHiddenSensors()}updated(){var e;const t=(null===(e=this.selectedDevice)||void 0===e?void 0:e.entry_id)||null;t&&t!==this._loadedEntry&&(this._loadedEntry=t,this._loadData())}async _loadData(){if(this.hass)try{var e,t;const[{meshcoreDeviceMap:i,deviceEntities:o},a,r]=await Promise.all([ul(this.hass),In(this.hass,null===(e=this.config)||void 0===e?void 0:e.entry_id).catch(()=>null),An(this.hass,null===(t=this.config)||void 0===t?void 0:t.entry_id).catch(()=>null)]);this._meshcoreDeviceMap=i,this._deviceEntities=o,this._repeaterStatus=a,this._deviceConfig=r}catch(e){this._repeaterStatus=null}}_deviceKey(){var e;return(null===(e=this.selectedDevice)||void 0===e?void 0:e.entry_id)||"companion"}_entities(){var e;if(!this.hass||!this.selectedDevice)return[];const t=new Set(this._hiddenSensors[this._deviceKey()]||[]),i=this.selectedDevice.entry_id,o=this._meshcoreDeviceMap[i];if(o&&this._deviceEntities[o])return this._deviceEntities[o].filter(e=>!t.has(e.entity_id));const a=(null===(e=this.selectedDevice.pubkey_prefix)||void 0===e||null===(e=e.substring(0,6))||void 0===e?void 0:e.toLowerCase())||"";if(!a)return[];const r=[];for(const[e,i]of Object.entries(this._deviceEntities))if(!Object.entries(this._meshcoreDeviceMap).some(([t,i])=>i===e&&(t.includes("_repeater_")||t.includes("_client_"))))for(const e of i)e.entity_id.toLowerCase().includes(a)&&!t.has(e.entity_id)&&r.push(e);return r.sort((e,t)=>e.sortOrder-t.sortOrder)}_descriptor(e){var t,i,o,a;return{type:"companion",name:e.name,pubkey_prefix:e.pubkey_prefix,connected:e.connected,firmware:e.firmware||(null===(t=this._deviceConfig)||void 0===t?void 0:t.firmware_version),hardware_model:null===(i=this._deviceConfig)||void 0===i?void 0:i.hardware_model,connection_type:null===(o=this._deviceConfig)||void 0===o?void 0:o.connection_type,connection_address:null===(a=this._deviceConfig)||void 0===a?void 0:a.connection_address,entry_id:e.entry_id}}_loadHiddenSensors(){try{this._hiddenSensors=JSON.parse(localStorage.getItem("meshcore-hidden-sensors")||"{}")}catch(e){this._hiddenSensors={}}}_saveHiddenSensors(){try{localStorage.setItem("meshcore-hidden-sensors",JSON.stringify(this._hiddenSensors))}catch(e){}}_hideSensor(e,t){const i=this._deviceKey(),o=this._hiddenSensors[i]||[];o.includes(e)||(this._hiddenSensors={...this._hiddenSensors,[i]:[...o,e]}),this._saveHiddenSensors(),this._contextMenu=null,this._showStatus("Oculto: "+t,"success")}_unhideSensor(e){const t=this._deviceKey(),i=(this._hiddenSensors[t]||[]).filter(t=>t!==e),o={...this._hiddenSensors};i.length?o[t]=i:delete o[t],this._hiddenSensors=o,this._saveHiddenSensors()}async _action(e,t,i){if(this.hass)try{var o;const a=await async function(e,t,i,o){try{const a={type:"hivefw_integration/execute_local",command:t};return i&&(a.args=i),o&&(a.entry_id=o),await e.callWS(a)}catch(e){const t=e;return{response:t&&t.message?t.code?`${t.message} (${t.code})`:t.message:String(e),success:!1,timestamp:(new Date).toISOString()}}}(this.hass,e,t,null===(o=this.config)||void 0===o?void 0:o.entry_id);this._showStatus("Companion: "+(i||e)+" → "+(a.response||"OK"),"success"),"set_time"===e&&this._loadData()}catch(t){this._showStatus("Companion: "+(i||e)+" — "+String(t),"error")}}async _copyPublicKey(e){if(e){try{await navigator.clipboard.writeText(e)}catch(t){const i=document.createElement("textarea");i.value=e,i.style.position="fixed",i.style.opacity="0",document.body.appendChild(i),i.select(),document.execCommand("copy"),i.remove()}this._showStatus("Public Key copiada","success")}}_showStatus(e,t){this._statusMessage={text:e,type:t},null!==this._statusMessageTimeout&&window.clearTimeout(this._statusMessageTimeout),this._statusMessageTimeout=window.setTimeout(()=>{this._statusMessage=null,this._statusMessageTimeout=null},5e3)}render(){var e;const t=this.selectedDevice;if(!t)return Ws(Po||(Po=ts`<div class="page"><div class="wrap">Sem Companion selecionado.</div></div>`));const i=this._entities(),o=this._hiddenSensors[this._deviceKey()]||[];return Ws(Bo||(Bo=ts`
    ...
    `),t.name,(null===(e=this._deviceConfig)||void 0===e?void 0:e.pubkey)||t.pubkey||t.pubkey_prefix,()=>{var e;this._copyPublicKey((null===(e=this._deviceConfig)||void 0===e?void 0:e.pubkey)||t.pubkey||t.pubkey_prefix)},o.length?Ws(Lo||(Lo=ts`<button class="minor" @click=${0}>Sensores ocultos (${0})</button>`),()=>this._hiddenSensorsOpen=!0,o.length):Xs,i.length?Ws(Ho||(Ho=ts`<meshcore-node-summary
      ...
      </div></div>`),()=>this._contextMenu=null,e=>e.stopPropagation(),this._contextMenu.label,()=>this._contextMenu=null,()=>this._hideSensor(this._contextMenu.entityId,this._contextMenu.label)):Xs,this._hiddenSensorsOpen?Ws(jo||(jo=ts`<div class="overlay" @click=${0}><div class="dialog" @click=${0}>
        <div class="dialog-head"><div class="dialog-title">Sensores ocultos</div><button class="minor" @click=${0}>Fechar</button></div>
        ${0}
      </div></div>`),()=>this._hiddenSensorsOpen=!1,e=>e.stopPropagation(),()=>this._hiddenSensorsOpen=!1,o.map(e=>{var t;return Ws(qo||(qo=ts`<div class="sensor-row"><div><div>${0}</div><div class="sensor-id">${0}</div></div><button class="minor" @click=${0}>Mostrar</button></div>`),(null===(t=Object.values(this._deviceEntities).flat().find(t=>t.entity_id===e))||void 0===t?void 0:t.label)||e,e,()=>this._unhideSensor(e))})):Xs,this._statusMessage?Ws(Vo||(Vo=ts`<div class="toast ${0}">${0}</div>`),this._statusMessage.type,this._statusMessage.text):Xs)}};Cl.styles=ls(Wo||(Wo=ts`
  ...
  `)),is([fn({type:Object})],Cl.prototype,"hass",void 0),is([fn({type:Object})],Cl.prototype,"config",void 0),is([fn({type:Boolean})],Cl.prototype,"narrow",void 0),is([fn({type:Object})],Cl.prototype,"selectedDevice",void 0),is([fn({type:Number})],Cl.prototype,"knownNodeCount",void 0),is([fn({type:Number})],Cl.prototype,"contactCount",void 0),is([fn({type:Number})],Cl.prototype,"channelCount",void 0),is([_n()],Cl.prototype,"_repeaterStatus",void 0),is([_n()],Cl.prototype,"_deviceConfig",void 0),is([_n()],Cl.prototype,"_deviceEntities",void 0),is([_n()],Cl.prototype,"_meshcoreDeviceMap",void 0),is([_n()],Cl.prototype,"_hiddenSensors",void 0),is([_n()],Cl.prototype,"_contextMenu",void 0),is([_n()],Cl.prototype,"_statusMessage",void 0),is([_n()],Cl.prototype,"_hiddenSensorsOpen",void 0),Cl=is([vn("meshcore-status-page")],Cl);let Ml=class extends hn{constructor(){super(),this.open=!1,this.title="Confirm",this.message="",this.confirmLabel="Confirm",this.cancelLabel="Cancel",this.dangerous=!1,this._typedValue="",tl(this,{isOpen:()=>this.open,onEscape:()=>this._onCancel()})}render(){if(!this.open)return;const e=this.requireTyped&&this._typedValue!==this.requireTyped;return Ws(Ko||(Ko=ts`
    ...
    `),this._onOverlayClick,this.title,this.title,this.message,this.requireTyped?Ws(Go||(Go=ts`
                  <div class="form-group">
    ...
    `))],is([fn({type:Boolean})],Ml.prototype,"open",void 0),is([fn({type:String})],Ml.prototype,"title",void 0),is([fn({type:String})],Ml.prototype,"message",void 0),is([fn({type:String})],Ml.prototype,"confirmLabel",void 0),is([fn({type:String})],Ml.prototype,"cancelLabel",void 0),is([fn({type:Boolean})],Ml.prototype,"dangerous",void 0),is([fn({type:String})],Ml.prototype,"requireTyped",void 0),is([_n()],Ml.prototype,"_typedValue",void 0),Ml=is([vn("meshcore-confirm-dialog")],Ml);const Al=[{step:"generating",label:"Generating new key"},{step:"importing",label:"Sending key to device"},{step:"rebooting",label:"Rebooting device"},{step:"reconnecting",label:"Waiting for device reconnect"},{step:"reloading",label:"Reloading HiveFW integration"},{step:"verifying",label:"Verifying new identity"}];let Rl=class extends hn{constructor(){super(),this.narrow=!1,this.contactCount=0,this.channelCount=0,this._deviceConfig=null,this._repeaterStatus=null,this._managedDevices={repeaters:[],clients:[]},this._scopeDraft="",this._scopeGlobal=!1,this._scopeSaving=!1,this._regionTarget="",this._regionText="",this._regionBusy=!1,this._localRegions=null,this._localRegionBusy=!1,this._localRegionAction="put",this._localRegionName="",this._localRegionParent="",this._regionAction="allowf",this._regionName="",this._loading=!0,this._error=null,this._editValues={},this._saving=!1,this._firmwareOtaStatus=null,this._firmwareFile=null,this._firmwareBusy=!1,this._firmwareChecking=!1,this._firmwareUploadStage=null,this._dutyCycleValue=10,this._dutyCycleBusy=null,this._adminPasswordDraft="",this._guestPasswordDraft="",this._repeaterAccessBusy=null,this._repeaterReadBusy=!1,this._repeaterQuickBusy=null,this._aclNewPublicKey="",this._aclNewPermissions=1,this._backupBusy=null,this._confirmAction=null,this._confirmDialogOpen=!1,this._locationSource="manual",this._importKeyValue="",this._identityFlowState={kind:"closed"},this._identityFlowUnsubscribe=null,this._settingsWriteQueue=Promise.resolve(),this._renameSuccess=null,this._statusMessage=null,this._statusMessageTimeout=null,tl(this,{isOpen:()=>"closed"!==this._identityFlowState.kind,onEscape:()=>{"success"!==this._identityFlowState.kind&&"failure"!==this._identityFlowState.kind||this._closeIdentityFlowModal()},getScope:()=>{var e;return null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector('[data-a11y="identity-flow"]')}}),tl(this,{isOpen:()=>null!==this._renameSuccess,onEscape:()=>this._closeRenameSuccessModal(),getScope:()=>{var e;return null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector('[data-a11y="rename-success"]')}})}connectedCallback(){super.connectedCallback(),this._loadDeviceConfig()}disconnectedCallback(){super.disconnectedCallback(),null!==this._statusMessageTimeout&&(clearTimeout(this._statusMessageTimeout),this._statusMessageTimeout=null)}updated(e){e.has("config")&&this._loadDeviceConfig()}async _loadDeviceConfig(){if(this.hass){this._loading=!0,this._error=null;try{var e,t,i,o,a;if(this._deviceConfig=await An(this.hass,null===(e=this.config)||void 0===e?void 0:e.entry_id),await this._readRepeaterStatus(!1,!1),this._deviceConfig&&null!==(t=this._repeaterStatus)&&void 0!==t&&t.radio){var r,s,n,l,d,c,p;const e=this._repeaterStatus.radio;this._deviceConfig={...this._deviceConfig,frequency:null!==(r=e.frequency)&&void 0!==r?r:this._deviceConfig.frequency,bandwidth:null!==(s=e.bandwidth)&&void 0!==s?s:this._deviceConfig.bandwidth,spreading_factor:null!==(n=e.spreading_factor)&&void 0!==n?n:this._deviceConfig.spreading_factor,coding_rate:null!==(l=e.coding_rate)&&void 0!==l?l:this._deviceConfig.coding_rate,tx_power:null!==(d=e.tx_power)&&void 0!==d?d:this._deviceConfig.tx_power,path_hash_mode:null!==(c=null===(p=this._repeaterStatus.device_info)||void 0===p?void 0:p.path_hash_mode)&&void 0!==c?c:this._deviceConfig.path_hash_mode}}try{var h;this._localRegions=await Tn(this.hass,null===(h=this.config)||void 0===h?void 0:h.entry_id)}catch(e){this._localRegions=null}try{var u;this._firmwareOtaStatus=await Fn(this.hass,null===(u=this.config)||void 0===u?void 0:u.entry_id)}catch(e){this._firmwareOtaStatus=null}this._managedDevices=await async function(e,t){try{const i={type:"hivefw_integration/get_managed_devices"};t&&(i.entry_id=t);const o=await e.callWS(i);return{repeaters:o.repeaters||[],clients:o.clients||[]}}catch(e){return{repeaters:[],clients:[]}}}(this.hass,null===(i=this.config)||void 0===i?void 0:i.entry_id);const v=await zn(this.hass,null===(o=this.config)||void 0===o?void 0:o.entry_id);this._scopeDraft=v.scopes.join(", "),this._scopeGlobal=v.global,!this._regionTarget&&this._managedDevices.repeaters.length&&(this._regionTarget=this._managedDevices.repeaters[0].pubkey_prefix),null!==(a=this._deviceConfig)&&void 0!==a&&a.location_source&&(this._locationSource=this._deviceConfig.location_source)}catch(e){this._error=`Failed to load device configuration: ${String(e)}`}finally{this._loading=!1}}}render(){var e,t,i,o;return this._loading?Ws(Qo||(Qo=ts`
      ...
      `)):this._error?Ws(Yo||(Yo=ts`
        <div class="settings-page">
          <div style="padding: 16px; color: var(--error-color); font-size: 14px;">
            ${0}
          </div>
        </div>
      `),this._error):this._deviceConfig?Ws(Zo||(Zo=ts`
      <div class="settings-page">
    ...
    `),this.selectedDevice?Ws(ea||(ea=ts`
          ...
          `),this._repeaterReadBusy||this._saving,()=>this._readRepeaterStatus(!0,!0),this._repeaterReadBusy?"A ler…":"↻ Ler configuração",this._renderRepeaterSettings(),this._renderRegionsScopes()):Xs,this.selectedDevice?Ws(ta||(ta=ts`
          ...
          `),this._renderRadioSettings()):Xs,this.selectedDevice?this._renderFirmwareOta():Xs,this.selectedDevice?this._renderBackupRestore():Xs,this._renderIdentityManagement(),this._renderLocation(),this._renderIdentityFlowModal(),this._renderRenameSuccessModal(),this._statusMessage?Ws(ia||(ia=ts`
        <div class="status-toast ${0}">
          ${0}
        </div>
      `),this._statusMessage.type,this._statusMessage.text):Xs,this._confirmDialogOpen,(null===(e=this._confirmAction)||void 0===e?void 0:e.title)||"",(null===(t=this._confirmAction)||void 0===t?void 0:t.message)||"",null===(i=this._confirmAction)||void 0===i?void 0:i.requireTyped,!(null===(o=this._confirmAction)||void 0===o||!o.requireTyped),this._onConfirmAction,this._onConfirmCancel):Ws(Jo||(Jo=ts`<div>No device config loaded</div>`))}_renderFirmwareOta(){var e;const t=this._firmwareOtaStatus,i=(null==t?void 0:t.installed_version)||(null===(e=this.selectedDevice)||void 0===e?void 0:e.firmware)||"—",o=(null==t?void 0:t.latest_version)||"—",a=Boolean((null==t?void 0:t.supported)&&(null==t?void 0:t.secure_ota)&&!(null!=t&&t.bootstrap_required));return Ws(oa||(oa=ts`
    ...
    `),i,null!=t&&t.release_available?Ws(aa||(aa=ts`<span>Última Release: ${0}</span>`),o):Ws(ra||(ra=ts`<span>Release: por verificar</span>`)),null!=t&&t.host?Ws(sa||(sa=ts`<span class="firmware-host">${0}</span>`),t.host):Xs,t?t.supported?t.bootstrap_required?Ws(da||(da=ts`
            ...
            `)),this._firmwareBusy||this._firmwareChecking,this._checkFirmwareUpdates,this._firmwareChecking?"A verificar Releases…":"Verificar Releases",null!=t&&t.release_available?Ws(pa||(pa=ts`
                ...
                `),o,t.release_url?Ws(ha||(ha=ts`
                        ...
                        `),t.release_url):Xs,this._firmwareBusy||!a,this._installLatestFirmware,this._firmwareBusy?"A processar firmware…":`Flash da última Release (${o})`):Ws(ua||(ua=ts`
    ...
    `),i.length,1===i.length?"":"s",null!=t&&t.acl_entries_error?Ws(Ua||(Ua=ts`
        ...
        `),t.acl_entries_error):Xs,i.length?Ws(ja||(ja=ts`
    ...
    `),null!==(e=this._editValues.name)&&void 0!==e?e:this._deviceConfig.name,e=>{this._editValues.name=e.target.value},!this._editValues.name||this._editValues.name===this._deviceConfig.name,this._handleNameSave,this._showRegenIdentityConfirm,this._importKeyValue,e=>{this._importKeyValue=e.target.value},!this._importKeyValue.trim(),this._handleImportKeyConfirm):Xs}_hasChanges(e,t){return!!this._deviceConfig&&t.some(e=>void 0!==this._editValues[e]&&this._editValues[e]!==this._deviceConfig[e])}async _handleApply(e){if(!this.hass||!this._deviceConfig)return;let t=[];switch(e){case"device-name":t=["name"];break;case"radio-settings":t=["tx_power","frequency","bandwidth","spreading_factor","coding_rate","path_hash_mode","rx_boosted_gain","adc_multiplier"]}const i={};for(const e of t)void 0!==this._editValues[e]&&(i[e]=this._editValues[e]);this._saving=!0;try{var o;const a=await Rn(this.hass,i,null===(o=this.config)||void 0===o?void 0:o.entry_id);if(a.success){this._deviceConfig&&(this._deviceConfig={...this._deviceConfig,...i});for(const e of t)delete this._editValues[e];this._editValues={...this._editValues},"radio-settings"===e&&("rx_boosted_gain"in i||"adc_multiplier"in i)&&await this._readRepeaterStatus(!1,!1),a.rename?this._renameSuccess=a.rename:this._showStatusMessage(`Saved: ${t.join(", ")}`,"success")}else this._showStatusMessage("Save failed","error")}catch(e){this._showStatusMessage(`Error: ${String(e)}`,"error")}finally{this._saving=!1}}async _copyToClipboard(e){try{await navigator.clipboard.writeText(e),this._showStatusMessage("Copied to clipboard","success")}catch(e){this._showStatusMessage("Failed to copy","error")}}_showStatusMessage(e,t){this._statusMessage={text:e,type:t},null!==this._statusMessageTimeout&&clearTimeout(this._statusMessageTimeout),this._statusMessageTimeout=window.setTimeout(()=>{this._statusMessage=null,this._statusMessageTimeout=null},5e3)}_handleNameSave(){var e;const t=this._editValues.name,i=null===(e=this._deviceConfig)||void 0===e?void 0:e.name;if(void 0===t||t===i)return;const o=e=>(e||"").toLowerCase().replace(/[^a-z0-9]+/g,"_").replace(/^_|_$/g,""),a=o(null!=i?i:""),r=o(String(t));this._confirmAction={title:"Rename Device",message:`Renaming the device will rename all entity IDs ending in _${a} to _${r}. Any automations, scripts, or dashboards referencing entity IDs by the old name will need updating. A repair issue will list every renamed entity. Continue?`,onConfirm:async()=>{await this._handleApply("device-name")}},this._confirmDialogOpen=!0}async _applyLocation(){if(this.hass&&this._deviceConfig){this._saving=!0;try{var e;const i=["latitude","longitude"],o={};if("ha_location"===this._locationSource){const e=this.hass.states["zone.home"];if(!e||null==e.attributes.latitude||null==e.attributes.longitude)return void this._showStatusMessage("Could not read zone.home coordinates from Home Assistant","error");o.latitude=e.attributes.latitude,o.longitude=e.attributes.longitude}else for(const e of i)void 0!==this._editValues[e]&&(o[e]=this._editValues[e]);if(Object.keys(o).length>0){var t;if(!(await Rn(this.hass,o,null===(t=this.config)||void 0===t?void 0:t.entry_id)).success)return void this._showStatusMessage("Failed to save coordinates","error");this._deviceConfig&&(this._deviceConfig={...this._deviceConfig,...o});for(const e of i)delete this._editValues[e];this._editValues={...this._editValues}}if(!(await Pn(this.hass,this._locationSource,null===(e=this.config)||void 0===e?void 0:e.entry_id)).success)return void this._showStatusMessage("Failed to update location source","error");await this._loadDeviceConfig(),this._showStatusMessage("Location settings applied","success")}catch(e){this._showStatusMessage(`Error: ${String(e)}`,"error")}finally{this._saving=!1}}}_showRegenIdentityConfirm(){this._confirmAction={title:"Regenerate Identity",message:"This will create a new cryptographic identity, reboot the device, and migrate all entity IDs to the new key prefix. Existing automations referencing entity IDs by the old prefix will need updating. All contacts must re-add this device. This cannot be undone.",requireTyped:"REGENERATE",onConfirm:async()=>{var e;this.hass&&this._startIdentityFlow("regenerate",{type:"hivefw_integration/regenerate_identity",payload:null!==(e=this.config)&&void 0!==e&&e.entry_id?{entry_id:this.config.entry_id}:{}})}},this._confirmDialogOpen=!0}_handleImportKeyConfirm(){const e=this._importKeyValue.trim().replace(/\s+/g,"");e&&(64===e.length||128===e.length?/^[0-9a-fA-F]+$/.test(e)?(this._confirmAction={title:"Import Private Key",message:"Importing a private key will replace the device identity, reboot the device, and migrate all entity IDs to the new key prefix. Existing automations referencing entity IDs by the old prefix will need updating. All contacts must re-add this device.",requireTyped:"IMPORT",onConfirm:()=>this._importIdentityKey()},this._confirmDialogOpen=!0):this._showStatusMessage("Private key must be hex (0-9, a-f)","error"):this._showStatusMessage("Private key must be 64 or 128 hex characters","error"))}async _importIdentityKey(){var e;if(!this.hass||!this._importKeyValue.trim())return;const t=this._importKeyValue.trim().replace(/\s+/g,"");this._importKeyValue="";const i={private_key:t};null!==(e=this.config)&&void 0!==e&&e.entry_id&&(i.entry_id=this.config.entry_id),this._startIdentityFlow("import",{type:"hivefw_integration/import_identity",payload:i})}_startIdentityFlow(e,t){if(!this.hass)return;this._identityFlowUnsubscribe&&(this._identityFlowUnsubscribe(),this._identityFlowUnsubscribe=null),this._identityFlowState={kind:"progress",flow:e,currentStep:"generating",completedSteps:new Set};const{unsubscribe:i}=function(e,t,i,o){let a,r=null;const s=new Promise(e=>{a=e});let n={success:!1,code:"unknown",message:"Identity flow terminated without a result event."};return e.connection.subscribeMessage(e=>{if("done"===e.step&&e.success&&e.old_pubkey&&e.new_pubkey){const t={success:!0,old_pubkey:e.old_pubkey,new_pubkey:e.new_pubkey,warning:e.warning};n=t,o({type:"result",data:t})}else"done"!==e.step&&o({type:"progress",step:e.step})},{type:t,...i}).then(e=>{r=e,a(n)}).catch(e=>{const t={success:!1,code:e.code||"error",message:e.message||"Identity flow failed."};o({type:"error",data:t}),a(t)}),{unsubscribe:()=>{r&&r()},done:s}}(this.hass,t.type,t.payload,t=>{if("progress"===t.type){if("progress"!==this._identityFlowState.kind)return;const e=new Set(this._identityFlowState.completedSteps);e.add(this._identityFlowState.currentStep),this._identityFlowState={...this._identityFlowState,currentStep:t.step,completedSteps:e}}else"result"===t.type?this._identityFlowState={kind:"success",flow:e,oldPubkey:t.data.old_pubkey,newPubkey:t.data.new_pubkey,warning:t.data.warning}:"error"===t.type&&(this._identityFlowState={kind:"failure",flow:e,code:t.data.code,message:t.data.message})});this._identityFlowUnsubscribe=i}_closeIdentityFlowModal(){this._identityFlowUnsubscribe&&(this._identityFlowUnsubscribe(),this._identityFlowUnsubscribe=null);const e="success"===this._identityFlowState.kind;this._identityFlowState={kind:"closed"},e&&this._loadDeviceConfig()}_renderIdentityFlowModal(){const e=this._identityFlowState;if("closed"===e.kind)return Xs;const t="regenerate"===e.flow?"Regenerate Identity":"Import Private Key",i="regenerate"===e.flow?"Regenerating Identity":"Importing Identity",o="regenerate"===e.flow?"Identity Regenerated":"Identity Imported",a="regenerate"===e.flow?"Identity Regeneration Failed":"Identity Import Failed";let r,s;"progress"===e.kind?(r=Ws(Ka||(Ka=ts`
      ...
      `),Al.map(t=>{const i=e.completedSteps.has(t.step),o=e.currentStep===t.step;let a="○",r="var(--secondary-text-color)";return i?(a="✓",r="var(--success-color, #28a745)"):o&&(a="⏳",r="var(--primary-color)"),Ws(Ga||(Ga=ts`
            ...
            `),r,a,t.label)})),s=Xs):"success"===e.kind?(r=Ws(Xa||(Xa=ts`
        ...
        ${0}
      `),e.oldPubkey.slice(0,12),e.newPubkey.slice(0,12),e.warning?Ws(Qa||(Qa=ts`
    ...
    `),t,e=>e.stopPropagation(),n,"progress"===e.kind?Xs:Ws(tr||(tr=ts`
              <button class="modal-close" aria-label="Close" @click=${0}>&times;</button>
            `),this._closeIdentityFlowModal),r,s?Ws(ir||(ir=ts`<div style="margin-top: 20px; display: flex; justify-content: flex-end;">${0}</div>`),s):Xs)}_closeRenameSuccessModal(){this._renameSuccess=null,this._loadDeviceConfig(),this.dispatchEvent(new CustomEvent("device-renamed",{bubbles:!0,composed:!0}))}_renderRenameSuccessModal(){const e=this._renameSuccess;return e?Ws(or||(or=ts`
  ...
  `))],is([fn({type:Boolean})],zl.prototype,"open",void 0),is([fn({type:String})],zl.prototype,"contactName",void 0),is([fn({type:Object})],zl.prototype,"result",void 0),is([fn({type:String})],zl.prototype,"error",void 0),is([fn({type:Array})],zl.prototype,"availableRepeaters",void 0),is([fn({type:Object})],zl.prototype,"targetContact",void 0),is([_n()],zl.prototype,"pathMode",void 0),is([_n()],zl.prototype,"pathHops",void 0),is([_n()],zl.prototype,"enteredPath",void 0),is([_n()],zl.prototype,"_repeaterFilter",void 0),is([_n()],zl.prototype,"_running",void 0),zl=is([vn("meshcore-trace-dialog")],zl);let Il=class extends hn{constructor(){super(),this.open=!1,this.contacts=[],this._typeFilter="all",this._search="",this._onTypeChange=e=>{this._typeFilter=e.target.value},this._onSearchInput=e=>{this._search=e.target.value},this._close=()=>{this.dispatchEvent(new CustomEvent("target-picker-closed",{bubbles:!0,composed:!0}))},tl(this,{isOpen:()=>this.open,onEscape:()=>this._close()})}willUpdate(e){e.has("open")&&this.open&&!e.get("open")&&(this._typeFilter="all",this._search="")}render(){if(!this.open)return Ws(Ar||(Ar=ts``));const e=this._search.trim().toLowerCase(),t=this.contacts.filter(e=>{switch(this._typeFilter){case"all":default:return!0;case"client":return 1===e.type;case"repeater":return 2===e.type;case"room_server":return 3===e.type;case"sensor":return 4===e.type}}).filter(t=>{if(!e)return!0;const i=(t.adv_name||"").toLowerCase(),o=(t.pubkey_prefix||"").toLowerCase();return i.includes(e)||o.startsWith(e)}).sort((e,t)=>(e.adv_name||"").localeCompare(t.adv_name||""));return Ws(Rr||(Rr=ts`
    ...
    `),this.narrow||"always_hidden"===(null===(e=this.hass)||void 0===e?void 0:e.dockedSidebar)?Ws(Hr||(Hr=ts`<button class="menu-icon" @click=${0} aria-label="Toggle sidebar">
          ...
          <hivefw-integration-page
            ...
            @mark-all-read-requested=${0}></hivefw-integration-page>`),this.hass,this._config,[...this._channels,...this._contacts.filter(e=>e.added_to_node)],this._unread,this._pendingChatTarget,this.narrow,this._onActiveEntityChanged,()=>this._loadDeviceData(),()=>this._loadDeviceData(),()=>this._refreshChannelsFromRadio(),this._handleMarkAllReadRequested);case"nodes":return Ws(Qr||(Qr=ts`
          <meshcore-nodes-page
            .hass=${0}
            .config=${0}
            .contacts=${0}
