...
`)),Bn=/^<[^>]+>\s*/,Hn=/@\[([^\]]+)\]/g,Vn=/@(\w+)/g,Un={recipient_type_entity:"select.hivefw_recipient_type",channel_entity:"select.hivefw_channel",contact_entity:"select.hivefw_contact",channel_entity_pattern:"binary_sensor.hivefw_{prefix}_ch_{idx}_messages",contact_entity_pattern:"binary_sensor.hivefw_{prefix}_{contact}_messages",domain_filter:"hivefw"},jn={...Un,hours_to_show:48,initial_hours:1,max_messages:500,show_date_separators:!0,group_messages:!0,group_timeout:300,timestamp_format:"relative",update_mode:"auto",refresh_interval:30,enable_cache:!0,cache_ttl:86400,cache_max_size:5242880};async function Kn(e){try{return(await e.callWS({type:"hivefw_integration/get_devices"})).devices||[]}catch(e){return[]}}async function Wn(e,t){try{const i={type:"hivefw_integration/get_contacts"};return t&&(i.entry_id=t),(await e.callWS(i)).contacts||[]}catch(e){return[]}}async function Gn(e,t){try{const i={type:"hivefw_integration/get_channels"};return t&&(i.entry_id=t),(await e.callWS(i)).channels||[]}catch(e){return[]}}async function Xn(e,t){try{const i={type:"hivefw_integration/get_device_config"};return t&&(i.entry_id=t),await e.callWS(i)}catch(e){throw new Error("Failed to get device configuration")}}async function Yn(e,t,i){try{const o={type:"hivefw_integration/set_device_config",settings:t};return i&&(o.entry_id=i),await e.callWS(o)}catch(e){const t=e;return{success:!1,changed:[],error:t&&t.message?t.code?`${t.message} (${t.code})`:t.message:String(e)}}}async function Qn(e,t,i,o){try{const a={type:"hivefw_integration/execute_local",command:t};return i&&(a.args=i),o&&(a.entry_id=o),await e.callWS(a)}catch(e){const t=e;return{response:t&&t.message?t.code?`${t.message} (${t.code})`:t.message:String(e),success:!1,timestamp:(new Date).toISOString()}}}async function Jn(e,t,i,o){try{const a={type:"hivefw_integration/execute_remote",target_prefix:t,command:i};return o&&(a.entry_id=o),await e.callWS(a)}catch(e){const t=e;return{response:t&&t.message?t.code?`${t.message} (${t.code})`:t.message:String(e),success:!1,timestamp:(new Date).toISOString()}}}async function Zn(e,t){try{const i={type:"hivefw_integration/get_flood_scopes"};t&&(i.entry_id=t);const o=await e.callWS(i);return{scopes:o.scopes||[],global:!!o.global}}catch(e){return{scopes:[],global:!1}}}async function el(e,t){const i={type:"hivefw_integration/get_firmware_ota_status"};return t&&(i.entry_id=t),e.callWS(i)}async function tl(e,t,i,o){try{const a={type:"hivefw_integration/add_contact",public_key:t};return i&&(a.name=i),o&&(a.entry_id=o),await e.callWS(a)}catch(e){return{success:!1}}}async function il(e,t,i){try{const o={type:"hivefw_integration/remove_contact",public_key:t};return i&&(o.entry_id=i),await e.callWS(o)}catch(e){return{success:!1}}}class ol{constructor(){this._counts={},this._lastRead={},this._subscribers=new Set,this._markReadRequestedHandler=null,this._readProgress=null,this._postSwitchTimerHandler=null}subscribe(e){return this._subscribers.add(e),()=>{this._subscribers.delete(e)}}onMarkReadRequested(e){this._markReadRequestedHandler=e}onPostSwitchTimerFire(e){this._postSwitchTimerHandler=e}requestMarkRead(e){e&&this._markReadRequestedHandler&&this._markReadRequestedHandler(e)}_notify(){for(const e of[...this._subscribers])try{e()}catch(e){console.error("[UnreadController] subscriber callback threw",e)}}ingestBackendData(e,t){var i,o;this._counts={...null!==(i=null==e?void 0:e.unread)&&void 0!==i?i:{}},this._lastRead={...null!==(o=null==e?void 0:e.last_read)&&void 0!==o?o:{}},this._notify()}clearEntity(e){e&&this._counts[e]&&(this._counts={...this._counts,[e]:0},this._notify())}get counts(){return this._counts}get lastRead(){return this._lastRead}beginConversation(e,t){var i;this._clearPostSwitchTimer();const o={entityId:e,anchorId:e&&null!==(i=this._lastRead[e])&&void 0!==i?i:null,unreadCountAtSelection:t,graceUntil:Date.now()+1e3,postSwitchTimer:null,markReadFired:!1,lastMarkReadIdSent:null};this._readProgress=o,o.postSwitchTimer=setTimeout(()=>{var e;this._readProgress===o&&(o.postSwitchTimer=null,null===(e=this._postSwitchTimerHandler)||void 0===e||e.call(this))},1e3)}endConversation(){this._clearPostSwitchTimer(),this._readProgress=null}_clearPostSwitchTimer(){const e=this._readProgress;null!=e&&e.postSwitchTimer&&(clearTimeout(e.postSwitchTimer),e.postSwitchTimer=null)}resetUnreadCountAtSelection(){this._readProgress&&(this._readProgress.unreadCountAtSelection=0)}maybeReanchorOnLateData(e){const t=this._readProgress;if(!t||t.entityId!==e)return!1;if(null!==t.anchorId)return!1;if(t.markReadFired)return!1;const i=this._lastRead[e];return!!i&&(t.anchorId=i,!0)}onScrollState(e){return this._tryAdvanceCursor(e.entityId,e.lastMessageVisible,e.hasNewerMessages,e.bufferTailId,!1)}onPillJump(e){return this._tryAdvanceCursor(e.entityId,!0,!1,e.bufferTailId,!0)}_tryAdvanceCursor(e,t,i,o,a){if(!e)return!1;const r=this._readProgress;return!(!r||r.entityId!==e||!a&&Date.now()<r.graceUntil||i||!t||null!==o&&o===r.lastMarkReadIdSent||(r.lastMarkReadIdSent=o,r.markReadFired=!0,this.requestMarkRead(e),0))}badgeCount(e,t,i){if(!e)return 0;const o=this._counts;if(i&&o[i])return o[i];const a=/^\d+$/.test(e),r=t?`hivefw_${t}_ch_${e}_messages`:null;for(const[t,i]of Object.entries(o))if(!(i<=0))if(a){if(r){if(t.endsWith(r))return i}else if(t.endsWith(`_ch_${e}_messages`))return i}else{const o=e.substring(0,6);if(t.endsWith(`_${o}_messages`))return i}return 0}dividerAfterGroupIdx(e){const t=this._readProgress;if(!t)return null;let i=null;if(t.anchorId){let o=0;for(const a of e)if("date-separator"!==a.type){if(a.group.messages.some(e=>e.id===t.anchorId)){i=o;break}o++}}if(null!==i){let t=0;for(const o of e)if("date-separator"!==o.type){if(t>i&&!o.group.isOutgoing)return t;t++}return null}if(t.unreadCountAtSelection>0){const i=e.filter(e=>"date-separator"!==e.type).length,o=i-t.unreadCountAtSelection;return o>=0?o:0}return null}cursorAtTail(e,t){return!(!e||null===t)&&this._lastRead[e]===t}}const al=[1116352408,1899447441,3049323471,3921009573,961987163,1508970993,2453635748,2870763221,3624381080,310598401,607225278,1426881987,1925078388,2162078206,2614888103,3248222580,3835390401,4022224774,264347078,604807628,770255983,1249150122,1555081692,1996064986,2554220882,2821834349,2952996808,3210313671,3336571891,3584528711,113926993,338241895,666307205,773529912,1294757372,1396182291,1695183700,1986661051,2177026350,2456956037,2730485921,2820302411,3259730800,3345764771,3516065817,3600352804,4094571909,275423344,430227734,506948616,659060556,883997877,958139571,1322822218,1537002063,1747873779,1955562222,2024104815,2227730452,2361852424,2428436474,2756734187,3204031479,3329325298];function rl(e){const t=(new TextEncoder).encode(e),i=t.length,o=8*i,a=i+9+63&-64,r=new Uint8Array(a);r.set(t),r[i]=128;const s=new DataView(r.buffer);s.setUint32(a-4,o,!1);let n=1779033703,l=3144134277,d=1013904242,c=2773480762,p=1359893119,h=2600822924,u=528734635,m=1541459225;const g=new Int32Array(64);for(let e=0;e<a;e+=64){for(let t=0;t<16;t++)g[t]=s.getInt32(e+4*t,!1);for(let e=16;e<64;e++){const t=(g[e-15]>>>7|g[e-15]<<25)^(g[e-15]>>>18|g[e-15]<<14)^g[e-15]>>>3,i=(g[e-2]>>>17|g[e-2]<<15)^(g[e-2]>>>19|g[e-2]<<13)^g[e-2]>>>10;g[e]=g[e-16]+t+g[e-7]+i|0}let t=n,i=l,o=d,a=c,r=p,v=h,f=u,y=m;for(let e=0;e<64;e++){const s=y+((r>>>6|r<<26)^(r>>>11|r<<21)^(r>>>25|r<<7))+(r&v^~r&f)+al[e]+g[e]|0,n=t&i^t&o^i&o;y=f,f=v,v=r,r=a+s|0,a=o,o=i,i=t,t=s+(((t>>>2|t<<30)^(t>>>13|t<<19)^(t>>>22|t<<10))+n|0)|0}n=n+t|0,l=l+i|0,d=d+o|0,c=c+a|0,p=p+r|0,h=h+v|0,u=u+f|0,m=m+y|0}const v=e=>(e>>>0).toString(16).padStart(8,"0");return v(n)+v(l)+v(d)+v(c)+v(p)+v(h)+v(u)+v(m)}function sl(e){const t=[],i=new Set;let o;const a=new RegExp(Hn.source,"g");for(;null!==(o=a.exec(e));){const e=o[1];i.has(e)||(i.add(e),t.push(e))}const r=new RegExp(Vn.source,"g");for(;null!==(o=r.exec(e));){const e=o[1];i.has(e)||(i.add(e),t.push(e))}return t}function nl(e){if(!e||0===e.length)return{};let t,i;for(const o of e)void 0===t&&"string"==typeof o.flood_scope&&(t=o.flood_scope),void 0===i&&"boolean"==typeof o.region_scope&&(i=o.region_scope);return{floodScope:t,regionScope:i}}function ll(e){var t,i;const o=nl(e.rx_log_data);return{id:e.id,sender:e.sender,text:e.text,timestamp:new Date(e.timestamp),isOutgoing:e.outgoing,isSystem:!1,raw:e.text,mentions:sl(e.text),rxLogData:e.rx_log_data,deliveryStatus:e.delivery_status?{status:e.delivery_status,ackReceived:e.ack_received,repeaterCount:e.repeater_count,roundTripMs:e.round_trip_ms}:void 0,repeaterCount:e.repeater_count,floodScope:null!==(t=e.flood_scope)&&void 0!==t?t:o.floodScope,regionScope:null!==(i=e.region_scope)&&void 0!==i?i:o.regionScope}}function dl(e,t){return e.getFullYear()!==t.getFullYear()||e.getMonth()!==t.getMonth()||e.getDate()!==t.getDate()}function cl(e){const t=new Date,i=new Date(t.getFullYear(),t.getMonth(),t.getDate()),o=new Date(e.getFullYear(),e.getMonth(),e.getDate()),a=Math.floor((i.getTime()-o.getTime())/864e5);return 0===a?"Today":1===a?"Yesterday":a<7?e.toLocaleDateString(void 0,{weekday:"long"}):e.toLocaleDateString(void 0,{weekday:"long",month:"long",day:"numeric"})}class pl{constructor(e){this._messages=[],this._loading=!1,this._error=null,this._entityId=null,this._hass=null,this._pollTimer=null,this._realtimeSubscriptions=[],this._retryCount=0,this._onChange=null,this._fetchDebounce=null,this._active=!1,this._hasOlderMessages=!0,this._loadingOlder=!1,this._hasNewerMessages=!1,this._loadingNewer=!1,this._newMessagesWhileAway=0,this._userAtBottom=!1,this._config=e}get messages(){return this._messages}get loading(){return this._loading}get error(){return this._error}get entityId(){return this._entityId}get loadingOlder(){return this._loadingOlder}get hasOlderMessages(){return this._hasOlderMessages}get loadingNewer(){return this._loadingNewer}get hasNewerMessages(){return this._hasNewerMessages}get newMessagesWhileAway(){return this._newMessagesWhileAway}setUserAtBottom(e){this._userAtBottom!==e&&(this._userAtBottom=e,e&&!this._hasNewerMessages&&this._newMessagesWhileAway>0&&(this._newMessagesWhileAway=0,this._notify()))}resetNewMessagesCounter(){0!==this._newMessagesWhileAway&&(this._newMessagesWhileAway=0,this._notify())}setOnChange(e){this._onChange=e}setHass(e){this._hass=e}setConfig(e){this._config=e}async switchEntity(e,t=null){if(e!==this._entityId){if(this._stopUpdates(),this._entityId=e,this._messages=[],this._error=null,this._retryCount=0,this._hasOlderMessages=!0,this._loadingOlder=!1,this._hasNewerMessages=!1,this._loadingNewer=!1,this._newMessagesWhileAway=0,this._userAtBottom=!1,!e)return this._active=!1,void this._notify();this._active=!0,this._startUpdates(e),t?await this._fetchAroundAnchor(e,t):await this._fetchMessages(e)}}async refresh(){this._entityId&&await this._fetchMessages(this._entityId)}addOptimisticMessage(e,t){const i=new Date,o={id:`optimistic_${i.getTime()}_${Math.random().toString(36).slice(2,8)}`,sender:e,text:t,timestamp:i,isOutgoing:!0,isSystem:!1,raw:`${e}: ${t}`,mentions:[]};this._messages=[...this._messages,o],this._notify()}async loadOlderMessages(){if(!this._loadingOlder&&this._hasOlderMessages&&this._hass&&this._entityId){this._loadingOlder=!0,this._notify();try{const e=this._messages.find(e=>!e.id.startsWith("rt_")&&!e.id.startsWith("optimistic_")),t={type:"hivefw_integration/get_stored_messages",entity_id:this._entityId,limit:50};e&&(t.before=e.id);const i=await this._hass.callWS(t),o=i.messages.map(ll);this._hasOlderMessages=i.has_more;const a=new Set(this._messages.map(e=>e.id)),r=o.filter(e=>!a.has(e.id));r.length>0&&(this._messages=[...r,...this._messages],this._messages.sort((e,t)=>e.timestamp.getTime()-t.timestamp.getTime()))}catch(e){}finally{this._loadingOlder=!1,this._notify()}}}async loadNewerMessages(){if(!this._loadingNewer&&this._hasNewerMessages&&this._hass&&this._entityId){this._loadingNewer=!0,this._notify();try{let t;for(let e=this._messages.length-1;e>=0;e--){const i=this._messages[e].id;if(!i.startsWith("rt_")&&!i.startsWith("optimistic_")){t=i;break}}const i={type:"hivefw_integration/get_stored_messages",entity_id:this._entityId,limit:50};t&&(i.after=t);const o=await this._hass.callWS(i),a=o.messages.map(ll);this._hasNewerMessages=o.has_more;const r=new Set(a.map(e=>e.id));this._messages=this._messages.filter(e=>!e.id.startsWith("rt_")||!r.has(e.id.substring(3)));const s=new Set(this._messages.map(e=>e.id)),n=a.filter(e=>!s.has(e.id));if(n.length>0){var e;this._messages=[...this._messages,...n],this._messages.sort((e,t)=>e.timestamp.getTime()-t.timestamp.getTime());const t=null!==(e=this._config.max_messages)&&void 0!==e?e:500;this._messages.length>t&&(this._messages=this._messages.slice(-t),this._hasOlderMessages=!0)}}catch(e){}finally{this._loadingNewer=!1,this._notify()}}}async fetchAroundTimestamp(e){const t=new Date(e).getTime(),i=this._messages.find(e=>Math.abs(e.timestamp.getTime()-t)<2e3);if(i)return!0;let o=0;for(;this._hasOlderMessages&&o<20;){await this.loadOlderMessages(),o++;const e=this._messages.find(e=>Math.abs(e.timestamp.getTime()-t)<2e3);if(e)return!0}return!1}pause(){this._stopUpdates(),this._active=!1,this._fetchDebounce&&(clearTimeout(this._fetchDebounce),this._fetchDebounce=null)}async resume(){this._entityId&&!this._active&&(this._active=!0,this._startUpdates(this._entityId),await this._fetchMessages(this._entityId))}destroy(){this._stopUpdates(),this._active=!1,this._fetchDebounce&&(clearTimeout(this._fetchDebounce),this._fetchDebounce=null),this._onChange=null}async _fetchMessages(e){if(this._hass){this._loading=!0,this._notify();try{var t;const i=50,o=await this._hass.callWS({type:"hivefw_integration/get_stored_messages",entity_id:e,limit:i}),a=o.messages.map(ll);this._hasOlderMessages=o.has_more;const r=new Set(a.map(e=>e.id)),s=this._messages.filter(e=>{if(e.id.startsWith("optimistic_")){const t=a.some(t=>t.sender===e.sender&&t.text===e.text);return!t}if(e.id.startsWith("rt_")){const t=e.id.substring(3);return!r.has(t)}return!1});this._messages=[...a,...s],this._messages.sort((e,t)=>e.timestamp.getTime()-t.timestamp.getTime());const n=null!==(t=this._config.max_messages)&&void 0!==t?t:500;this._messages.length>n&&(this._messages=this._messages.slice(-n),this._hasOlderMessages=!0),this._error=null,this._retryCount=0}catch(e){const t=e instanceof Error?e.message:String(e);this._error=`Failed to fetch messages: ${t}`,this._retryCount++}finally{this._loading=!1,this._notify()}}}async _fetchAroundAnchor(e,t){if(this._hass){this._loading=!0,this._notify();try{var i;const o=await async function(e,t,i,o=25,a=50){return e.callWS({type:"hivefw_integration/get_messages_around",entity_id:t,anchor_id:i,before_limit:o,after_limit:a})}(this._hass,e,t),a=o.messages.map(ll);this._hasOlderMessages=o.has_more_before,this._hasNewerMessages=o.has_more_after;const r=new Set(a.map(e=>e.id)),s=this._messages.filter(e=>{if(e.id.startsWith("optimistic_")){const t=a.some(t=>t.sender===e.sender&&t.text===e.text);return!t}if(e.id.startsWith("rt_")){const t=e.id.substring(3);return!r.has(t)}return!1});this._messages=[...a,...s],this._messages.sort((e,t)=>e.timestamp.getTime()-t.timestamp.getTime());const n=null!==(i=this._config.max_messages)&&void 0!==i?i:500;this._messages.length>n&&(this._messages=this._messages.slice(-n),this._hasOlderMessages=!0),this._error=null,this._retryCount=0}catch(e){const t=e instanceof Error?e.message:String(e);this._error=`Failed to fetch messages: ${t}`,this._retryCount++}finally{this._loading=!1,this._notify()}}}_startUpdates(e){this._startPolling(e),this._subscribeRealtime(e).catch(()=>{})}async _subscribeRealtime(e){if(!this._hass)return;const t=[];try{const i=await this._hass.connection.subscribeEvents(t=>{t.data.entity_id===e&&this._handleRealtimeMessage(t.data)},"hivefw_message");t.push(i);const o=await this._hass.connection.subscribeEvents(t=>{t.data.entity_id===e&&this._handleDeliveryUpdate(t.data)},"hivefw_delivery_update");t.push(o),this._realtimeSubscriptions=t}catch(e){throw t.forEach(e=>e()),e}}_handleRealtimeMessage(e){var t,i;const o=null!==(t=e.sender_name)&&void 0!==t?t:e.sender,a=null!==(i=e.message)&&void 0!==i?i:e.text;if(o===this._config.node_name){if(o&&a){const t=e.ack_received,i=e.repeater_count,s=e.rx_log_data,n=e.message_type;let l;var r;if("dm"===n||"direct"===n)l={status:!0===t?"delivered":"sent",ackReceived:null!=t?t:void 0};else l={status:"sent",repeaterCount:null!=i?i:null!==(r=null==s?void 0:s.length)&&void 0!==r?r:0};for(let e=this._messages.length-1;e>=0;e--){const t=this._messages[e];if(t.id.startsWith("optimistic_")&&t.sender===o&&t.text===a){t.deliveryStatus=l,s&&(t.rxLogData=s),this._notify();break}}}!this._entityId||this._hasNewerMessages||this._hasOlderMessages||this._debouncedFetch(this._entityId)}else{if(o&&a){let t=a.replace(Bn,"");const i=o+": ";t.startsWith(i)&&(t=t.substring(i.length));const r=e.timestamp||(new Date).toISOString(),s=new Date(r),n=function(e,t,i){return rl(`${e}|${t}|${i}`).substring(0,12)}(r,o,t),l=`rt_${n}`,d=this._messages.some(e=>e.id===l||e.id===n);if(!d){const i=sl(t),r=e.rx_log_data,n={id:l,sender:o,text:t,timestamp:s,isOutgoing:!1,isSystem:!1,raw:a,mentions:i,rxLogData:r&&r.length>0?r:void 0,...nl(r)};this._messages.push(n),this._messages.sort((e,t)=>e.timestamp.getTime()-t.timestamp.getTime()),this._userAtBottom&&!this._hasNewerMessages||this._newMessagesWhileAway++,this._notify()}}!this._entityId||this._hasNewerMessages||this._hasOlderMessages||this._debouncedFetch(this._entityId)}}_debouncedFetch(e){this._fetchDebounce&&clearTimeout(this._fetchDebounce),this._fetchDebounce=setTimeout(async()=>{if(this._fetchDebounce=null,this._active)try{await this._fetchMessages(e)}catch(e){}},500)}_handleDeliveryUpdate(e){const t=e.rx_log_data;if(e.progressive&&t&&t.length>0){const i=e.sender_name,o=e.message,a=e.timestamp;if(i&&o){const e=a?new Date(a).getTime():0;for(let a=this._messages.length-1;a>=0;a--){const r=this._messages[a];if(!r.isOutgoing&&r.sender===i&&r.text===o&&(!e||Math.abs(r.timestamp.getTime()-e)<1e4))return r.rxLogData=t,r.repeaterCount=t.length,void this._notify()}}}const i=e.send_id,o=e.status,a=e.repeater_count,r=e.ack_received,s=e.round_trip_ms,n=e.progressive;if(!i)return;let l,d;l=o||(!0===r?"delivered":!n||void 0!==a&&0!==a?"sent":"waiting");for(let e=this._messages.length-1;e>=0;e--)if(this._messages[e].isOutgoing){d=this._messages[e];break}d&&(d.deliveryStatus={status:l,repeaterCount:a,ackReceived:r,roundTripMs:s},void 0!==a&&(d.repeaterCount=a),this._notify())}async _pollFetch(e){if(this._hass&&!this._hasNewerMessages)try{let i;for(let e=this._messages.length-1;e>=0;e--){const t=this._messages[e].id;if(!t.startsWith("rt_")&&!t.startsWith("optimistic_")){i=t;break}}const o={type:"hivefw_integration/get_stored_messages",entity_id:e,limit:50};i&&(o.after=i);const a=await this._hass.callWS(o);if(0===a.messages.length)return this._error=null,void(this._retryCount=0);const r=a.messages.map(ll),s=new Set(this._messages.map(e=>e.id)),n=r.filter(e=>!s.has(e.id));if(n.length>0){var t;const e=new Set(n.map(e=>e.id));this._messages=this._messages.filter(t=>!t.id.startsWith("rt_")||!e.has(t.id.substring(3))),this._messages=this._messages.filter(e=>!e.id.startsWith("optimistic_")||!n.some(t=>t.sender===e.sender&&t.text===e.text)),this._messages=[...this._messages,...n],this._messages.sort((e,t)=>e.timestamp.getTime()-t.timestamp.getTime());const i=null!==(t=this._config.max_messages)&&void 0!==t?t:500;this._messages.length>i&&(this._messages=this._messages.slice(-i),this._hasOlderMessages=!0),this._notify()}this._error=null,this._retryCount=0}catch(e){this._retryCount++}}_startPolling(e){const t=()=>{if(!this._active)return;const i=this._retryCount>=5?6e4:3e4;this._pollTimer=setTimeout(async()=>{if(this._active){try{await this._pollFetch(e)}catch(e){}t()}},i)};t()}_stopUpdates(){this._pollTimer&&(clearTimeout(this._pollTimer),this._pollTimer=null);for(const e of this._realtimeSubscriptions)e();this._realtimeSubscriptions=[]}_notify(){this._onChange&&this._onChange()}}let hl=class extends zn{constructor(){super(...arguments),this.conversations=[],this.activeId=null,this.unreadCounts={},this.nodePrefix=null,this._activeFilter="all",this._filteredConversations=[],this._appsChannelId=null,this._appsPickerOpen=!1}connectedCallback(){super.connectedCallback(),this._loadAppsChannelPreference()}updated(e){e.has("nodePrefix")&&this._loadAppsChannelPreference(),(e.has("conversations")||e.has("_activeFilter")||e.has("_appsChannelId"))&&this._updateFiltered()}render(){const e=this._getAppsChannel(),t=this._channelConversations();return mn(n||(n=ws`
  ...
  `)),$s([Pn({type:Array})],hl.prototype,"conversations",void 0),$s([Pn({type:String})],hl.prototype,"activeId",void 0),$s([Pn({attribute:!1})],hl.prototype,"unread",void 0),$s([Pn({type:Object})],hl.prototype,"unreadCounts",void 0),$s([Pn({type:String})],hl.prototype,"nodePrefix",void 0),$s([qn()],hl.prototype,"_activeFilter",void 0),$s([qn()],hl.prototype,"_filteredConversations",void 0),$s([qn()],hl.prototype,"_appsChannelId",void 0),$s([qn()],hl.prototype,"_appsPickerOpen",void 0),hl=$s([Dn("meshcore-conversation-list")],hl);const ul=["a[href]","button:not([disabled])",'input:not([disabled]):not([type="hidden"])',"select:not([disabled])","textarea:not([disabled])",'[tabindex]:not([tabindex="-1"])'].join(","),ml=[];let gl=!1;function vl(){gl||(gl=!0,document.addEventListener("keydown",fl,!0))}function fl(e){0!==ml.length&&ml[ml.length-1]._handleKeyDown(e)}class yl{constructor(e,t){this.host=e,this.opts=t,this._wasOpen=!1,this._previousActive=null,this._inStack=!1,this.host.addController(this),vl()}hostConnected(){vl()}hostDisconnected(){this._inStack&&this._popStack(),this._previousActive=null,this._wasOpen=!1}hostUpdated(){const e=this.opts.isOpen();if(e&&!this._wasOpen)this._previousActive=this._currentDocumentActive(),this._pushStack(),this._focusFirstSoon();else if(!e&&this._wasOpen){this._popStack();const e=this._previousActive;if(this._previousActive=null,e&&e.isConnected&&"function"==typeof e.focus)try{e.focus()}catch(e){}}this._wasOpen=e}_pushStack(){this._inStack||(ml.push(this),this._inStack=!0)}_popStack(){const e=ml.indexOf(this);e>=0&&ml.splice(e,1),this._inStack=!1}_getFocusables(){var e,t,i;const o=null!==(e=null===(t=(i=this.opts).getScope)||void 0===t?void 0:t.call(i))&&void 0!==e?e:this.host.shadowRoot;return o?Array.from(o.querySelectorAll(ul)).filter(e=>!(e.hasAttribute("aria-hidden")||e.hidden||null===e.offsetParent&&0===e.getClientRects().length)):[]}_focusFirstSoon(){queueMicrotask(()=>{var e,t,i;if(!this.opts.isOpen())return;const o=null!==(e=null===(t=(i=this.opts).getScope)||void 0===t?void 0:t.call(i))&&void 0!==e?e:this.host.shadowRoot;if(o&&this._scopeContainsFocus(o))return;const a=this._getFocusables();if(0!==a.length)try{a[0].focus()}catch(e){}})}_scopeContainsFocus(e){let t=document.activeElement;for(;t;){if(t===e)return!0;if(e.host===t)return!0;if("contains"in e&&e.contains(t))return!0;const i=t.shadowRoot;if(!i||!i.activeElement)break;t=i.activeElement}return!1}_currentDocumentActive(){let e=document.activeElement;for(;e&&e.shadowRoot&&e.shadowRoot.activeElement;)e=e.shadowRoot.activeElement;return e}_handleKeyDown(e){var t,i,o;if(!this.opts.isOpen())return;if("Escape"===e.key)return e.preventDefault(),e.stopPropagation(),void this.opts.onEscape();if("Tab"!==e.key)return;const a=this._getFocusables();if(0===a.length)return;const r=null!==(t=null===(i=(o=this.opts).getScope)||void 0===i?void 0:i.call(o))&&void 0!==t?t:this.host.shadowRoot,s=r?this._findFocusedInScope(r):null,n=s?a.indexOf(s):-1;let l;l=e.shiftKey?n<=0?a.length-1:n-1:-1===n||n>=a.length-1?0:n+1,e.preventDefault(),e.stopPropagation();try{a[l].focus()}catch(e){}}_findFocusedInScope(e){let t=document.activeElement;for(;t;){if(e===t||"contains"in e&&e.contains(t)){if(t.shadowRoot&&t.shadowRoot.activeElement){t=t.shadowRoot.activeElement;continue}return t}if(e.host===t){t=e.activeElement;continue}const i=t.shadowRoot;if(!i||!i.activeElement)break;t=i.activeElement}return null}}function bl(e,t){new yl(e,t)}let _l=class extends zn{constructor(){super(),this.open=!1,this.narrow=!1,this.editMode=!1,this.initialChannelIdx=0,this.initialChannelName="",this.initialScope="",this.initialKey="",this.availableIndices=[],this._channelIdx=0,this._channelName="",this._customKey="",this._autoKey=!0,this._scope="",this._availableScopes=null,this._globalAllowed=!1,this._saving=!1,this._error=null,this._initialized=!1,bl(this,{isOpen:()=>this.open,onEscape:()=>this._onCancel()})}willUpdate(e){if(e.has("open")&&this.open&&!this._initialized){if(this.editMode){this._channelIdx=this.initialChannelIdx,this._channelName=this.initialChannelName,this._scope=this.initialScope;const e=rl(this.initialChannelName).slice(0,32);this.initialKey&&this.initialKey.toLowerCase()!==e?(this._autoKey=!1,this._customKey=this.initialKey.toLowerCase()):(this._autoKey=!0,this._customKey="")}else this._channelIdx=this.availableIndices.length>0?this.availableIndices[0]:0;this._initialized=!0,this._loadScopes()}e.has("open")&&!this.open&&(this._initialized=!1)}async _loadScopes(){if(this._availableScopes=null,!this.hass)return this._availableScopes=[],void(this._globalAllowed=!1);const e=await Zn(this.hass,this.entryId);this._availableScopes=e.scopes,this._globalAllowed=e.global}render(){if(!this.open)return;const e=this._customKey.length,t=32===e||0===e||this._autoKey;return mn(f||(f=ws`
    ...
    `),t,e.adv_name||"Unknown",e.pubkey_prefix,i?"added":"discovered",i?mn(E||(E=ws`<svg viewBox="0 0 24 24" width="10" height="10" fill="currentColor" style="vertical-align: -1px; margin-right: 2px;"><path d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z"/></svg>Added`)):"Discovered",o?mn(P||(P=ws`
            ...
            `),()=>this._doRemoveContact(e),()=>{this._confirmingRemoveContact=null}):i?mn(q||(q=ws`
              ...
              `),a,()=>{this._confirmingRemoveContact=e.public_key},a?"...":"Remove"):mn(L||(L=ws`
                <button
              ...
              `),a,()=>this._doAddContact(e),a?"...":mn(B||(B=ws`<svg viewBox="0 0 24 24" width="12" height="12" fill="currentColor" style="vertical-align: -1px; margin-right: 4px;"><path d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z"/></svg>Add`))))}_renderChannels(){if(0===this._channels.length)return mn(H||(H=ws`
        <div class="empty-state">
  ...
  `)),$s([Pn({type:Object})],wl.prototype,"group",void 0),$s([Pn({type:Object})],wl.prototype,"message",void 0),$s([Pn({type:String})],wl.prototype,"timestampFormat",void 0),$s([qn()],wl.prototype,"_selectedMessage",void 0),wl=$s([Dn("meshcore-message-bubble")],wl);let $l=class extends zn{constructor(){super(),this._query="",this._fromDate="",this._toDate="",this._results=[],this._totalCount=0,this._searching=!1,this._hasSearched=!1,this._showFilters=!1,this._debounceTimer=null,bl(this,{isOpen:()=>!0,onEscape:()=>this.dispatchEvent(new CustomEvent("search-close",{bubbles:!0,composed:!0}))})}render(){return mn(ve||(ve=ws`
    ...
    `),this._query,this._onQueryInput,this._showFilters?"active":"",()=>{this._showFilters=!this._showFilters},this._showFilters?mn(fe||(fe=ws`
            ...
            `),this._fromDate,e=>{this._fromDate=e.target.value,this._doSearch()},this._toDate,e=>{this._toDate=e.target.value,this._doSearch()}):"",this._hasSearched?mn(ye||(ye=ws`<div class="result-count">${0} result${0}</div>`),this._totalCount,1!==this._totalCount?"s":""):"",this._searching?mn(be||(be=ws`<div class="loading-state">Searching...</div>`)):this._hasSearched?0===this._results.length?mn(xe||(xe=ws`
              ...
              `)))}_renderResult(e){const t=new Date(e.timestamp),i=t.toLocaleDateString(void 0,{month:"short",day:"numeric"}),o=t.toLocaleTimeString(void 0,{hour:"2-digit",minute:"2-digit"}),a=this._highlightQuery(e.text);return mn(we||(we=ws`
  ...
  `)),$s([Pn({type:Object})],$l.prototype,"hass",void 0),$s([Pn({type:String})],$l.prototype,"entryId",void 0),$s([Pn({type:String})],$l.prototype,"entityId",void 0),$s([Pn({type:String})],$l.prototype,"meshNodeName",void 0),$s([qn()],$l.prototype,"_query",void 0),$s([qn()],$l.prototype,"_fromDate",void 0),$s([qn()],$l.prototype,"_toDate",void 0),$s([qn()],$l.prototype,"_results",void 0),$s([qn()],$l.prototype,"_totalCount",void 0),$s([qn()],$l.prototype,"_searching",void 0),$s([qn()],$l.prototype,"_hasSearched",void 0),$s([qn()],$l.prototype,"_showFilters",void 0),$l=$s([Dn("meshcore-message-search")],$l);let kl=class extends zn{constructor(){super(...arguments),this.conversations=[],this.selectedId=null,this.narrow=!1,this.lastRead={},this._messageStore=null,this._unsubUnread=null,this._inputText="",this._sending=!1,this._viewportNarrow=!1,this._mediaQuery=null,this._mediaHandler=null,this._narrowShowMessages=!1,this._manageOpen=!1,this._manageInitialTab="contacts",this._searchOpen=!1,this._currentEntityId=null,this._conversationResolved=!1,this._pendingScroll=null,this._scrollInFlight=!1,this._scrollGuardUntil=0,this._lastMessageCount=0}get _isNarrow(){return this.narrow||this._viewportNarrow}connectedCallback(){super.connectedCallback(),this.config&&!this._messageStore&&(this._messageStore=new pl(this.config),this._messageStore.setOnChange(()=>this.requestUpdate())),this.unread&&!this._unsubUnread&&(this._unsubUnread=this.unread.subscribe(()=>{this.lastRead=this.unread.lastRead,this.requestUpdate()}),this.lastRead=this.unread.lastRead,this.unread.onPostSwitchTimerFire(()=>this._checkAndMarkReadIfAtBottom())),this._mediaQuery=window.matchMedia("(max-width: 870px)"),this._viewportNarrow=this._mediaQuery.matches,this._mediaHandler=e=>{this._viewportNarrow=e.matches},this._mediaQuery.addEventListener("change",this._mediaHandler)}disconnectedCallback(){var e;super.disconnectedCallback(),this._messageStore&&(this._messageStore.destroy(),this._messageStore=null),this._unsubUnread&&(this._unsubUnread(),this._unsubUnread=null),null===(e=this.unread)||void 0===e||e.endConversation(),this._mediaQuery&&this._mediaHandler&&(this._mediaQuery.removeEventListener("change",this._mediaHandler),this._mediaQuery=null,this._mediaHandler=null)}updated(e){if(e.has("hass")&&this.hass&&this._messageStore&&this._messageStore.setHass(this.hass),e.has("config")&&this.config&&this._messageStore){this._messageStore.setConfig(this.config);const t=e.get("config");t&&t.entry_id!==this.config.entry_id&&(this.selectedId=null,this._currentEntityId=null,this._conversationResolved=!1,this._pendingScroll=null,this._lastMessageCount=0,this.unread.endConversation(),this._messageStore.switchEntity(null),this.dispatchEvent(new CustomEvent("active-entity-changed",{detail:{entityId:null},bubbles:!0,composed:!0})))}if(e.has("selectedId")&&this._onConversationSelected(),e.has("lastRead")&&this._currentEntityId&&this._conversationResolved&&null===this._pendingScroll&&this.unread.maybeReanchorOnLateData(this._currentEntityId)&&(this._pendingScroll="last-read"),this._pendingScroll){const e=this._messageStore,t=e&&!e.loading;t&&e.messages.length>0?(this._executeScroll(this._pendingScroll),this._pendingScroll=null,this._lastMessageCount=e.messages.length):t&&0===e.messages.length&&(this._pendingScroll=null)}else if(this._messageStore){const e=this._messageStore.messages.length;e>this._lastMessageCount&&this._lastMessageCount>0&&this._scrollToBottomIfNearEnd(),this._lastMessageCount=e}}render(){var e,t,i,o,a,r;return this._isNarrow?this._narrowShowMessages?mn(Ce||(Ce=ws`
        ...
        `),this.conversations,this.selectedId,this.unread,this.unread.counts,(null===(a=this.config)||void 0===a?void 0:a.node_prefix)||null,e=>{const t=e.detail.id;t===this.selectedId&&(this.unread.resetUnreadCountAtSelection(),this._pendingScroll="bottom"),this.selectedId=t,this._narrowShowMessages=!0},()=>this._onManageRequested(),this._manageOpen?mn(Me||(Me=ws`
              <meshcore-manage-dialog
                ...
                @channels-changed=${0}
              ></meshcore-manage-dialog>
            `),this.hass,null===(r=this.config)||void 0===r?void 0:r.entry_id,this.narrow,this._manageInitialTab,()=>this._manageOpen=!1,this._onContactsChanged,this._onChannelsChanged):mn(Ae||(Ae=ws``))):mn(Re||(Re=ws`
      <div class="chat-layout">
        <meshcore-conversation-list
          .conversations=${0}
          .activeId=${0}
    ...
    `),this.conversations,this.selectedId,this.unread,this.unread.counts,(null===(e=this.config)||void 0===e?void 0:e.node_prefix)||null,e=>{const t=e.detail.id;t===this.selectedId&&(this.unread.resetUnreadCountAtSelection(),this._pendingScroll="bottom"),this.selectedId=t},()=>this._onManageRequested(),this.selectedId?mn(Fe||(Fe=ws`
        ...
        `),this.hass,null===(t=this.config)||void 0===t?void 0:t.entry_id,this._currentEntityId||void 0,null===(i=this.config)||void 0===i?void 0:i.node_name,this._onSearchResultSelected,()=>{this._searchOpen=!1}):"",this._manageOpen?mn(Oe||(Oe=ws`
          <meshcore-manage-dialog
            ...
            @channels-changed=${0}
          ></meshcore-manage-dialog>
        `),this.hass,null===(o=this.config)||void 0===o?void 0:o.entry_id,this.narrow,this._manageInitialTab,()=>this._manageOpen=!1,this._onContactsChanged,this._onChannelsChanged):mn(ze||(ze=ws``)))}_renderChatArea(){var e,t,i,o,a,r;if(!this._messageStore||!this.selectedId)return mn(Ie||(Ie=ws`
        <div class="empty-state">
    ...
    `),this._onReplyToSender,this._onChatScroll,this._messageStore.loadingOlder?mn(Ee||(Ee=ws`<div class="loading-older"><div class="loading-spinner"></div></div>`)):mn(Pe||(Pe=ws``)),this._messageStore.error?mn(qe||(qe=ws`
      ...
      `),n.group,null!==(r=null===(s=this.config)||void 0===s?void 0:s.timestamp_format)&&void 0!==r?r:"relative")),i++):t.push(mn(je||(je=ws`
  ...
  `)),$s([Pn({type:Object})],Cl.prototype,"contact",void 0),$s([Pn({type:Boolean})],Cl.prototype,"selected",void 0),Cl=$s([Dn("meshcore-contact-card")],Cl);let Sl=class extends zn{constructor(){super(),this.open=!1,this.pendingAction=null,this._confirming=!1,this._confirmAction=null,bl(this,{isOpen:()=>this.open,onEscape:()=>{this._confirming?(this._confirming=!1,this._confirmAction=null):this._close()}})}render(){if(!this.open||!this.node)return mn(pt||(pt=ws``));const e="adv_name"in this.node,t=e?2===this.node.type:"repeater"===this.node.type,i=e&&3===this.node.type,o=e?1===this.node.type:"client"===this.node.type,a=e&&4===this.node.type,r=e?this.node.adv_name:this.node.name,s=this.node.pubkey_prefix;let n=mn(ht||(ht=ws`<svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor"><path d="M16 11c1.66 0 2.99-1.34 2.99-3S17.66 5 16 5c-1.66 0-3 1.34-3 3s1.34 3 3 3zm-8 0c1.66 0 2.99-1.34 2.99-3S9.66 5 8 5C6.34 5 5 6.34 5 8s1.34 3 3 3zm0 2c-2.33 0-7 1.17-7 3.5V19h14v-2.5c0-2.33-4.67-3.5-7-3.5zm8 0c-.29 0-.62.02-.97.05 1.16.84 1.97 1.97 1.97 3.45V19h6v-2.5c0-2.33-4.67-3.5-7-3.5z"/></svg>`)),l="Contact",d="";return t?(n=mn(ut||(ut=ws`<svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor"><path d="M12 5c-3.87 0-7 3.13-7 7h2c0-2.76 2.24-5 5-5s5 2.24 5 5h2c0-3.87-3.13-7-7-7zm0-4C5.93 1 1 5.93 1 12h2c0-4.97 4.03-9 9-9s9 4.03 9 9h2c0-6.07-4.93-11-11-11zm0 8c-1.66 0-3 1.34-3 3s1.34 3 3 3 3-1.34 3-3-1.34-3-3-3z"/></svg>`)),l="Repeater",d="repeater"):i?(n=mn(mt||(mt=ws`<svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor"><path d="M20 2H4c-1.1 0-2 .9-2 2v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm0 14H6l-2 2V4h16v12z"/></svg>`)),l="Room Server",d="room-server"):a?(n=mn(gt||(gt=ws`<svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z"/></svg>`)),l="Sensor",d="sensor"):o&&(n=mn(vt||(vt=ws`<svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor"><path d="M17 1.01L7 1c-1.1 0-2 .9-2 2v18c0 1.1.9 2 2 2h10c1.1 0 2-.9 2-2V3c0-1.1-.9-1.99-2-1.99zM17 19H7V5h10v14z"/></svg>`)),l="Client",d="client"),mn(ft||(ft=ws`
    ...
    `),this._close,r,e=>e.stopPropagation(),`dialog-avatar ${d}`,n,r,l,this._close,this._confirming?mn(yt||(yt=ws`
  ...
  `)),$s([Pn({type:Array})],Rl.prototype,"contacts",void 0),$s([Pn({type:Array})],Rl.prototype,"channels",void 0),$s([Pn({type:Boolean})],Rl.prototype,"narrow",void 0),$s([Pn({type:Object})],Rl.prototype,"hass",void 0),$s([Pn({type:Object})],Rl.prototype,"config",void 0),$s([qn()],Rl.prototype,"_viewportNarrow",void 0),$s([qn()],Rl.prototype,"_mapReady",void 0),$s([qn()],Rl.prototype,"_mapFocusId",void 0),$s([qn()],Rl.prototype,"_primaryFilter",void 0),$s([qn()],Rl.prototype,"_typeFilter",void 0),$s([qn()],Rl.prototype,"_searchQuery",void 0),$s([qn()],Rl.prototype,"_activityFilter",void 0),$s([qn()],Rl.prototype,"_displayedContacts",void 0),$s([qn()],Rl.prototype,"_totalCount",void 0),$s([qn()],Rl.prototype,"_typeCounts",void 0),$s([qn()],Rl.prototype,"_l1Counts",void 0),$s([qn()],Rl.prototype,"_loading",void 0),$s([qn()],Rl.prototype,"_selectedNode",void 0),$s([qn()],Rl.prototype,"_nodeDetailDialogOpen",void 0),$s([qn()],Rl.prototype,"_pendingAction",void 0),$s([qn()],Rl.prototype,"_sortBy",void 0),Rl=$s([Dn("meshcore-nodes-page")],Rl);let Fl=class extends zn{constructor(){super(...arguments),this.narrow=!1,this._data=null,this._loading=!0,this._error=null,this._sort="recent"}firstUpdated(){this._load()}updated(e){e.has("config")&&this.hasUpdated&&this._load()}async _load(){if(this.hass){this._loading=!0,this._error=null;try{var e;this._data=await async function(e,t){try{const i={type:"hivefw_integration/get_hive_neighbors"};return t&&(i.entry_id=t),await e.callWS(i)}catch(e){return{supported:!1,repeater_enabled:!1,count:0,neighbors:[]}}}(this.hass,null===(e=this.config)||void 0===e?void 0:e.entry_id)}catch(e){this._error=e instanceof Error?e.message:"Não foi possível carregar os vizinhos."}finally{this._loading=!1}}}_age(e){const t=Math.max(0,Math.floor(e||0));if(t<10)return"agora";if(t<60)return`${t}s`;const i=Math.floor(t/60);if(i<60)return`${i} min`;const o=Math.floor(i/60);return o<24?`${o} h`:`${Math.floor(o/24)} d`}_sorted(){var e;const t=[...(null===(e=this._data)||void 0===e?void 0:e.neighbors)||[]];return"name"===this._sort?t.sort((e,t)=>e.name.localeCompare(t.name)):t.sort((e,t)=>e.secs_ago-t.secs_ago),t}render(){const e=this._data,t=null!=e&&e.neighbors.length?Math.min(...e.neighbors.map(e=>e.secs_ago)):null;return mn(ii||(ii=ws`
    ...
    `),this._loading,()=>this._load(),this._loading?"A atualizar…":"↻ Atualizar",this._error?this._state("Erro ao carregar",this._error):this._loading&&!e?this._state("A carregar","A consultar os caminhos dos adverts guardados pelo Companion."):null!=e&&e.supported?e.repeater_enabled?mn(oi||(oi=ws`
                      ...
                      ${0}
                    `),this._metric("Vizinhos",String(e.count),"Repeaters diretos"),this._metric("Método","Zero-hop","Advert Path"),this._metric("Último advert",null==t?"—":this._age(t),"mais recente"),this._metric("Modo","Ativo","HiveFW"),"recent"===this._sort?"active":"",()=>this._sort="recent","name"===this._sort?"active":"",()=>this._sort="name",0===e.neighbors.length?this._state("Ainda sem vizinhos zero-hop","Nenhum contacto Repeater tem neste momento um Advert Path direto guardado no Companion."):mn(ai||(ai=ws`<div class="grid">${0}</div>`),this._sorted().map(e=>this._neighbor(e)))):this._state("Modo Repeater desligado","O Companion está ligado, mas o modo Repeater encontra-se desligado."):this._state("Consulta indisponível","O Companion não disponibiliza os dados necessários."))}_metric(e,t,i){return mn(ri||(ri=ws`<div class="metric">
  ...
  `)),$s([Pn({type:Object})],Fl.prototype,"hass",void 0),$s([Pn({type:Object})],Fl.prototype,"config",void 0),$s([Pn({type:Boolean})],Fl.prototype,"narrow",void 0),$s([qn()],Fl.prototype,"_data",void 0),$s([qn()],Fl.prototype,"_loading",void 0),$s([qn()],Fl.prototype,"_error",void 0),$s([qn()],Fl.prototype,"_sort",void 0),Fl=$s([Dn("meshcore-neighbors-page")],Fl);let Tl=class extends zn{constructor(){super(),this.open=!1,this.title="Confirm",this.message="",this.confirmLabel="Confirm",this.cancelLabel="Cancel",this.dangerous=!1,this._typedValue="",bl(this,{isOpen:()=>this.open,onEscape:()=>this._onCancel()})}render(){if(!this.open)return;const e=this.requireTyped&&this._typedValue!==this.requireTyped;return mn(di||(di=ws`
    ...
    `),this._onOverlayClick,this.targetPrefix?mn(ui||(ui=ws`<div style="font-size: 12px; color: var(--secondary-text-color); margin-top: 4px;">
        ...
        `),!!a,t=>{this._paramValues[e.name]=t.target.checked},r,e.description?mn(Ci||(Ci=ws`<div class="form-description">${0}</div>`),e.description):"");case"select":{const t=e.selectOptions?e.selectOptions:(e.options||[]).map(e=>({label:e,value:e}));return mn(Si||(Si=ws`
          <div class="form-group">
        ...
        `),r,(e.bits||[]).map(t=>{var i,o;const a=Number(null!==(i=null!==(o=this._paramValues[e.name])&&void 0!==o?o:e.default)&&void 0!==i?i:0);return mn(Fi||(Fi=ws`
                <label class="form-toggle">
                  <input
                    type="checkbox"
                    ?checked=${0}
        ...
        `),r,e.required,e.min,e.max,String(a),t=>{const i=t.target;this._paramValues[e.name]=i.value?Number(i.value):""},e.description?mn(zi||(zi=ws`<div class="form-description">${0}</div>`),e.description):"");default:return mn(Ii||(Ii=ws`
          <div class="form-group">
            <label class="form-label">${0}</label>
            <input
              type="text"
        ...
        `),r,e.required,String(a),t=>{this._paramValues[e.name]=t.target.value},e.description?mn(Di||(Di=ws`<div class="form-description">${0}</div>`),e.description):"")}}_formatValue(e){if(!0===e)return"Yes";if(!1===e)return"No";if(null==e)return"—";if("object"==typeof e)try{return JSON.stringify(e)}catch(t){return String(e)}return"string"==typeof e&&e.length,String(e)}_renderFormattedResponse(e){try{const t=JSON.parse(e);if(t&&"object"==typeof t&&!Array.isArray(t)){const e=Object.entries(t);if(e.length>0)return mn(Ni||(Ni=ws`
          ...
          `),e.map(([e,t])=>{const i=Ll._FRIENDLY_LABELS[e]||e.replace(/_/g," ").replace(/\b\w/g,e=>e.toUpperCase()),o=Ll._VALUE_FORMATTERS[e],a=o?o(t):void 0;if(a&&"object"==typeof a)return mn(Ei||(Ei=ws`
                    <div style="grid-column: 1 / -1; color: var(--secondary-text-color);">${0}</div>
                    ${0}
                  `),i,Object.entries(a).map(([e,t])=>mn(Pi||(Pi=ws`
                      <div style="padding-left: 12px; white-space: nowrap;">${0}</div>
                      <div style="font-family: var(--code-font-family, monospace);">${0}</div>`),e,t?"✓":"✗")));const r=void 0!==a?String(a):this._formatValue(t),s="string"==typeof t&&t.length>24;return mn(qi||(qi=ws`
  ...
  `)),$s([Pn({type:String})],Yl.prototype,"content",void 0),$s([Pn({type:String})],Yl.prototype,"source",void 0),$s([qn()],Yl.prototype,"_open",void 0),Yl=$s([Dn("meshcore-info-tip")],Yl);const Ql=[{key:"sent_flood",label:"Sent · Flood",color:"var(--info, #2196f3)",dash:!1},{key:"sent_direct",label:"Sent · Direct",color:"var(--info, #2196f3)",dash:!0},{key:"recv_flood",label:"Recv · Flood",color:"var(--good, #4caf50)",dash:!1},{key:"recv_direct",label:"Recv · Direct",color:"var(--good, #4caf50)",dash:!0},{key:"errors",label:"Errors",color:"var(--bad, #f44336)",dash:!1}];let Jl=class extends zn{constructor(){super(...arguments),this.data=[],this.width=700,this.height=170,this.timeRange=48,this._hoverIndex=null,this._onPointerMove=e=>{const t=this._indexFromEvent(e);null!=t&&t!==this._hoverIndex&&(this._hoverIndex=t)},this._onPointerDown=e=>{const t=this._indexFromEvent(e);null!=t&&(this._hoverIndex=t===this._hoverIndex?null:t)},this._onPointerLeave=e=>{"mouse"===e.pointerType&&(this._hoverIndex=null)}}render(){return this.data&&0!==this.data.length?mn(eo||(eo=ws`
    ...
    `),this._renderChart(),null!=this._hoverIndex?this._renderTooltip():fn,Ql.map(e=>mn(to||(to=ws`<div class="legend-item">
            ...
            </div>`),e.dash?"dashed":"",e.color,e.label))):fn}_timeLabel(e,t){const i=Math.round((t-e)/36e5);return i<=0?"now":`-${i}h`}_fmtValue(e){return"number"==typeof e&&isFinite(e)?0===e?"0":e<1?e.toFixed(2):e.toFixed(1):"—"}_geom(){const e=this.width,t=this.height,i=e-40-12,o=t-12-22;let a=0;for(const e of this.data)for(const t of Ql){const i=e.values[t.key];"number"==typeof i&&isFinite(i)&&(a=Math.max(a,i))}a<=0&&(a=1);const r=Date.now(),s=36e5*this.timeRange,n=r-s;return{padL:40,padR:12,padT:12,padB:22,w:e,h:t,cw:i,ch:o,maxV:a,now:r,range:s,oldest:n,xScale:e=>40+(e-n)/s*i,yScale:e=>12+o-e/a*o}}_nearestBucket(e){const{xScale:t}=this._geom();let i=-1,o=1/0;for(let a=0;a<this.data.length;a++){const r=Math.abs(t(this.data[a].timestamp)-e);r<o&&(o=r,i=a)}return i}_indexFromEvent(e){const t=this.renderRoot.querySelector("svg");if(!t||0===this.data.length)return null;const i=t.getBoundingClientRect();if(0===i.width)return null;const o=(e.clientX-i.left)/i.width*this.width;return this._nearestBucket(o)}_renderChart(){const e=this._geom(),{padL:t,padR:i,padT:o,padB:a,w:r,h:s,ch:n,maxV:l,now:d,range:c,oldest:p,xScale:h,yScale:u}=e,m=[0,l/2,l].map(e=>{const o=u(e);return gn(io||(io=ws`
        <line x1="${0}" y1="${0}" x2="${0}" y2="${0}"
          stroke="var(--divider-color,#e0e0e0)" stroke-dasharray="4,4" opacity="0.3" />
        <text x="${0}" y="${0}" font-size="9" text-anchor="end"
          fill="var(--secondary-text-color,#727272)">${0}</text>`),t,o,r-i,o,t-6,o+3,e<1?e.toFixed(1):Math.round(e))}),g=[p,p+c/2,d].map(e=>gn(oo||(oo=ws`
        <text x="${0}" y="${0}" font-size="9" text-anchor="middle"
          fill="var(--secondary-text-color,#727272)">${0}</text>`),h(e),s-a+14,this._timeLabel(e,d))),v=Ql.map(e=>{const t=this.data.filter(t=>"number"==typeof t.values[e.key]&&isFinite(t.values[e.key])).map(t=>`${h(t.timestamp).toFixed(1)},${u(t.values[e.key]).toFixed(1)}`);if(0===t.length)return gn(ao||(ao=ws``));if(1===t.length){const[i,o]=t[0].split(",");return gn(ro||(ro=ws`<circle cx="${0}" cy="${0}" r="2" fill="${0}" />`),i,o,e.color)}return gn(so||(so=ws`<polyline points="${0}" fill="none" stroke="${0}"
        ...
        ${0}`),t,o,t,s-a,i)}return gn(ho||(ho=ws`
      ...
      </svg>`),r,s,this.timeRange,this._onPointerMove,this._onPointerDown,this._onPointerLeave,m,t,o,t,s-a,t,s-a,r-i,s-a,v,f,g,t,o-2,t,o,e.cw,n)}_renderTooltip(){const e=this._hoverIndex;if(null==e||e>=this.data.length)return fn;const t=this._geom(),i=this.data[e],o=t.xScale(i.timestamp)/t.w*100,a=o>55,r=new Date(i.timestamp).toLocaleString([],{weekday:"short",hour:"2-digit",minute:"2-digit"}),s=a?`left:${o}%; transform:translateX(calc(-100% - 8px));`:`left:${o}%; transform:translateX(8px);`;return mn(uo||(uo=ws`
      <div class="tooltip" style="${0}">
        <div class="tt-head">${0} · msg/min</div>
        ${0}
      </div>
    `),s,r,Ql.map(e=>mn(mo||(mo=ws`<div class="tt-row">
  ...
  `)),$s([Pn({type:Array})],Jl.prototype,"data",void 0),$s([Pn({type:Number})],Jl.prototype,"width",void 0),$s([Pn({type:Number})],Jl.prototype,"height",void 0),$s([Pn({type:Number})],Jl.prototype,"timeRange",void 0),$s([qn()],Jl.prototype,"_hoverIndex",void 0),Jl=$s([Dn("meshcore-message-rate-chart")],Jl);let Zl=class extends zn{constructor(){super(...arguments),this.entities=[],this.hiddenCount=0,this._rateHistory=[],this._rateHistoryKey=null}render(){if(!this.hass||!this.device)return fn;const e=new Set,t=this._renderHeroTiles(e),i=this._buildGroups(e);return mn(vo||(vo=ws`
    ...
    `),this._renderBatteryTile(),this._renderSignalTile(),this._renderRequestsTile(e))}_renderCompanionHero(e){const t=this._findByMetric("noise_floor");return t&&e.add(t.entity_id),mn($o||($o=ws`
      ...
      ${0}
      ${0}
    `),this._renderRepeaterStateTile(),this._renderCompanionRadioActivityTile(),this._renderMessagesSentTile(e),this._renderMessagesReceivedTile(e),this._renderUptimeTile(e),this._renderBatteryTile(),this._renderTemperatureTile(e),this._renderSignalTile(),this._renderDeviceClockTile(),this._renderProtocolInfoTile(),this._renderHardwareInfoTile(),this._renderRepeatFrequenciesTile(),this._renderQueueTile(e),this._renderCapacityInfoTile(),this._renderStorageTile(),this._renderLocationTile(),this._renderRequestTokensTile(e),this._renderDiscoveredContactsTile(e))}_renderHardwareInfoTile(){var e,t;const i=null===(e=this.repeaterStatus)||void 0===e?void 0:e.device_info,o=(null==i?void 0:i.model)||(null===(t=this.repeaterStatus)||void 0===t?void 0:t.model);if(!o)return fn;const a=null==i?void 0:i.firmware_build;return mn(ko||(ko=ws`
    ...
    `),o,a?mn(Co||(Co=ws`<span class="secondary">· ${0}</span>`),a):fn,100,0,100,"info")}_renderProtocolInfoTile(){var e,t;const i=null===(e=this.repeaterStatus)||void 0===e?void 0:e.device_info;if(!i)return fn;const o=null!=i.protocol_version?`v${i.protocol_version}`:"—",a=null==i.path_hash_mode?"—":null!==(t=["1 byte","2 bytes","3 bytes"][Number(i.path_hash_mode)])&&void 0!==t?t:String(i.path_hash_mode);return mn(So||(So=ws`
    ...
    `),o,a,100,0,100,"info")}_renderCapacityInfoTile(){var e,t,i;const o=null===(e=this.repeaterStatus)||void 0===e?void 0:e.device_info;return null==(null==o?void 0:o.max_contacts)&&null==(null==o?void 0:o.max_channels)?fn:mn(Mo||(Mo=ws`
    ...
    `),i[0],i.length>1?mn(Ro||(Ro=ws`<span class="secondary">· ${0} MHz</span>`),i.slice(1).join(" · ")):fn,100,0,100,"info")}_renderTemperatureTile(e){var t,i;const o=this._findByMetric("temperature");if(!o)return fn;const a=this._readNumber(o.entity_id);if(!Number.isFinite(a))return fn;e.add(o.entity_id);const r=(null!==(t=null===(i=this.hass)||void 0===i||null===(i=i.states[o.entity_id])||void 0===i||null===(i=i.attributes)||void 0===i?void 0:i.unit_of_measurement)&&void 0!==t?t:"°C").includes("F")?5*(a-32)/9:a,s=Ul("temperature",9*r/5+32);return mn(Fo||(Fo=ws`
    ...
    `),s,n,l,Math.min(r,120),0,120,s)}_renderRequestTokensTile(e){const t=this.entities.find(e=>e.entity_id.includes("request_rate_limiter"));if(!t)return fn;const i=this._readNumber(t.entity_id);if(!Number.isFinite(i))return fn;e.add(t.entity_id);const o=i<5?"bad":i<10?"warn":"good";return mn(Oo||(Oo=ws`
    ...
    `),r,a.toFixed(0),i,o,a,0,100,r)}_renderRepeaterStateTile(){const e=this.repeaterStatus;if(null==e||!e.supported)return fn;const t=Boolean(e.repeat);return mn(Do||(Do=ws`
    ...
    `),()=>this._fireMoreInfo(t.entity_id),this._renderInfoTip(r),r.band,this._formatNumber(i,0),Number.isFinite(a)?mn(Lo||(Lo=ws`<span class="secondary">· ${0} V</span>`),a.toFixed(3)):fn,i,0,100,r.band)}_renderSignalTile(){const e=this._findByMetric("rssi");if(!e)return fn;const t=this._readNumber(e.entity_id),i=this._findByMetric("snr"),o=i?this._readNumber(i.entity_id):NaN,a=Ul("rssi",t);return mn(Bo||(Bo=ws`
      <div class="hero-tile" @click=${0}>
        <div class="hero-tile-head">
    ...
    `),()=>this._fireMoreInfo(e.entity_id),this._renderInfoTip(a),a.band,this._formatNumber(t,0),Number.isFinite(o)?mn(Ho||(Ho=ws`<span class="secondary">· SNR ${0} dB</span>`),o.toFixed(1)):fn,t,-130,-30,a.band)}_renderRadioActivityTile(){const e=this._findByMetric("tx_airtime_util"),t=this._findByMetric("rx_airtime_util");if(!e&&!t)return fn;const i=e?this._readNumber(e.entity_id):0,o=t?this._readNumber(t.entity_id):0,a=Number.isFinite(i)?Math.max(0,i):0,r=Number.isFinite(o)?Math.max(0,o):0,s=Math.max(0,100-a-r),n=Ul("tx_airtime_util",a).band,l=Ul("rx_airtime_util",r).band,d=this._worseBand(n,l),c=[{value:a,label:`TX ${a.toFixed(1)}%`,kind:"tx"},{value:r,label:`RX ${r.toFixed(1)}%`,kind:"rx"},{value:s,label:`Idle ${s.toFixed(1)}%`,kind:"idle"}],p=a+r;return mn(Vo||(Vo=ws`
      <div class="hero-tile"
           @click=${0}>
        <div class="hero-tile-head">
    ...
    `),()=>e&&this._fireMoreInfo(e.entity_id),this._renderInfoTip({band:d,fillPct:0,tooltip:"Half-duplex composition over the last reporting interval. The radio can transmit OR receive, never both. TX above 10% indicates duty-cycle pressure; sustained TX+RX above 30% means the channel is congested."}),d,p.toFixed(1),c,100,"none",e?mn(Uo||(Uo=ws`<span class="ra-legend-item" @click=${0}>
                ...
                </span>`),t=>{t.stopPropagation(),e&&this._fireMoreInfo(e.entity_id)},a.toFixed(1)):mn(jo||(jo=ws`<span class="ra-legend-item">
                  <span class="legend-swatch tx"></span>TX ${0}%
                </span>`),a.toFixed(1)),t?mn(Ko||(Ko=ws`<span class="ra-legend-item" @click=${0}>
                  <span class="legend-swatch rx"></span>RX ${0}%
                </span>`),e=>{e.stopPropagation(),t&&this._fireMoreInfo(t.entity_id)},r.toFixed(1)):mn(Wo||(Wo=ws`<span class="ra-legend-item">
                  <span class="legend-swatch rx"></span>RX ${0}%
                </span>`),r.toFixed(1)),s.toFixed(1))}_renderMessagesSentTile(e){const t=this._findEntityIdMatching("nb_sent"),i=this._findEntityIdMatching("sent_flood"),o=this._findEntityIdMatching("sent_direct");if(!t||!i&&!o)return fn;const a=this._readNumber(t.entity_id),r=i?this._readNumber(i.entity_id):0,s=o?this._readNumber(o.entity_id):0,n=[{value:r,label:`Flood ${r}`,kind:"flood"},{value:s,label:`Direct ${s}`,kind:"direct"}];return e.add(t.entity_id),i&&e.add(i.entity_id),o&&e.add(o.entity_id),mn(Go||(Go=ws`
      <div class="hero-tile" @click=${0}>
        <div class="hero-tile-head">
    ...
    `),()=>this._fireMoreInfo(t.entity_id),this._renderInfoTip({band:"info",fillPct:0,tooltip:"Messages received (lifetime), split by receive mode:\n• Flood — broadcast packets received from neighbours.\n• Direct — routed packets where this node is on the path.\n\nEach bar below is a percentage of its own total:\n• Red = receive errors (CRC failures), as a share of all reception attempts (received + errors) — i.e. the error rate.\n• Amber = duplicate receptions, as a share of received messages (duplicates are a subset of received).\n\nBoth are context only, not banded — in a flooding mesh every active neighbour retransmits the same flood once, so a high duplicate ratio is normal (a 2-neighbour repeater sees ~50%, a 3-neighbour ~67%, etc.)."}),this._formatCount(s),d,"none",v>0?mn(Yo||(Yo=ws`<div class="err-line"
            ...
            </div>`),h,u.toFixed(1),Math.min(100,u).toFixed(1)):fn,n,l,v>0?mn(Jo||(Jo=ws`<span><span class="msg-swatch error"></span>Error ${0}</span>`),v):fn,h>0?mn(Zo||(Zo=ws`<span><span class="msg-swatch dup"></span>Dup ${0}</span>`),h):fn)}_renderRequestsTile(e){const t=this._findEntityIdMatching("request_succ"),i=this._findEntityIdMatching("request_fail");if(!t||!i)return fn;const o=this._readNumber(t.entity_id),a=this._readNumber(i.entity_id),r=o+a,s=r>0?o/r*100:0,n=r>=50?Ul("request_success_rate",s):{band:"info",fillPct:0,tooltip:""},l=[{value:o,label:`OK ${o}`,kind:"success"},{value:a,label:`Fail ${a}`,kind:"failure"}];return e.add(t.entity_id),e.add(i.entity_id),mn(ea||(ea=ws`
      <div class="hero-tile" @click=${0}>
        <div class="hero-tile-head">
    ...
    `),()=>this._fireMoreInfo(t.entity_id),this._renderInfoTip({...n,tooltip:"Outgoing requests this node initiated (login, telemetry, neighbour query) and how they resolved. Success rate bands: Green > 90%, Yellow 70–90%, Red < 70%, with a minimum sample of 50 attempts to colour. Below the floor, the bar stays neutral — too few samples to judge."}),n.band,r>0?`${s.toFixed(0)}%`:"—",r>0?mn(ta||(ta=ws`<span class="secondary">· ${0} attempt${0}</span>`),r,1===r?"":"s"):fn,l,"inline")}_formatCount(e){return Number.isFinite(e)?Math.round(e).toLocaleString():"—"}_renderLocationTile(){const e=this._findEntityIdMatching("latitude"),t=this._findEntityIdMatching("longitude");let i=e?this._readNumber(e.entity_id):NaN,o=t?this._readNumber(t.entity_id):NaN,a="entity";!Number.isFinite(i)&&Number.isFinite(this.fallbackLatitude)&&(i=this.fallbackLatitude,a="fallback"),!Number.isFinite(o)&&Number.isFinite(this.fallbackLongitude)&&(o=this.fallbackLongitude,a="fallback");const r=Number.isFinite(i)&&Number.isFinite(o)&&(0!==i||0!==o);if(!r)return fn;let s=null;if("entity"===a&&e){var n;const t=null===(n=this.hass)||void 0===n||null===(n=n.states[e.entity_id])||void 0===n?void 0:n.last_updated;if(t){const e=new Date(t);Number.isNaN(e.getTime())||(s=e)}}else"fallback"===a&&Number.isFinite(this.fallbackUpdated)&&(s=new Date(1e3*this.fallbackUpdated));const l=r&&s?this._formatRelativeTime(s):"";return mn(ia||(ia=ws`
      <div class="hero-tile" @click=${0}>
        <div class="hero-tile-head">
    ...
    `),()=>{e&&this._fireMoreInfo(e.entity_id)},"fallback"===a?mn(oa||(oa=ws`<span style="opacity:0.55;text-transform:none;letter-spacing:0;font-size:10px;margin-left:4px;">via contact</span>`)):fn,r?mn(aa||(aa=ws`<span class="coord-pair">
                ${0}, ${0}
              </span>`),i.toFixed(4),o.toFixed(4)):mn(ra||(ra=ws`<span class="primary">—</span>`)),l?mn(sa||(sa=ws`<div class="loc-updated">Updated ${0}</div>`),l):fn)}_formatRelativeTime(e){const t=(Date.now()-e.getTime())/1e3;return!Number.isFinite(t)||t<0||t<60?"just now":t<3600?`${Math.floor(t/60)} min ago`:t<86400?`${Math.floor(t/3600)} h ago`:`${Math.floor(t/86400)} d ago`}_renderCompanionRadioActivityTile(){const e=this._findEntityIdMatching("tx_airtime"),t=this._findEntityIdMatching("rx_airtime"),i=this._findByMetric("uptime_hours");if(!e&&!t||!i)return fn;const o=this._readUptimeMinutes(i);if(!Number.isFinite(o)||o<=0)return fn;const a=e?this._readNumber(e.entity_id):0,r=t?this._readNumber(t.entity_id):0;if(!Number.isFinite(a)&&!Number.isFinite(r))return fn;const s=e=>Number.isFinite(e)?Math.min(100,Math.max(0,e/o*100)):0,n=s(a),l=s(r),d=Math.max(0,100-n-l),c=Ul("tx_airtime_util",n).band,p=Ul("rx_airtime_util",l).band,h=this._worseBand(c,p),u=[{value:n,label:`TX ${n.toFixed(1)}%`,kind:"tx"},{value:l,label:`RX ${l.toFixed(1)}%`,kind:"rx"},{value:d,label:`Idle ${d.toFixed(1)}%`,kind:"idle"}],m=n+l;return mn(na||(na=ws`
      <div class="hero-tile"
           @click=${0}>
        <div class="hero-tile-head">
          <span>Radio activity${0}</span>
  ...
  `)),$s([Pn({type:Object})],Zl.prototype,"hass",void 0),$s([Pn({type:Object})],Zl.prototype,"device",void 0),$s([Pn({type:Array})],Zl.prototype,"entities",void 0),$s([Pn({type:Number})],Zl.prototype,"hiddenCount",void 0),$s([Pn({type:Number})],Zl.prototype,"fallbackLatitude",void 0),$s([Pn({type:Number})],Zl.prototype,"fallbackLongitude",void 0),$s([Pn({type:Number})],Zl.prototype,"fallbackUpdated",void 0),$s([Pn({type:Object})],Zl.prototype,"repeaterStatus",void 0),$s([qn()],Zl.prototype,"_rateHistory",void 0),Zl=$s([Dn("meshcore-node-summary")],Zl);const td=[{step:"generating",label:"Generating new key"},{step:"importing",label:"Sending key to device"},{step:"rebooting",label:"Rebooting device"},{step:"reconnecting",label:"Waiting for device reconnect"},{step:"reloading",label:"Reloading HiveFW integration"},{step:"verifying",label:"Verifying new identity"}];let id=class extends zn{constructor(){super(),this.narrow=!1,this.contactCount=0,this.channelCount=0,this._deviceConfig=null,this._repeaterStatus=null,this._managedDevices={repeaters:[],clients:[]},this._scopeDraft="",this._scopeGlobal=!1,this._scopeSaving=!1,this._regionTarget="",this._regionText="",this._regionBusy=!1,this._regionAction="allowf",this._regionName="",this._loading=!0,this._error=null,this._editValues={},this._saving=!1,this._firmwareOtaStatus=null,this._firmwareFile=null,this._firmwareBusy=!1,this._firmwareUploadProgress=null,this._dutyCycleValue=10,this._dutyCycleReadValue=null,this._dutyCycleBusy=null,this._commandDialogOpen=!1,this._confirmAction=null,this._confirmDialogOpen=!1,this._locationSource="manual",this._importKeyValue="",this._deviceEntities={},this._meshcoreDeviceMap={},this._entityRegistryLoaded=!1,this._hiddenSensors={},this._contextMenu=null,this._overlayPointerStarted=!1,this._settingsModalOpen=!1,this._keyManagementModalOpen=!1,this._identityFlowState={kind:"closed"},this._identityFlowUnsubscribe=null,this._renameSuccess=null,this._hiddenSensorsModalKey=null,this._statusMessage=null,this._statusMessageTimeout=null,this._onCompanionTrace=()=>{var e;const t=null===(e=this.selectedDevice)||void 0===e?void 0:e.entry_id;this.dispatchEvent(new CustomEvent("companion-trace-requested",{detail:{entryId:t},bubbles:!0,composed:!0}))},bl(this,{isOpen:()=>null!==this._contextMenu,onEscape:()=>this._closeContextMenu(),getScope:()=>{var e;return null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector('[data-a11y="tile-context"]')}}),bl(this,{isOpen:()=>this._settingsModalOpen,onEscape:()=>this._closeSettingsModal(),getScope:()=>{var e;return null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector('[data-a11y="companion-settings"]')}}),bl(this,{isOpen:()=>this._keyManagementModalOpen,onEscape:()=>this._closeKeyManagementModal(),getScope:()=>{var e;return null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector('[data-a11y="key-management"]')}}),bl(this,{isOpen:()=>null!==this._hiddenSensorsModalKey,onEscape:()=>this._closeHiddenSensorsModal(),getScope:()=>{var e;return null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector('[data-a11y="hidden-sensors"]')}}),bl(this,{isOpen:()=>"closed"!==this._identityFlowState.kind,onEscape:()=>{"success"!==this._identityFlowState.kind&&"failure"!==this._identityFlowState.kind||this._closeIdentityFlowModal()},getScope:()=>{var e;return null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector('[data-a11y="identity-flow"]')}}),bl(this,{isOpen:()=>null!==this._renameSuccess,onEscape:()=>this._closeRenameSuccessModal(),getScope:()=>{var e;return null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector('[data-a11y="rename-success"]')}})}connectedCallback(){super.connectedCallback(),this._loadDeviceConfig(),this._loadHiddenSensors()}disconnectedCallback(){super.disconnectedCallback(),null!==this._statusMessageTimeout&&(clearTimeout(this._statusMessageTimeout),this._statusMessageTimeout=null)}updated(e){e.has("config")&&this._loadDeviceConfig(),e.has("hass")&&this.hass&&!this._entityRegistryLoaded&&this._loadEntityRegistry()}async _loadDeviceConfig(){if(this.hass){this._loading=!0,this._error=null;try{var e,t,i,o;this._deviceConfig=await Xn(this.hass,null===(e=this.config)||void 0===e?void 0:e.entry_id);try{var a,r;this._repeaterStatus=await async function(e,t){const i={type:"hivefw_integration/get_local_repeater_status"};return t&&(i.entry_id=t),e.callWS(i)}(this.hass,null===(a=this.config)||void 0===a?void 0:a.entry_id),void 0!==(null===(r=this._repeaterStatus)||void 0===r?void 0:r.duty_cycle)&&null===this._dutyCycleReadValue&&(this._dutyCycleValue=Number(this._repeaterStatus.duty_cycle),this._dutyCycleReadValue=Number(this._repeaterStatus.duty_cycle))}catch(e){this._repeaterStatus=null}try{var s;this._firmwareOtaStatus=await el(this.hass,null===(s=this.config)||void 0===s?void 0:s.entry_id)}catch(e){this._firmwareOtaStatus=null}this._managedDevices=await async function(e,t){try{const i={type:"hivefw_integration/get_managed_devices"};t&&(i.entry_id=t);const o=await e.callWS(i);return{repeaters:o.repeaters||[],clients:o.clients||[]}}catch(e){return{repeaters:[],clients:[]}}}(this.hass,null===(t=this.config)||void 0===t?void 0:t.entry_id);const n=await Zn(this.hass,null===(i=this.config)||void 0===i?void 0:i.entry_id);this._scopeDraft=n.scopes.join(", "),this._scopeGlobal=n.global,!this._regionTarget&&this._managedDevices.repeaters.length&&(this._regionTarget=this._managedDevices.repeaters[0].pubkey_prefix),null!==(o=this._deviceConfig)&&void 0!==o&&o.location_source&&(this._locationSource=this._deviceConfig.location_source)}catch(e){this._error=`Failed to load device configuration: ${String(e)}`}finally{this._loading=!1}}}render(){var e,t,i,o,a;return this._loading?mn(ba||(ba=ws`
      ...
      `)):this._error?mn(_a||(_a=ws`
        <div class="settings-page">
          <div style="padding: 16px; color: var(--error-color); font-size: 14px;">
            ${0}
          </div>
        </div>
      `),this._error):this._deviceConfig?mn(wa||(wa=ws`
      <div class="settings-page">
    ...
    `),this.selectedDevice?this._renderCompanionCard():fn,this._renderDeviceInfo(),this._renderRadioSettings(),this._renderRepeaterSettings(),this._renderRegionsScopes(),this._renderLocation(),this._contextMenu?mn($a||($a=ws`
      ...
      `),this._onOverlayPointerDown,this._closeContextMenu,this._contextMenu.label,e=>e.stopPropagation(),e=>e.stopPropagation(),this._contextMenu.label,this._closeContextMenu,e=>e.stopPropagation(),this._hideSensorFromContext):fn,this._settingsModalOpen?mn(ka||(ka=ws`
      ...
      `),this._closeSettingsModal,e=>e.stopPropagation(),this._closeSettingsModal,this._openHiddenSensorsList,(this._hiddenSensors[this._getCompanionDeviceKey()]||[]).length,this._handleRebootFromModal,this._openKeyManagementModal):fn,this._keyManagementModalOpen?mn(Ca||(Ca=ws`
        <div class="modal-overlay" @click=${0}>
    ...
    `),e=>this._onTileContextMenu(e,o),t.name,t.firmware||"unknown",t.pubkey_prefix,this.contactCount,this.channelCount,void 0!==l?mn(Aa||(Aa=ws`<span>Added nodes: ${0}</span>`),l):fn,()=>this._settingsModalOpen=!0,a.length>0?mn(Ra||(Ra=ws`
    ...
    `),i,null!=t&&t.release_available?mn(Ta||(Ta=ws` · Disponível: <strong>${0}</strong>`),o):fn,null!=t&&t.host?mn(Oa||(Oa=ws`<span style="font:11px ui-monospace,SFMono-Regular,Menlo,monospace;color:var(--secondary-text-color);">${0}</span>`),t.host):fn,t?t.supported?t.bootstrap_required?mn(Da||(Da=ws`
                ...
                `),t.release_url?mn(Na||(Na=ws`
                        ...
                        `),t.release_url):fn,`http://${t.host}/update`):mn(Ea||(Ea=ws`
                  ...
                  ${0}
                `),this._firmwareBusy,e=>{var t;const i=e.target;this._firmwareFile=(null===(t=i.files)||void 0===t?void 0:t[0])||null},this._firmwareBusy||!this._firmwareFile,this._uploadFirmwareFile,this._firmwareBusy?"A atualizar…":"Enviar .bin",null!==this._firmwareUploadProgress?mn(Pa||(Pa=ws`
                      ...
                      `),`height:100%;width:${this._firmwareUploadProgress}%;background:var(--primary-color);transition:width .15s;`,this._firmwareUploadProgress):fn,t.release_available?mn(qa||(qa=ws`
                        <button
                          class="apply-button"
                      ...
                      `),this._firmwareBusy,this._installLatestFirmware,o):fn):mn(Ia||(Ia=ws`
            ...
            `)))}async _refreshFirmwareOtaStatus(){if(this.hass)try{var e;this._firmwareOtaStatus=await el(this.hass,null===(e=this.config)||void 0===e?void 0:e.entry_id)}catch(e){}}async _uploadFirmwareFile(){var e;if(!this.hass||!this._firmwareFile||null===(e=this.config)||void 0===e||!e.entry_id)return;if(!this.hass.fetchWithAuth)return void this._showStatusMessage("Esta versão do Home Assistant não disponibiliza upload autenticado para o painel.","error");const t=this._firmwareFile;if(t.name.toLowerCase().endsWith(".bin")&&!t.name.toLowerCase().includes("merged")){this._firmwareBusy=!0,this._firmwareUploadProgress=10;try{const e=new FormData;e.append("entry_id",this.config.entry_id),e.append("firmware",t,t.name);const i=await this.hass.fetchWithAuth("/api/hivefw_integration/firmware",{method:"POST",body:e});this._firmwareUploadProgress=90;let o={};try{o=await i.json()}catch(e){o={}}if(!i.ok||!o.success)throw new Error(o.error||`HTTP ${i.status}`);this._firmwareUploadProgress=100,this._firmwareFile=null,this._showStatusMessage("Firmware enviado. O HiveFW está a reiniciar.","success"),window.setTimeout(()=>{this._refreshFirmwareOtaStatus()},12e3)}catch(e){this._showStatusMessage(`Firmware OTA: ${e instanceof Error?e.message:String(e)}`,"error")}finally{this._firmwareBusy=!1,window.setTimeout(()=>{this._firmwareUploadProgress=null},2500)}}else this._showStatusMessage("Seleciona o firmware .bin OTA, não o ficheiro merged.","error")}async _installLatestFirmware(){if(this.hass){this._firmwareBusy=!0,this._firmwareUploadProgress=null;try{var e;const t=await async function(e,t){const i={type:"hivefw_integration/install_latest_firmware"};return t&&(i.entry_id=t),e.callWS(i)}(this.hass,null===(e=this.config)||void 0===e?void 0:e.entry_id);if(!t.success)throw new Error("A atualização não foi aceite.");this._showStatusMessage(`Firmware ${t.version||""} enviado. O HiveFW está a reiniciar.`,"success"),window.setTimeout(()=>{this._refreshFirmwareOtaStatus()},12e3)}catch(e){const t=e;this._showStatusMessage(`Firmware OTA: ${(null==t?void 0:t.message)||String(e)}`,"error")}finally{this._firmwareBusy=!1}}}_renderHiddenSensorsModal(){const e=this._hiddenSensorsModalKey,t=(this._hiddenSensors[e]||[]).map(e=>{let t=e;for(const i of Object.values(this._deviceEntities)){const o=i.find(t=>t.entity_id===e);if(o){t=o.label;break}}return{entityId:e,label:t}});return mn(La||(La=ws`
      <div class="modal-overlay" @click=${0}>
    ...
    `),this._closeHiddenSensorsModal,e=>e.stopPropagation(),this._closeHiddenSensorsModal,0===t.length?mn(Ba||(Ba=ws`<div class="empty-hidden">No hidden sensors</div>`)):t.map(t=>mn(Ha||(Ha=ws`
                ...
                `),t.label,t.entityId,()=>this._unhideSensor(e,t.entityId))),t.length>1?mn(Va||(Va=ws`
                <div class="modal-footer">
                  <button class="action-btn" @click=${0}>Unhide All</button>
                </div>
              `),()=>{this._unhideAllSensors(e)}):fn)}_renderDeviceInfo(){var e;if(this._deviceConfig)return mn(Ua||(Ua=ws`
      <div class="info-row">
    ...
    `),this._deviceConfig.hardware_model,this._deviceConfig.pubkey,()=>this._copyToClipboard(this._deviceConfig.pubkey),this._deviceConfig.connection_type?mn(ja||(ja=ws`
        <div class="info-row">
          <span class="info-label">Connection</span>
          <span class="info-value">${0}${0}</span>
        </div>
      `),this._deviceConfig.connection_type.toUpperCase(),this._deviceConfig.connection_address?mn(Ka||(Ka=ws` — ${0}`),this._deviceConfig.connection_address):""):"",null!==(e=this._editValues.name)&&void 0!==e?e:this._deviceConfig.name,e=>{this._editValues.name=e.target.value},!this._editValues.name||this._editValues.name===this._deviceConfig.name,this._handleNameSave)}_renderRadioSettings(){var e,t,i,o;if(!this._deviceConfig)return;const a=this._hasChanges("radio-settings",["tx_power","frequency","bandwidth","spreading_factor","coding_rate","path_hash_mode"]);return mn(Wa||(Wa=ws`
    ...
    `),String(null!==(e=null!==(t=this._editValues.tx_power)&&void 0!==t?t:this._deviceConfig.tx_power)&&void 0!==e?e:17),e=>{this._editValues.tx_power=Number(e.target.value)},String(null!==(i=null!==(o=this._editValues.frequency)&&void 0!==o?o:this._deviceConfig.frequency)&&void 0!==i?i:906.875),e=>{this._editValues.frequency=Number(e.target.value)},e=>{this._editValues.bandwidth=Number(e.target.value)},[7.8,10.4,15.6,20.8,31.25,41.7,62.5,125,250,500].map(e=>{var t,i;const o=null!==(t=null!==(i=this._editValues.bandwidth)&&void 0!==i?i:this._deviceConfig.bandwidth)&&void 0!==t?t:250;return mn(Ga||(Ga=ws`<option value=${0} ?selected=${0}>${0}</option>`),e,Number(o)===e,e)}),e=>{this._editValues.spreading_factor=Number(e.target.value)},[7,8,9,10,11,12].map(e=>{var t,i;const o=null!==(t=null!==(i=this._editValues.spreading_factor)&&void 0!==i?i:this._deviceConfig.spreading_factor)&&void 0!==t?t:11;return mn(Xa||(Xa=ws`<option value=${0} ?selected=${0}>${0}</option>`),e,Number(o)===e,e)}),e=>{this._editValues.coding_rate=Number(e.target.value)},[5,6,7,8].map(e=>{var t,i;const o=null!==(t=null!==(i=this._editValues.coding_rate)&&void 0!==i?i:this._deviceConfig.coding_rate)&&void 0!==t?t:5;return mn(Ya||(Ya=ws`<option value=${0} ?selected=${0}>${0}</option>`),e,Number(o)===e,e)}),e=>{this._editValues.path_hash_mode=Number(e.target.value)},[[0,"0 - 1 byte"],[1,"1 - 2 byte"],[2,"2 - 3 byte"]].map(([e,t])=>{var i,o;const a=null!==(i=null!==(o=this._editValues.path_hash_mode)&&void 0!==o?o:this._deviceConfig.path_hash_mode)&&void 0!==i?i:0;return mn(Qa||(Qa=ws`<option value=${0} ?selected=${0}>${0}</option>`),e,Number(a)===e,t)}),!a||this._saving,()=>this._handleApply("radio-settings"),this._saving?"Applying...":"Apply Radio Settings")}_renderLocation(){var e,t,i,o,a,r,s,n;if(!this._deviceConfig)return;const l="ha_location"===this._locationSource,d=l?null===(e=this.hass)||void 0===e?void 0:e.states["zone.home"]:null,c=this._locationSource!==(null!==(t=this._deviceConfig.location_source)&&void 0!==t?t:"manual"),p=this._hasChanges("location",["latitude","longitude"]),h=c||p,u=String(l&&d?null!==(i=d.attributes.latitude)&&void 0!==i?i:0:null!==(o=null!==(a=this._editValues.latitude)&&void 0!==a?a:this._deviceConfig.latitude)&&void 0!==o?o:0),m=String(l&&d?null!==(r=d.attributes.longitude)&&void 0!==r?r:0:null!==(s=null!==(n=this._editValues.longitude)&&void 0!==n?n:this._deviceConfig.longitude)&&void 0!==s?s:0);return mn(Ja||(Ja=ws`
      <div class="section-row">
        <div class="form-group-inline">
    ...
    `),u,l,e=>{this._editValues.latitude=Number(e.target.value)},m,l,e=>{this._editValues.longitude=Number(e.target.value)},l?mn(Za||(Za=ws`
      ...
      `)):"",this._locationSource,e=>{this._locationSource=e.target.value},!h||this._saving,this._applyLocation,this._saving?"Applying...":"Apply Location Settings")}_renderRegionsScopes(){const e=this._managedDevices.repeaters||[];return mn(er||(er=ws`
      ...
      ${0}
    `),this._scopeDraft,e=>{this._scopeDraft=e.target.value},this._scopeGlobal,e=>{this._scopeGlobal=e.target.checked},this._scopeSaving,this._saveFloodScopes,this._scopeSaving?"A guardar…":"Guardar Scopes",e.length?mn(tr||(tr=ws`
        <div class="form-group-inline">
      ...
      `),this._regionTarget,e=>{this._regionTarget=e.target.value,this._regionText=""},e.map(e=>mn(ir||(ir=ws`<option value=${0}>${0}</option>`),e.pubkey_prefix,e.name)),this._regionBusy||!this._regionTarget,this._readRemoteRegions,this._regionBusy?"A consultar…":"Ler Regions (RF)",this._regionText?mn(or||(or=ws`
        ...
        `),this._regionText):fn,this._regionAction,e=>{this._regionAction=e.target.value},this._regionName,e=>{this._regionName=e.target.value},this._regionBusy||!this._regionTarget||!this._regionName.trim()&&"default"!==this._regionAction,this._applyRemoteRegion,this._regionBusy||!this._regionTarget,()=>this._sendRemoteRegionCommand("region save")):mn(ar||(ar=ws`
      ...
      `));const o=i.filter(e=>e.connected||"online"===e.status).length;return mn(sr||(sr=ws`
    ...
    `),i.length,e.length,t.length,o,i.map(e=>{var t;const i=e.connected||"online"===e.status,o="repeater"===e.type?"Repeater":"Client";return mn(nr||(nr=ws`
    ...
    `),this._showRegenIdentityConfirm,this._importKeyValue,e=>{this._importKeyValue=e.target.value},!this._importKeyValue.trim(),this._handleImportKeyConfirm)}_hasChanges(e,t){return!!this._deviceConfig&&t.some(e=>void 0!==this._editValues[e]&&this._editValues[e]!==this._deviceConfig[e])}async _handleApply(e){if(!this.hass||!this._deviceConfig)return;let t=[];switch(e){case"device-name":t=["name"];break;case"radio-settings":t=["tx_power","frequency","bandwidth","spreading_factor","coding_rate","path_hash_mode"]}const i={};for(const e of t)void 0!==this._editValues[e]&&(i[e]=this._editValues[e]);this._saving=!0;try{var o;const e=await Yn(this.hass,i,null===(o=this.config)||void 0===o?void 0:o.entry_id);if(e.success){this._deviceConfig&&(this._deviceConfig={...this._deviceConfig,...i});for(const e of t)delete this._editValues[e];this._editValues={...this._editValues},e.rename?this._renameSuccess=e.rename:this._showStatusMessage(`Saved: ${t.join(", ")}`,"success")}else this._showStatusMessage("Save failed","error")}catch(e){this._showStatusMessage(`Error: ${String(e)}`,"error")}finally{this._saving=!1}}async _copyToClipboard(e){try{await navigator.clipboard.writeText(e),this._showStatusMessage("Copied to clipboard","success")}catch(e){this._showStatusMessage("Failed to copy","error")}}_showStatusMessage(e,t){this._statusMessage={text:e,type:t},null!==this._statusMessageTimeout&&clearTimeout(this._statusMessageTimeout),this._statusMessageTimeout=window.setTimeout(()=>{this._statusMessage=null,this._statusMessageTimeout=null},5e3)}_handleNameSave(){var e;const t=this._editValues.name,i=null===(e=this._deviceConfig)||void 0===e?void 0:e.name;if(void 0===t||t===i)return;const o=e=>(e||"").toLowerCase().replace(/[^a-z0-9]+/g,"_").replace(/^_|_$/g,""),a=o(null!=i?i:""),r=o(String(t));this._confirmAction={title:"Rename Device",message:`Renaming the device will rename all entity IDs ending in _${a} to _${r}. Any automations, scripts, or dashboards referencing entity IDs by the old name will need updating. A repair issue will list every renamed entity. Continue?`,onConfirm:async()=>{await this._handleApply("device-name")}},this._confirmDialogOpen=!0}_handleRebootFromModal(){this._settingsModalOpen=!1,this._confirmAction={title:"Reboot Device",message:"Are you sure you want to reboot the device? The device will be temporarily unavailable.",onConfirm:()=>this._executeDeviceCommand("reboot")},this._confirmDialogOpen=!0}async _executeDeviceCommand(e){if(this.hass)try{var t;const i=await Qn(this.hass,e,void 0,null===(t=this.config)||void 0===t?void 0:t.entry_id);i.success?this._showStatusMessage(`Device ${e} initiated`,"success"):this._showStatusMessage(`Command failed: ${i.response}`,"error")}catch(e){this._showStatusMessage(`Error: ${String(e)}`,"error")}}async _applyLocation(){if(this.hass&&this._deviceConfig){this._saving=!0;try{var e;const i=["latitude","longitude"],o={};if("ha_location"===this._locationSource){const e=this.hass.states["zone.home"];if(!e||null==e.attributes.latitude||null==e.attributes.longitude)return void this._showStatusMessage("Could not read zone.home coordinates from Home Assistant","error");o.latitude=e.attributes.latitude,o.longitude=e.attributes.longitude}else for(const e of i)void 0!==this._editValues[e]&&(o[e]=this._editValues[e]);if(Object.keys(o).length>0){var t;if(!(await Yn(this.hass,o,null===(t=this.config)||void 0===t?void 0:t.entry_id)).success)return void this._showStatusMessage("Failed to save coordinates","error");this._deviceConfig&&(this._deviceConfig={...this._deviceConfig,...o});for(const e of i)delete this._editValues[e];this._editValues={...this._editValues}}if(!(await async function(e,t,i){try{const o={type:"hivefw_integration/set_location_source",source:t};return i&&(o.entry_id=i),await e.callWS(o)}catch(e){return{success:!1}}}(this.hass,this._locationSource,null===(e=this.config)||void 0===e?void 0:e.entry_id)).success)return void this._showStatusMessage("Failed to update location source","error");await this._loadDeviceConfig(),this._showStatusMessage("Location settings applied","success")}catch(e){this._showStatusMessage(`Error: ${String(e)}`,"error")}finally{this._saving=!1}}}_showRegenIdentityConfirm(){this._confirmAction={title:"Regenerate Identity",message:"This will create a new cryptographic identity, reboot the device, and migrate all entity IDs to the new key prefix. Existing automations referencing entity IDs by the old prefix will need updating. All contacts must re-add this device. This cannot be undone.",requireTyped:"REGENERATE",onConfirm:async()=>{var e;this.hass&&(this._closeKeyManagementModal(),this._startIdentityFlow("regenerate",{type:"hivefw_integration/regenerate_identity",payload:null!==(e=this.config)&&void 0!==e&&e.entry_id?{entry_id:this.config.entry_id}:{}}))}},this._confirmDialogOpen=!0}_handleImportKeyConfirm(){const e=this._importKeyValue.trim().replace(/\s+/g,"");e&&(64===e.length||128===e.length?/^[0-9a-fA-F]+$/.test(e)?(this._confirmAction={title:"Import Private Key",message:"Importing a private key will replace the device identity, reboot the device, and migrate all entity IDs to the new key prefix. Existing automations referencing entity IDs by the old prefix will need updating. All contacts must re-add this device.",requireTyped:"IMPORT",onConfirm:()=>this._importIdentityKey()},this._confirmDialogOpen=!0):this._showStatusMessage("Private key must be hex (0-9, a-f)","error"):this._showStatusMessage("Private key must be 64 or 128 hex characters","error"))}async _importIdentityKey(){var e;if(!this.hass||!this._importKeyValue.trim())return;const t=this._importKeyValue.trim().replace(/\s+/g,"");this._closeKeyManagementModal(),this._importKeyValue="";const i={private_key:t};null!==(e=this.config)&&void 0!==e&&e.entry_id&&(i.entry_id=this.config.entry_id),this._startIdentityFlow("import",{type:"hivefw_integration/import_identity",payload:i})}_startIdentityFlow(e,t){if(!this.hass)return;this._identityFlowUnsubscribe&&(this._identityFlowUnsubscribe(),this._identityFlowUnsubscribe=null),this._identityFlowState={kind:"progress",flow:e,currentStep:"generating",completedSteps:new Set};const{unsubscribe:i}=function(e,t,i,o){let a,r=null;const s=new Promise(e=>{a=e});let n={success:!1,code:"unknown",message:"Identity flow terminated without a result event."};return e.connection.subscribeMessage(e=>{if("done"===e.step&&e.success&&e.old_pubkey&&e.new_pubkey){const t={success:!0,old_pubkey:e.old_pubkey,new_pubkey:e.new_pubkey,warning:e.warning};n=t,o({type:"result",data:t})}else"done"!==e.step&&o({type:"progress",step:e.step})},{type:t,...i}).then(e=>{r=e,a(n)}).catch(e=>{const t={success:!1,code:e.code||"error",message:e.message||"Identity flow failed."};o({type:"error",data:t}),a(t)}),{unsubscribe:()=>{r&&r()},done:s}}(this.hass,t.type,t.payload,t=>{if("progress"===t.type){if("progress"!==this._identityFlowState.kind)return;const e=new Set(this._identityFlowState.completedSteps);e.add(this._identityFlowState.currentStep),this._identityFlowState={...this._identityFlowState,currentStep:t.step,completedSteps:e}}else"result"===t.type?this._identityFlowState={kind:"success",flow:e,oldPubkey:t.data.old_pubkey,newPubkey:t.data.new_pubkey,warning:t.data.warning}:"error"===t.type&&(this._identityFlowState={kind:"failure",flow:e,code:t.data.code,message:t.data.message})});this._identityFlowUnsubscribe=i}_closeIdentityFlowModal(){this._identityFlowUnsubscribe&&(this._identityFlowUnsubscribe(),this._identityFlowUnsubscribe=null);const e="success"===this._identityFlowState.kind;this._identityFlowState={kind:"closed"},e&&this._loadDeviceConfig()}_renderIdentityFlowModal(){const e=this._identityFlowState;if("closed"===e.kind)return fn;const t="regenerate"===e.flow?"Regenerate Identity":"Import Private Key",i="regenerate"===e.flow?"Regenerating Identity":"Importing Identity",o="regenerate"===e.flow?"Identity Regenerated":"Identity Imported",a="regenerate"===e.flow?"Identity Regeneration Failed":"Identity Import Failed";let r,s;"progress"===e.kind?(r=mn(gr||(gr=ws`
      ...
      `),td.map(t=>{const i=e.completedSteps.has(t.step),o=e.currentStep===t.step;let a="○",r="var(--secondary-text-color)";return i?(a="✓",r="var(--success-color, #28a745)"):o&&(a="⏳",r="var(--primary-color)"),mn(vr||(vr=ws`
              <li style="display: flex; align-items: center; gap: 8px; color: ${0}; font-size: 14px;">
                <span style="font-family: monospace; width: 1em;">${0}</span>
                <span>${0}</span>
              </li>
            `),r,a,t.label)})),s=fn):"success"===e.kind?(r=mn(fr||(fr=ws`
        ...
        ${0}
      `),e.oldPubkey.slice(0,12),e.newPubkey.slice(0,12),e.warning?mn(yr||(yr=ws`
        ...
        `),e.warning):fn),s=mn(br||(br=ws`
        <button class="modal-action" @click=${0}>Close</button>
      `),this._closeIdentityFlowModal)):(r=mn(_r||(_r=ws`
        <div style="font-size: 32px; text-align: center; margin-bottom: 8px;">❌</div>
      ...
      `),"regenerate"===e.flow?"The device firmware rejected the new key. Your device identity is unchanged.":"The import did not take effect. Your device identity may be unchanged.",e.code,e.message),s=mn(xr||(xr=ws`
        <button class="modal-action" @click=${0}>Close</button>
      `),this._closeIdentityFlowModal));const n="progress"===e.kind?i:"success"===e.kind?o:a;return mn(wr||(wr=ws`
      <div class="modal-overlay">
    ...
    `),t,e=>e.stopPropagation(),n,"progress"===e.kind?fn:mn($r||($r=ws`
              <button class="modal-close" aria-label="Close" @click=${0}>&times;</button>
            `),this._closeIdentityFlowModal),r,s?mn(kr||(kr=ws`<div style="margin-top: 20px; display: flex; justify-content: flex-end;">${0}</div>`),s):fn)}_closeRenameSuccessModal(){this._renameSuccess=null,this._loadDeviceConfig(),this.dispatchEvent(new CustomEvent("device-renamed",{bubbles:!0,composed:!0}))}_renderRenameSuccessModal(){const e=this._renameSuccess;return e?mn(Cr||(Cr=ws`
    ...
    `),this._close,this.contactName,e=>e.stopPropagation(),this.contactName,this._close,this._renderBody()):mn(Mr||(Mr=ws``))}_renderBody(){return this.error?mn(Rr||(Rr=ws`<div class="error-box">${0}</div>`),this.error):this.result?this._renderResult(this.result):this._running?mn(Fr||(Fr=ws`<div class="info-value">Tracing…</div>`)):this._renderInput()}_renderInput(){return mn(Tr||(Tr=ws`
      <div class="form-group">
    ...
    `),this.pathMode,this._onPathModeChange,"discovery"===this.pathMode?mn(Or||(Or=ws`<div class="info-item path-hint">
            Flood path discovery will find a route automatically. May time
            out if the target is many hops away or unreachable by flood.
          </div>`)):"select"===this.pathMode?this._renderRepeaterPicker():this._renderExplicitInput(),"discovery"!==this.pathMode&&this._canRunTrace()?mn(zr||(zr=ws`<div class="info-item">
            <div class="info-label">Resolved Path</div>
            <div class="resolved-path">${0}</div>
          </div>`),this._buildPathString()):mn(Ir||(Ir=ws``)),!this._canRunTrace(),this._onRunTrace)}_renderRepeaterPicker(){var e,t,i;const o=new Set(this.pathHops.map(e=>e.public_key)),a=this._repeaterFilter.trim().toLowerCase(),r=[...this.availableRepeaters].filter(e=>!o.has(e.public_key)).filter(e=>{if(!a)return!0;const t=(e.adv_name||"").toLowerCase(),i=(e.pubkey_prefix||"").toLowerCase();return t.includes(a)||i.startsWith(a)}).sort((e,t)=>(e.adv_name||"").localeCompare(t.adv_name||"")),s=(null===(e=this.targetContact)||void 0===e?void 0:e.adv_name)||(null===(t=this.targetContact)||void 0===t?void 0:t.pubkey_prefix)||"(no target)",n=(null===(i=this.targetContact)||void 0===i||null===(i=i.pubkey_prefix)||void 0===i?void 0:i.substring(0,2).toUpperCase())||"--";return mn(Dr||(Dr=ws`
      <div class="info-item">
    ...
    `),this._repeaterFilter,e=>{this._repeaterFilter=e.target.value},0===r.length?mn(Nr||(Nr=ws`<div class="picker-empty">${0}</div>`),a?"No matches":"No repeaters available"):r.map(e=>mn(Er||(Er=ws`
                      <div
                        class="picker-item"
                        @click=${0}
                        title="Add ${0}"
                    ...
                    `),()=>this._addRepeater(e),e.adv_name,e.adv_name||e.pubkey_prefix,e.pubkey_prefix.substring(0,2).toUpperCase())),0===this.pathHops.length?mn(Pr||(Pr=ws`<div class="picker-empty">Click a repeater to add (or leave empty for direct-neighbor)</div>`)):this.pathHops.map((e,t)=>mn(qr||(qr=ws`
                    ...
                    `),t+1,e.adv_name||e.pubkey_prefix,e.pubkey_prefix.substring(0,2).toUpperCase(),0===t,()=>this._moveRepeater(t,-1),t===this.pathHops.length-1,()=>this._moveRepeater(t,1),()=>this._removeRepeater(t))),s,n)}_renderExplicitInput(){var e,t,i;const o=!!this.enteredPath&&!this._isValidExplicitHops(),a=(null===(e=this.targetContact)||void 0===e?void 0:e.adv_name)||(null===(t=this.targetContact)||void 0===t?void 0:t.pubkey_prefix)||"(no target)",r=(null===(i=this.targetContact)||void 0===i||null===(i=i.pubkey_prefix)||void 0===i?void 0:i.substring(0,2).toUpperCase())||"--";return mn(Lr||(Lr=ws`
      <div class="info-item">
    ...
    `),this.enteredPath,this._onExplicitPathInput,mn(o?Br||(Br=ws`<div class="path-error">
      ...
      ${0}
    `),e.response_time,0===e.hops?"Direct (0 hops)":`${e.hops}`,null!==e.final_snr&&void 0!==e.final_snr?mn(Ur||(Ur=ws`
            <div class="info-item">
              <div class="info-label">Final SNR (at this device)</div>
              <div class="info-value">${0} dB</div>
            </div>
          `),e.final_snr.toFixed(2)):mn(jr||(jr=ws``)),t.length>0?mn(Kr||(Kr=ws`
            <div class="info-item">
          ...
          `),t.map((e,t)=>mn(Wr||(Wr=ws`
                    <div class="hop-row">
                      <span>Hop ${0}: ${0}</span>
                      <span>${0} dB</span>
                    </div>
                  `),t+1,e.hash,e.snr.toFixed(2)))):mn(Gr||(Gr=ws``)))}_close(){this.open=!1,this.dispatchEvent(new CustomEvent("trace-dialog-closed",{bubbles:!0,composed:!0}))}};od.styles=[Ln,Rs(Xr||(Xr=ws`
  ...
  `))],$s([Pn({type:Boolean})],od.prototype,"open",void 0),$s([Pn({type:String})],od.prototype,"contactName",void 0),$s([Pn({type:Object})],od.prototype,"result",void 0),$s([Pn({type:String})],od.prototype,"error",void 0),$s([Pn({type:Array})],od.prototype,"availableRepeaters",void 0),$s([Pn({type:Object})],od.prototype,"targetContact",void 0),$s([qn()],od.prototype,"pathMode",void 0),$s([qn()],od.prototype,"pathHops",void 0),$s([qn()],od.prototype,"enteredPath",void 0),$s([qn()],od.prototype,"_repeaterFilter",void 0),$s([qn()],od.prototype,"_running",void 0),od=$s([Dn("meshcore-trace-dialog")],od);let ad=class extends zn{constructor(){super(),this.open=!1,this.contacts=[],this._typeFilter="all",this._search="",this._onTypeChange=e=>{this._typeFilter=e.target.value},this._onSearchInput=e=>{this._search=e.target.value},this._close=()=>{this.dispatchEvent(new CustomEvent("target-picker-closed",{bubbles:!0,composed:!0}))},bl(this,{isOpen:()=>this.open,onEscape:()=>this._close()})}willUpdate(e){e.has("open")&&this.open&&!e.get("open")&&(this._typeFilter="all",this._search="")}render(){if(!this.open)return mn(Yr||(Yr=ws``));const e=this._search.trim().toLowerCase(),t=this.contacts.filter(e=>{switch(this._typeFilter){case"all":default:return!0;case"client":return 1===e.type;case"repeater":return 2===e.type;case"room_server":return 3===e.type;case"sensor":return 4===e.type}}).filter(t=>{if(!e)return!0;const i=(t.adv_name||"").toLowerCase(),o=(t.pubkey_prefix||"").toLowerCase();return i.includes(e)||o.startsWith(e)}).sort((e,t)=>(e.adv_name||"").localeCompare(t.adv_name||""));return mn(Qr||(Qr=ws`
    ...
    `),this._close,e=>e.stopPropagation(),this._close,this._typeFilter,this._onTypeChange,this._search,this._onSearchInput,0===t.length?mn(Jr||(Jr=ws`<div class="empty">No matching contacts</div>`)):t.map(e=>mn(Zr||(Zr=ws`
                    <div
                      class="result-row"
                      @click=${0}
                      title="Trace to ${0}"
    ...
    `))],$s([Pn({type:Object})],rd.prototype,"hass",void 0),$s([Pn({type:Boolean,reflect:!0})],rd.prototype,"narrow",void 0),$s([Pn({type:Object})],rd.prototype,"panel",void 0),$s([qn()],rd.prototype,"_config",void 0),$s([qn()],rd.prototype,"_activeTab",void 0),$s([qn()],rd.prototype,"_devices",void 0),$s([qn()],rd.prototype,"_contacts",void 0),$s([qn()],rd.prototype,"_channels",void 0),$s([qn()],rd.prototype,"_selectedEntryId",void 0),$s([qn()],rd.prototype,"_loading",void 0),$s([qn()],rd.prototype,"_loadingStarted",void 0),$s([qn()],rd.prototype,"_error",void 0),$s([qn()],rd.prototype,"_unsubscribeList",void 0),$s([qn()],rd.prototype,"_pendingChatTarget",void 0),$s([qn()],rd.prototype,"_deviceDropdownOpen",void 0),$s([qn()],rd.prototype,"_traceDialogOpen",void 0),$s([qn()],rd.prototype,"_traceDialogContactName",void 0),$s([qn()],rd.prototype,"_traceDialogResult",void 0),$s([qn()],rd.prototype,"_traceDialogError",void 0),$s([qn()],rd.prototype,"_traceDialogPubkeyPrefix",void 0),$s([qn()],rd.prototype,"_traceDialogEntryId",void 0),$s([qn()],rd.prototype,"_traceDialogTargetContact",void 0),$s([qn()],rd.prototype,"_targetPickerOpen",void 0),$s([qn()],rd.prototype,"_pendingTraceEntryId",void 0),rd=$s([Dn("hivefw-integration-panel")],rd);export{rd as MeshCorePanel};
