...
`)),Fn=/^<[^>]+>\s*/,Dn=/@\[([^\]]+)\]/g,En=/@(\w+)/g,On={recipient_type_entity:"select.hivefw_recipient_type",channel_entity:"select.hivefw_channel",contact_entity:"select.hivefw_contact",channel_entity_pattern:"binary_sensor.hivefw_{prefix}_ch_{idx}_messages",contact_entity_pattern:"binary_sensor.hivefw_{prefix}_{contact}_messages",domain_filter:"hivefw"},Pn={...On,hours_to_show:48,initial_hours:1,max_messages:500,show_date_separators:!0,group_messages:!0,group_timeout:300,timestamp_format:"time",update_mode:"auto",refresh_interval:30,enable_cache:!0,cache_ttl:86400,cache_max_size:5242880};async function Bn(e){try{return(await e.callWS({type:"hivefw_integration/get_devices"})).devices||[]}catch(e){return[]}}async function Ln(e,t){try{const i={type:"hivefw_integration/get_contacts"};return t&&(i.entry_id=t),(await e.callWS(i)).contacts||[]}catch(e){return[]}}async function Vn(e,t){try{const i={type:"hivefw_integration/get_channels"};return t&&(i.entry_id=t),(await e.callWS(i)).channels||[]}catch(e){return[]}}async function Hn(e,t){try{const i={type:"hivefw_integration/get_device_config"};return t&&(i.entry_id=t),await e.callWS(i)}catch(e){throw new Error("Failed to get device configuration")}}async function Un(e,t,i){try{const o={type:"hivefw_integration/set_device_config",settings:t};return i&&(o.entry_id=i),await e.callWS(o)}catch(e){const t=e;return{success:!1,changed:[],error:t&&t.message?t.code?`${t.message} (${t.code})`:t.message:String(e)}}}async function jn(e,t){try{const i={type:"hivefw_integration/get_flood_scopes"};t&&(i.entry_id=t);const o=await e.callWS(i);return{scopes:o.scopes||[],global:!!o.global}}catch(e){return{scopes:[],global:!1}}}async function qn(e,t){const i={type:"hivefw_integration/get_local_repeater_status"};return t&&(i.entry_id=t),e.callWS(i)}async function Wn(e,t){const i={type:"hivefw_integration/get_local_regions"};return t&&(i.entry_id=t),e.callWS(i)}async function Kn(e,t,i="",o="",a){const r={type:"hivefw_integration/set_local_region",operation:t,name:i,parent:o};return a&&(r.entry_id=a),e.callWS(r)}async function Gn(e,t,i=!1){const o={type:"hivefw_integration/get_firmware_ota_status"};return t&&(o.entry_id=t),i&&(o.force=!0),e.callWS(o)}async function Xn(e,t){try{const i={type:"hivefw_integration/get_hive_neighbors"};return t&&(i.entry_id=t),await e.callWS(i)}catch(e){return{supported:!1,repeater_enabled:!1,count:0,neighbors:[]}}}async function Yn(e,t){const i={type:"hivefw_integration/get_hive_neighbor_discovery"};return t&&(i.entry_id=t),e.callWS(i)}async function Qn(e,t,i,o){try{const a={type:"hivefw_integration/add_contact",public_key:t};return i&&(a.name=i),o&&(a.entry_id=o),await e.callWS(a)}catch(e){return{success:!1}}}async function Jn(e,t,i){try{const o={type:"hivefw_integration/remove_contact",public_key:t};return i&&(o.entry_id=i),await e.callWS(o)}catch(e){return{success:!1}}}class Zn{constructor(){this._counts={},this._lastRead={},this._subscribers=new Set,this._markReadRequestedHandler=null,this._readProgress=null,this._postSwitchTimerHandler=null}subscribe(e){return this._subscribers.add(e),()=>{this._subscribers.delete(e)}}onMarkReadRequested(e){this._markReadRequestedHandler=e}onPostSwitchTimerFire(e){this._postSwitchTimerHandler=e}requestMarkRead(e){e&&this._markReadRequestedHandler&&this._markReadRequestedHandler(e)}_notify(){for(const e of[...this._subscribers])try{e()}catch(e){console.error("[UnreadController] subscriber callback threw",e)}}ingestBackendData(e,t){var i,o;this._counts={...null!==(i=null==e?void 0:e.unread)&&void 0!==i?i:{}},this._lastRead={...null!==(o=null==e?void 0:e.last_read)&&void 0!==o?o:{}},this._notify()}clearEntity(e){e&&this._counts[e]&&(this._counts={...this._counts,[e]:0},this._notify())}get counts(){return this._counts}get lastRead(){return this._lastRead}beginConversation(e,t){var i;this._clearPostSwitchTimer();const o={entityId:e,anchorId:e&&null!==(i=this._lastRead[e])&&void 0!==i?i:null,unreadCountAtSelection:t,graceUntil:Date.now()+1e3,postSwitchTimer:null,markReadFired:!1,lastMarkReadIdSent:null};this._readProgress=o,o.postSwitchTimer=setTimeout(()=>{var e;this._readProgress===o&&(o.postSwitchTimer=null,null===(e=this._postSwitchTimerHandler)||void 0===e||e.call(this))},1e3)}endConversation(){this._clearPostSwitchTimer(),this._readProgress=null}_clearPostSwitchTimer(){const e=this._readProgress;null!=e&&e.postSwitchTimer&&(clearTimeout(e.postSwitchTimer),e.postSwitchTimer=null)}resetUnreadCountAtSelection(){this._readProgress&&(this._readProgress.unreadCountAtSelection=0)}maybeReanchorOnLateData(e){const t=this._readProgress;if(!t||t.entityId!==e)return!1;if(null!==t.anchorId)return!1;if(t.markReadFired)return!1;const i=this._lastRead[e];return!!i&&(t.anchorId=i,!0)}onScrollState(e){return this._tryAdvanceCursor(e.entityId,e.lastMessageVisible,e.hasNewerMessages,e.bufferTailId,!1)}onPillJump(e){return this._tryAdvanceCursor(e.entityId,!0,!1,e.bufferTailId,!0)}_tryAdvanceCursor(e,t,i,o,a){if(!e)return!1;const r=this._readProgress;return!(!r||r.entityId!==e||!a&&Date.now()<r.graceUntil||i||!t||null!==o&&o===r.lastMarkReadIdSent||(r.lastMarkReadIdSent=o,r.markReadFired=!0,this.requestMarkRead(e),0))}badgeCount(e,t,i){if(!e)return 0;const o=this._counts;if(i&&o[i])return o[i];const a=/^\d+$/.test(e),r=t?`hivefw_${t}_ch_${e}_messages`:null;for(const[t,i]of Object.entries(o))if(!(i<=0))if(a){if(r){if(t.endsWith(r))return i}else if(t.endsWith(`_ch_${e}_messages`))return i}else{const o=e.substring(0,6);if(t.endsWith(`_${o}_messages`))return i}return 0}dividerAfterGroupIdx(e){const t=this._readProgress;if(!t)return null;let i=null;if(t.anchorId){let o=0;for(const a of e)if("date-separator"!==a.type){if(a.group.messages.some(e=>e.id===t.anchorId)){i=o;break}o++}}if(null!==i){let t=0;for(const o of e)if("date-separator"!==o.type){if(t>i&&!o.group.isOutgoing)return t;t++}return null}if(t.unreadCountAtSelection>0){const i=e.filter(e=>"date-separator"!==e.type).length,o=i-t.unreadCountAtSelection;return o>=0?o:0}return null}cursorAtTail(e,t){return!(!e||null===t)&&this._lastRead[e]===t}}const el=[1116352408,1899447441,3049323471,3921009573,961987163,1508970993,2453635748,2870763221,3624381080,310598401,607225278,1426881987,1925078388,2162078206,2614888103,3248222580,3835390401,4022224774,264347078,604807628,770255983,1249150122,1555081692,1996064986,2554220882,2821834349,2952996808,3210313671,3336571891,3584528711,113926993,338241895,666307205,773529912,1294757372,1396182291,1695183700,1986661051,2177026350,2456956037,2730485921,2820302411,3259730800,3345764771,3516065817,3600352804,4094571909,275423344,430227734,506948616,659060556,883997877,958139571,1322822218,1537002063,1747873779,1955562222,2024104815,2227730452,2361852424,2428436474,2756734187,3204031479,3329325298];function tl(e){const t=(new TextEncoder).encode(e),i=t.length,o=8*i,a=i+9+63&-64,r=new Uint8Array(a);r.set(t),r[i]=128;const s=new DataView(r.buffer);s.setUint32(a-4,o,!1);let n=1779033703,l=3144134277,d=1013904242,c=2773480762,p=1359893119,h=2600822924,u=528734635,v=1541459225;const g=new Int32Array(64);for(let e=0;e<a;e+=64){for(let t=0;t<16;t++)g[t]=s.getInt32(e+4*t,!1);for(let e=16;e<64;e++){const t=(g[e-15]>>>7|g[e-15]<<25)^(g[e-15]>>>18|g[e-15]<<14)^g[e-15]>>>3,i=(g[e-2]>>>17|g[e-2]<<15)^(g[e-2]>>>19|g[e-2]<<13)^g[e-2]>>>10;g[e]=g[e-16]+t+g[e-7]+i|0}let t=n,i=l,o=d,a=c,r=p,m=h,f=u,_=v;for(let e=0;e<64;e++){const s=_+((r>>>6|r<<26)^(r>>>11|r<<21)^(r>>>25|r<<7))+(r&m^~r&f)+el[e]+g[e]|0,n=t&i^t&o^i&o;_=f,f=m,m=r,r=a+s|0,a=o,o=i,i=t,t=s+(((t>>>2|t<<30)^(t>>>13|t<<19)^(t>>>22|t<<10))+n|0)|0}n=n+t|0,l=l+i|0,d=d+o|0,c=c+a|0,p=p+r|0,h=h+m|0,u=u+f|0,v=v+_|0}const m=e=>(e>>>0).toString(16).padStart(8,"0");return m(n)+m(l)+m(d)+m(c)+m(p)+m(h)+m(u)+m(v)}function il(e){const t=[],i=new Set;let o;const a=new RegExp(Dn.source,"g");for(;null!==(o=a.exec(e));){const e=o[1];i.has(e)||(i.add(e),t.push(e))}const r=new RegExp(En.source,"g");for(;null!==(o=r.exec(e));){const e=o[1];i.has(e)||(i.add(e),t.push(e))}return t}function ol(e){if(!e||0===e.length)return{};let t,i;for(const o of e)void 0===t&&"string"==typeof o.flood_scope&&(t=o.flood_scope),void 0===i&&"boolean"==typeof o.region_scope&&(i=o.region_scope);return{floodScope:t,regionScope:i}}function al(e){var t,i;const o=ol(e.rx_log_data);return{id:e.id,sender:e.sender,text:e.text,timestamp:new Date(e.timestamp),isOutgoing:e.outgoing,isSystem:!1,raw:e.text,mentions:il(e.text),rxLogData:e.rx_log_data,deliveryStatus:e.delivery_status?{status:e.delivery_status,ackReceived:e.ack_received,repeaterCount:e.repeater_count,roundTripMs:e.round_trip_ms}:void 0,repeaterCount:e.repeater_count,floodScope:null!==(t=e.flood_scope)&&void 0!==t?t:o.floodScope,regionScope:null!==(i=e.region_scope)&&void 0!==i?i:o.regionScope}}function rl(e,t){return e.getFullYear()!==t.getFullYear()||e.getMonth()!==t.getMonth()||e.getDate()!==t.getDate()}function sl(e){const t=new Date,i=new Date(t.getFullYear(),t.getMonth(),t.getDate()),o=new Date(e.getFullYear(),e.getMonth(),e.getDate()),a=Math.floor((i.getTime()-o.getTime())/864e5);return 0===a?"Today":1===a?"Yesterday":a<7?e.toLocaleDateString(void 0,{weekday:"long"}):e.toLocaleDateString(void 0,{weekday:"long",month:"long",day:"numeric"})}class nl{constructor(e){this._messages=[],this._loading=!1,this._error=null,this._entityId=null,this._hass=null,this._pollTimer=null,this._realtimeSubscriptions=[],this._retryCount=0,this._onChange=null,this._fetchDebounce=null,this._active=!1,this._hasOlderMessages=!0,this._loadingOlder=!1,this._hasNewerMessages=!1,this._loadingNewer=!1,this._newMessagesWhileAway=0,this._userAtBottom=!1,this._config=e}get messages(){return this._messages}get loading(){return this._loading}get error(){return this._error}get entityId(){return this._entityId}get loadingOlder(){return this._loadingOlder}get hasOlderMessages(){return this._hasOlderMessages}get loadingNewer(){return this._loadingNewer}get hasNewerMessages(){return this._hasNewerMessages}get newMessagesWhileAway(){return this._newMessagesWhileAway}setUserAtBottom(e){this._userAtBottom!==e&&(this._userAtBottom=e,e&&!this._hasNewerMessages&&this._newMessagesWhileAway>0&&(this._newMessagesWhileAway=0,this._notify()))}resetNewMessagesCounter(){0!==this._newMessagesWhileAway&&(this._newMessagesWhileAway=0,this._notify())}setOnChange(e){this._onChange=e}setHass(e){this._hass=e}setConfig(e){this._config=e}async switchEntity(e,t=null){if(e!==this._entityId){if(this._stopUpdates(),this._entityId=e,this._messages=[],this._error=null,this._retryCount=0,this._hasOlderMessages=!0,this._loadingOlder=!1,this._hasNewerMessages=!1,this._loadingNewer=!1,this._newMessagesWhileAway=0,this._userAtBottom=!1,!e)return this._active=!1,void this._notify();this._active=!0,this._startUpdates(e),t?await this._fetchAroundAnchor(e,t):await this._fetchMessages(e)}}async refresh(){this._entityId&&await this._fetchMessages(this._entityId)}addOptimisticMessage(e,t){const i=new Date,o={id:`optimistic_${i.getTime()}_${Math.random().toString(36).slice(2,8)}`,sender:e,text:t,timestamp:i,isOutgoing:!0,isSystem:!1,raw:`${e}: ${t}`,mentions:[]};this._messages=[...this._messages,o],this._notify()}async loadOlderMessages(){if(!this._loadingOlder&&this._hasOlderMessages&&this._hass&&this._entityId){this._loadingOlder=!0,this._notify();try{const e=this._messages.find(e=>!e.id.startsWith("rt_")&&!e.id.startsWith("optimistic_")),t={type:"hivefw_integration/get_stored_messages",entity_id:this._entityId,limit:50};e&&(t.before=e.id);const i=await this._hass.callWS(t),o=i.messages.map(al);this._hasOlderMessages=i.has_more;const a=new Set(this._messages.map(e=>e.id)),r=o.filter(e=>!a.has(e.id));r.length>0&&(this._messages=[...r,...this._messages],this._messages.sort((e,t)=>e.timestamp.getTime()-t.timestamp.getTime()))}catch(e){}finally{this._loadingOlder=!1,this._notify()}}}async loadNewerMessages(){if(!this._loadingNewer&&this._hasNewerMessages&&this._hass&&this._entityId){this._loadingNewer=!0,this._notify();try{let t;for(let e=this._messages.length-1;e>=0;e--){const i=this._messages[e].id;if(!i.startsWith("rt_")&&!i.startsWith("optimistic_")){t=i;break}}const i={type:"hivefw_integration/get_stored_messages",entity_id:this._entityId,limit:50};t&&(i.after=t);const o=await this._hass.callWS(i),a=o.messages.map(al);this._hasNewerMessages=o.has_more;const r=new Set(a.map(e=>e.id));this._messages=this._messages.filter(e=>!e.id.startsWith("rt_")||!r.has(e.id.substring(3)));const s=new Set(this._messages.map(e=>e.id)),n=a.filter(e=>!s.has(e.id));if(n.length>0){var e;this._messages=[...this._messages,...n],this._messages.sort((e,t)=>e.timestamp.getTime()-t.timestamp.getTime());const t=null!==(e=this._config.max_messages)&&void 0!==e?e:500;this._messages.length>t&&(this._messages=this._messages.slice(-t),this._hasOlderMessages=!0)}}catch(e){}finally{this._loadingNewer=!1,this._notify()}}}async fetchAroundTimestamp(e){const t=new Date(e).getTime(),i=this._messages.find(e=>Math.abs(e.timestamp.getTime()-t)<2e3);if(i)return!0;let o=0;for(;this._hasOlderMessages&&o<20;){await this.loadOlderMessages(),o++;const e=this._messages.find(e=>Math.abs(e.timestamp.getTime()-t)<2e3);if(e)return!0}return!1}pause(){this._stopUpdates(),this._active=!1,this._fetchDebounce&&(clearTimeout(this._fetchDebounce),this._fetchDebounce=null)}async resume(){this._entityId&&!this._active&&(this._active=!0,this._startUpdates(this._entityId),await this._fetchMessages(this._entityId))}destroy(){this._stopUpdates(),this._active=!1,this._fetchDebounce&&(clearTimeout(this._fetchDebounce),this._fetchDebounce=null),this._onChange=null}async _fetchMessages(e){if(this._hass){this._loading=!0,this._notify();try{var t;const i=50,o=await this._hass.callWS({type:"hivefw_integration/get_stored_messages",entity_id:e,limit:i}),a=o.messages.map(al);this._hasOlderMessages=o.has_more;const r=new Set(a.map(e=>e.id)),s=this._messages.filter(e=>{if(e.id.startsWith("optimistic_")){const t=a.some(t=>t.sender===e.sender&&t.text===e.text);return!t}if(e.id.startsWith("rt_")){const t=e.id.substring(3);return!r.has(t)}return!1});this._messages=[...a,...s],this._messages.sort((e,t)=>e.timestamp.getTime()-t.timestamp.getTime());const n=null!==(t=this._config.max_messages)&&void 0!==t?t:500;this._messages.length>n&&(this._messages=this._messages.slice(-n),this._hasOlderMessages=!0),this._error=null,this._retryCount=0}catch(e){const t=e instanceof Error?e.message:String(e);this._error=`Failed to fetch messages: ${t}`,this._retryCount++}finally{this._loading=!1,this._notify()}}}async _fetchAroundAnchor(e,t){if(this._hass){this._loading=!0,this._notify();try{var i;const o=await async function(e,t,i,o=25,a=50){return e.callWS({type:"hivefw_integration/get_messages_around",entity_id:t,anchor_id:i,before_limit:o,after_limit:a})}(this._hass,e,t),a=o.messages.map(al);this._hasOlderMessages=o.has_more_before,this._hasNewerMessages=o.has_more_after;const r=new Set(a.map(e=>e.id)),s=this._messages.filter(e=>{if(e.id.startsWith("optimistic_")){const t=a.some(t=>t.sender===e.sender&&t.text===e.text);return!t}if(e.id.startsWith("rt_")){const t=e.id.substring(3);return!r.has(t)}return!1});this._messages=[...a,...s],this._messages.sort((e,t)=>e.timestamp.getTime()-t.timestamp.getTime());const n=null!==(i=this._config.max_messages)&&void 0!==i?i:500;this._messages.length>n&&(this._messages=this._messages.slice(-n),this._hasOlderMessages=!0),this._error=null,this._retryCount=0}catch(e){const t=e instanceof Error?e.message:String(e);this._error=`Failed to fetch messages: ${t}`,this._retryCount++}finally{this._loading=!1,this._notify()}}}_startUpdates(e){this._startPolling(e),this._subscribeRealtime(e).catch(()=>{})}async _subscribeRealtime(e){if(!this._hass)return;const t=[];try{const i=await this._hass.connection.subscribeEvents(t=>{t.data.entity_id===e&&this._handleRealtimeMessage(t.data)},"hivefw_message");t.push(i);const o=await this._hass.connection.subscribeEvents(t=>{t.data.entity_id===e&&this._handleDeliveryUpdate(t.data)},"hivefw_delivery_update");t.push(o),this._realtimeSubscriptions=t}catch(e){throw t.forEach(e=>e()),e}}_handleRealtimeMessage(e){var t,i;const o=null!==(t=e.sender_name)&&void 0!==t?t:e.sender,a=null!==(i=e.message)&&void 0!==i?i:e.text;if(o===this._config.node_name){if(o&&a){const t=e.ack_received,i=e.repeater_count,s=e.rx_log_data,n=e.message_type;let l;var r;if("dm"===n||"direct"===n)l={status:!0===t?"delivered":"sent",ackReceived:null!=t?t:void 0};else l={status:"sent",repeaterCount:null!=i?i:null!==(r=null==s?void 0:s.length)&&void 0!==r?r:0};for(let e=this._messages.length-1;e>=0;e--){const t=this._messages[e];if(t.id.startsWith("optimistic_")&&t.sender===o&&t.text===a){t.deliveryStatus=l,s&&(t.rxLogData=s),this._notify();break}}}!this._entityId||this._hasNewerMessages||this._hasOlderMessages||this._debouncedFetch(this._entityId)}else{if(o&&a){let t=a.replace(Fn,"");const i=o+": ";t.startsWith(i)&&(t=t.substring(i.length));const r=e.timestamp||(new Date).toISOString(),s=new Date(r),n=function(e,t,i){return tl(`${e}|${t}|${i}`).substring(0,12)}(r,o,t),l=`rt_${n}`,d=this._messages.some(e=>e.id===l||e.id===n);if(!d){const i=il(t),r=e.rx_log_data,n={id:l,sender:o,text:t,timestamp:s,isOutgoing:!1,isSystem:!1,raw:a,mentions:i,rxLogData:r&&r.length>0?r:void 0,...ol(r)};this._messages.push(n),this._messages.sort((e,t)=>e.timestamp.getTime()-t.timestamp.getTime()),this._userAtBottom&&!this._hasNewerMessages||this._newMessagesWhileAway++,this._notify()}}!this._entityId||this._hasNewerMessages||this._hasOlderMessages||this._debouncedFetch(this._entityId)}}_debouncedFetch(e){this._fetchDebounce&&clearTimeout(this._fetchDebounce),this._fetchDebounce=setTimeout(async()=>{if(this._fetchDebounce=null,this._active)try{await this._fetchMessages(e)}catch(e){}},500)}_handleDeliveryUpdate(e){const t=e.rx_log_data;if(e.progressive&&t&&t.length>0){const i=e.sender_name,o=e.message,a=e.timestamp;if(i&&o){const e=a?new Date(a).getTime():0;for(let a=this._messages.length-1;a>=0;a--){const r=this._messages[a];if(!r.isOutgoing&&r.sender===i&&r.text===o&&(!e||Math.abs(r.timestamp.getTime()-e)<1e4))return r.rxLogData=t,r.repeaterCount=t.length,void this._notify()}}}const i=e.send_id,o=e.status,a=e.repeater_count,r=e.ack_received,s=e.round_trip_ms,n=e.progressive;if(!i)return;let l,d;l=o||(!0===r?"delivered":!n||void 0!==a&&0!==a?"sent":"waiting");for(let e=this._messages.length-1;e>=0;e--)if(this._messages[e].isOutgoing){d=this._messages[e];break}d&&(d.deliveryStatus={status:l,repeaterCount:a,ackReceived:r,roundTripMs:s},void 0!==a&&(d.repeaterCount=a),this._notify())}async _pollFetch(e){if(this._hass&&!this._hasNewerMessages)try{let i;for(let e=this._messages.length-1;e>=0;e--){const t=this._messages[e].id;if(!t.startsWith("rt_")&&!t.startsWith("optimistic_")){i=t;break}}const o={type:"hivefw_integration/get_stored_messages",entity_id:e,limit:50};i&&(o.after=i);const a=await this._hass.callWS(o);if(0===a.messages.length)return this._error=null,void(this._retryCount=0);const r=a.messages.map(al),s=new Set(this._messages.map(e=>e.id)),n=r.filter(e=>!s.has(e.id));if(n.length>0){var t;const e=new Set(n.map(e=>e.id));this._messages=this._messages.filter(t=>!t.id.startsWith("rt_")||!e.has(t.id.substring(3))),this._messages=this._messages.filter(e=>!e.id.startsWith("optimistic_")||!n.some(t=>t.sender===e.sender&&t.text===e.text)),this._messages=[...this._messages,...n],this._messages.sort((e,t)=>e.timestamp.getTime()-t.timestamp.getTime());const i=null!==(t=this._config.max_messages)&&void 0!==t?t:500;this._messages.length>i&&(this._messages=this._messages.slice(-i),this._hasOlderMessages=!0),this._notify()}this._error=null,this._retryCount=0}catch(e){this._retryCount++}}_startPolling(e){const t=()=>{if(!this._active)return;const i=this._retryCount>=5?6e4:3e4;this._pollTimer=setTimeout(async()=>{if(this._active){try{await this._pollFetch(e)}catch(e){}t()}},i)};t()}_stopUpdates(){this._pollTimer&&(clearTimeout(this._pollTimer),this._pollTimer=null);for(const e of this._realtimeSubscriptions)e();this._realtimeSubscriptions=[]}_notify(){this._onChange&&this._onChange()}}let ll=class extends Sn{constructor(){super(...arguments),this.conversations=[],this.activeId=null,this.unreadCounts={},this.nodePrefix=null,this._activeFilter="all",this._filteredConversations=[],this._appsChannelId=null,this._appsPickerOpen=!1}connectedCallback(){super.connectedCallback(),this._loadAppsChannelPreference()}updated(e){e.has("nodePrefix")&&this._loadAppsChannelPreference(),(e.has("conversations")||e.has("_activeFilter")||e.has("_appsChannelId"))&&this._updateFiltered()}render(){const e=this._getAppsChannel(),t=this._channelConversations();return nn(n||(n=gs`
  ...
  `)),ms([Tn({type:Object})],fl.prototype,"hass",void 0),ms([Tn({type:String})],fl.prototype,"entryId",void 0),ms([Tn({type:Boolean})],fl.prototype,"narrow",void 0),ms([Tn({type:String})],fl.prototype,"initialTab",void 0),ms([In()],fl.prototype,"_activeTab",void 0),ms([In()],fl.prototype,"_contacts",void 0),ms([In()],fl.prototype,"_channels",void 0),ms([In()],fl.prototype,"_searchQuery",void 0),ms([In()],fl.prototype,"_categoryFilter",void 0),ms([In()],fl.prototype,"_typeFilter",void 0),ms([In()],fl.prototype,"_loading",void 0),ms([In()],fl.prototype,"_actionInProgress",void 0),ms([In()],fl.prototype,"_confirmingRemoveContact",void 0),ms([In()],fl.prototype,"_confirmingRemoveChannel",void 0),ms([In()],fl.prototype,"_channelDialogOpen",void 0),ms([In()],fl.prototype,"_editingChannel",void 0),ms([In()],fl.prototype,"_suggestedChannelName",void 0),ms([In()],fl.prototype,"_suggestedChannelKey",void 0),ms([In()],fl.prototype,"_maxChannels",void 0),fl=ms([An("meshcore-manage-dialog")],fl);let _l=class extends Sn{constructor(){super(),this.timestampFormat="relative",this._selectedMessage=null,gl(this,{isOpen:()=>null!==this._selectedMessage,onEscape:()=>{this._selectedMessage=null},getScope:()=>{var e;return null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector(".message-dialog")}})}render(){return this.group?nn(X||(X=gs`
        ${0}
        ${0}
  ...
  `)),ms([Tn({type:Object})],_l.prototype,"group",void 0),ms([Tn({type:Object})],_l.prototype,"message",void 0),ms([Tn({type:String})],_l.prototype,"timestampFormat",void 0),ms([In()],_l.prototype,"_selectedMessage",void 0),_l=ms([An("meshcore-message-bubble")],_l);let bl=class extends Sn{constructor(){super(),this._query="",this._fromDate="",this._toDate="",this._results=[],this._totalCount=0,this._searching=!1,this._hasSearched=!1,this._showFilters=!1,this._debounceTimer=null,gl(this,{isOpen:()=>!0,onEscape:()=>this.dispatchEvent(new CustomEvent("search-close",{bubbles:!0,composed:!0}))})}render(){return nn(me||(me=gs`
  ...
  `)),ms([Tn({type:Number})],Dl.prototype,"value",void 0),ms([Tn({type:Number})],Dl.prototype,"min",void 0),ms([Tn({type:Number})],Dl.prototype,"max",void 0),ms([Tn({type:String})],Dl.prototype,"band",void 0),Dl=ms([An("meshcore-stat-bar")],Dl);let El=class extends Sn{constructor(){super(...arguments),this.segments=[],this.legend="below"}_denom(){if(void 0!==this.total&&this.total>0)return this.total;const e=this.segments.reduce((e,t)=>e+(Number.isFinite(t.value)?t.value:0),0);return e>0?e:1}render(){if(!this.segments.length)return cn;const e=this._denom();return nn(ki||(ki=gs`
      <div class="stat-bar"
           role="img"
           aria-label="${0}">
        ${0}
    ...
    `),this.segments.map(e=>`${e.label} ${e.value}`).join(", "),this.segments.map(t=>{const i=Number.isFinite(t.value)?Math.max(0,t.value):0;if(0===i)return cn;const o=i/e*100;return nn(Ci||(Ci=gs`<div class="stat-bar-segment ${0}"
          ...
          <div class="stat-bar-legend ${0}">
            ${0}
            ${0}
          </div>`),"inline"===this.legend?"inline":"",this.segments.filter(e=>Number.isFinite(e.value)&&e.value>=0).map(e=>nn(Mi||(Mi=gs`<span><span class="legend-swatch ${0}"></span>${0}</span>`),e.kind,e.label)),this.extraLegendText?nn(Ai||(Ai=gs`<span class="legend-extra">${0}</span>`),this.extraLegendText):cn):cn)}};El.styles=ws(Ri||(Ri=gs`
  ...
  `)),ms([Tn({type:Array})],El.prototype,"segments",void 0),ms([Tn({type:Number})],El.prototype,"total",void 0),ms([Tn({type:String})],El.prototype,"legend",void 0),ms([Tn({type:String})],El.prototype,"extraLegendText",void 0),El=ms([An("meshcore-stacked-bar")],El);let Ol=class extends Sn{constructor(){super(...arguments),this.content="",this._open=!1,this._onOpen=()=>{this._open||(this._open=!0,window.addEventListener("scroll",this._onScroll,!0))},this._onClose=()=>{this._open&&(this._open=!1,window.removeEventListener("scroll",this._onScroll,!0))},this._onScroll=()=>this._onClose()}render(){return this.content?nn(zi||(zi=gs`
  ...
  `)),ms([Tn({type:String})],Ol.prototype,"content",void 0),ms([Tn({type:String})],Ol.prototype,"source",void 0),ms([In()],Ol.prototype,"_open",void 0),Ol=ms([An("meshcore-info-tip")],Ol);const Pl=[{key:"sent_flood",label:"Sent · Flood",color:"var(--info, #2196f3)",dash:!1},{key:"sent_direct",label:"Sent · Direct",color:"var(--info, #2196f3)",dash:!0},{key:"recv_flood",label:"Recv · Flood",color:"var(--good, #4caf50)",dash:!1},{key:"recv_direct",label:"Recv · Direct",color:"var(--good, #4caf50)",dash:!0},{key:"errors",label:"Errors",color:"var(--bad, #f44336)",dash:!1}];let Bl=class extends Sn{constructor(){super(...arguments),this.data=[],this.width=700,this.height=170,this.timeRange=48,this._hoverIndex=null,this._onPointerMove=e=>{const t=this._indexFromEvent(e);null!=t&&t!==this._hoverIndex&&(this._hoverIndex=t)},this._onPointerDown=e=>{const t=this._indexFromEvent(e);null!=t&&(this._hoverIndex=t===this._hoverIndex?null:t)},this._onPointerLeave=e=>{"mouse"===e.pointerType&&(this._hoverIndex=null)}}render(){return this.data&&0!==this.data.length?nn(Ni||(Ni=gs`
    ...
    `),this._renderChart(),null!=this._hoverIndex?this._renderTooltip():cn,Pl.map(e=>nn(Fi||(Fi=gs`<div class="legend-item">
        ...
        <text x="${0}" y="${0}" font-size="9" text-anchor="middle"
          fill="var(--secondary-text-color,#727272)">${0}</text>`),h(e),s-a+14,this._timeLabel(e,d))),m=Pl.map(e=>{const t=this.data.filter(t=>"number"==typeof t.values[e.key]&&isFinite(t.values[e.key])).map(t=>`${h(t.timestamp).toFixed(1)},${u(t.values[e.key]).toFixed(1)}`);if(0===t.length)return ln(Oi||(Oi=gs``));if(1===t.length){const[i,o]=t[0].split(",");return ln(Pi||(Pi=gs`<circle cx="${0}" cy="${0}" r="2" fill="${0}" />`),i,o,e.color)}return ln(Bi||(Bi=gs`<polyline points="${0}" fill="none" stroke="${0}"
    ...
    `),s,r,Pl.map(e=>nn(Wi||(Wi=gs`<div class="tt-row">
  ...
  `)),ms([Tn({type:Array})],Bl.prototype,"data",void 0),ms([Tn({type:Number})],Bl.prototype,"width",void 0),ms([Tn({type:Number})],Bl.prototype,"height",void 0),ms([Tn({type:Number})],Bl.prototype,"timeRange",void 0),ms([In()],Bl.prototype,"_hoverIndex",void 0),Bl=ms([An("meshcore-message-rate-chart")],Bl);let Ll=class extends Sn{constructor(){super(...arguments),this.entities=[],this.hiddenCount=0,this.knownNodeCount=0,this.contactCount=0,this.channelCount=0,this._rateHistory=[],this._rateHistoryKey=null}render(){if(!this.hass||!this.device)return cn;const e=new Set,t=this._renderHeroTiles(e),i=this._buildGroups(e);return nn(Gi||(Gi=gs`
      <div class="hero-row">
        ${0}
      </div>
    ...
    `),i[0],i.length>1?nn(vo||(vo=gs`<span class="secondary">· ${0} MHz</span>`),i.slice(1).join(" · ")):cn,100,0,100,"info")}_renderTemperatureTile(e){var t,i;const o=this._findByMetric("temperature");if(!o)return cn;const a=this._readNumber(o.entity_id);if(!Number.isFinite(a))return cn;e.add(o.entity_id);const r=(null!==(t=null===(i=this.hass)||void 0===i||null===(i=i.states[o.entity_id])||void 0===i||null===(i=i.attributes)||void 0===i?void 0:i.unit_of_measurement)&&void 0!==t?t:"°C").includes("F")?5*(a-32)/9:a,s=Tl("temperature",9*r/5+32);return nn(go||(go=gs`
    ...
    `),()=>this._fireMoreInfo(e.entity_id),this._renderInfoTip(a),a.band,this._formatNumber(t,0),Number.isFinite(o)?nn(Mo||(Mo=gs`<span class="secondary">· SNR ${0} dB</span>`),o.toFixed(1)):cn,t,-130,-30,a.band)}_renderRadioActivityTile(){const e=this._findByMetric("tx_airtime_util"),t=this._findByMetric("rx_airtime_util");if(!e&&!t)return cn;const i=e?this._readNumber(e.entity_id):0,o=t?this._readNumber(t.entity_id):0,a=Number.isFinite(i)?Math.max(0,i):0,r=Number.isFinite(o)?Math.max(0,o):0,s=Math.max(0,100-a-r),n=Tl("tx_airtime_util",a).band,l=Tl("rx_airtime_util",r).band,d=this._worseBand(n,l),c=[{value:a,label:`TX ${a.toFixed(1)}%`,kind:"tx"},{value:r,label:`RX ${r.toFixed(1)}%`,kind:"rx"},{value:s,label:`Idle ${s.toFixed(1)}%`,kind:"idle"}],p=a+r;return nn(Ao||(Ao=gs`
      <div class="hero-tile"
           @click=${0}>
        <div class="hero-tile-head">
    ...
    `),()=>this._fireMoreInfo(t.entity_id),this._renderInfoTip({band:"info",fillPct:0,tooltip:"Messages received (lifetime), split by receive mode:\n• Flood — broadcast packets received from neighbours.\n• Direct — routed packets where this node is on the path.\n\nEach bar below is a percentage of its own total:\n• Red = receive errors (CRC failures), as a share of all reception attempts (received + errors) — i.e. the error rate.\n• Amber = duplicate receptions, as a share of received messages (duplicates are a subset of received).\n\nBoth are context only, not banded — in a flooding mesh every active neighbour retransmits the same flood once, so a high duplicate ratio is normal (a 2-neighbour repeater sees ~50%, a 3-neighbour ~67%, etc.)."}),this._formatCount(s),d,"none",m>0?nn(Do||(Do=gs`<div class="err-line"
            ...
            </div>`),h,u.toFixed(1),Math.min(100,u).toFixed(1)):cn,n,l,m>0?nn(Oo||(Oo=gs`<span><span class="msg-swatch error"></span>Error ${0}</span>`),m):cn,h>0?nn(Po||(Po=gs`<span><span class="msg-swatch dup"></span>Dup ${0}</span>`),h):cn)}_renderRequestsTile(e){const t=this._findEntityIdMatching("request_succ"),i=this._findEntityIdMatching("request_fail");if(!t||!i)return cn;const o=this._readNumber(t.entity_id),a=this._readNumber(i.entity_id),r=o+a,s=r>0?o/r*100:0,n=r>=50?Tl("request_success_rate",s):{band:"info",fillPct:0,tooltip:""},l=[{value:o,label:`OK ${o}`,kind:"success"},{value:a,label:`Fail ${a}`,kind:"failure"}];return e.add(t.entity_id),e.add(i.entity_id),nn(Bo||(Bo=gs`
      <div class="hero-tile" @click=${0}>
        <div class="hero-tile-head">
          <span>Pedidos${0}</span>
          <span class="status-dot ${0}"></span>
    ...
    `),()=>this._fireMoreInfo(e.entity_id),t=>this._fireContextMenu(t,e),Nl(()=>this._fireContextMenu(void 0,e)),p,e.label,u?this._renderInfoTip(u):cn,v,d?nn(ea||(ea=gs`<span class="unit">${0}</span>`),d):cn,c&&e.metricKey?nn(ta||(ta=gs`<meshcore-stat-bar
                .value=${0}
                .min=${0}
                .max=${0}
                .band=${0}>
              </meshcore-stat-bar>`),c.fillPct,0,100,p):cn)}_evaluateForRow(e,t,i){if("uptime_hours"===e){var o,a;let r=t;switch(null!==(o=null===(a=this.hass)||void 0===a||null===(a=a.states[i.entity_id])||void 0===a||null===(a=a.attributes)||void 0===a?void 0:a.unit_of_measurement)&&void 0!==o?o:""){case"d":r=24*t;break;case"h":r=t;break;case"min":r=t/60;break;default:r=t/3600}return Tl(e,r)}var r,s;return Tl(e,"temperature"===e&&(null!==(r=null===(s=this.hass)||void 0===s||null===(s=s.states[i.entity_id])||void 0===s||null===(s=s.attributes)||void 0===s?void 0:s.unit_of_measurement)&&void 0!==r?r:"").includes("C")?9*t/5+32:t)}_findByMetric(e){return this.entities.find(t=>t.metricKey===e)}_findEntityIdMatching(e){return this.entities.find(t=>t.entity_id.includes(e))}_findEntityByLabel(e){return this.entities.find(t=>t.label===e)}_readNumber(e){var t;const i=null===(t=this.hass)||void 0===t?void 0:t.states[e];if(!i||"unavailable"===i.state||"unknown"===i.state)return NaN;const o=parseFloat(i.state);return Number.isFinite(o)?o:NaN}_formatNumber(e,t){return Number.isFinite(e)?e.toFixed(t):"—"}_formatRowValue(e,t,i){var o;if("unavailable"===i||"unknown"===i)return"—";if(!Number.isFinite(t))return null!=i?i:"—";const a=null===(o=this.hass)||void 0===o||null===(o=o.entities)||void 0===o||null===(o=o[e.entity_id])||void 0===o?void 0:o.display_precision;return null!=a&&a>=0?t.toFixed(a):i&&i.includes(".")?i:t.toString()}_renderInfoTip(e){var t;return e.tooltip?nn(ia||(ia=gs`<meshcore-info-tip
      .content=${0}
      .source=${0}>
  ...
  `)),ms([Tn({type:Object})],Ll.prototype,"hass",void 0),ms([Tn({type:Object})],Ll.prototype,"device",void 0),ms([Tn({type:Array})],Ll.prototype,"entities",void 0),ms([Tn({type:Number})],Ll.prototype,"hiddenCount",void 0),ms([Tn({type:Number})],Ll.prototype,"knownNodeCount",void 0),ms([Tn({type:Number})],Ll.prototype,"contactCount",void 0),ms([Tn({type:Number})],Ll.prototype,"channelCount",void 0),ms([Tn({type:Number})],Ll.prototype,"fallbackLatitude",void 0),ms([Tn({type:Number})],Ll.prototype,"fallbackLongitude",void 0),ms([Tn({type:Number})],Ll.prototype,"fallbackUpdated",void 0),ms([Tn({type:Object})],Ll.prototype,"repeaterStatus",void 0),ms([In()],Ll.prototype,"_rateHistory",void 0),Ll=ms([An("meshcore-node-summary")],Ll);let Vl=class extends Sn{constructor(){super(...arguments),this.narrow=!1,this.knownNodeCount=0,this.contactCount=0,this.channelCount=0,this._repeaterStatus=null,this._deviceConfig=null,this._deviceEntities={},this._meshcoreDeviceMap={},this._hiddenSensors={},this._contextMenu=null,this._statusMessage=null,this._hiddenSensorsOpen=!1,this._loadedEntry=null,this._statusMessageTimeout=null,this._trace=()=>{var e;this.dispatchEvent(new CustomEvent("companion-trace-requested",{detail:{entryId:null===(e=this.selectedDevice)||void 0===e?void 0:e.entry_id},bubbles:!0,composed:!0}))}}connectedCallback(){super.connectedCallback(),this._loadHiddenSensors()}updated(){var e;const t=(null===(e=this.selectedDevice)||void 0===e?void 0:e.entry_id)||null;t&&t!==this._loadedEntry&&(this._loadedEntry=t,this._loadData())}async _loadData(){if(this.hass)try{var e,t;const[{meshcoreDeviceMap:i,deviceEntities:o},a,r]=await Promise.all([Al(this.hass),qn(this.hass,null===(e=this.config)||void 0===e?void 0:e.entry_id).catch(()=>null),Hn(this.hass,null===(t=this.config)||void 0===t?void 0:t.entry_id).catch(()=>null)]);this._meshcoreDeviceMap=i,this._deviceEntities=o,this._repeaterStatus=a,this._deviceConfig=r}catch(e){this._repeaterStatus=null}}_deviceKey(){var e;return(null===(e=this.selectedDevice)||void 0===e?void 0:e.entry_id)||"companion"}_entities(){var e;if(!this.hass||!this.selectedDevice)return[];const t=new Set(this._hiddenSensors[this._deviceKey()]||[]),i=this.selectedDevice.entry_id,o=this._meshcoreDeviceMap[i];if(o&&this._deviceEntities[o])return this._deviceEntities[o].filter(e=>!t.has(e.entity_id));const a=(null===(e=this.selectedDevice.pubkey_prefix)||void 0===e||null===(e=e.substring(0,6))||void 0===e?void 0:e.toLowerCase())||"";if(!a)return[];const r=[];for(const[e,i]of Object.entries(this._deviceEntities))if(!Object.entries(this._meshcoreDeviceMap).some(([t,i])=>i===e&&(t.includes("_repeater_")||t.includes("_client_"))))for(const e of i)e.entity_id.toLowerCase().includes(a)&&!t.has(e.entity_id)&&r.push(e);return r.sort((e,t)=>e.sortOrder-t.sortOrder)}_descriptor(e){var t,i,o,a;return{type:"companion",name:e.name,pubkey_prefix:e.pubkey_prefix,connected:e.connected,firmware:e.firmware||(null===(t=this._deviceConfig)||void 0===t?void 0:t.firmware_version),hardware_model:null===(i=this._deviceConfig)||void 0===i?void 0:i.hardware_model,connection_type:null===(o=this._deviceConfig)||void 0===o?void 0:o.connection_type,connection_address:null===(a=this._deviceConfig)||void 0===a?void 0:a.connection_address,entry_id:e.entry_id}}_loadHiddenSensors(){try{this._hiddenSensors=JSON.parse(localStorage.getItem("meshcore-hidden-sensors")||"{}")}catch(e){this._hiddenSensors={}}}_saveHiddenSensors(){try{localStorage.setItem("meshcore-hidden-sensors",JSON.stringify(this._hiddenSensors))}catch(e){}}_hideSensor(e,t){const i=this._deviceKey(),o=this._hiddenSensors[i]||[];o.includes(e)||(this._hiddenSensors={...this._hiddenSensors,[i]:[...o,e]}),this._saveHiddenSensors(),this._contextMenu=null,this._showStatus("Oculto: "+t,"success")}_unhideSensor(e){const t=this._deviceKey(),i=(this._hiddenSensors[t]||[]).filter(t=>t!==e),o={...this._hiddenSensors};i.length?o[t]=i:delete o[t],this._hiddenSensors=o,this._saveHiddenSensors()}async _action(e,t,i){if(this.hass)try{var o;const a=await async function(e,t,i,o){try{const a={type:"hivefw_integration/execute_local",command:t};return i&&(a.args=i),o&&(a.entry_id=o),await e.callWS(a)}catch(e){const t=e;return{response:t&&t.message?t.code?`${t.message} (${t.code})`:t.message:String(e),success:!1,timestamp:(new Date).toISOString()}}}(this.hass,e,t,null===(o=this.config)||void 0===o?void 0:o.entry_id);this._showStatus("Companion: "+(i||e)+" → "+(a.response||"OK"),"success"),"set_time"===e&&this._loadData()}catch(t){this._showStatus("Companion: "+(i||e)+" — "+String(t),"error")}}async _copyPublicKey(e){if(e){try{await navigator.clipboard.writeText(e)}catch(t){const i=document.createElement("textarea");i.value=e,i.style.position="fixed",i.style.opacity="0",document.body.appendChild(i),i.select(),document.execCommand("copy"),i.remove()}this._showStatus("Public Key copiada","success")}}_showStatus(e,t){this._statusMessage={text:e,type:t},null!==this._statusMessageTimeout&&window.clearTimeout(this._statusMessageTimeout),this._statusMessageTimeout=window.setTimeout(()=>{this._statusMessage=null,this._statusMessageTimeout=null},5e3)}render(){var e;const t=this.selectedDevice;if(!t)return nn(aa||(aa=gs`<div class="page"><div class="wrap">Sem Companion selecionado.</div></div>`));const i=this._entities(),o=this._hiddenSensors[this._deviceKey()]||[];return nn(ra||(ra=gs`
    ...
    `),t.name,(null===(e=this._deviceConfig)||void 0===e?void 0:e.pubkey)||t.pubkey||t.pubkey_prefix,()=>{var e;this._copyPublicKey((null===(e=this._deviceConfig)||void 0===e?void 0:e.pubkey)||t.pubkey||t.pubkey_prefix)},o.length?nn(sa||(sa=gs`<button class="minor" @click=${0}>Sensores ocultos (${0})</button>`),()=>this._hiddenSensorsOpen=!0,o.length):cn,i.length?nn(na||(na=gs`<meshcore-node-summary
        ...
        ${0}
      </div></div>`),()=>this._hiddenSensorsOpen=!1,e=>e.stopPropagation(),()=>this._hiddenSensorsOpen=!1,o.map(e=>{var t;return nn(ca||(ca=gs`<div class="sensor-row"><div><div>${0}</div><div class="sensor-id">${0}</div></div><button class="minor" @click=${0}>Mostrar</button></div>`),(null===(t=Object.values(this._deviceEntities).flat().find(t=>t.entity_id===e))||void 0===t?void 0:t.label)||e,e,()=>this._unhideSensor(e))})):cn,this._statusMessage?nn(pa||(pa=gs`<div class="toast ${0}">${0}</div>`),this._statusMessage.type,this._statusMessage.text):cn)}};Vl.styles=ws(ha||(ha=gs`
  ...
  `)),ms([Tn({type:Object})],Vl.prototype,"hass",void 0),ms([Tn({type:Object})],Vl.prototype,"config",void 0),ms([Tn({type:Boolean})],Vl.prototype,"narrow",void 0),ms([Tn({type:Object})],Vl.prototype,"selectedDevice",void 0),ms([Tn({type:Number})],Vl.prototype,"knownNodeCount",void 0),ms([Tn({type:Number})],Vl.prototype,"contactCount",void 0),ms([Tn({type:Number})],Vl.prototype,"channelCount",void 0),ms([In()],Vl.prototype,"_repeaterStatus",void 0),ms([In()],Vl.prototype,"_deviceConfig",void 0),ms([In()],Vl.prototype,"_deviceEntities",void 0),ms([In()],Vl.prototype,"_meshcoreDeviceMap",void 0),ms([In()],Vl.prototype,"_hiddenSensors",void 0),ms([In()],Vl.prototype,"_contextMenu",void 0),ms([In()],Vl.prototype,"_statusMessage",void 0),ms([In()],Vl.prototype,"_hiddenSensorsOpen",void 0),Vl=ms([An("meshcore-status-page")],Vl);let Hl=class extends Sn{constructor(){super(),this.open=!1,this.title="Confirm",this.message="",this.confirmLabel="Confirm",this.cancelLabel="Cancel",this.dangerous=!1,this._typedValue="",gl(this,{isOpen:()=>this.open,onEscape:()=>this._onCancel()})}render(){if(!this.open)return;const e=this.requireTyped&&this._typedValue!==this.requireTyped;return nn(ua||(ua=gs`
    ...
    `),null!==(e=this._editValues.name)&&void 0!==e?e:this._deviceConfig.name,e=>{this._editValues.name=e.target.value},!this._editValues.name||this._editValues.name===this._deviceConfig.name,this._handleNameSave,this._showRegenIdentityConfirm,this._importKeyValue,e=>{this._importKeyValue=e.target.value},!this._importKeyValue.trim(),this._handleImportKeyConfirm):cn}_hasChanges(e,t){return!!this._deviceConfig&&t.some(e=>void 0!==this._editValues[e]&&this._editValues[e]!==this._deviceConfig[e])}async _handleApply(e){if(!this.hass||!this._deviceConfig)return;let t=[];switch(e){case"device-name":t=["name"];break;case"radio-settings":t=["tx_power","frequency","bandwidth","spreading_factor","coding_rate","path_hash_mode"]}const i={};for(const e of t)void 0!==this._editValues[e]&&(i[e]=this._editValues[e]);this._saving=!0;try{var o;const e=await Un(this.hass,i,null===(o=this.config)||void 0===o?void 0:o.entry_id);if(e.success){this._deviceConfig&&(this._deviceConfig={...this._deviceConfig,...i});for(const e of t)delete this._editValues[e];this._editValues={...this._editValues},e.rename?this._renameSuccess=e.rename:this._showStatusMessage(`Saved: ${t.join(", ")}`,"success")}else this._showStatusMessage("Save failed","error")}catch(e){this._showStatusMessage(`Error: ${String(e)}`,"error")}finally{this._saving=!1}}async _copyToClipboard(e){try{await navigator.clipboard.writeText(e),this._showStatusMessage("Copied to clipboard","success")}catch(e){this._showStatusMessage("Failed to copy","error")}}_showStatusMessage(e,t){this._statusMessage={text:e,type:t},null!==this._statusMessageTimeout&&clearTimeout(this._statusMessageTimeout),this._statusMessageTimeout=window.setTimeout(()=>{this._statusMessage=null,this._statusMessageTimeout=null},5e3)}_handleNameSave(){var e;const t=this._editValues.name,i=null===(e=this._deviceConfig)||void 0===e?void 0:e.name;if(void 0===t||t===i)return;const o=e=>(e||"").toLowerCase().replace(/[^a-z0-9]+/g,"_").replace(/^_|_$/g,""),a=o(null!=i?i:""),r=o(String(t));this._confirmAction={title:"Rename Device",message:`Renaming the device will rename all entity IDs ending in _${a} to _${r}. Any automations, scripts, or dashboards referencing entity IDs by the old name will need updating. A repair issue will list every renamed entity. Continue?`,onConfirm:async()=>{await this._handleApply("device-name")}},this._confirmDialogOpen=!0}async _applyLocation(){if(this.hass&&this._deviceConfig){this._saving=!0;try{var e;const i=["latitude","longitude"],o={};if("ha_location"===this._locationSource){const e=this.hass.states["zone.home"];if(!e||null==e.attributes.latitude||null==e.attributes.longitude)return void this._showStatusMessage("Could not read zone.home coordinates from Home Assistant","error");o.latitude=e.attributes.latitude,o.longitude=e.attributes.longitude}else for(const e of i)void 0!==this._editValues[e]&&(o[e]=this._editValues[e]);if(Object.keys(o).length>0){var t;if(!(await Un(this.hass,o,null===(t=this.config)||void 0===t?void 0:t.entry_id)).success)return void this._showStatusMessage("Failed to save coordinates","error");this._deviceConfig&&(this._deviceConfig={...this._deviceConfig,...o});for(const e of i)delete this._editValues[e];this._editValues={...this._editValues}}if(!(await async function(e,t,i){try{const o={type:"hivefw_integration/set_location_source",source:t};return i&&(o.entry_id=i),await e.callWS(o)}catch(e){return{success:!1}}}(this.hass,this._locationSource,null===(e=this.config)||void 0===e?void 0:e.entry_id)).success)return void this._showStatusMessage("Failed to update location source","error");await this._loadDeviceConfig(),this._showStatusMessage("Location settings applied","success")}catch(e){this._showStatusMessage(`Error: ${String(e)}`,"error")}finally{this._saving=!1}}}_showRegenIdentityConfirm(){this._confirmAction={title:"Regenerate Identity",message:"This will create a new cryptographic identity, reboot the device, and migrate all entity IDs to the new key prefix. Existing automations referencing entity IDs by the old prefix will need updating. All contacts must re-add this device. This cannot be undone.",requireTyped:"REGENERATE",onConfirm:async()=>{var e;this.hass&&this._startIdentityFlow("regenerate",{type:"hivefw_integration/regenerate_identity",payload:null!==(e=this.config)&&void 0!==e&&e.entry_id?{entry_id:this.config.entry_id}:{}})}},this._confirmDialogOpen=!0}_handleImportKeyConfirm(){const e=this._importKeyValue.trim().replace(/\s+/g,"");e&&(64===e.length||128===e.length?/^[0-9a-fA-F]+$/.test(e)?(this._confirmAction={title:"Import Private Key",message:"Importing a private key will replace the device identity, reboot the device, and migrate all entity IDs to the new key prefix. Existing automations referencing entity IDs by the old prefix will need updating. All contacts must re-add this device.",requireTyped:"IMPORT",onConfirm:()=>this._importIdentityKey()},this._confirmDialogOpen=!0):this._showStatusMessage("Private key must be hex (0-9, a-f)","error"):this._showStatusMessage("Private key must be 64 or 128 hex characters","error"))}async _importIdentityKey(){var e;if(!this.hass||!this._importKeyValue.trim())return;const t=this._importKeyValue.trim().replace(/\s+/g,"");this._importKeyValue="";const i={private_key:t};null!==(e=this.config)&&void 0!==e&&e.entry_id&&(i.entry_id=this.config.entry_id),this._startIdentityFlow("import",{type:"hivefw_integration/import_identity",payload:i})}_startIdentityFlow(e,t){if(!this.hass)return;this._identityFlowUnsubscribe&&(this._identityFlowUnsubscribe(),this._identityFlowUnsubscribe=null),this._identityFlowState={kind:"progress",flow:e,currentStep:"generating",completedSteps:new Set};const{unsubscribe:i}=function(e,t,i,o){let a,r=null;const s=new Promise(e=>{a=e});let n={success:!1,code:"unknown",message:"Identity flow terminated without a result event."};return e.connection.subscribeMessage(e=>{if("done"===e.step&&e.success&&e.old_pubkey&&e.new_pubkey){const t={success:!0,old_pubkey:e.old_pubkey,new_pubkey:e.new_pubkey,warning:e.warning};n=t,o({type:"result",data:t})}else"done"!==e.step&&o({type:"progress",step:e.step})},{type:t,...i}).then(e=>{r=e,a(n)}).catch(e=>{const t={success:!1,code:e.code||"error",message:e.message||"Identity flow failed."};o({type:"error",data:t}),a(t)}),{unsubscribe:()=>{r&&r()},done:s}}(this.hass,t.type,t.payload,t=>{if("progress"===t.type){if("progress"!==this._identityFlowState.kind)return;const e=new Set(this._identityFlowState.completedSteps);e.add(this._identityFlowState.currentStep),this._identityFlowState={...this._identityFlowState,currentStep:t.step,completedSteps:e}}else"result"===t.type?this._identityFlowState={kind:"success",flow:e,oldPubkey:t.data.old_pubkey,newPubkey:t.data.new_pubkey,warning:t.data.warning}:"error"===t.type&&(this._identityFlowState={kind:"failure",flow:e,code:t.data.code,message:t.data.message})});this._identityFlowUnsubscribe=i}_closeIdentityFlowModal(){this._identityFlowUnsubscribe&&(this._identityFlowUnsubscribe(),this._identityFlowUnsubscribe=null);const e="success"===this._identityFlowState.kind;this._identityFlowState={kind:"closed"},e&&this._loadDeviceConfig()}_renderIdentityFlowModal(){const e=this._identityFlowState;if("closed"===e.kind)return cn;const t="regenerate"===e.flow?"Regenerate Identity":"Import Private Key",i="regenerate"===e.flow?"Regenerating Identity":"Importing Identity",o="regenerate"===e.flow?"Identity Regenerated":"Identity Imported",a="regenerate"===e.flow?"Identity Regeneration Failed":"Identity Import Failed";let r,s;"progress"===e.kind?(r=nn(nr||(nr=gs`
      ...
      `),Ul.map(t=>{const i=e.completedSteps.has(t.step),o=e.currentStep===t.step;let a="○",r="var(--secondary-text-color)";return i?(a="✓",r="var(--success-color, #28a745)"):o&&(a="⏳",r="var(--primary-color)"),nn(lr||(lr=gs`
    ...
    `),e.response_time,0===e.hops?"Direct (0 hops)":`${e.hops}`,null!==e.final_snr&&void 0!==e.final_snr?nn(Er||(Er=gs`
          ...
          `),t.map((e,t)=>nn(Br||(Br=gs`
                  ...
                  `),t+1,e.hash,e.snr.toFixed(2)))):nn(Lr||(Lr=gs``)))}_close(){this.open=!1,this.dispatchEvent(new CustomEvent("trace-dialog-closed",{bubbles:!0,composed:!0}))}};ql.styles=[Nn,ws(Vr||(Vr=gs`
  ...
  `))],ms([Tn({type:Boolean})],ql.prototype,"open",void 0),ms([Tn({type:String})],ql.prototype,"contactName",void 0),ms([Tn({type:Object})],ql.prototype,"result",void 0),ms([Tn({type:String})],ql.prototype,"error",void 0),ms([Tn({type:Array})],ql.prototype,"availableRepeaters",void 0),ms([Tn({type:Object})],ql.prototype,"targetContact",void 0),ms([In()],ql.prototype,"pathMode",void 0),ms([In()],ql.prototype,"pathHops",void 0),ms([In()],ql.prototype,"enteredPath",void 0),ms([In()],ql.prototype,"_repeaterFilter",void 0),ms([In()],ql.prototype,"_running",void 0),ql=ms([An("meshcore-trace-dialog")],ql);let Wl=class extends Sn{constructor(){super(),this.open=!1,this.contacts=[],this._typeFilter="all",this._search="",this._onTypeChange=e=>{this._typeFilter=e.target.value},this._onSearchInput=e=>{this._search=e.target.value},this._close=()=>{this.dispatchEvent(new CustomEvent("target-picker-closed",{bubbles:!0,composed:!0}))},gl(this,{isOpen:()=>this.open,onEscape:()=>this._close()})}willUpdate(e){e.has("open")&&this.open&&!e.get("open")&&(this._typeFilter="all",this._search="")}render(){if(!this.open)return nn(Hr||(Hr=gs``));const e=this._search.trim().toLowerCase(),t=this.contacts.filter(e=>{switch(this._typeFilter){case"all":default:return!0;case"client":return 1===e.type;case"repeater":return 2===e.type;case"room_server":return 3===e.type;case"sensor":return 4===e.type}}).filter(t=>{if(!e)return!0;const i=(t.adv_name||"").toLowerCase(),o=(t.pubkey_prefix||"").toLowerCase();return i.includes(e)||o.startsWith(e)}).sort((e,t)=>(e.adv_name||"").localeCompare(t.adv_name||""));return nn(Ur||(Ur=gs`
    ...
    `),this._close,e=>e.stopPropagation(),this._close,this._typeFilter,this._onTypeChange,this._search,this._onSearchInput,0===t.length?nn(jr||(jr=gs`<div class="empty">No matching contacts</div>`)):t.map(e=>nn(qr||(qr=gs`
                  ...
                  `),()=>this._select(e),e.adv_name||e.pubkey_prefix,this._iconFor(e.type),e.adv_name||e.pubkey_prefix,(e.pubkey_prefix||"").substring(0,2).toUpperCase())))}_iconFor(e){switch(e){case 2:return nn(Wr||(Wr=gs`<svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor"><path d="M12 2a2 2 0 012 2c0 .74-.4 1.39-1 1.73V10h4.27c.15-.86.45-1.66.87-2.36l-1.82-1.06a.5.5 0 01-.18-.68l.5-.87a.5.5 0 01.68-.18l1.81 1.05C19.66 4.66 20.78 4 22 4v2c-.8 0-1.54.32-2.08.84l1.5 2.6a.5.5 0 01-.18.68l-.87.5a.5.5 0 01-.68-.18L18.2 7.92c-.14.65-.2 1.33-.2 2.08 0 3.31-2.69 6-6 6s-6-2.69-6-6 2.69-6 6-6z"/></svg>`));case 3:return nn(Kr||(Kr=gs`<svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor"><path d="M4 6h16v4H4V6zm0 8h16v4H4v-4zm2-6.5A.5.5 0 116 7a.5.5 0 010 .5zm0 8A.5.5 0 116 15a.5.5 0 010 .5z"/></svg>`));case 4:return nn(Gr||(Gr=gs`<svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor"><path d="M12 2a4 4 0 00-4 4v7.55A5.5 5.5 0 1015.5 20a5.47 5.47 0 00.5-2.45V6a4 4 0 00-4-4zm0 2a2 2 0 012 2v8.1a3.5 3.5 0 11-4 0V6a2 2 0 012-2z"/></svg>`));default:return nn(Xr||(Xr=gs`<svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor"><path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/></svg>`))}}_select(e){this.dispatchEvent(new CustomEvent("target-selected",{detail:e,bubbles:!0,composed:!0}))}};Wl.styles=[Nn,ws(Yr||(Yr=gs`
      :host { display: contents; }
